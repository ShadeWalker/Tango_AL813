    ...
    public static IPhoneAccountExt getPhoneAccountExt() {
        if (sPhoneAccountExt == null) {
            synchronized (IPhoneAccountExt.class) {
                if (sPhoneAccountExt == null) {
                    sPhoneAccountExt = (IPhoneAccountExt) MPlugin.createInstance(
                            IPhoneAccountExt.class.getName(), TelecomGlobals.getInstance().getContext());
                    if (sPhoneAccountExt == null) {
                        sPhoneAccountExt = new DefaultPhoneAccountExt();
                    }
