...
import com.mediatek.telecom.SmartBookUtils;
...
public class CallActivity extends Activity {
    ...
    private void verifyCallAction(Intent intent) {
        if (CallActivity.class.getName().equals(intent.getComponent().getClassName())) {
            ...
            if (!Intent.ACTION_CALL.equals(intent.getAction()) && !Intent.ACTION_PICK.equals(intent.getAction())) {
    ...
    private void processOutgoingCallIntent(Intent intent) {
        ...
        Log.d(this, "user manager not return ");
    ...
    private boolean sendBroadcastToReceiver(Intent intent) {
        ...
        // /added by guofeiyao 
        int id = intent.getIntExtra("slot_id",-1);
		Log.d("guofeiyao","slot_id in CallAc:" + id);
        // /end
