...
class MissedCallNotifier extends CallsManagerListenerBase {
    ...
    void showMissedCallNotification(Call call) {
        ...
        if (mMissedCallCount == 1) {
           ...
           if (call.isNameEmpty() && (!TextUtils.isEmpty(expandedText)) && langage.startsWith("ar")||langage.startsWith("fa")||langage.startsWith("iw")) {
            //HQ_baozhan 2015-12-30 modified for reset title HQ01609043
        ...
        builder.setSmallIcon(android.R.drawable.stat_notify_missed_call)
                ...
                .setWhen(System.currentTimeMillis() - call.getAgeMillis())//HQ_wuruijun add for HQ01622569
