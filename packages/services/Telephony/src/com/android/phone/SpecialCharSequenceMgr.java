...
public class SpecialCharSequenceMgr {
    ...
    static boolean handleCharsForLockedDevice(Context context,
        ...
        if (SystemProperties.getBoolean("ro.config.show_edialer_imei", false)) {
    ...
    static boolean handleDeviceIdDisplay(Context context, String input) {
        ...
        if (telephonyManager != null && input.equals(MMI_IMEI_DISPLAY)) {
            //int labelResId = (telephonyManager.getPhoneType() == TelephonyManager.PHONE_TYPE_GSM) ? R.string.imei : R.string.meid;
            ...
            */
            ...
            Log.d(TAG, "handleDeviceIdDisplay:meid: " + meid + " imei1 " + imei1 + " imei2 " + imei2+ " product " + productName + " PLMN " + OperatorIsoCountry);

            if (productName.equalsIgnoreCase("TAG-TL00") && OperatorIsoCountry.equals("cn")){
                //meid
