...
/*
because huawei requirement changed,so mask it. but now not remove for unexpected modification in future 
		if(SystemProperties.get("ro.config.emergency_call_taiwan").equals("1")){
			errorMessageId = R.string.incall_error_of_airplane;
		  }
*/
