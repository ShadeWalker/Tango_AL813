...
import android.os.SystemProperties;//add by zhaizhanfeng for voicemail is vibration enabled at 151207


public class VoicemailNotificationSettingsUtil {
	
	private static final String VOICEMAIL_NOTIFICATION_IS_FOLLOW_NOTIFICATION = "is_follow_notification_";
    ...
    public static boolean isVibrationEnabled(Phone phone) {
		...
		//add by zhaizhanfeng for voicemail is vibration enabled at 151207 start
		if(SystemProperties.get("ro.hq.voice.mail.is.vibration").equals("1")){
        	return prefs.getBoolean(getVoicemailVibrationSharedPrefsKey(phone), true /* defValue */);
		}else{
		//add by zhaizhanfeng for voicemail is vibration enabled at 151207 end
   ...
   public static void setRingtoneUri(Phone phone, Uri ringtoneUri) {
    ...
    public static String getVoicemailRingtoneFollowSharedPrefsKey(Phone phone) {
        return VOICEMAIL_NOTIFICATION_IS_FOLLOW_NOTIFICATION + phone.getSubId();
    }
}
