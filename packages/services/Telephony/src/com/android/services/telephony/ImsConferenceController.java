    ...
    private void recalculateConference() {
        ...
        while (it.hasNext()) {
            ...
            if (connection.isImsConnection() && connection.getOriginalConnection() != null &&
                    ...
                    !connection.getOriginalConnection().isRinging()) {
                    /// @}
        ...
        /// M: ALPS02046774. @{
        for (ImsConference conf : mImsConferences) {
            Log.v(this, "recalculate conference capability for " + conf);
            conf.updateConferenceCapability();
        }
        /// @}
    }
