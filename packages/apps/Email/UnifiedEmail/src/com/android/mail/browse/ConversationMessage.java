...
public final class ConversationMessage extends Message {
    ...
    public int getStateHashCode() {
        /// M: restrict attachment hash code generation. Align the condition with
        /// hasAttachments. Otherwise, the getAttachments return true but the hasAttachments maybe
        /// false. This would cause some UI rendering issue.
        return Objects.hashCode(uri, hasAttachments ? getAttachmentsStateHashCode() : 0);
    }
