...
public class ConfirmDialogFragment extends DialogFragment {
    ...
    private final AlertDialog.OnClickListener POSITIVE_ACTION = new AlertDialog.OnClickListener() {
        ...
        public void onClick(DialogInterface arg0, int arg1) {
            ...
            // development.
            /** M: check activity to avoid npe. @{*/
            ControllableActivity activity = (ControllableActivity) getActivity();
            if (activity != null) {
                final AlertDialog.OnClickListener listener = activity
                        .getConversationUpdater().getListener();
                if (listener != null) {
                    listener.onClick(arg0, arg1);
                }
            } else {
                LogUtils.w(DIALOG_TAG, "can not get activity.");
            }
            /**@}*/
        }
    };
