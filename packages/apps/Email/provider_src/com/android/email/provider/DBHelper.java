...
public final class DBHelper {
    ...
    private static final String TRIGGER_ACCOUNT_DELETE =
        ...
        " where " + SmartPush.ACCOUNT_KEY + "=old." + BaseColumns._ID +
        "; end";
    ...
    //              exchange accounts.
    // Version 127: Added MAX_ATTACHMENT_SIZE to the account table

    // Version 128: Add credentials table for OAuth.
    // Version 129: Decode address lists for To, From, Cc, Bcc and Reply-To columns in Message.
    // Version 130: Force mFlags to contain the correct flags for EAS accounts given a protocol
    //              version above 12.0
    ...
    private static void upgradeJB2SmartPush(SQLiteDatabase db) {
        try {
            ...
            Cursor accountCursor = db.query(Account.TABLE_NAME, new String[]{
                    AccountColumns._ID, AccountColumns.FLAGS, AccountColumns.SYNC_INTERVAL}, null, null, null, null, null);
