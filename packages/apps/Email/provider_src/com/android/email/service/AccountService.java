    ...
    private final IAccountService.Stub mBinder = new IAccountService.Stub() {
        ...
        public void notifySendingFailed(long accountId, int messageCount) {
            SendNotificationProxy.getInstance(mContext).showSendingNotification(accountId,
                    EmailNotificationController.SEND_FAILED, messageCount);
        }
        ...
        public void notifySendingSucceeded(long accountId, int messageCount) {
            SendNotificationProxy.getInstance(mContext).showSendingNotification(accountId,
                    EmailNotificationController.SEND_COMPLETE, messageCount);
        }
        ...
        public void notifySendingStarted(long accountId, int messageCount) {
            SendNotificationProxy.getInstance(mContext).showSendingNotification(accountId,
                    EmailNotificationController.SEND_MAIL, messageCount);
        }
