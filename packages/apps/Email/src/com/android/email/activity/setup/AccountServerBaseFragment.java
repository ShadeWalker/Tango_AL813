...
public abstract class AccountServerBaseFragment extends AccountSetupFragment
    ...
    public void onClick(View v) {
        ...
        if (viewId == R.id.cancel) {
            ...
            /// M: Block "done" button for 1s to avoid flicking
            blockNextButton();
            collectUserInput();
        } else {
            super.onClick(v);
    ...
    /**
     * M: Override setNextButtonEnabled from AccountSetupFragment
    ...
    /**
     * M: Is "done" button was enabled
     */
    @Override
    public boolean isNextButtonEnabled() {
        if (mProceedButton != null) {
            return mProceedButton.isEnabled();
        } else {
