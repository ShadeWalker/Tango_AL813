...
public class EditQuickResponseDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextUtilities.setupLengthFilter(mQuickResponseEditText, getActivity(),
                Configuration.COMMON_EDITVIEW_MAX_LENGTH,
                getActivity().getString(R.string.not_add_more_text));
