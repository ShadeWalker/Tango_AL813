...
public class PackageInstallerActivity extends Activity implements OnCancelListener, OnClickListener {
    ...
    private void startInstallConfirm() {
        ...
        if (mScrollView == null) {
            ...
            {
             mOkCanInstall = false;
             Toast.makeText(PackageInstallerActivity.this, getString(R.string.wifi_dont_use_wifi_childmode_on), Toast.LENGTH_SHORT).show(); 
            }
            else
            {
    ...
    /*add by lihaizhou for ChildMode at 2015-08-22 by begin*/
       private boolean isForbidInstallApp() {
        if (!ChildMode.isChildModeOn(this.getContentResolver())) {
            Log.i(TAG, "Not child mode, pass install app.");
            return false;
        }
        String result = ChildMode.getString(this.getContentResolver(),
    ...
    /*add by lihaizhou for ChildMode at 2015-08-22 by end*/
    ...
    public Dialog onCreateDialog(int id, Bundle bundle) {
        ...
        case DLG_UNKNOWN_SOURCES:
        	/* HQ_tanyali 2015-10-20 modified for HQ01355348*/
    		super.setTheme(getResources().getIdentifier("androidhwext:style/Theme.Emui.Dialog", null, null));
    ...
    private void launchSettingsAppAndFinish() {
        ...
        //mod by HQ_machao1 at 20150724 HQ01259541 begin
        //launchSettingsIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        //startActivity(launchSettingsIntent);
        startActivityForResult(launchSettingsIntent, 1);
        //finish();
        //mod by HQ_machao1 at 20150724 HQ01259541 end
    }
    ...
    private boolean isInstallRequestFromUnknownSource(Intent intent) {
        ...
        /* HQ_tanyali 2015-10-20 modified for HQ01488835 begin*/
        String[] strArray={"com.portal"};
        for (int i=0;i<strArray.length;i++) {
            if (strArray[i].equals(callerPackage)) {
                return false;
            }
        }
        /* HQ_tanyali 2015-10-20 modified for HQ01488835 end*/
    ...
    protected void onCreate(Bundle icicle) {
		...
		if(intent == null)
			return; //modify by majian for NULL intent fatal error
		...
		/*HQ_liugang add for HQ01429947 20151008*/
		if( mPackageURI != null){
