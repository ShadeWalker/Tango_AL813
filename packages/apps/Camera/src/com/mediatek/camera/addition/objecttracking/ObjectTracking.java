...
public class ObjectTracking extends CameraAddition implements OtListener {
    ...
    private boolean isSupportOtCases() {
        ...
        featureSupport = !(FEATURE_ON.equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_SMILE_SHOT))
                || FEATURE_ON.equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_GESTURE_SHOT))
                || FEATURE_ON.equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_HDR))
                || FEATURE_ON.equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_ASD))
                || FEATURE_ON.equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_PANORAMA))
                || FEATURE_ON.equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_MAV))
                || FEATURE_ON.equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_LIVE_PHOTO))
                || FEATURE_ON.equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_SLOW_MOTION))
                || FEATURE_ON.equals(mISettingCtrl.getSettingValue(SettingConstants.KEY_MOTION_TRACK)));
