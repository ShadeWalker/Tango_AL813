...
public class EffectRotateLayout extends ViewGroup implements Rotatable {
    private static final String TAG = "EffectRotateLayout";
    ...
    public EffectRotateLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setOrientation(int orientation, boolean animation) {
        Log.d(TAG, "[setOrientation]orientation = " + orientation + ",mOrientation = "
