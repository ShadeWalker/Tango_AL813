...
import com.mediatek.camera.util.IAppGuide.OnGuideFinishListener;
...
public class ModuleManager {
    ...
    public ModuleManager(Activity activity, IFileSaver fileSaver, ICameraAppUi cameraAppUi,
            IFeatureConfig featureConfig, ICameraDeviceManager deviceManager, IModuleCtrl moduleCtrl, ISelfTimeManager iSelfTimeManager) {
        ...
        mCameraAppguide = new CameraAppGuide(activity);
    ...
    public void onFullScreenChanged(boolean full) {
        mAdditionManager.execute(ActionType.ACTION_ON_FULL_SCREEN_CHANGED, false, full);
        mICameraMode.execute(ActionType.ACTION_ON_FULL_SCREEN_CHANGED, full);
    }
    ...
    // Click the setting icon ,need notify current mode,such as FaceBeauty and
    // MotionTrack
    ...
    public void showCameraAppguide(String type, final OnGuideFinishListener listener) {
        mCameraAppguide.showCameraGuide(type, listener);
    }
    
    public void dismissCameraAppguide() {
        mCameraAppguide.dismiss();
    }
    public void configurationChanged() {
        mCameraAppguide.configurationChanged();
