...
public interface ISettingRule {
    ...
    /**
     * Add one limitation. If the given value is equal with condition, then the
     * result will be selected in result array and mapping finder.
     * 
     * @param condition
     *            the condition value.       
     * @param result
     *            the result values.
     * @param mappingFinder
     *            execute some logic to find out the result value from result array.
     *            
     */
