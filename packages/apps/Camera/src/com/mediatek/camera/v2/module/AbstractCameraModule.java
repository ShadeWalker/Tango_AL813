...
public abstract class AbstractCameraModule implements 
    ...
    public void open(Activity activity, boolean isSecureCamera, boolean isCaptureIntent) {
        ...
        mAaaManager.open(activity, mAppUi.getModuleLayoutRoot(), isCaptureIntent);
        mAdditionManager.open(activity, mAppUi.getModuleLayoutRoot(), isCaptureIntent);
        ...
        mSettingServant.registerSettingChangedListener(this, null, ISettingChangedListener.LOW_PRIORITY);
    ...
    public void onPreviewAreaChanged(RectF previewArea) {
        mAdditionManager.onPreviewAreaChanged(previewArea);
        mAaaManager.onPreviewAreaChanged(previewArea);
