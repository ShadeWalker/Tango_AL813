...
import com.mediatek.camera.v2.stream.PreviewStreamController.PreviewCallback;
...
public class StreamManager {
    ...
    public PreviewStreamController getPreviewController(int modeId) {
    ...
    public CaptureStreamController getCaptureController(int modeId) {
        return chooseCaptureStreamByModeId(modeId);
    }
    
    public RecordStreamController getRecordController(int modeId) {
    ...
    private PreviewStreamController choosePreviewStreamByModeId(int modeId) {
        Log.i(TAG, " choosePreviewStreamByModeId modeId = " + modeId);
        PreviewStreamController controller = getPreviewStream();
        switch (modeId) {
    ...
    private CaptureStreamController chooseCaptureStreamByModeId(int modeId) {
        Log.i(TAG, " chooseCaptureStreamByModeId modeId = " + modeId);
        CaptureStreamController controller = getCaptureStream();
        switch (modeId) {
        case ModeChangeListener.MODE_CAPTURE:
    ...
    private RecordStreamController chooseRecordStreamByModeId(int modeId) {
        Log.i(TAG, " chooseRecordStreamByModeId modeId = " + modeId);
        RecordStreamController controller = getRecordStream();
        switch (modeId) {
        case ModeChangeListener.MODE_CAPTURE:
