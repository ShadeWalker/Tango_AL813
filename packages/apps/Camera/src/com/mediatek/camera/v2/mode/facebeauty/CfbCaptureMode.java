...
public class CfbCaptureMode extends CaptureMode {
    ...
    private void onCameraSwitch() {
        // Need reopen current effect Hal,otherwise will found the session
        // is configure fail when switch camera
        // Need check with native, current Effect Hal statues is error ?TODO
        closeCfbEffectHal();
        openCfbEffectHal();
    }
