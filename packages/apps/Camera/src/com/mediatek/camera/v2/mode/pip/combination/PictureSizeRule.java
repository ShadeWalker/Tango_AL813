...
public class PictureSizeRule implements ISettingRule {
    ...
    public void execute() {
        ...
        if ("on".equalsIgnoreCase(pipKeyValue)) {
            ...
            Size bottomPictureSize = Utils.getSize(mSettingServant.getSettingValue(SettingKeys.KEY_PICTURE_SIZE));
            ...
            Size topPictureSize = Utils.filterSupportedSize(Utils.getSizeList(topSupportedPictureSizes), 
                    bottomPictureSize, 
            ...
            Log.i(TAG, "Enter Bottom:" + Utils.buildSize(bottomPictureSize) + 
                    " Top:" + Utils.buildSize(topPictureSize) + " mCurrentCameraId:" + mCurrentCameraId);
