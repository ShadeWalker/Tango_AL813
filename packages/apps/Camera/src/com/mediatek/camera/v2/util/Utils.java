...
public class Utils {
    ...
    public static CameraCharacteristics getCameraCharacteristics(Activity activity, String cameraId) {
    ...
    public static Bitmap createBitmapFromVideo(String filePath, FileDescriptor fd,int targetWidth) {
        Bitmap bitmap = null;
        MediaMetadataRetriever retriever = new MediaMetadataRetriever();
        Log.i("mmTAG","filePath = " + filePath + " : fd = " + fd + " : targetWidth  = " + targetWidth);
        try {
            if (filePath != null) {
    ...
    private static boolean checkAspectRatiosMatch(Size a, Size b) {
        ...
        return Math.abs(aAspect - bAspect) < 0.0001f;//ASPECT_RATIO_TOLERANCE;
    }
}
