...
public class SmileDetection implements ISmileDetectionController {
    ...
    private SmileDetectionListener mSmileDetectionListener = new SmileDetectionListenerImpl();
    ...
    public SmileDetection(ISmileDetectionDevice device) {
        mSmileDetectionDevice = device;
        mSmileDetectionDevice.setSmileDetectionListener(mSmileDetectionListener);
    }

    @Override
    public void startSmileDetection() {
        Log.i(TAG, "startSmileDetection");
        mSmileDetectionDevice.startSmileDetection();
        if (mSmileDetectionStatus != null) {
            mSmileDetectionStatus.onSmileStarted();
        }
    }
    ...
    public void stopSmileDetection() {
        ...
        mSmileDetectionDevice.stopSmileDetection();
    }

    public void registerListener(ISmileDetectionStatus status) {
        mSmileDetectionStatus = status;
    }
