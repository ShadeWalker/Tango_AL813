...
/**
 * The class acts as a role of a view(although there is not any view of smile
 * Detection currently).
 * 
 */
public class SmileDetectionView {
    ...
    private ISmileDetectionStatus mSmileDetectionStatus = new SmileDetectionStatusImpl();

    public SmileDetectionView(Activity activity, SmileDetection smileDetection, AppUi appUi) {
        mAppUi             = appUi;
        mActivity          = activity;
        mSmileDetection    = smileDetection;
        mSmileDetection.registerListener(mSmileDetectionStatus);
    }
