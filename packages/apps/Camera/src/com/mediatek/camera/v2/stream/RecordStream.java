...
public class RecordStream implements RecordStreamController {
    ...
    // status observer
    private final ArrayList<RecordStreamStatus>
    ...
    // video part
    private int                                 mVideoSource;// = MediaRecorder.VideoSource.SURFACE;
