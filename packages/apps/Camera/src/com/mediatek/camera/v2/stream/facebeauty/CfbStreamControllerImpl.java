...
public class CfbStreamControllerImpl implements ICfbStreamController, CaptureStreamController {
    ...
    private List<String> mAllSupportedVersions = new ArrayList<String>();
    private List<EffectHalVersion> mCfbSupporteVersions = new ArrayList<EffectHalVersion>();
    ...
    public CfbStreamControllerImpl(
            CaptureStreamController captureStreamController) {
    ...
    public void openStream(StreamStatusCallback streamStatusCallback) {
        ...
        try {
            // Step One: get all the supported versions
            // mCameraEffectHalManager.getAllSupportedVersions(mAllSupportedVersions);
            // Step Two: Need Check how to get the CFB version TODO
            // mCameraEffectHalManager.getSupportedVersion(BaseParameters.KEY_EFFECT_NAME_CFB,
            // mCfbSupporteVersions);
    ...
    private void setOutputSurface(List<Surface> surfaces, List<BaseParameters> surfaceParameters) {
        ...
        if (mCameraEffect != null) {
            ...
            try {
                mCameraEffectHalSession = mCameraEffect.createCaptureSession(surfaces,
    ...
    private com.mediatek.mmsdk.CameraEffectSession.SessionStateCallback mSessionStateCallback = new com.mediatek.mmsdk.CameraEffectSession.SessionStateCallback() {
