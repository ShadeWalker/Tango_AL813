...
import com.mediatek.camera.v2.addition.smiledetection.SmileDetection.SmileDetectionListener;
...
public class SmileDetectionDeviceImpl implements ISmileDetectionDevice {
    ...
    private SmileDetectionListener mListener;
    ...
    public SmileDetectionDeviceImpl(IAdditionListener additionListener) {
    ...
    public void startSmileDetection() {
        ...
        mAdditionListener.requestChangeCaptureRequets(false,mAdditionListener.getRepeatingRequestType(),
    ...
    @Override
    public void setSmileDetectionListener(SmileDetectionListener listener) {
        mListener = listener;
    }
    ...
    private class CaptureObserver implements IAdditionCaptureObserver {
        ...
        public void configuringRequests(CaptureRequest.Builder requestBuilder, RequestType requestType) {
            ...
            requestBuilder.set(TagRequest.STATISTICS_SMILE_MODE,
                    TagMetadata.MTK_FACE_FEATURE_SMILE_MODE_SIMPLE);
        }
        ...
        public void onCaptureCompleted(CaptureRequest request, TotalCaptureResult result) {
            ...
            Log.i(TAG, "onCaptureCompleted smileResult is " + smileResult);
