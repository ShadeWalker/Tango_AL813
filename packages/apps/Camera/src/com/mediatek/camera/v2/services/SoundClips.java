...
public class SoundClips {
    ...
    private static class MediaActionSoundPlayer implements Player {
        private static final String TAG = "CAM_API2/MediaActionSoundPlayer";
    ...
    private static class SoundPoolPlayer implements Player, SoundPool.OnLoadCompleteListener {
        ...
        private static final String TAG = "CAM_API2/SoundPoolPlayer";
        private static final int NUM_SOUND_STREAMS = 1;
        private static final int[] SOUND_RES = { // Soundtrack res IDs.
        R.raw.focus_complete, R.raw.video_record, R.raw.video_record, R.raw.shutter };
