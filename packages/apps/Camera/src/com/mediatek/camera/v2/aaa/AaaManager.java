...
public class AaaManager implements IAaaManager,
                        IAaaListener, 
                        IAaaController,
    ...
    public AaaManager(AppController app, ModuleListener moduleListener, boolean isAutoCtrl, String cameraId) {
        Log.i(TAG, "AaaManager cameraId: " + cameraId);
    ...
    public void configuringSessionRequests(
        ...
        int nativeSceneMode = SettingConvertor.getNativeValue(SettingKeys.KEY_SCENE_MODE, mSceneMode);
        ...
        while (iterator.hasNext()) {
            ...
            mFocus.configuringSessionRequest(requestType, requestBuilder, captureType, bottomCamera);
            mExposure.configuringSessionRequest(requestType, requestBuilder, bottomCamera);
    ...
    private void updateSceneMode() {
        ...
        if (currentsceneMode != null && !currentsceneMode.equals(mSceneMode)) {
            ...
            requestChangeCaptureRequets(false, getRepeatingRequestType(), CaptureType.REPEATING_REQUEST);
        }
        Log.i(TAG, "[updateSceneMode]- ");
    }
