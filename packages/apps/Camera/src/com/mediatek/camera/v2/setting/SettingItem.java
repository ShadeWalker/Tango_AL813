...
public class SettingItem {
    ...
    private List<SettingItem> mEffectedSetting = new ArrayList<SettingItem>();
    ...
    public void addEffectdSetting(SettingItem item) {
        if (!mEffectedSetting.contains(item)) {
            mEffectedSetting.add(item);
        }
    }
    
    public List<SettingItem> getEffectedSetting() {
        return mEffectedSetting;
    }
