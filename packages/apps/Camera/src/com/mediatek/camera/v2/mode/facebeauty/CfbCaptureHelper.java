...
public class CfbCaptureHelper {
    ...
    /**
     * in native:alps/vendor/mediatek/proprietary/platform/mt6752/hardware/mtkcam/hal/aaa/aaa_hal_raw.cpp,
    ...
    public static void saveJpegExifInfo(byte[] data, TotalCaptureResult result) {
