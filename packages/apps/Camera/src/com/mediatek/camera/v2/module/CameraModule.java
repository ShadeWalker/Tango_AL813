...
public class CameraModule extends AbstractCameraModule {
    ...
    public CameraModule(AppController app) {
        super(app);
        mAdditionManager         = new AdditionManager(app, this, null);
        mAaaManager              = new AaaManager(app, this, true, null);
    }
    ...
    public void onOrientationChanged(int orientation) {
        ...
        mAdditionManager.onOrientationChanged(mOrientation);
    }
    ...
    protected boolean checkSatisfyCaptureCondition() {
        if (mCameraDevice == null) {
            Log.i(TAG, "checkSatisfyCaptureCondition Photo Shutter Cliecked but mCameraDevice = " + mCameraDevice);
            return false;
        }
        return true;
    }
    ...
    private CameraSessionCallback mCameraSessionCallback = new CameraSessionCallback() {
        ...
        public void onSessionConfigured() {
            requestChangeCaptureRequets(true/*sync*/,getDefaultRepeatingRequest(), CaptureType.REPEATING_REQUEST);
        };
    ...
    private class ModeChangeListanerImpl implements ModeChangeListener {
        ...
        public void onModeSelected(int modeIndex) {
            Log.i(TAG, "onModeSelected old --> new : " + mCurrentModeIndex + " --> " + modeIndex);
    ...
    private void openCamera() {
        ...
        mCameraDeviceManager.open(mCameraId, mCameraStateCallback, mCameraSessionCallback, mCameraHandler);
    }
    ...
    private void sendRequestChanging(RequestType requestType, CaptureType captureType,boolean sync) {
        if (mCameraDevice == null) {
