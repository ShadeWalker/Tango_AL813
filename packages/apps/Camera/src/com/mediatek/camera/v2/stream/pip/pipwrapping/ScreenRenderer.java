...
//        if (mPreviewSurface == surface && mRenderTexWidth > 2 && mRenderTexHeight > 2
//                && (getRendererWidth() != mRenderTexWidth || getRendererHeight() != mRenderTexHeight)) {
...
//            int rotation = rotated? getDisplayRotation(getActivity()) : 0;
    ...
    private class ScreenHandler extends Handler {
        ...
        private void doDraw(AnimationRect topGraphicRect, int texId, boolean highlight) {
            ...
            if (topGraphicRect != null) {
                ...
                mEditTexRenderer.draw(topGraphicRect.getRightBottom()[0], topGraphicRect.getRightBottom()[1], mEditTexSize, null);
            }
