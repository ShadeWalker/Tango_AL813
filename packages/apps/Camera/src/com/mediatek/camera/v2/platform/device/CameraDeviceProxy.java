...
public interface CameraDeviceProxy {
    ...
    public interface CameraSessionCallback {
        ...
        public CaptureCallback configuringSessionRequests(CaptureRequest.Builder requestBuilder, RequestType requestType, CaptureType captureType);
    }
    /**
     * 
     ...
     *               current design is only for {@link ISettingChangedListener#onSettingChanged(java.util.Map)}
     ...
     */
    public void requestChangeCaptureRequets(boolean sync, RequestType requestType, CaptureType captureType);
