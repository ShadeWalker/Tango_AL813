...
public class CaptureStream implements CaptureStreamController {
    ...
    public boolean updateCaptureSize(Size pictureSize, int pictureFormat) {
        Log.i(TAG, "[updateCaptureSize]+ size:" + pictureSize.getWidth() + "x" + pictureSize.getHeight());
...
//            mImageReader = null;
//        }
        mImageReader = ImageReader.newInstance(mCaptureWidth, mCaptureHeight,pictureFormat, MAX_CAPTURE_IMAGES);
    ...
    public Map<String,Surface> getCaptureInputSurface() {
        ...
        if (mCaptureSurface == null) {
            throw new IllegalStateException("You should call CaptureStream.updateCaptureSize firstly, " +
