...
public class MavProgressIndicator extends ProgressIndicator{
    ...
    public MavProgressIndicator(Activity activity) {
        super(activity);
        Drawable drawable = new MavProgressDrawable(activity, mProgressBars,
                BLOCK_NUMBERS, BLOCK_PADDING);
        mProgressBars.setImageDrawable(drawable);
    }
    ...
    public void setOrientation(int orientation) {
        ...
        progressViewLayout.setOrientation(LinearLayout.HORIZONTAL);
