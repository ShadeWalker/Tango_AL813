...
public class BottomGraphicRenderer extends Renderer {
    ...
    public void setRendererSize(int width, int height, boolean needReverse) {
        Log.i(TAG, "setRendererSize width = " + width + " height = " + height + " needReverse = "
                + needReverse);
        resetMatrix();
    ...
    public void draw(int preTexId, final float[] preTexMtx, final float[] texReverseRotateMtx,
        ...
        GLES20.glUniformMatrix4fv(muTexMtxHandle, 1, false, (preTexMtx == null)? GLUtil.createIdentityMtx() : preTexMtx, 0);
        GLES20.glUniformMatrix4fv(muTexRotateMtxHandle, 1, false, texReverseRotateMtx, 0);
        //sampler
        GLES20.glUniform1i((preTexMtx == null)? muPictureSampleHandle : muPreviewSamplerHandle, sampleId);
        //texture
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0 + sampleId);
        GLES20.glBindTexture((preTexMtx == null)? GLES20.GL_TEXTURE_2D : GLES11Ext.GL_TEXTURE_EXTERNAL_OES, preTexId);
        //draw
