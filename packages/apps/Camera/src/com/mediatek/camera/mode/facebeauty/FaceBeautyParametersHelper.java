...
public class FaceBeautyParametersHelper {
    ...
    private int getMaxLevel(int key) {
        ...
        case FACEBEAUTY_SMOOTH:
            return getInt(KEY_FACEBEAUTY_SMOOTH_MAX, 0);
            
        case FACEBEAUTY_SKIN_COLOR:
            return getInt(KEY_FACEBEAUTY_SKIN_COLOR_MAX, 0);
            
        case FACEBEAUTY_SHARP:
            return getInt(KEY_FACEBEAUTY_SHARP_MAX, 0);
            
        case FACEBEAUTY_BIG_EYES:
            return getInt(KEY_FACEBEAUTY_BIG_EYES_MAX, 0);
            
        case FACEBEAUTY_SLIM:
            return getInt(KEY_FACEBEAUTY_SLIM_MAX, 0);
    ...
    private int getMinLevel(int key) {
        switch (key) {
        case FACEBEAUTY_SMOOTH:
            return getInt(KEY_FACEBEAUTY_SMOOTH_MIN, 0);
            
        case FACEBEAUTY_SKIN_COLOR:
            return getInt(KEY_FACEBEAUTY_SKIN_COLOR_MIN, 0);
            
        case FACEBEAUTY_SHARP:
            return getInt(KEY_FACEBEAUTY_SHARP_MIN, 0);
            
        case FACEBEAUTY_BIG_EYES:
            return getInt(KEY_FACEBEAUTY_BIG_EYES_MIN, 0);
            
        case FACEBEAUTY_SLIM:
            return getInt(KEY_FACEBEAUTY_SLIM_MIN, 0);
    ...
    private int getvFbSharedPreferences(int index) {
        ...
        return getVFBSharedPreference(key, "0");
    }
