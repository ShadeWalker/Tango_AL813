...
public class PipPreviewSizeRule implements ISettingRule {
    ...
    public void execute() {
        ...
        if (mSwitchingPip) {
            ...
            mISettingCtrl.setSettingValue(SettingConstants.KEY_PICTURE_RATIO, previewRatio, deviceManager
                    .getCurrentCameraId());
    ...
    private void setPreviewSize(Context context, Parameters parameters, String prviewRatio) {
        ...
        Size optimalSize = SettingUtils.getOptimalPreviewSize(context, sizes, previewRatio, false, true);
