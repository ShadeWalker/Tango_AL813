...
public class MediaRecorderWrapper implements MediaCodecRecorder.OnInfoListener, MediaRecorder.OnInfoListener {
    ...
    public void setVideoEncoder(int video_encoder) throws IllegalStateException, IllegalArgumentException {
    ...
    public void setAudioEncoder(int audio_encoder) throws IllegalStateException, IllegalArgumentException {
    ...
    /**
      ...
      * In addition, call MediaRecorderWrapper.start() to resume the recorder after this method is called.
      *
