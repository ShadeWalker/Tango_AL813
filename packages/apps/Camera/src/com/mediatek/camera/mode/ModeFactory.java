...
import com.mediatek.camera.mode.livephoto.LivePhotoMode;
import com.mediatek.camera.mode.mav.MavMode;
import com.mediatek.camera.mode.motiontrack.MotionTrackMode;
...
public class ModeFactory {
    ...
    public ICameraMode createMode(CameraModeType type, ICameraContext cameraContext) {
        ...
        case EXT_MODE_MAV:
            return new MavMode(cameraContext);
        ...
        case EXT_MODE_MOTION_TRACK:
            return new MotionTrackMode(cameraContext);
            
        case EXT_MODE_VIDEO:
            return new VideoMode(cameraContext);
            
        case EXT_MODE_LIVE_PHOTO:
            return new LivePhotoMode(cameraContext);
