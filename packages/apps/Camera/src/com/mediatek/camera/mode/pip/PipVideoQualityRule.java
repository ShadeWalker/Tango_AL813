...
public class PipVideoQualityRule implements ISettingRule {
    ...
    private static final String VIDEO_QUALITY_LOW = Integer.toString(CamcorderProfileEx.QUALITY_LOW);
    private static final String VIDEO_QUALITY_MEDIUM = Integer.toString(CamcorderProfileEx.QUALITY_MEDIUM);
    private static final String VIDEO_QUALITY_HIGH = Integer.toString(CamcorderProfileEx.QUALITY_HIGH);
    private static final String VIDEO_QUALITY_FINE = Integer.toString(CamcorderProfileEx.QUALITY_FINE);
    private static final String VIDEO_QUALITY_FINE_4K2K = Integer.toString(CamcorderProfileEx.QUALITY_FINE_4K2K);
