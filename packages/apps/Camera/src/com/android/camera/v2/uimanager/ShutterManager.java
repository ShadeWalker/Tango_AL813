...
public class ShutterManager extends AbstractUiManager {
    ...
    private List<OnShutterButtonListener> mPhotoListeners = new ArrayList<OnShutterButtonListener>();
    private Shutteristener                mPhotoShutterButtonListener;

    private List<OnShutterButtonListener> mVideoListeners = new ArrayList<OnShutterButtonListener>();
    ...
    public void removeShutterButtonListener(OnShutterButtonListener listener, boolean videoShutter) {
        if (videoShutter) {
            if (listener != null && mVideoListeners.contains(listener)) {
                mVideoListeners.remove(listener);
            }
