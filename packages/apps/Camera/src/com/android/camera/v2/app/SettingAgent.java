...
public interface SettingAgent {
    ...
    public interface SettingChangedListener {
        public void onSettingResult(Map<String, String> values, Map<String, String> overrideValues);
    }
    ...
    public void registerSettingChangedListener(SettingChangedListener listener);
