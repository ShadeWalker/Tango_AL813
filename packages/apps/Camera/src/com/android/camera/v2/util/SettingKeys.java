...
public class SettingKeys {
    ...
    public static final int ROW_SETTING_SLOW_MOTION               = 8;//video
    public static final int ROW_SETTING_SMILE_SHOT                = 9;//common
    public static final int ROW_SETTING_GESTURE_SHOT              = 10;
    public static final int ROW_SETTING_HDR                       = 11;//common
    public static final int ROW_SETTING_ASD                       = 12;//common
    public static final int ROW_SETTING_DUAL_CAMERA               = 13;//common
    public static final int ROW_SETTING_EXPOSURE                  = 14;//common
    public static final int ROW_SETTING_SCENCE_MODE               = 15;//common
    public static final int ROW_SETTING_WHITE_BALANCE             = 16;//common
    public static final int ROW_SETTING_COLOR_EFFECT              = 17;//common
    public static final int ROW_SETTING_SELF_TIMER                = 18;//camera
    public static final int ROW_SETTING_CONTINUOUS_NUM            = 19;
    public static final int ROW_SETTING_RECORD_LOCATION           = 20;//common
    public static final int ROW_SETTING_VIDEO_QUALITY             = 21;//camera
    public static final int ROW_SETTING_ISO                       = 22;//camera
    public static final int ROW_SETTING_ANTI_FLICKER              = 23;//common
    public static final int ROW_SETTING_VIDEO_STABLE              = 24;//video
    public static final int ROW_SETTING_MICROPHONE                = 25;//video
    public static final int ROW_SETTING_AUDIO_MODE                = 26;//video
    public static final int ROW_SETTING_TIME_LAPSE                = 27;//video
    public static final int ROW_SETTING_PICTURE_RATIO             = 28;//video
    public static final int ROW_SETTING_PICTURE_SIZE              = 29;//camera
    public static final int ROW_SETTING_ZSD                       = 30;//camera
    public static final int ROW_SETTING_VOICE                     = 31;//camera
    public static final int ROW_SETTING_3DNR                      = 32;
    public static final int ROW_SETTING_SLOW_MOTION_VIDEO_QUALITY = 33;//video
    public static final int ROW_SETTING_AIS                       = 34;//camera
    public static final int ROW_SETTING_SHARPNESS                 = 35;//common
    public static final int ROW_SETTING_HUE                       = 36;//common
    public static final int ROW_SETTING_SATURATION                = 37;//common
    public static final int ROW_SETTING_BRIGHTNESS                = 38;//common
    public static final int ROW_SETTING_CONTRAST                  = 39;//common
    public static final int ROW_SETTING_IMAGE_PROPERTIES          = 40;//common
    public static final int ROW_SETTING_FLASH                     = 41;//common
    public static final int ROW_SETTING_STEREO_MODE               = 42;
    public static final int ROW_SETTING_FACEBEAUTY_PROPERTIES     = 43;//camera
    public static final int ROW_SETTING_FACEBEAUTY_SMOOTH         = 44;//camera
    public static final int ROW_SETTING_FACEBEAUTY_SKIN_COLOR     = 45;//camera
    public static final int ROW_SETTING_FACEBEAUTY_SHARP          = 46;//camera
    public static final int ROW_SETTING_CAMERA_FACE_DETECT        = 47;//camera
    public static final int ROW_SETTING_MULTI_FACE_MODE           = 48;
    public static final int ROW_SETTING_FACEBEAUTY_SLIM           = 49;//mean's slim effect
    public static final int ROW_SETTING_FACEBEAUTY_BIG_EYES       = 50;
    public static final int ROW_SETTING_FAST_AF                   = 51;//common
    public static final int ROW_SETTING_DISTANCE                  = 52;//common
    public static final int ROW_SETTING_DUAL_CAMERA_MODE          = 53;//common
    ...
    static {
        ...
        SETTING_TYPE[ROW_SETTING_MAV]                       = DECIDE_BY_HARDWARE;
        SETTING_TYPE[ROW_SETTING_MOTION_TRACK]              = DECIDE_BY_HARDWARE;
        SETTING_TYPE[ROW_SETTING_PHOTO_PIP]                 = DECIDE_BY_HARDWARE;
        SETTING_TYPE[ROW_SETTING_VIDEO_PIP]                 = DECIDE_BY_HARDWARE;
        SETTING_TYPE[ROW_SETTING_LIVE_PHOTO]                = DECIDE_BY_HARDWARE;
    ...
    static {
        ...
        KEYS_FOR_SETTING[ROW_SETTING_ANTI_FLICKER]          = null;//KEY_ANTI_BANDING;
        ...
        KEYS_FOR_SETTING[ROW_SETTING_TIME_LAPSE]            = null;//KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL;
    ...
    public static final int[] KEYS_UN_SUPPORTED_BY_3TH = {
        ...
        ROW_SETTING_MAV,
        ROW_SETTING_MOTION_TRACK,
        ROW_SETTING_PHOTO_PIP,
        ROW_SETTING_LIVE_PHOTO,
        ROW_SETTING_REFOCUS,
    };
