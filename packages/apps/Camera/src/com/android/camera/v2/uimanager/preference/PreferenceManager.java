...
public class PreferenceManager {
    ...
    private Map<Integer, PreferenceGroup>      mPreferenceGroupMap = new HashMap<Integer, PreferenceGroup>();
    ...
    public void initializePreferences(int preferencesRes, int cameraId) {
        ...
        if (group == null) {
            ...
            for (int i = 0; i < mSettingKeys.length; i++) {
                ...
                List<String> supportedValues = mSettingAgent.getSupportedValues(key, String.valueOf(mCameraId));
        ...
        for (int i = 0; i < mSettingKeys.length; i++) {
            ...
            String sharePreferencesValue = mSettingAgent.getSharedPreferencesValue(key, String.valueOf(mCameraId));
    ...
    public void clearSharedPreferencesValue() {
        ...
        for (int i = 0; i < SettingKeys.KEYS_UN_CLERA.length; i++) {
            int settingId = SettingKeys.KEYS_UN_CLERA[i];
