...
public class SettingManager extends AbstractUiManager implements View.OnClickListener, 
    ...
    public void onSettingChanged(SettingListLayout settingList,
        ...
        if (mSettingChangedListener != null) {
            ...
            Log.i(TAG, "[onSettingChanged], key:" + preference.getKey() + ", value:" + preference.getValue());
    ...
    private void initializeSettings() {
        if (mSettingLayout == null) {
            ...
            // image capture setting, compared to default setting, common settings and video setting 
            // may be different.
            ...
            for (int i = 0; i < size; i++) {
                ...
                // new page view
                SettingListLayout pageView = (SettingListLayout)  mActivity.getLayoutInflater().inflate(
