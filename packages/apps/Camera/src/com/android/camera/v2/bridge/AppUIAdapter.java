...
public class AppUIAdapter implements AppUi {
    ...
    public int getPreviewVisibility() {
        ...
        case CameraAppUI.VISIBILITY_COVERED:
            ...
            break;
        case CameraAppUI.VISIBILITY_HIDDEN:
            localPreviewVisibility = AppUi.PREVIEW_VISIBILITY_HIDDEN;
            break;
        case CameraAppUI.VISIBILITY_VISIBLE:
            localPreviewVisibility = AppUi.PREVIEW_VISIBILITY_VISIBLE;
            break;
        default:
            localPreviewVisibility = AppUi.PREVIEW_VISIBILITY_HIDDEN;
            break;
    ...
    @Override
    public void showReviewView(byte[] jpegData,int orientation) {
        mCameraAppUi.showReviewManager(jpegData,orientation);
    }
