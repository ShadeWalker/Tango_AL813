...
import com.android.camera.externaldevice.SmartBookDeviceCtrl;
import com.android.camera.externaldevice.WfdDeviceCtrl;
...
public class ExternalDeviceManager {
    ...
    public ExternalDeviceManager(CameraActivity cameraActivity) {
        ...
        mIDeviceConnected.add(new SmartBookDeviceCtrl(cameraActivity));
