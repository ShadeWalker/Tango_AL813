...
public class PIPViewManager extends ViewManager implements
    ...
    public void showEffect() {
        ...
        if (getContext().isFullScreen()) {
            if (!mIsShowingPipSetting && getContext().getCameraAppUI().isNormalViewState()
                ...
                initialEffect();
                // getContext().getCameraAppUI().setViewState(CameraActivity.VIEW_STATE_PIP_SETTING);
    ...
    public void onFullScreenChanged(boolean full) {
        ...
        if (!full && mPipSettingLayout != null) {
            removeAllLayout();
            clearListener();
        }
    }
