...
public class PreviewSurfaceView extends SurfaceView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.i(TAG, "onMeasure previewWidth = " + previewWidth + " previewHeight = " + previewHeight);
        ...
        Log.i(TAG, "After onMeasure  aspectRatio = " + mAspectRatio + " previewWidth = " + previewWidth + " previewHeight = " + previewHeight);
    }
     ...
     */
    public void expand() {
        Log.i(TAG, "expand mPreviewWidth = " + mPreviewWidth + " mPreviewHeight = " + mPreviewHeight);
