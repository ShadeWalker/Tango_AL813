...
public class SettingListLayout extends FrameLayout implements InLineSettingItem.Listener,
    ...
    public interface Listener {
        ...
        void onStereoCameraSettingChanged(SettingListLayout settingList, ListPreference preference, int index, boolean showing);
    ...
    @Override
    public void onStereoCameraSettingChanged(InLineSettingItem item, ListPreference preference, int index, boolean showing) {
        if (mLastItem != null && mLastItem != item) {
            mLastItem.collapseChild();
        }
        if (mListener != null) {
