...
public class MockCamcorderProfileHelper {
    ...
    public static CamcorderProfile getMtkCamcorderProfile(int cameraId, int quality) {
        ...
        try {
            ...
            Constructor ctor = c.getDeclaredConstructor(new Class[] { int.class, int.class,
                    int.class, int.class, int.class, int.class, int.class, int.class, int.class,
                    int.class, int.class, int.class });
            ctor.setAccessible(true);
            camcorderProfile = (CamcorderProfile) ctor.newInstance(new Object[] { 30, 10, 2, 2,
                    9000000, 30, 1280, 720, 0, 128000, 44100, 1 });
