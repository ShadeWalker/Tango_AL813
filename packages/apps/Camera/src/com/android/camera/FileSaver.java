...
public class FileSaver {
    ...
    public SaveRequest prepareVideoRequest(int fileType, int outputFileFormat, String resolution,
        ...
        // info.
        VideoOperator operator = new VideoOperator(fileType, outputFileFormat, resolution, rotation);
    ...
    private FileSaverService.FileSaverListener mFileSaverListener = new FileSaverService.FileSaverListener() {
        ...
        public void onFileSaved(SaveRequest request) {
            // here should not call r.notifyListener, otherwise will call
            // MavActor onFileSaver twice
            // lead call start animation twice, capture animation in Mav will
            // tearing
    ...
    private synchronized String createName(int fileType, long dateTaken, int count) {
        if (mFileNamer == null) {
            ...
            mFileNamer.put(Storage.FILE_TYPE_LIV,
                    new ImageFileNamer(mContext.getString(R.string.livephoto_file_name_format)));
        }
    ...
    private abstract class RequestOperator implements SaveRequest {
        ...
        // camera decouple
        protected boolean mNeedSaveToDB = true;
        ...
        @Override
        public void needSaveToDataBase(boolean insertDb) {
            mNeedSaveToDB = insertDb;
        }
