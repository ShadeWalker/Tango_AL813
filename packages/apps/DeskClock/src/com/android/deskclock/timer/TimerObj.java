...
public class TimerObj implements Parcelable {
    ...
    public void writeToSharedPref(SharedPreferences prefs) {
        ...
        /**
         * M:Use the copy obj to commit add operation to avoid concurrence
         * exception@{
         */
        Set<String> copyTimeList = new HashSet<String>(timersList);
        copyTimeList.add(id);
        editor.putStringSet(PREF_TIMERS_LIST, copyTimeList);
        /** @} */
    ...
    public void deleteFromSharedPref(SharedPreferences prefs) {
        ...
        /**
         * M:Use the copy obj to commit remove operation to avoid concurrence
         * exception@{
         */
        Set<String> copyTimeList = new HashSet<String>(timersList);
        copyTimeList.remove(id);
        editor.putStringSet(PREF_TIMERS_LIST, copyTimeList);
        key = PREF_LABEL + id;
        editor.remove(key);
        key = PREF_DELETE_AFTER_USE + id;
        editor.remove(key);
        if (copyTimeList.isEmpty()) {
