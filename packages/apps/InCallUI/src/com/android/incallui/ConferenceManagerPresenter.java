...
public class ConferenceManagerPresenter
    ...
    /**
     * Returns if the conference call can support additional child calls.
     *
     * @return Whether the conference call supports adding more child calls.
     */
    public boolean canAddConferenceMember() {
        ...
        int childNumbers = currentCall.getChildCallIds().size();
        if (childNumbers < AddMemberScreenController.MAX_CALLERS_IN_CONFERENCE) {
            result = true;
        }
        return result;
    }
    ...
    /**
     * show "dialog" of add member, which is a activity actually.
    ...
    /**
     * Update add member button for volte conference.
     * @param currentCall
     */
