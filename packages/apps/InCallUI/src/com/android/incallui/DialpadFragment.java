...
public class DialpadFragment extends BaseFragment<DialpadPresenter, DialpadPresenter.DialpadUi>
    ...
    private TextView mDtmfDialerField;
	private TextView callName,callNumber;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mDialpadView = (DialpadView) parent.findViewById(R.id.dialpad_view_incall);
        ...
        mDialpadView.setBackgroundResource(R.color.incall_hw_dialpad_background);
         Activity activity = getActivity();
		View callCardFragment = (View)activity.findViewById(R.id.callCardFragment);
		mDtmfDialerField = (TextView)callCardFragment.findViewById(R.id.digits_number);
		callName = (TextView)callCardFragment.findViewById(R.id.name);
		callNumber = (TextView)callCardFragment.findViewById(R.id.phoneNumber); 
    ...
    public void updateColors() {
        ...
        */
        ...
        for (int i = 0; i < mButtonIds.length; i++) {
            ...
            //((TextView) dialpadKey.findViewById(R.id.dialpad_key_number)).setTextColor(R.color.incall_hw_key);
        }
    ...
    public void animateShowDialpad() {
        final DialpadView dialpadView = (DialpadView) getView().findViewById(R.id.dialpad_view_incall);
    ...
    public void appendDigitsToField(char digit) {
        if (mDtmfDialerField != null) {
            ...
            if(firstShow){
				...
				mDtmfDialerField.setVisibility(View.VISIBLE);
				callNumber.setText(name);
				firstShow=false;
			}
			mDtmfDialerField.append(digit+"");
        }
    }
