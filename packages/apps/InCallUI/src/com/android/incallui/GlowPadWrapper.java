...
public class GlowPadWrapper extends GlowPadView implements GlowPadView.OnTriggerListener {
    ...
    public void onGrabbed(View v, int handle) {
        ...
        stopPing();
        // Dim secondary incoming call view.
		/**
        if (CallList.getInstance().getSecondaryIncomingCall() != null) {
            InCallPresenter.getInstance().updateDimEffectForSecondaryCallInfo(true);
        }
		*/
    }
    ...
    public void onReleased(View v, int handle) {
        ...
        // Backout dim effect for secondary incoming call view.
		/**
        if (CallList.getInstance().getSecondaryIncomingCall() != null) {
            InCallPresenter.getInstance().updateDimEffectForSecondaryCallInfo(false);
        }
		*/
    }
