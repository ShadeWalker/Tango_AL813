...
#define NFC_DEV_PROTOCOL_CI_CARD    0x84  // NCI_RF_PROTOCOL_CHINA_ID_CARD
...
// device JNI state 
// 0: deactivated, 1: Sleep, 2: activated
#define NFC_DEV_JNI_STATE_DEACTIVATED   0x00
#define NFC_DEV_JNI_STATE_SLEEP         0x01
#define NFC_DEV_JNI_STATE_ACTIVATED     0x02
...
typedef struct nfc_jni_hce_native_data
{
    JavaVM *vm;
    jobject manager;
    mtk_nfc_ee_notify_host_emu_data_t notify_hce_data;    
} nfc_jni_hce_native_data_t;
#endif

//---- L Migration------
typedef struct nfc_jni_discovery_info
{
...
bool nfc_jni_enable_discovery_with_info( struct nfc_jni_native_data * nat, nfc_jni_discovery_info_t info);
