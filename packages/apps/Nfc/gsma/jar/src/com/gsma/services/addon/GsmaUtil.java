...
public class GsmaUtil {

    static final String TAG = "GsmaUtil";
    ...
    public static String printNdef(NdefMessage PrintNdef) {
        ...
        ResultStr += "  Array::" + bytesToString(PrintNdefByteArray);
    ...
    public static String printNdef(byte[] NdefArray) {
        ...
        ResultStr += "  Array::" + bytesToString(NdefArray);
...
/*
    public static INfcGsma getNfcGsmaInterface() {
        IBinder b = ServiceManager.getService("nfc_gsma");
        if (b == null) {
            return null;
        }
        return INfcGsma.Stub.asInterface(b);
    }
*/
