...
public class NfcGsmaRuntimeOptions {
    static final String TAG = "NfcGsmaRuntimeOptions";
     ...
     * Values
     */
    static public final int VERSION_UNKNOW = 0x0;
     
    static public final int VERSION_3_0 = 0x30;
    static public final int VERSION_4_1 = 0x41;
    static public final int VERSION_5_0 = 0x50;
    static public final int VERSION_6_0 = 0x60;
    static public final int GSMA_VERSION_VALUE[] = { VERSION_UNKNOW,
                                                     VERSION_3_0, 
                                                     VERSION_4_1, 
                                                     VERSION_5_0, 
                                                     VERSION_6_0, };
    ...
    static boolean sFileExist = false;

    static {
        sConfigFileParser = ConfigUtil.createParser(CFG_FILE_RULES);
        sFileExist = sConfigFileParser.parse(CFG_FILE_PATH);
    }
    ...
    static public int getGsmaVersion() {
        Log.d(TAG, "getGsmaVersion()");

        if(sFileExist == false){
            Log.e(TAG, "!! CFG_FILE_PATH not exist, return 0");
            return GSMA_VERSION_VALUE[0];
        }
