        ...
        public void onConnected(IWifiP2pProxy.IWifiP2pDevice device,String goDeviceAddr) {
            ...
            case STATE_CONNECTING:
                if (mTargetInfo.getDeviceAddress().equalsIgnoreCase(
                    ...
                    try {
                        Log.d(TAG, " mThisDeviceInfo.getDeviceAddress():"+mThisDeviceInfo.getDeviceAddress());

                        isGoCase = goDeviceAddr.equalsIgnoreCase(mThisDeviceInfo.getDeviceAddress());
                    ...
                    if(mBeamSimultaneously == true && isGoCase){
                        Log.d(TAG, "mBeamSimultaneously == true , mFileTransferClient.connect GcIpAddress : "+mTargetInfo.getGcIpAddress());
                        mFileTransferClient.connect(mTargetInfo.getGcIpAddress());

                    }else{
                        Log.d(TAG, "[normal case], mFileTransferClient.connect GoIpAddress : "+mTargetInfo.getGoIpAddress());
