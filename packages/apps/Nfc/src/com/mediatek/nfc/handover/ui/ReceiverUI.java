...
public class ReceiverUI extends BeamPlusUi
    ...
    public void onProgressUpdate(int id, String filename, int progress) {
        ...
        //    floatProgress = (float) (position-1) * progressUnit + floatProgress * progressUnit;
        //    //progressWithCount = (int)  floatProgress;
        //}


        updateProgressUI(id, filename, progress, false);
    }
    ...
    BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(INTENT_USER_WANT_CANCEL)) {
