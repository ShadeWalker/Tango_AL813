...
public abstract class BeamPlusUi {
     ...
     * @param progress
     */
    protected void updateProgressUI(int id, CharSequence title, int progress, boolean isUpload) {
        ...
        if (noti != null) {
            ...
            Notification n = new Notification.Builder(mContext)
                        .setContentTitle(mContext.getString(R.string.beam_outgoing))
                        ...
                        .setProgress(100, progress, false).setPriority(100).build();
