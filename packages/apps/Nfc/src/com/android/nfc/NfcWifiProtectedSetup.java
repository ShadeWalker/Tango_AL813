...
public final class NfcWifiProtectedSetup {
    /// M: @{
    static final String TAG ="NfcWifiProtectedSetup";
    /// }
    ...
    private static WifiConfiguration parseCredential(ByteBuffer payload, short size) {
        ...
        /// M: @{
        Log.d(TAG, "configuration.preSharedKey:"+result.preSharedKey);
        Log.d(TAG, "configuration.SSID:"+result.SSID);
        /// }
    ...
    private static void populateAllowedKeyManagement(BitSet allowedKeyManagement, short authType) {
        ...
        /// M: @{
        Log.d(TAG, "configuration.allowedKeyManagement.set(authType: "+authType+")");
        /// }
