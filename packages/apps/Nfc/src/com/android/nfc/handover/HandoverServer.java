            ...
            try {
                ...
                while (running) {
                    ...
                    if (handoverRequestMsg != null) {
                        ...
                        Log.d(TAG, "====  HandoverServer ==== mSock.receive Get HrM,   then     call onHandoverRequestReceived");

                        int mScenario = MtkNfcEntry.getInstance().parseHandoverMessage(handoverRequestMsg); //tryHandoverRequest(NdefMessage m)
                        if (mScenario == MtkNfcEntry.SCENARIO_BEAMPLUS_P2P ||
                            ...
                            handoverData = new HandoverDataParser.IncomingHandoverData(
                            MtkNfcEntry.getInstance().tryHandoverRequest(mScenario, handoverRequestMsg),
                            null);
                            
                            if (handoverData.handoverSelect == null) {
                                Log.e(TAG, "handoverData.handoverSelect == null , call onHandoverRequestReceived");
                            ...
                            handoverData = mHandoverDataParser.getIncomingHandoverData(handoverRequestMsg);
                        ...
                        /// M: @ {  
                        if (mScenario == MtkNfcEntry.SCENARIO_JB_ORIGINAL){
                        Log.d(TAG, " beamManager.startBeamReceive(..)");
