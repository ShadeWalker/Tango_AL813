...
public final class NfcDiscoveryParameters {
    private static final String TAG = "nfc.NfcDiscoveryParameters";
    ...
    public int getTechMask() {
        Log.d(TAG, " getTechMask() mTechMask:"+mTechMask);
    ...
    public boolean shouldEnableDiscovery() {
        Log.d(TAG, " shouldEnableDiscovery() mTechMask:"+mTechMask+"  mEnableHostRouting:"+mEnableHostRouting);
