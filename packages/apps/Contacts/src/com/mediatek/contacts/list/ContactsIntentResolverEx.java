...
public class ContactsIntentResolverEx extends ContactsIntentResolver {
    ...
    public ContactsRequest resolveIntent(Intent intent) {
        ...
        if (ContactsIntent.contain(intent)) {
            ...
            } else if (ContactsIntent.LIST.ACTION_PICK_MULTIPLE_PHONEANDIMSANDSIPCONTACTS.equals(action)) {
                request.setActionCode(ContactsRequestAction.ACTION_PICK_MULTIPLE_PHONE_IMS_SIP_CALLS);
            }
