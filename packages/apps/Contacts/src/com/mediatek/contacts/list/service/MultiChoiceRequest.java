...
public class MultiChoiceRequest {
    ...
    public MultiChoiceRequest(int indicator, int simIndex, int contactId, String displayName, Account targetAccount) {
        mIndicator = indicator;
        mSimIndex = simIndex;
        mContactId = contactId;
        mContactName = displayName;
    ...
    public MultiChoiceRequest(int indicator, int simIndex, int contactId, String displayName, Account source,
            Account destination) {
        mIndicator = indicator;
        mSimIndex = simIndex;
        mContactId = contactId;
