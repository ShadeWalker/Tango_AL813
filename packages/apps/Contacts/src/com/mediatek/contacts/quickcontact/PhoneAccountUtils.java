...
public class PhoneAccountUtils {
    ...
    public static Drawable getAccountIcon(Context context, PhoneAccountHandle phoneAccount) {
        ...
        return new BitmapDrawable(context.getResources(), account.getIconBitmap());
    }
    ...
    private static PhoneAccount getAccountOrNull(Context context,
        ...
        final TelecomManager telecommManager =
                (TelecomManager) context.getSystemService(Context.TELECOM_SERVICE);
        final PhoneAccount account = telecommManager.getPhoneAccount(phoneAccount);
        if (account == null || !telecommManager.hasMultipleCallCapableAccounts()) {
            return null;
        }
        return account;
    }
