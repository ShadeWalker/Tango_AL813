        ...
        while (mGroupMetaData.moveToNext()) {
            ...
            if (accountName.equals(mAccountName) && accountType.equals(mAccountType)
                ...
                if (groupId != mFavoritesGroupId
                    ...
                    String title = mGroupMetaData.getString(GroupMetaDataLoader.TITLE);
                    if (mFamily.contains(title)) {
                        title = this.getResources().getString(R.string.family_group);
                    } else if (mColleague.contains(title)) {
                        title = this.getResources().getString(R.string.colleague_group);
                    } else if (mFriend.contains(title)) {
                        title = this.getResources().getString(R.string.friend_group);
                    } else if (mSchoolmate.contains(title)) {
                        title = this.getResources().getString(R.string.schoolmate_group);
                    }
