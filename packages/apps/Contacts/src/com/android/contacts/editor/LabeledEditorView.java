    ...
    private class EditTypeAdapter extends ArrayAdapter<EditType> {
        ...
        private TextView createViewFromResource(int position, View convertView, ViewGroup parent,
            ...
            if (convertView == null) {
                ...
                //maheling HQ00055994 2015.11.18 start
                String language = getResources().getConfiguration().locale.getLanguage();
                if ("ar".equalsIgnoreCase(language) || "fa".equalsIgnoreCase(language) || "iw".equalsIgnoreCase(language)){
                    textView.setLayoutDirection(LayoutDirection.RTL);
                }
                //maheling HQ00055994 2015.11.18 end
                /// M: bug fix.
            ...
            /** M:AAS [COMMD_FOR_AAS]@ { */
            String text = ExtensionManager.getInstance().getAasExtension().getCustomTypeLabel(type.rawValue,
                    type.customColumn);
            if (text == null) {
            /** M: @ } */
