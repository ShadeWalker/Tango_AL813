...
public class ConfirmAddDetailActivity extends Activity implements
    ...
    protected void onCreate(Bundle icicle) {
       ...
       /** @} */
        ...
        LogUtils.d(TAG, "mContactUri: " + mContactUri);
    ...
    private class QueryHandler extends AsyncQueryHandler {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            if (cursor == null || !cursor.moveToFirst()) {
                LogUtils.w(TAG, "[onQueryComplete] cursor is empty!  token:" + token + ",cookie:" + cookie + ",cursor:"
                        + cursor + ",mContactUri:" + mContactUri);
            }
            try {
                ...
                switch (token) {
                    ...
                    case TOKEN_CONTACT_INFO: {
                        ...
                        /** M: Check error @{ */
                            ...
                            LogUtils.w(TAG, "[onQueryComplete] cursor is error!  token is TOKEN_CONTACT_INFO,cursor:" + cursor
                                + ",Finish Activity!");
        ...
        if (mRawContactDelta == null) {
            ...
            if (extras != null && extras.size() > 0) {
            	...
            	RawContactModifier.parseExtras(this, mEditableAccountType, mRawContactDelta,
            			extras);
                LogUtils.d(TAG, "after parse mRawContactDelta: " + mRawContactDelta);
            }
        }
    ...
    private void bindEditor() {
        ...
        if (mIsReadOnly) {
            ...
            showDialogContent();
            LogUtils.d(TAG, "[bindEditor],read only contacts....");
            return;
        }
        ...
        protected Integer doInBackground(RawContactDeltaList... params) {
            ...
            while (tries++ < PERSIST_TRIES) {
                try {
                    ...
                    result = ActivitiesUtils.checkSelectedDeleted(result, diff, results, RESULT_FAILURE);
