...
public class ContactsRequest implements Parcelable {
    ...
    public static final int ACTION_DIAL = 18;

    /** Started from Phone in 4 Tabs */
    public static final int ACTION_CONTACTS_FROM_DIALER = 19;
	public static final int ACTION_MMS = 31;
