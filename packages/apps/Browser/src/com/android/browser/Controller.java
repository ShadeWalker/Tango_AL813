...
public class Controller
    ...
    private static final String SD_STORAGE = File.separator + "storage" + File.separator + "sdcard1";
    private static final String PHONE_EXTERNAL_STORAGE = File.separator + "storage" + File.separator + "sdcard0";
...
//        }
    ...
    public void onDownloadStart(Tab tab, String url, String userAgent,
        ...
        Xlog.d(XLOGTAG, "onDownloadStart: dispos=" + (contentDisposition == null ? "null" : contentDisposition));
        if (contentDisposition == null
            ...
            Xlog.d(XLOGTAG, "onDownloadStart: ResolveInfo=" + (info == null ? "null" : info));
            if (info != null) {
                ComponentName myName = mActivity.getComponentName();
                // If we resolved to ourselves, we don't want to attempt to
                // load the url only to try and download it again.
                Xlog.d(XLOGTAG, "onDownloadStart: myName=" + myName
                ...
                if (!myName.getPackageName().equals(
                    ...
                    Xlog.d(XLOGTAG, "onDownloadStart: mimetype=" + mimetype);
        ...
        Xlog.d(XLOGTAG, "onDownloadStart: download directly, mimetype=" + mimetype + ", url=" + url);
...
//        }
        ...
        if ( tab != null ) {
            ...
            Xlog.d(SAVE_PAGE_LOGTAG, "install GMS: " + useGMS);
...
//                break;
            ...
            case R.id.save_snapshot_menu_id:
                ...
                if (!webview.savePage()) {
                    Xlog.d(SAVE_PAGE_LOGTAG, "webview.savePage() return false.");
...
//          case KeyEvent.KEYCODE_Z:    // unused
        ...
        public void handleMessage(Message m) {
            ...
            switch (m.what) {
                case ADD_SAVE_PAGE:
                    ...
                    Xlog.d(SAVE_PAGE_LOGTAG, "ADD_SAVE_PAGE: " + jobId);
                ...
                case UPDATE_SAVE_PAGE:
                    ...
                    Xlog.d(SAVE_PAGE_LOGTAG, "UPDATE_SAVE_PAGE: " + m.arg2);
                ...
                case FINISH_SAVE_PAGE:
                    ...
                    Xlog.d(SAVE_PAGE_LOGTAG, "FINISH_SAVE_PAGE: " + m.arg1);
                ...
                case FAIL_SAVE_PAGE:
                    ...
                    while (queryTitle.moveToNext()) {
                        ...
                        Xlog.d(SAVE_PAGE_LOGTAG, "fail title is: " + title);
                    }
                    if (title != null) {
                    ...
                    Xlog.d(SAVE_PAGE_LOGTAG, "FAIL_SAVE_PAGE: " + m.arg1);
    ...
    class BrowserSavePageClient extends SavePageClient {
        ...
        public void getSaveDir(ValueCallback<String> callback, boolean canSaveAsComplete) {
            if (mTab != null) {
                ...
                Xlog.d(SAVE_PAGE_LOGTAG, "save dir:" + mSavePageFolder + File.separator + subFolder.toString() + File.separator);
        ...
        public void onSavePageStart(int id, String file) {
            Xlog.d(SAVE_PAGE_LOGTAG, "onSavePageStart: " + id + " " + file);
        ...
        public void onSaveProgressChange(int progress, int id) {
            Xlog.d(SAVE_PAGE_LOGTAG, "onSaveProgressChange: " + progress + " " + id);
        ...
        public void onSaveFinish(int flag, int id) {
            Xlog.d(SAVE_PAGE_LOGTAG, "onSaveFinish: " + flag + " " + id);
    ...
    private boolean createSavePageFolder() {
        String defaultStorage = StorageManagerEx.getDefaultPath(); // /storage/sdcard0
        Log.d(SAVE_PAGE_LOGTAG, "default path: " + defaultStorage);

        if (defaultStorage.equals(SD_STORAGE)) {
            if (!new File(SD_STORAGE).canWrite()) {
                defaultStorage = PHONE_EXTERNAL_STORAGE;
            }
        }
