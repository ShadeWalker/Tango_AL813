...
public class BlobCache implements Closeable {
    ...
    private void closeAll() {
        /// M: [BUG.ADD] @{
        mIndexBuffer = null;
        Log.d(TAG, "<closeAll> mapped buffer closed");
        /// @}
    ...
    public void insert(long key, byte[] data) throws IOException {
        ...
        /// M: [DEBUG.ADD] @{
        Trace.traceBegin(Trace.TRACE_TAG_VIEW, ">>>>BlobCache-flipRegion");
        /// @}
        ...
        /// M: [DEBUG.ADD] @{
        Trace.traceBegin(Trace.TRACE_TAG_VIEW, ">>>>BlobCache-lookupInternal & writeInt");
        /// @}
        ...
        /// M: [DEBUG.ADD] @{
        Trace.traceBegin(Trace.TRACE_TAG_VIEW, ">>>>BlobCache-insertInternal");
        /// @}
        insertInternal(key, data, data.length);
        /// M: [DEBUG.ADD] @{
        Trace.traceEnd(Trace.TRACE_TAG_VIEW);
        Trace.traceBegin(Trace.TRACE_TAG_VIEW, ">>>>BlobCache-updateIndexHeader");
        /// @}
        updateIndexHeader();
        /// M: [DEBUG.ADD] @{
        Trace.traceEnd(Trace.TRACE_TAG_VIEW);
