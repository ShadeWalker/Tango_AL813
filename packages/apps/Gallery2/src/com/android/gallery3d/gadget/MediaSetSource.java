    ...
    private static class CheckedMediaSetSource implements WidgetSource, ContentListener {
        ...
        public synchronized Uri getContentUri(int index) {
            ...
            if (index < mCacheStart || index >= mCacheEnd) {
                /// M: [DEBUG.ADD] @{
                Log.e(TAG, "getContentUri: index out of range: " + index + ", start=" + mCacheStart + ", end=" + mCacheEnd);
                /// @}
                return null;
            }
        ...
        public synchronized Bitmap getImage(int index) {
            ...
            if (index < mCacheStart || index >= mCacheEnd) {
                /// M: [DEBUG.ADD] @{
                Log.e(TAG, "getImage: index out of range: " + index + ", start=" + mCacheStart + ", end=" + mCacheEnd);
                /// @}
                return null;
            }
            /// M: [DEBUG.ADD] @{
