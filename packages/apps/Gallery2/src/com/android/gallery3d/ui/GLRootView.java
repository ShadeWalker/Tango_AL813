...
public class GLRootView extends GLSurfaceView
    ...
    public GLRootView(Context context, AttributeSet attrs) {
        ...
        */
        ...
        /// M: [FEATURE.ADD] @{
        TraceHelper.traceBegin(">>>>GLRootView-new2-setZOrderMediaOverlay");
    ...
    public void onSurfaceCreated(GL10 gl1, EGLConfig config) {
        ...
        try {
            ...
            if (FeatureConfig.supportEmulator) {
                mCanvas = (ApiHelper.HAS_GLES20_REQUIRED && (supportSW3D || "1"
    ...
    public class DebugThread extends Thread {
        ...
        public void run() {
            ...
            try {
                while(true) {
                    time++;
                    Log.i(TAG, "<DebugThread> time = " + time + ", begin ###########################################################");
                    Log.i(TAG, "<DebugThread> mRenderLock = " + mRenderLock);
                    Log.i(TAG, "<DebugThread> mRenderLock.getHoldCount() = " + mRenderLock.getHoldCount());
                    Log.i(TAG, "<DebugThread> mRenderLock.getQueueLength() = " + mRenderLock.getQueueLength());
                    Log.i(TAG, "<DebugThread> mRenderLock.hasQueuedThreads() = " + mRenderLock.hasQueuedThreads());
                    Log.i(TAG, "<DebugThread> mRenderLock.isFair() = " + mRenderLock.isFair());
                    Log.i(TAG, "<DebugThread> mRenderLock.isHeldByCurrentThread() = " + mRenderLock.isHeldByCurrentThread());
                    Log.i(TAG, "<DebugThread> mRenderLock.isLocked() = " + mRenderLock.isLocked());
                    Log.i(TAG, "<DebugThread> time = " + time + ", end #############################################################");
                    Thread.sleep(1000);
                }
