...
/// @}
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mDisplayMatrix.mapRect(mScreenCropBounds)) {
            ...
            RectF imagebounds = new RectF((float) Math.floor(mScreenImageBounds.left), (float) Math.floor(mScreenImageBounds.top),
                    (float) Math.ceil(mScreenImageBounds.right), (float) Math.ceil(mScreenImageBounds.bottom));
