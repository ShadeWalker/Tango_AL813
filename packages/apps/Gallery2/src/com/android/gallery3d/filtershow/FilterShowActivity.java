            ...
            if (panel != null) {
                if (panel instanceof MainPanel) {
                    ...
                    if (mCurrentPanel == MainPanel.LOOKS) {
                        ...
                        Log.d(TAG, "loadCategoryLookPanel on resuming");
                    }
                }
            }
        }
...
/// M: [BEHAVIOR.ADD] @{
    ...
    private boolean finishIfInvalidUri() {
        ...
        if (uri != null) {
            if (ContentResolver.SCHEME_FILE.equals(uri.getScheme())) return false;
            // fix cursor leak
    ...
    /// M: [FEATURE.ADD] clear refocus Exif/db when edit photo @{
    public static String NEED_CLEAR_REFOCUS_EXIF_DB = "needClearRefocusExifAndDb";
    ...
    /// M: [BUG.ADD] whether no filter applied to the edited image
