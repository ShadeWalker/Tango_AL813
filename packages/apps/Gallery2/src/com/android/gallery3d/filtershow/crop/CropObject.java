...
public class CropObject {
    ...
    public boolean setInnerAspectRatio(float width, float height) {
        ...
        RectF inner = mOriginalInnerRect == null ? mBoundedRect.getInner() : new RectF(mOriginalInnerRect);
        /// @}

        CropMath.fixAspectRatioContained(inner, width, height);
        Log.d(TAG, " inner.width() = "+inner.width()+" inner.height() = "+inner.height() +" mMinSideSize = "+mMinSideSize);
