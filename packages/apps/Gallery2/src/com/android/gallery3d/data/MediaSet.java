...
public abstract class MediaSet extends MediaObject {
    ...
    private Object WEAK_HASH_MAP_LOCK = new Object();
    /// @}
    ...
    // We think  recursive calls in ClusterAlbum and ClusterAlbumSet as a Stack , and record offset to the Stack top.
