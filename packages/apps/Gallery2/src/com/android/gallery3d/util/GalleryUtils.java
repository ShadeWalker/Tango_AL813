...
public class GalleryUtils {
    ...
    public static void initialize(Context context) {
        ...
        Log.i(TAG, "<initialize> device width " + reMetrics.widthPixels + " height " + reMetrics.heightPixels);
        // @}
        /// M: [BEHAVIOR.ADD] @{
        MediaItem.sHighQualityThumbnailSize = REAL_RESOLUTION_MAX_SIZE;
        /// @}
        // 6592 FHD add
        initializeTiledTxtureSize(metrics);
        Is_Low_Ram_Device = ((ActivityManager) context.getSystemService("activity")).isLowRamDevice();
        FeatureConfig.isLowRamDevice = Is_Low_Ram_Device;
