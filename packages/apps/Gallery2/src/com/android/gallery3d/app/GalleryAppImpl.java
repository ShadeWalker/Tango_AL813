...
public class GalleryAppImpl extends Application implements GalleryApp {
    ...
    /// M: [BUG.MODIFY] for closing cache when SD card got unmounted@{
    ...
    public void onCreate() {
        ...
        /// M: [FEATURE.ADD] @{
        PhotoPlayFacade.initialize(this,
                MediaItem.getTargetSize(MediaItem.TYPE_MICROTHUMBNAIL),
                MediaItem.getTargetSize(MediaItem.TYPE_THUMBNAIL), MediaItem.getTargetSize(MediaItem.TYPE_HIGHQUALITYTHUMBNAIL));
        /// @}
