...
public final class EglCore {
    private static final String TAG = "MtkGallery2/EglCore";
    ...
    public EglCore(EGLContext sharedContext, int flags) {
        ...
        if ((flags & FLAG_TRY_GLES3) != 0) {
            ...
            if (EGL14.eglGetError() != EGL14.EGL_SUCCESS) {
                MtkLog.d(TAG, "<EglCore> GLES 3.x not available");
                mEGLContext = null;
            }
        }
        if (mEGLContext == null) {
    ...
    public void makeCurrent(EGLSurface eglSurface) {
        if (mEGLDisplay == EGL14.EGL_NO_DISPLAY) {
            ...
            MtkLog.d(TAG, "<makeCurrent> NOTE: makeCurrent w/o display");
        }
    ...
    public static void logCurrent(String msg) {
        ...
        MtkLog.i(TAG, "<logCurrent> Current EGL (" + msg + "): display=" + display + ", context=" + context +
                ", surface=" + surface);
    }
}
