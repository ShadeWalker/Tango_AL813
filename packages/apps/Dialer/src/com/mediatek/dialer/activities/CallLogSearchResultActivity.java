...
/**
 * [CallLog Search] Displays a list of call log entries.
 */
public class CallLogSearchResultActivity extends ListActivity implements
    ...
    protected void onCreate(Bundle state) {
        ...
        mAdapter = new CallLogAdapter(this, this, new ContactInfoHelper(this, currentCountryIso), null, null, true);
...
//    }
    ...
    public void startCallsQuery() {
        ...
        mData = intent.getStringExtra(SearchManager.USER_QUERY);
        Uri uri = Uri.withAppendedPath(DialerConstants.CALLLOG_SEARCH_URI_BASE, mData);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case MENU_ITEM_DELETE_ALL:
                ...
                intent.putExtra(DialerConstants.IS_GOOGLE_SEARCH, "true");
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (intentProvider != null) {
            this.startActivity(intentProvider.getIntent(this).putExtra(
                    "follow_sim_management" /*TODO Constants.EXTRA_FOLLOW_SIM_MANAGEMENT*/, true));
        }
    }
}
