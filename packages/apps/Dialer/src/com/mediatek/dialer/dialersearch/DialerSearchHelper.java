...
public class DialerSearchHelper {
    ...
    public Cursor getSmartDialerSearchResults(String query) {
        //LogUtils.d(TAG, "MTK-DialerSearch, getSmartDialerSearchResults, queryFilter: " + query);
        ...
        try {
            ...
            LogUtils.d(TAG, "MTK-DialerSearch, displayOrder: " + displayOrder + " ,sortOrder: " + sortOrder);
            ...
            Log.w(TAG, "Exception thrown during handling MTK-DialerSearch, getSmartDialerSearchResults", e);
    ...
    public Cursor getRegularDialerSearchResults(String query, boolean useCallableUri) {
        LogUtils.d(TAG, "MTK-DialerSearch, getRegularDialerSearchResults, query: " + query);
        ...
        try {
            ...
            if (sContactsPrefs.getDisplayOrder() == ContactsContract.Preferences.DISPLAY_ORDER_PRIMARY) {
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    int simIndicate = cursor.getInt(cursor.getColumnIndex(RawContacts.INDICATE_PHONE_SIM));
                    int isSdn = cursor.getInt(cursor.getColumnIndex(RawContacts.IS_SDN_CONTACT));

                    objectMap[cursorPos++] = buildCursorRecord(0, contactId, dataId, null, 0, 0, null, null, null, 0, simIndicate, 0,
                            photoId, type, null, displayName, number, lookup, isSdn, "true", query);
                }
            ...
            Log.w(TAG, "Exception thrown during handling MTK-DialerSearch, getRegularDialerSearchResults", e);
    ...
    private Object[] buildCursorRecord(long id, long contactId, long dataId, String callDate, long callLogId,
        ...
        Object[] record = new Object[] {
                id, contactId, dataId, callDate, callLogId,
