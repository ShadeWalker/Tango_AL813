 ...
 */
public class CallLogAdapterEM extends GroupingListAdapter
        implements ViewTreeObserver.OnPreDrawListener, CallLogGroupBuilder.GroupCreator
        {
    private static final String TAG = CallLogAdapterEM.class.getSimpleName();
	...
	//modify by zhangjinqiang for al812--end
            ...
            class DialCallback implements View.OnClickListener, View.OnLongClickListener {
                ...
                public boolean onLongClick(View v) {
                    ...
                    if (isSaved) {
                        ...
                        if (null == contactUri) return false;
                    }
                    buildContextMenu();
                    return true;
                }
                                    ...
                                    public void onClick(DialogInterface dialog, int id) {
                                        switch (id) {
                                            ...
                                            case 5:
                                                ...
                                                break;
                                            default:
                                                Log.e(G + TAG, "DialCallback, Error item is clicked");
                                                break;
                                        }
                                    }
                                }).create().show();
            ...
            class CheatListener implements View.OnClickListener {
                ...
                public void onClick(View view) {
                    ...
                    if (null == u) {
                        Log.d("guofeiyao", "cheat click,Uri is null!!!");
                        return;
                    }
                    Intent intent = QuickContact.composeQuickContactsIntent(
    ...
    public CallLogAdapterEM(Context context, CallFetcher callFetcher,
    ...
    private class QueryThread extends Thread {
        ...
        public QueryThread() {
            super("CallLogAdapterEM.QueryThread");
        }
...
//        CallLogListItemViews views = CallLogListItemViews.fromView(view);
	...
	if(InCallApp.gIsHwUi){
        ...
        DialCallback dialCallback = new DialCallback(views.number, false);
        // / End
	...
	//modify by zhangjinqiang for al812--end
        ...
        /*//modified by zhouyoukun for HQ01335481 begin
	       ...
	       // modified by zhouyoukun for HQ01335481 end
            modify by zhaizhanfeng for HQ01708827 at 160129*/
       ...
       //add by HQ_xitao HQ01335986 end
        if (TextUtils.isEmpty(name)) {
            details = new PhoneCallDetails(number, numberPresentation,
                    formattedNumber, countryIso, geocode, mShowLastCallTypes, date,
    ...
    */
    ...
    private void expandOrCollapseActions(View callLogItem, boolean isExpanded) {
        ...
        if (isExpanded) {
			...
			// / Commented out by guofeiyao,we dont need it when we adjust to EMUI
	...
	private void showDialog(){
		...
		btnOne.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Settings.System.putInt(mContext.getContentResolver(), "phone_account", 0);
                 DialerUtils.startActivityWithErrorToast(mContext, intent);
				alertDialog.dismiss();
			}
		});
		...
		btnTwo.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent = CallUtil.getCallIntent(phoneNumber,
                            (mContext instanceof PeopleActivity?
                                    ((PeopleActivity) mContext).getDialerPlugIn().getCallOrigin() : null));
				Settings.System.putInt(mContext.getContentResolver(), "phone_account", 1);
                DialerUtils.startActivityWithErrorToast(mContext, intent);
				alertDialog.dismiss();
			}
		});
