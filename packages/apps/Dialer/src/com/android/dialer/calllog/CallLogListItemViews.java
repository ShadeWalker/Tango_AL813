...
public final class CallLogListItemViews {
    ...
    /** M: [Ip Dial] add IP dial button on details view @{ */
    public TextView ipDialButtonView;
    /** @} */

    /** M: [VoLTE ConfCall] the conference call numbers if it was conference call @{ */
	...
	private CallLogListItemViews(QuickContactBadge quickContactView, View primaryActionView,
            PhoneCallDetailsViews phoneCallDetailsViews, View callLogEntryView,
            TextView dayGroupHeader,View contactDetail) {
        this( quickContactView, primaryActionView,
            phoneCallDetailsViews, callLogEntryView,
            dayGroupHeader);
	...
	// /added by guofeiyao
	public static CallLogListItemViews fromView(View view,boolean flag) {
        return new CallLogListItemViews(
                (QuickContactBadge) view.findViewById(R.id.quick_contact_photo),
                view.findViewById(R.id.primary_action_view),
                PhoneCallDetailsViews.fromView(view),
                view.findViewById(R.id.call_log_row),
                (TextView) view.findViewById(R.id.call_log_day_group_label),
                view.findViewById(R.id.iv_contact));
    }
	// /end
