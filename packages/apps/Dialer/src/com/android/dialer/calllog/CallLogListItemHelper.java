...
/* package */class CallLogListItemHelper {
    ...
    public void setPhoneCallDetails(
        ...
        mPhoneCallDetailsHelper.setPhoneCallDetails(views.phoneCallDetailsViews, details, typeOrLocation);

        // Set the accessibility text for the contact badge
        views.quickContactView.setContentDescription(getContactBadgeDescription(details, views.nameOrNumber));

        // Set the primary action accessibility description
        views.primaryActionView.setContentDescription(getCallDescription(context, details, typeOrLocation, views.nameOrNumber));
     ...
     */
    private CharSequence getContactBadgeDescription(PhoneCallDetails details,  CharSequence nameOrNumber) {
        return mResources.getString(R.string.description_contact_details, nameOrNumber);
    }
     ...
     */
    public CharSequence getCallDescription(Context context, PhoneCallDetails details, CharSequence typeOrLocation, CharSequence nameOrNumber) {
...
//        final CharSequence typeOrLocation = mPhoneCallDetailsHelper.getCallTypeOrLocation(details);
     ...
     */
    public  CharSequence getNameOrNumber(PhoneCallDetails details) {
