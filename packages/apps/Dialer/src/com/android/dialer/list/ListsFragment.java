...
//modify by zhangjinqiang for al812 --start
	      ...
	      //final int topPaneHeight = (int) (slideOffset * mShortcutCardsListView.getHeight()); modify by zhangjinqiang
	...
	mActionBar.hide();//add by zhangjinqiang for al812
        fetchCalls();
...
//modify by zhangjinqiang for al812--end
    ...
    public void fetchCalls() {
        mCallLogQueryHandler.fetchCalls(CallLogQueryHandler.CALL_TYPE_ALL, mEarlyCallDate);
    }
...
//modify by zhagnjinqiang for al812-start
/*
        if (mShortcutCardsListView.getChildCount() > 0) {
