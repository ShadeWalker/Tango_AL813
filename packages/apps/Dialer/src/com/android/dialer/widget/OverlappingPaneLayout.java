...
public class OverlappingPaneLayout extends ViewGroup {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        Log.d(TAG, "onSaveInstanceState ss.isOpen=" + ss.isOpen
                + ", isSlideable()=" + isSlideable() + ", isOpen()=" + isOpen()
                + ", mPreservedOpenState=" + mPreservedOpenState);
        return ss;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        Log.d(TAG, "onRestoreInstanceState ss.isOpen=" + ss.isOpen);
        if (ss.isOpen) {
            openPane();
        } else {
            closePane();
