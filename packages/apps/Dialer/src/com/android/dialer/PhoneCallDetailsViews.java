...
public final class PhoneCallDetailsViews {
	...
	public final TextView phoneLocation;
	public final ImageView callLabelImage;
    ...
    private PhoneCallDetailsViews(TextView nameView, View callTypeView,
            ...
            TextView phoneLocation,ImageView callLabelImage,TextView callNumber) {
		...
		this.callLabelImage = callLabelImage;
        this.callNumber = callNumber;
        // / Added by guofeiyao
        //this.nameView.getPaint().setFakeBoldText(true);
        // / End
        /*HQ_guomiao add for HQ01455114 begin*/
        if (SystemProperties.get("ro.hq.claro.dialer.hide.city").equals("1")) {
            this.phoneLocation.setVisibility(View.GONE);
        }
        /*HQ_guomiao add for HQ01455114 end*/
    }
    ...
    public static PhoneCallDetailsViews fromView(View view) {
        return new PhoneCallDetailsViews((TextView) view.findViewById(R.id.name),
				...
				(TextView) view.findViewById(R.id.number_loaction),
				(ImageView) view.findViewById(R.id.call_label_img),
				(TextView) view.findViewById(R.id.call_number));
    }
