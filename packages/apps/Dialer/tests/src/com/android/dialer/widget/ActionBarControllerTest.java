...
public class ActionBarControllerTest extends InstrumentationTestCase {
    ...
    protected void setUp() {
        ...
        /// M: Need the actionbar of the DialtactsActivity
        setUpDialtactsActivity();
    }

    /// M: Need the actionbar of the DialtactsActivity @{
    private Activity mDialtactsActivity;

    private void setUpDialtactsActivity() {
        Intent intent = new Intent();
        intent.setClass(getInstrumentation().getTargetContext(), DialtactsActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        mDialtactsActivity = getInstrumentation().startActivitySync(intent);
    }

    @Override
    protected void tearDown() throws Exception {
        if (mDialtactsActivity != null) {
            mDialtactsActivity.finish();
        }
        super.tearDown();
    }
    /// @}
