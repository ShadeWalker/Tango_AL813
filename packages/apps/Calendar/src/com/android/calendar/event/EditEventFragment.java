...
//        mContext.requestWindowFeature(Window.FEATURE_INDETERMINATE_PROGRESS);
        ...
        mView = new EditEventView(mActivity, view, mOnDone, mTimeSelectedWasStartTime,
                mDateSelectedWasStartDate, mShowDatePicker, mSelectedDate,
    ...
    public void onSaveInstanceState(Bundle outState) {
        /**
         * M: double check whether the date picker has been dismissed, in case
         * that the onPause not be called before onSaveInstanceState. @{
         */
        LogUtil.oi(TAG, "onSaveInstanceState, try to dismiss DatePickerDialog if it is visible.");
