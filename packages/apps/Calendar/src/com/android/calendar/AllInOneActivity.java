    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (icicle != null && !isTabletConfig) {
            ...
            if (f != null) {
                ...
                ft.remove(f);
                ft.commit();
                long eventId = icicle.getLong(EventInfoFragment.BUNDLE_KEY_EVENT_ID);
                long startMillis = icicle.getLong(EventInfoFragment.BUNDLE_KEY_START_MILLIS);
                long endMillis = icicle.getLong(EventInfoFragment.BUNDLE_KEY_END_MILLIS);
