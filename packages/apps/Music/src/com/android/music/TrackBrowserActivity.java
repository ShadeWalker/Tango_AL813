        ...
        implements View.OnCreateContextMenuListener, MusicUtils.Defs, ServiceConnection, DialogInterface.OnClickListener
{
    ...
    private static final String ACTIVITY_NAME = PluginUtils.TRACK_BROWSER_ACTIVITY;
    ...
    private IMusicTrackBrowser mMusicPlugin;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        options.putInt(PluginUtils.PLAYLIST_LEN, (mTrackList == null) ? 0 : mTrackList.getCount());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            default:
                ...
                options.putString(PluginUtils.PLAYLIST_NAME, mPlaylist);
                options.putInt(PluginUtils.PLAYLIST_LEN, (mTrackList == null) ? 0 : mTrackList.getCount());
                if (mMusicPlugin.onOptionsItemSelectedForPlugin(getApplicationContext(), item, ACTIVITY_NAME, this, mMusicListenerForPlugin, options)) {
                    return true;
                }
                return false;
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        switch (requestCode) {
            ...
            default:
                ...
                mMusicPlugin.onActivityResultForPlugin(requestCode, resultCode, intent,
    ...
    private PluginUtils.IMusicListenter mMusicListenerForPlugin = new PluginUtils.IMusicListenter() {
