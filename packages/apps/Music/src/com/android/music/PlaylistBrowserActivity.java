    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    private static final String ACTIVITY_NAME = PluginUtils.PLAYLIST_BROWSER_ACTIVITY;
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        switch (requestCode) {
            ...
            default:
                ...
                IMusicTrackBrowser mMusicPlugin = Extensions.getPluginObject(getApplicationContext());
                mMusicPlugin.onActivityResultForPlugin(requestCode, resultCode, intent,
                        getApplicationContext(), mMusicListenerForPlugin, ACTIVITY_NAME, this, extra);
                /// @}
                break;
        }
    }
