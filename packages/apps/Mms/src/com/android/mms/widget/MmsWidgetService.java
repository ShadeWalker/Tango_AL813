        ...
        public RemoteViews getViewAt(int position) {
            ...
            synchronized (sWidgetLock) {
                ...
                */
                ...
                if (conv.getType() == Telephony.Threads.IP_MESSAGE_GUIDE_THREAD) {
...
//                clickIntent.putExtra("thread_id", conv.getThreadId());
                ...
                if (MmsConfig.getFolderModeEnabled() && dirMode) {
                    ...
                    } else if (Telephony.Threads.WAPPUSH_THREAD == conv.getType() ||
                            Telephony.Threads.CELL_BROADCAST_THREAD == conv.getType()) {
