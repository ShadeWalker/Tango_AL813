...
public class DownloadManager {
    ...
    public void markState(final Uri uri, int state) {
        ...
        IMmsCancelDownloadExt sCancelDownloadPlugin = (IMmsCancelDownloadExt) MmsPluginManager
        ...
        if (state == STATE_PERMANENT_FAILURE 
                && (sCancelDownloadPlugin != null)
                && !sCancelDownloadPlugin.getCancelToastEnabled()) {
            mHandler.post(new Runnable() {
                public void run() {
                    try {
