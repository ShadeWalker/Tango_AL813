...
public class SmileyParser {
    ...
    static class Smileys {
        private static final int[] sIconIds = {
            ...
            R.drawable.emo_im_jiong,
            R.drawable.emo_im_shock,
            R.drawable.emo_im_weep
	    ...
	    public static int JIONG = 17;
	    public static int SHOCK = 18;
	    public static int WEEP = 19;
        public static int MAD = 20;
        public static int HEART = 21;
        public static int SMIRK = 22;
        public static int POKERFACE = 23;
    ...
    public static final int[] DEFAULT_SMILEY_RES_IDS = {
        ...
        Smileys.getSmileyResource(Smileys.JIONG),          //17
        Smileys.getSmileyResource(Smileys.SHOCK),      //18
        Smileys.getSmileyResource(Smileys.WEEP)   //19
       // Smileys.getSmileyResource(Smileys.MAD),                  //  20
        //Smileys.getSmileyResource(Smileys.HEART),                //  21
       // Smileys.getSmileyResource(Smileys.SMIRK),                //  22
       // Smileys.getSmileyResource(Smileys.POKERFACE),  
/*baijianhua add for huawei input Smileys (X310A) SW00018923 2013 11 6*/
       //  Smileys.getSmileyResource(Smileys.CRYING)
    };
//add by qilin for new ui
...
/* Add By chaoyongan to smiley icon display (QL1701) SW00112697 2015-2-9 begin */
    public CharSequence addSmileyForSmall(CharSequence text) {
        SpannableStringBuilder builder = new SpannableStringBuilder(text);
...
/* Add By chaoyongan to smiley icon display (QL1701) SW00112697 2015-2-9 end */
}
