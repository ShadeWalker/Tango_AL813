...
public class NotificationTransaction extends Transaction implements Runnable {
        ...
        try {
            ...
            if (MmsConfig.isCancelDownloadEnable() && mIsCancelling) {
                MmsLog.d(MmsApp.TXN_TAG,
                    "***Canceling download in processing!(NotificationTransaction)");
            ...
            if (MmsConfig.isCancelDownloadEnable()) {
                IMmsCancelDownloadExt mmsCancelDownloadExt = (IMmsCancelDownloadExt)
                        MmsPluginManager.getMmsPluginObject(MmsPluginManager
                            .MMS_PLUGIN_TYPE_CANCEL_DOWNLOAD);
    ...
    public void sendNotifyRespInd(int status) {
        ...
        mMmsPreferencePlugin.setNotifyRespDeliveryReport(mContext,mSubId, notifyRespInd);
