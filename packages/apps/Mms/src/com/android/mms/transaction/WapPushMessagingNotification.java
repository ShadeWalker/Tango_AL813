...
public class WapPushMessagingNotification {
    ...
    private static void updateNotification(
        ...
        if (uniqueThreadCount > 1) {    // messages from multiple threads
           ...
           /*HQ_sunli  20151020 HQ01446422 begin*/
            try {
                 contactDrawable =(BitmapDrawable)context.getPackageManager().getActivityIcon(new ComponentName("com.android.contacts", "com.android.mms.ui.ConversationList"));
                } catch (android.content.pm.PackageManager.NameNotFoundException ex) {
                                // go on, it is ok.
                }
           /*HQ_sunli  20151020 HQ01446422  end*/
