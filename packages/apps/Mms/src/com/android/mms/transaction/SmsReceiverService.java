...
//add by  wanghui  for HQ01250658  start
import android.app.KeyguardManager;
import android.app.KeyguardManager.KeyguardLock;
//add by  wanghui  for HQ01250658  end
...
public class SmsReceiverService extends Service implements IMissedSmsReceiverHost {
	...
	public static final String ACTION_RESEND_MESSAGE =
    "android.huaqin.action.RESEND";
	/*HQ_zhangjing add end*/
    /* HQ_sunli 20150929 HQ01387521 begin*/
   private static final String PREVENT_MODE_SERVICE = "com.huawei.systemmanager.preventmode.PreventModeService";
   private IHoldPreventService holdPreventService;
   /* HQ_sunli 20150929 HQ01387521 end*/
...
//        }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        } else if (SystemProperties.get("ro.mtk_wfc_support").equals("1")
                && intent != null && ImsManager.ACTION_IMS_CAPABILITIES_CHANGED.equals(intent.getAction())) {
...
//        }
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (intent != null && MmsConfig.isSmsEnabled(getApplicationContext())) {
                ...
                } else if (ACTION_SEND_MESSAGE.endsWith(action) || ACTION_RESEND_MESSAGE.equals(action)) {
				/*HQ_zhangjing add end*/
                    handleSendMessage();
                ...
                /// M: WFC: Handle Ims capability change @{ 
                        ...
                        && ImsManager.ACTION_IMS_CAPABILITIES_CHANGED.equals(intent.getAction())) {
    ...
    public synchronized void sendFirstQueuedMessage() {
        ...
        /// M: WFC: do not apply this if WFC present or WFC is ON
        ...
        if (c != null) {
            try {
                if (c.moveToFirst()) {
					MmsLog.d(MmsApp.TXN_TAG, "sendFirstQueuedMessage(), c.moveToFirst() " );
    ...
    private void handleSmsSent(Intent intent, int error) {
        ...
        if(SystemProperties.get("persist.sys.esn_track_switch").equals("1")) {
            sendBroadcast(new Intent(mNotifyEsnTriggerMsgSent).putExtra(PhoneConstants.SUBSCRIPTION_KEY, subId));
        }
    ...
    private void messageFailedToSend(Uri uri, int error) {
        ...
        /// @}
        //HQ_wuruijun add for HQ01631772 start
        Cursor mCursor = this.getContentResolver().query(uri, new String[] {"_id"}, null, null, null);
        if (mCursor.moveToFirst()) {
            if (ref_id != mCursor.getInt(mCursor.getColumnIndex("_id"))) {
                ref_id = mCursor.getInt(mCursor.getColumnIndex("_id"));
    ...
    private void handleSmsReceived(Intent intent, int error) {
       ...
       isPrevent = holdPreventService.isPrevent(sender,false);
        }catch (Exception e) {
      // TODO: handle exception
       MmsLog.e(TAG, "Get exception while communicate with holdPreventService");
        }
		/* HQ_sunli 20150929 HQ01387521 end*/ 
	//add by HQ_caoxuhao at 20150928 HQ01406575 begin
	//HQ_caoxuhao adapt for huawei keyguard wakeup_when_receive_notification
	final String WAKEUP_WHEN_RECEIVE_NOTIFICATION = "wakeup_when_receive_notification";

	boolean smsLightingScreenEnable = Settings.Secure.getInt(getContentResolver(),
        		WAKEUP_WHEN_RECEIVE_NOTIFICATION, 0) != 0;
	if(smsLightingScreenEnable && !isPrevent){
   ...
   //add by HQ_caoxuhao at 20150928 HQ01406575 begin
        ...
        if (messageUri != null) {
         ...
         /*HQ_sunli HQ01431766 20151012 begin*/
            if(!isPrevent){
         /*HQ_sunli HQ01431766 20151012 end*/
        ...
        /// because its type is class 0,just show on phone and no need to save @{
            ...
            if (!TextUtils.isEmpty(message)&& !isPrevent) {
