...
import com.mediatek.mms.ext.IMmsRetrieveTransactionHost;
 ...
 * </ul>
 */
public class RetrieveTransaction extends Transaction implements IMmsRetrieveTransactionHost,
        Runnable {
        ...
        try {
            ...
            if (MmsConfig.isCancelDownloadEnable() && mIsCancelling) {
                MmsLog.d(MmsApp.TXN_TAG,
                    "***Canceling download in processing!(RetrieveTransaction)");
                mTransactionState.setState(TransactionState.SUCCESS);
                mTransactionState.setContentUri(mUri);
            ...
            if (MmsConfig.isCancelDownloadEnable()) {
                IMmsCancelDownloadExt mmsCancelDownloadExt = (IMmsCancelDownloadExt)
                        MmsPluginManager.getMmsPluginObject(
                            MmsPluginManager.MMS_PLUGIN_TYPE_CANCEL_DOWNLOAD);
                mmsCancelDownloadExt.addHttpClient(mContentLocation, mUri);
            }
            /// @}
    ...
    public void sendAcknowledgeInd(String resultUri) {
        ...
        try {
            ...
            if (tranId != null) {
				...
				IMmsPreferenceExt mMmsPreferencePlugin = (IMmsPreferenceExt) MmsPluginManager
                            .getMmsPluginObject(MmsPluginManager.MMS_PLUGIN_TYPE_PREFERENCE);	
		        mMmsPreferencePlugin.setAcknowledgeDeliveryReport(mContext, mSubId, acknowledgeInd);
		        /// @}
