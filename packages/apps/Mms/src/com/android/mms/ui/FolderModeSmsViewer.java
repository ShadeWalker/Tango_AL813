...
import android.provider.ChildMode;//add by lihaizhou for ChildMode at 2015-07-23
        ...
        public boolean onMenuItemClick(MenuItem arg0) {
            ...
            switch(arg0.getItemId()) {
              ...
              /*add by lihaizhou for lihaizhou for ChildMode at 2015-07-23 by begin */
                if (isChildModeOn()&&isProhibitDeleteSmsmms()) {
					Toast.makeText(FolderModeSmsViewer.this, R.string.Prohibit_delete, Toast.LENGTH_SHORT).show();//zhangjing
                 return false;
                 }
...
//                  deleteMsg();
    ...
    private String getMessageDetails() {
        ...
        if(mNumber!=null && MessageUtils.isInteger(mNumber)&&(langage.startsWith("ar")||langage.startsWith("fa")||langage.startsWith("iw"))){
            details.append("\u202D"+mNumber+"\u202C");
        }else{
            details.append(mNumber);
        }//end by lipeng
...
//        final Uri lockUri = ContentUris.withAppendedId(SMS_URI, id);
    ...
    private void forwardMessage(String body) {
        ...
        if (body != null) {
            ...
            smsBody = prefPlugin.formatSmsBody(FolderModeSmsViewer.this, smsBody, nameAndNumber, mMsgBox);
...
//                                              Uri.parse(url)));
                             ...
                             if(langage.startsWith("ar")||langage.startsWith("fa")||langage.startsWith("iw")){///RTL language
                            	 tv.setText("\u202D" + url + "\u202C");//modify by lipeng for  display
                             }else{
                            	 tv.setText(url);
                             }
...
//        }
  ...
  /// M: update sim state dynamically. @{
    ...
    private CharSequence getSimInfo(Context context, int subId) {
        MmsLog.d(TAG, "getSimInfo subId = " + subId);
      ...
      //add this code for more safty
        ...
        if (null != subInfo) {
            ...
            MmsLog.d(TAG, "SIMInfo subId=" + subInfo.getSubscriptionId() + " mDisplayName=" + displayName);
            ...
            int colorRes = (subInfo.getSubscriptionId() >= 0) ? MessageUtils.SubBackgroundLightRes[subInfo.getIconTint()]
                             : MessageResource.drawable.sim_background_locked;
            Drawable drawable = context.getResources().getDrawable(colorRes);
            buf.setSpan(new BackgroundImageSpan(colorRes, drawable),
