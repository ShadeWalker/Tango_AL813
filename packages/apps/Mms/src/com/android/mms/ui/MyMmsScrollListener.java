 ...
 * MyScrollListener
 */
public class MyMmsScrollListener implements OnScrollListener {
    ...
    public MyMmsScrollListener(int minCursorCount, String threadName) {
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        if (mContext != null) {
            MmsLog.d(TAG, "OnScrollListener.onScroll(): firstVisibleItem: " + firstVisibleItem
                    ...
                    + " Context: " + mContext);
            IpMessageUtils.getChatManager(mContext).onScroll(view, firstVisibleItem,
                    visibleItemCount, totalItemCount, mThreadId);
        }
    }
