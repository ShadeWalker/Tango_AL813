...
public class SlideView extends AbsoluteLayout implements
    ...
    private IMmsSlideShowExt mMmsSlideShowPlugin;
    /// @}
    ...
    private IMmsUnsupportedFilesExt mMmsUnsupprotedFilesExt = (IMmsUnsupportedFilesExt)
            MmsPluginManager.getMmsPluginObject(
                MmsPluginManager.MMS_PLUGIN_TYPE_UNSUPPORTED_FILES);
    ...
    public void setImage(String name, Bitmap bitmap) {
        if (mImageView == null) {
            ...
            if (MmsConfig.isUnsupportedFilesOn()) {
                mMmsUnsupprotedFilesExt.initUnsupportedViewForImage(this);
            }
            /// @}
        }
        try {
    ...
    private void initAudioInfoView(String name) {
        if (null == mAudioInfoView) {
            ...
            if (mConformanceMode) {
                ...
                /// M: OP09 Feature: Unsupported Files; @{
                if (MmsConfig.isUnsupportedFilesOn()) {
                    mMmsUnsupprotedFilesExt.setAudioUnsupportedIcon((LinearLayout) mAudioInfoView);
                    mMmsUnsupprotedFilesExt.initUnsupportedViewForAudio(mViewPort);
                }
                /// @}
            } else {
                ...
                if (MmsConfig.isUnsupportedFilesOn()) {
                    mMmsUnsupprotedFilesExt.setAudioUnsupportedIcon((LinearLayout) mAudioInfoView);
                    mMmsUnsupprotedFilesExt.initUnsupportedViewForAudio(this);
                }
                /// @}
            }
        }
    ...
    public void displayAudioInfo() {
        if (null != mAudioInfoView) {
            ...
            /// M: OP09 Feature: Unsupported Files;@{
            if (MmsConfig.isUnsupportedFilesOn()) {
                mMmsUnsupprotedFilesExt.setUnsupportedViewVisibilityForAudio(true);
            }
            /// @}
        }
    }
    ...
    private void hideAudioInfo() {
        ...
        /// M: OP09 Feature: Unsupported Files;@{
        if (MmsConfig.isUnsupportedFilesOn()) {
            mMmsUnsupprotedFilesExt.setUnsupportedViewVisibilityForAudio(false);
        }
        /// @}
    }
    ...
    public void setAudio(Uri audio, String name, Map<String, ?> extras) {
        ...
        /// M: OP09 Feature: Unsupported Files;@{
        if (MmsConfig.isUnsupportedFilesOn()) {
            mMmsUnsupprotedFilesExt.setAudioUri(audio);
        }
        /// @}
    ...
    public void setText(String name, String text) {
        if (!mConformanceMode) {
            ...
            if (null == mTextView) {
                ...
                /// @}
                if(SystemProperties.get("ro.hq.mms.number.link").equals("1")){ // lipeng to do
                    mTextView.setAutoLinkMask(Linkify.ALL_MMS);
                }else{
        ...
        for (View view : viewsByPosition.values()) {
            if (view instanceof VideoView) {
                ...
                mViewPort.addView(view, new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
                        LayoutParams.WRAP_CONTENT));
                /// M: OP09 Feature: Unsupported Files; @{
                if (MmsConfig.isUnsupportedFilesOn() && view instanceof ImageViewEx) {
                    mMmsUnsupprotedFilesExt.initUnsupportedViewForImage(mViewPort);
                }
                /// @}
            }
    ...
    /// M: Code analyze 004, new feature, Slideshow plugin (unknown) @{
    public void setMmsSlideShowPlugin(IMmsSlideShowExt plugin) {
