...
public class VCardAttachment {
    ...
    public String toString() {
        ...
        if (mName != null && !mName.equals("")) {
		       ...
		       String dataName = mName+"";
               if(langage.startsWith("ar")||langage.startsWith("fa")||langage.startsWith("iw")){///RTL language
                       if(MessageUtils.isInteger(mName)){
                               dataName = "\u202D"+dataName+"\u202C";
                       }
                       textVCardString += mContext.getString(R.string.contact_name) + ": " + dataName + "\n";
               }else{
            ...
            if (mNumbers.size() > 1) {
                ...
                for (String number : mNumbers) {
                       ...
                       if(langage.startsWith("ar")||langage.startsWith("fa")||langage.startsWith("iw")){
                               String dataInfo = number;
                               if(MessageUtils.isInteger(number)){
                                       dataInfo = "\u202D"+dataInfo+"\u202C";
                               }
                    buf.append(mContext.getString(R.string.contact_tel) + i + ": " + dataInfo + "\n");
                       }else{
               ...
               //add by lipeng for number display
               if(langage.startsWith("ar")||langage.startsWith("fa")||langage.startsWith("iw")){
                       String info = mNumbers.get(0)+"";
                       if(MessageUtils.isInteger(mNumbers.get(0))){
                               info = "\u202D"+info+"\u202C";
                       }
                       textVCardString += mContext.getString(R.string.contact_tel) + ": " + info
                    + "\n";
               }else{
