...
public class NotificationPreferenceActivity extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    public static final String NOTIFICATION_SET = "pref_key_notification";
    ...
    public static final String DEFAULT_RINGTONE_CLARO = "content://media/internal/audio/media/30";
    ...
    private void setMessagePreferences() {
        ...
        /*HQ_sunli HQ01421867 20151002 begin*/
        PreferenceCategory preCat = (PreferenceCategory) findPreference(NOTIFICATION_SET);
        preCat.removePreference(findPreference(NOTIFICATION_MUTE)); 
        /*HQ_sunli HQ01421867 20151002 end*/
    ...
    private void setRingtoneSummary(String soundValue) {
        ...
        if (!TextUtils.isEmpty(soundValue) && soundValue.startsWith(EXTERNAL_RINGTONE_PATH)) {
            ...
            if(SystemProperties.get("ro.hq.sms.default.ringtone").equals("1")){
                soundValue = DEFAULT_RINGTONE_CLARO;
             }else
     ...
     /*HQ_sunli HQ01431657 20151012 begin*/
	SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        boolean is_followe_notification = sharedPreferences.getBoolean(IS_FOLLOW_NOTIFICATION, true);
        if(soundUri==null) {
        mRingtonePref.setSummary(getResources().getString(R.string.silent_ringtone));
        }else{
        String Uri =soundUri.toString();
        if(SystemProperties.get("ro.hq.sms.default.ringtone").equals("1")&&Uri.equals("content://media/internal/audio/media/30")){
         soundValue = DEFAULT_RINGTONE_CLARO;
        mRingtonePref.setSummary(tone.getTitle(this));
        }else if(is_followe_notification|| (soundUri != null && Uri.equals("content://settings/system/notification_sound"))){
        restoreDefaultRingtone();
        soundValue = DEFAULT_RINGTONE;
	mRingtonePref.setSummary(getResources().getString(R.string.system_notification_tone));
	}else{
     /*HQ_sunli HQ01431657 20151012 end*/
    ...
    private void restoreDefaultPreferences() {
        ...
        editor.putString(NOTIFICATION_MUTE, "0");
        if(SystemProperties.get("ro.hq.sms.default.ringtone").equals("1")){
        editor.putString(NOTIFICATION_RINGTONE, DEFAULT_RINGTONE_CLARO);
        }else
    ...
    private void restoreDefaultRingtone() {
        ...
        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(this)
                .edit();
        if(SystemProperties.get("ro.hq.sms.default.ringtone").equals("1")){
        editor.putString(NotificationPreferenceActivity.NOTIFICATION_RINGTONE,DEFAULT_RINGTONE_CLARO);  
        }else
