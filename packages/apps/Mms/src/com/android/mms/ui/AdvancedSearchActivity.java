...
public class AdvancedSearchActivity extends Activity {
    ...
    private void initResource() {
        ...
        mCertainTimeSearchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(IMmsAdvanceSearchExt.ADVANCED_SEARCH_QUERY, true);
                intent.putExtra(IMmsAdvanceSearchExt.ADVANCED_SEARCH_BEGIN_DATE, (fromDate > 0L) ? fromDate : 0L);
                intent.putExtra(IMmsAdvanceSearchExt.ADVANCED_SEARCH_END_DATE, toDate);
        ...
        mSearchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(AdvancedSearchActivity.this, SearchActivity.class);
                intent.putExtra(IMmsAdvanceSearchExt.ADVANCED_SEARCH_QUERY, true);
                intent.putExtra(IMmsAdvanceSearchExt.ADVANCED_SEARCH_BEGIN_DATE, mFromDate);
                intent.putExtra(IMmsAdvanceSearchExt.ADVANCED_SEARCH_END_DATE, mToDate);
                startActivity(intent);
            }
        });
    }
    ...
    private void setSaveInstanceState(Bundle savedInstanceState) {
        ...
        MmsLog.d(TAG, "SetSaveInstanceState Restore disappear state = " + type);
    ...
    public void onSaveInstanceState(Bundle b) {
        MmsLog.d(TAG, "saveDatePickerStatus: currentDatePicker = " + mCurrentDatePicker);
