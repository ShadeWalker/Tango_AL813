...
public class DeliveryReportListItem extends LinearLayout {
    ...
    public final void bind(String recipient, String status, String deliveryDate) {
        ...
        if (!TextUtils.isEmpty(recipient)) {
        	String num = Contact.get(recipient, false).getName();
        	// modify by wangmingyue for number display
        	String langage = Locale.getDefault().getLanguage();
        	if ((!TextUtils.isEmpty(num)) && (langage.startsWith("ar")||langage.startsWith("fa")||langage.startsWith("iw"))) {
        	    num = "\u202D"+ num+ "\u202C";
        	}
            mRecipientView.setText(num);
