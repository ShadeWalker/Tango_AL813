...
public class WPMessageListItem extends LinearLayout implements Contact.UpdateListener {
    ...
    private void bindCommonMessage(final WPMessageItem msgItem) {
        ...
        IMmsUtilsExt mmsUtilsPlugin = (IMmsUtilsExt) MmsPluginManager.getMmsPluginObject(MmsPluginManager.MMS_PLUGIN_TYPE_MESSAGE_UTILS);
        mmsUtilsPlugin.showSimTypeBySubId(this.getContext(), msgItem.mSubId,
