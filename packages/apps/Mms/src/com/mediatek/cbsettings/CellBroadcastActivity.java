...
public class CellBroadcastActivity extends TimeConsumingPreferenceActivity {
    ...
    public void onResume() {
        ...
        SubscriptionInfo subInfo = SubscriptionManager.from(this).getSubscriptionInfo(mSubId);
    ...
    private void enableScreen() {
        ...
        boolean isHasSimCard = SubscriptionManager.from(MmsApp.getApplication()).getActiveSubscriptionInfoCount() > 0;
