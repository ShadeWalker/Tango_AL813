...
public class DefaultMmsAttachmentEnhanceExt extends ContextWrapper implements IMmsAttachmentEnhanceExt {
    private static final String TAG = "Mms/MmsAttachmentEnhanceExt";

    public DefaultMmsAttachmentEnhanceExt(Context context) {
        super(context);
    }
