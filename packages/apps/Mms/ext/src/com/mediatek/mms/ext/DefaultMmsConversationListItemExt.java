...
public class DefaultMmsConversationListItemExt extends ContextWrapper implements IMmsConversationListItemExt {
    private static final String TAG = "Mms/MmsConversationImpl";

    public DefaultMmsConversationListItemExt(Context context) {
        super(context);
    }
