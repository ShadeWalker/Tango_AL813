...
public class DefaultMmsSmsMessageSenderExt extends ContextWrapper implements IMmsSmsMessageSenderExt {
     ...
     */
    public DefaultMmsSmsMessageSenderExt(Context context) {
        super(context);
    }
    ...
    public Uri addMessageToUri(ContentResolver resolver, Uri uri, String address, String body,
        ...
        Log.d(TAG, "MmsSmsMessageSenderImpl: addMessageToUri()");
        return null;
    }
    ...
    public void sendSMSWithPriority(Context context, String destAddr, String scAddr,
        ...
        smsManager.sendMultipartTextMessageWithExtraParams(destAddr, scAddr, parts, extraParams,
