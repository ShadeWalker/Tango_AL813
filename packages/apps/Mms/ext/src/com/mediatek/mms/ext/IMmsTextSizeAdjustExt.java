...
public interface IMmsTextSizeAdjustExt {

    /**
     *  init IMmsTextSizeAdjustHost and reset host activity to set textView text size of the activity
     ...
     * @param event         the touch motionevent  in host activity
     * @return boolean      true if consume the event, else false
     */
