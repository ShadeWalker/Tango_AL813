...
public class DefaultMmsMultiDeleteAndForwardExt extends ContextWrapper implements IMmsMultiDeleteAndForwardExt {
    private static final String TAG = "Mms/DefaultMmsMultiDeleteAndForwardExt";
    ...
    public DefaultMmsMultiDeleteAndForwardExt(Context context) {
        super(context);
    }
...
//
    public boolean onMultiforwardItemSelected() {
        Log.d(TAG, "onMultiforwardItemSelected  ");
    ...
    public void setBodyandAddress(IMmsMultiDeleteAndForwardExt.BodyandAddressInfo info) {
        if (info.mType.equals("mms")) {
            ...
            if (Build.TYPE.equals("eng")) {
                Log.d(TAG, "initListMap mAddress = " + mAddress + "mBody" + mBody + ", boxid = " + boxType);
            }
