...
public class DefaultMmsManageSimMessageExt extends ContextWrapper implements IMmsManageSimMessageExt {

    public DefaultMmsManageSimMessageExt(Context context) {
        super(context);
