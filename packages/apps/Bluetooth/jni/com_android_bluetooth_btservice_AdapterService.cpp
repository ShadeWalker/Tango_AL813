...
/// M: ALPS01293574: Dump FTrace @{
static void dumpFTraceNative(JNIEnv *env, jobject obj) {
    ALOGV("%s:",__FUNCTION__);
#ifdef HAVE_AEE_FEATURE
    aee_system_warning(LOG_TAG, NULL, DB_OPT_FTRACE | DB_OPT_DUMMY_DUMP, "\nCRDISPATCH_KEY: Stop Service Timeout! Dump FTRACE");
#endif
}
/// @}
...
static JNINativeMethod sMethods[] = {
    ...
    /// M: ALPS01293574: Dump FTrace
    {"dumpFTraceNative", "()V", (void *) dumpFTraceNative}
};
