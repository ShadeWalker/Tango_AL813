...
final class AdapterState extends StateMachine {
    ...
    private static final int START_TIMEOUT_DELAY = 8500;
    private static final int STOP_TIMEOUT_DELAY = 8500;
    /// @}
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case ENABLE_TIMEOUT:
                    ...
                    errorLog("Error enabling Bluetooth");
                    /// M: ALPS01583929: Stop services after enable native timeout to avoid Looper fd leak issue @{
                    errorLog("Enable timeout! Android native code exists fd leak issue because the services are not stopped");
                    sendMessageDelayed(STOP_TIMEOUT, STOP_TIMEOUT_DELAY);
                    if (adapterService.stopProfileServices()) {
                        Log.d(TAG, "Stopping profile services that were post enabled");
                        break;
                ...
                case STOP_TIMEOUT:
                    ...
                    adapterService.dumpMessageHistory();
                    /// M: ALPS01293574: Dump FTrace
                    //adapterService.dumpFTraceNative();
                    mPendingCommandState.setTurningOff(false);
                    transitionTo(mOffState);
                    break;
