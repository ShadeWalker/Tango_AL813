...
public class BluetoothOppHandoverReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String carrierName = intent.getStringExtra(Constants.EXTRA_INVOKE_CARRIER);
        if (D) Log.d(TAG, "EXTRA_INVOKE_CARRIER = " + carrierName);
        ...
        if (action.equals(Constants.ACTION_HANDOVER_SEND) ||
            ...
            if (action.equals(Constants.ACTION_HANDOVER_SEND)) {
                ...
                if (stream != null && type != null) {
                    ...
                    BluetoothOppManager.getInstance(context).saveSendingFileInfo(type,
                            stream.toString(), true, carrierName);
                } else {
            ...
            BluetoothOppManager.getInstance(context).addToWhitelist(device.getAddress(), carrierName);
