...
public class AvrcpControllerService extends ProfileService {
    ...
    protected boolean cleanup() {
        // M : Fix ALPS01756097 Sanity fail while BT power on, do Handler check
        // M : and catch exception
        if (mHandler != null) {
            try {
                mHandler.removeCallbacksAndMessages(null);
            } catch (Exception ex) {
                Log.e(TAG, "[cleanup] exception happen while removeCallbacksAndMessages");
            }
        }
