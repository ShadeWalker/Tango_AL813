...
public class BluetoothMapSmsPdu {
    ...
    public static class SmsPdu {
        ...
        public void gsmDecodeUserDataHeader() {
            ...
            if(V) {
                Log.v(TAG, "[gsmDecodeUserDataHeader] encoding:" + mEncoding);
                Log.v(TAG, "[gsmDecodeUserDataHeader] msgSeptetCount:" + mMsgSeptetCount);
                Log.v(TAG, "[gsmDecodeUserDataHeader] userDataSeptetPadding:" + mUserDataSeptetPadding);
                Log.v(TAG, "[gsmDecodeUserDataHeader] languageShiftTable:" + mLanguageShiftTable);
                Log.v(TAG, "[gsmDecodeUserDataHeader] languageTable:" + mLanguageTable);
                Log.v(TAG, "[gsmDecodeUserDataHeader] userDataMsgOffset:" + mUserDataMsgOffset);
            }
        }
