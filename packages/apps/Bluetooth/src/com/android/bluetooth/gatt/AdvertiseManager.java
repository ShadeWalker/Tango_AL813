...
class AdvertiseManager {
    ...
    void cleanup() {
        ...
        if (null != mHandler && null != mHandler.getLooper()) {
            logd("advertise HandlerThread quit");
    ...
    private class AdvertiseNative {
        ...
        void stopAdvertising(AdvertiseClient client) {
            if (mAdapterService.isMultiAdvertisementSupported()) {
                Log.i(TAG, "gattClientDisableAdvNative(" + client.clientIf + ");");
                gattClientDisableAdvNative(client.clientIf);
            } else {
                Log.i(TAG, "gattAdvertiseNative(" + client.clientIf + ", false);");
                ...
                try {
                    ...
                    Log.i(TAG, "onAdvertiseInstanceDisabled(" + client.clientIf + ");");
                } catch (RemoteException e) {
