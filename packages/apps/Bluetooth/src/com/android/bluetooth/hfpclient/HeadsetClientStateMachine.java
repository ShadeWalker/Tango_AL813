...
final class HeadsetClientStateMachine extends StateMachine {
    ...
    /// M: stack will report command result for NREC config
    static final int CONFIG_NREC = 54;
    ...
    private void queryCallsDone() {
        ...
        while (it.hasNext()) {
            ...
            /// M: set AudioManager to MODE_IN_CALL {@
