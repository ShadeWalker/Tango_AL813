            ...
            if (mUserCert != null) {
                ...
                if (mEcc) {
                    if (mHasPkey) {
                        ...
                        keyPrefix = Credentials.WAPI_SERVER_CERTIFICATE;
                        extraName = Credentials.EXTRA_WAPI_SERVER_CERTIFICATE_NAME;
                        extraData = Credentials.EXTRA_WAPI_SERVER_CERTIFICATE_DATA;
                    }
