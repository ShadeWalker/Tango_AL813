    ...
    public void setPackageNames(String[] packageNames, String defaultPackageName) {
        ...
        for (ApplicationInfo appInfo : appInfos) {
            if (appInfo != null) {
				...
				/*HQ_zhangjing 2015-09-21 modified for CQ HQ01382817 begin*/
				if( appInfo != null && appInfo.packageName.equals("com.android.contacts")){
					applicationNames[index] = getContext().getString( R.string.default_sms);
					mEntryDrawables[index] = getContext().getResources().getDrawable( R.drawable.com_android_mms);
				}
				/*HQ_zhangjing 2015-09-21 modified for CQ HQ01382817 end*/
                index++;
            }
        }
