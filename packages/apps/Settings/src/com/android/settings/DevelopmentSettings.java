...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        /*HQ_yuankangbo 2015-07-28 modify for PointerLocation and ShowTouches in DevelopmentSettings start*/
        mPointerLocation.setOnPreferenceChangeListener(this);
        mShowTouches.setOnPreferenceChangeListener(this);
        /*HQ_yuankangbo 2015-07-28 modify for PointerLocation and ShowTouches in DevelopmentSettings end*/
        /*HQ_yuankangbo 2015-08-04 modify for DevelopmentSettings start*/
        mAllowMockLocation.setOnPreferenceChangeListener(this);
        mKeepScreenOn.setOnPreferenceChangeListener(this);
        mBtHciSnoopLog.setOnPreferenceChangeListener(this);
        mBugreportInPower.setOnPreferenceChangeListener(this);
        mDebugViewAttributes.setOnPreferenceChangeListener(this);
        mWifiDisplayCertification.setOnPreferenceChangeListener(this);
        mWifiVerboseLogging.setOnPreferenceChangeListener(this);
        mWifiAggressiveHandover.setOnPreferenceChangeListener(this);
        mWifiAllowScansWithTraffic.setOnPreferenceChangeListener(this);
        mShowScreenUpdates.setOnPreferenceChangeListener(this);
        mDebugLayout.setOnPreferenceChangeListener(this);
        mForceRtlLayout.setOnPreferenceChangeListener(this);
        mForceHardwareUi.setOnPreferenceChangeListener(this);
        mShowHwScreenUpdates.setOnPreferenceChangeListener(this);
        mShowHwLayersUpdates.setOnPreferenceChangeListener(this);
        mForceMsaa.setOnPreferenceChangeListener(this);
        mDisableOverlays.setOnPreferenceChangeListener(this);
        mUseAwesomePlayer.setOnPreferenceChangeListener(this);
        mUSBAudio.setOnPreferenceChangeListener(this);
        mShowCpuUsage.setOnPreferenceChangeListener(this);
        mStrictMode.setOnPreferenceChangeListener(this);
        mShowAllANRs.setOnPreferenceChangeListener(this);
        mImmediatelyDestroyActivities.setOnPreferenceChangeListener(this);
        mEnableOemUnlock.setOnPreferenceChangeListener(this);
        mEnableAdb.setOnPreferenceChangeListener(this);
        /*HQ_yuankangbo 2015-08-04 modify for DevelopmentSettings end*/
    }
    ...
    public void onResume() {
        ...
        if(Utils.isMonkeyRunning()) {
        	Log.d(TAG, "monkey test,disable adb preference");
        	if(mEnableAdb != null) {
    ...
    public void onSwitchChanged(Switch switchView, boolean isChecked) {
        ...
        if (isChecked != mLastEnabledState) {
            if (isChecked) {
                ...
                String DevSettingsWarningYes = this.getActivity().getResources().getString(android.R.string.yes);
                String DevSettingsWarningNo = this.getActivity().getResources().getString(android.R.string.no);
                if(getResources().getConfiguration().locale.getCountry().equals("RU")){
                	DevSettingsWarningYes = this.getActivity().getResources().getString(R.string.dev_settings_warning_yes);
                    DevSettingsWarningNo = this.getActivity().getResources().getString(R.string.dev_settings_warning_no);
                }
                mEnableDialog = new AlertDialog.Builder(getActivity()).setMessage(
                        getActivity().getResources().getString(
                                R.string.dev_settings_warning_message))
                        .setTitle(R.string.dev_settings_warning_title)
                        .setPositiveButton(DevSettingsWarningYes, this)
                        .setNegativeButton(DevSettingsWarningNo, this)
                        .show();
...
//            writeShowUpdatesOption();
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        /*HQ_yuankangbo 2015-07-28 modify for PointerLocation and ShowTouches in DevelopmentSettings start*/
            ...
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.POINTER_LOCATION, (boolean)newValue ? 1 : 0);
            return true;
        } else if (preference == mShowTouches) {
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.SHOW_TOUCHES, (boolean)newValue ? 1 : 0);
            return true;
        }
        /*HQ_yuankangbo 2015-07-28 modify for PointerLocation and ShowTouches in DevelopmentSettings end*/
        /*HQ_yuankangbo 2015-08-04 modify for DevelopmentSettings start*/
            ...
            Settings.Global.putInt(getActivity().getContentResolver(),
                    Settings.Global.STAY_ON_WHILE_PLUGGED_IN,
                    (boolean)newValue ? (BatteryManager.BATTERY_PLUGGED_AC | BatteryManager.BATTERY_PLUGGED_USB) : 0);
            return true;
        } else if (preference == mBtHciSnoopLog) {
            BluetoothAdapter adapter = BluetoothAdapter.getDefaultAdapter();
            adapter.configHciSnoopLog(mBtHciSnoopLog.isChecked());
            ...
            mWifiManager.enableVerboseLogging((boolean)newValue ? 1 : 0);
            return true;
        } else if (preference == mWifiAggressiveHandover) {
            mWifiManager.enableAggressiveHandover((boolean)newValue ? 1 : 0);
            return true;
        } else if (preference == mWifiAllowScansWithTraffic) {
            mWifiManager.setAllowScansWithTraffic((boolean)newValue ? 1 : 0);
            return true;
        } else if (preference == mShowScreenUpdates) {
            try {
                IBinder flinger = ServiceManager.getService("SurfaceFlinger");
                if (flinger != null) {
                    Parcel data = Parcel.obtain();
                    data.writeInterfaceToken("android.ui.ISurfaceComposer");
                    final int showUpdates = (boolean)newValue ? 1 : 0;
                    data.writeInt(showUpdates);
                    flinger.transact(1002, data, null, 0);
                    data.recycle();
            ...
            SystemProperties.set(HARDWARE_UI_PROPERTY, (boolean)newValue ? "true" : "false");
            pokeSystemProperties();
            return true;
        } else if (preference == mShowHwScreenUpdates) {
            SystemProperties.set(HardwareRenderer.DEBUG_DIRTY_REGIONS_PROPERTY,
                    (boolean)newValue ? "true" : null);
            pokeSystemProperties();
            return true;
        } else if (preference == mShowHwLayersUpdates) {
            SystemProperties.set(HardwareRenderer.DEBUG_SHOW_LAYERS_UPDATES_PROPERTY,
            ...
            SystemProperties.set(MSAA_PROPERTY, (boolean)newValue ? "true" : "false");
            pokeSystemProperties();
            return true;
        } else if (preference == mDisableOverlays) {
            try {
                ...
                if (flinger != null) {
                    Parcel data = Parcel.obtain();
                    data.writeInterfaceToken("android.ui.ISurfaceComposer");
                    final int disableOverlays = (boolean)newValue ? 1 : 0;
                    data.writeInt(disableOverlays);
                    flinger.transact(1008, data, null, 0);
                    data.recycle();
            ...
            SystemProperties.set(
                    USE_AWESOMEPLAYER_PROPERTY, (boolean)newValue ? "true" : "false");
            pokeSystemProperties();
            return true;
        } else if (preference == mUSBAudio) {
            Settings.Secure.putInt(getContentResolver(),
            ...
            try {
                mWindowManager.setStrictModeVisualIndicatorPreference((boolean)newValue
                        ? "1" : "");
            } catch (RemoteException e) {
            }
            return true;
            ...
            try {
                ActivityManagerNative.getDefault().setAlwaysFinish((boolean)newValue);
            } catch (RemoteException ex) {
            }
            return true;
        } else if (preference == mEnableOemUnlock) {
