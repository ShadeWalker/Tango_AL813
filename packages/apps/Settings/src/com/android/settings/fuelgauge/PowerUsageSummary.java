...
public class PowerUsageSummary extends PreferenceFragment {
    ...
    private BatteryStatusPreference BatteryStatusPreference;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
	    ...
	    if(SystemProperties.get("ro.hq.hide.battery_infor").equals("1")) {
...
//        BatteryStatusPreference.setHideLabels(true);
    ...
    private boolean updateBatteryStatus(Intent intent) {
        if (intent != null) {
            ...
            String batteryStatus = com.android.settings.Utils.getBatteryStatus(getResources(),
                    intent);
            String batteryStatusTitle = getResources().getString(R.string.power_usage_level_and_status,
                new Object[] { batteryLevel, batteryStatus });
            mBatteryStatusPref.setTitle(batteryStatusTitle);
    ...
    private void refreshStats() {
        ...
        BatteryStatusPreference = new BatteryStatusPreference(getActivity(), mStatsHelper.getStats());
        BatteryStatusPreference.setOrder(-1);
        mAppListGroup.addPreference(BatteryStatusPreference);
