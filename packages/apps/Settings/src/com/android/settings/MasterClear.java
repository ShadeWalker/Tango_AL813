...
public class MasterClear extends Fragment {
    ...
    private void establishInitialState() {
        ...
        ///M: Add for Shared-SD-Feature.@{
        boolean isSomeStorageEmulated = UtilsExt.isSomeStorageEmulated();
        Log.d(TAG, "isExtStorageEmulated=" + isExtStorageEmulated
        ...
        */
            mExternalStorageContainer.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                	if("unencrypted".equals(SystemProperties.get("ro.crypto.state","unencrypted")))//HQ_liugang add for HQ01659849
        ...
        loadAccountList(um);
		/*HQ_liugang add for HQ01659849*/
		if("encrypted".equals(SystemProperties.get("ro.crypto.state","unencrypted"))){
			mExternalStorage.setChecked(true);
    ...
    private void loadAccountList(final UserManager um) {
        ...
        for (int profileIndex = 0; profileIndex < profilesSize; profileIndex++) {
            ...
            titleText.setTextSize(TRIM_MEMORY_UI_HIDDEN);
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (icon != null) {
                	Drawable micon = zoomDrawable(icon, 150, 150); //taojin add for HQ01381553
                    child.setCompoundDrawablesWithIntrinsicBounds(micon, null, null, null);
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ///M: Dynamic show the volume title. @{
        mVolumeDescription = UtilsExt.getVolumeDescription(getActivity());
        updateTextLable();
        ///@}
    ...
    private void updateTextLable() {
        ...
        externalOption1
                .setText(UtilsExt.getVolumeString(R.string.master_clear_desc_erase_external_storage, mVolumeDescription, getActivity()));
        TextView externalOption2 = (TextView) mContentView
                .findViewById(R.id.erase_external_storage);
        externalOption2
                .setText(UtilsExt.getVolumeString(R.string.erase_external_storage, mVolumeDescription, getActivity()));
        TextView externalOption3 = (TextView) mContentView
                .findViewById(R.id.erase_external_storage_description);
        externalOption3
                .setText(UtilsExt.getVolumeString(R.string.erase_external_storage_description, mVolumeDescription, getActivity()));
    }
    
  //taojin add begin HQ01381553
