...
public class ChooseLockPattern extends SettingsActivity {
    ...
    public static class ChooseLockPatternFragment extends Fragment
        ...
        public static final int MIXED_PASSWORD_REQUEST = 56;
        ...
        public void onActivityResult(int requestCode, int resultCode,
            ...
            switch (requestCode) {
                case CONFIRM_EXISTING_REQUEST:
                    ...
                    break;
                  //hanchao add for HQ01379541  begin 
                case MIXED_PASSWORD_REQUEST:
                    if (resultCode != RESULT_CANCELED) {      
                    	saveChosenPatternAndFinish();
                    }

		    //caoxuhao add for HQ01520635  begin 
		    else{
			Log.i(TAG,"canncel mixpassword in pattern");
			getActivity().finish();
		    }
		    //caoxuhao add for HQ01520635  end 

                    break;
                  //hanchao add for HQ01379541	end
            }
        }
		...
		//add by caoxuhao for HQ01499002 
//                getActivity().setResult(RESULT_FINISHED);
                getActivity().finish();
            } else {
        ...
        public void handleRightButton() {
            if (mUiStage.rightMode == RightButtonMode.Continue) {
    			...
    			Intent mixIntent = new Intent(getActivity(),MixedChooseLockPassword.class);
    			startActivityForResult(mixIntent,MIXED_PASSWORD_REQUEST);  //hanchao change for HQ01379541
