 ...
 */
public class DoubleClockZonePicker extends ListFragment {
    private static final String TAG = "DoubleClockZonePicker";
    ...
    static class ZoneGetter {
        ...
        private void addTimeZone(String olsonId, String title) {
            ...
            map.put(KEY_DISPLAYNAME, mBidiFormatter.unicodeWrap(title));
	...
	Settings.System.putString(getActivity().getContentResolver(),Settings.System.DOUBLE_CLOCK_DEFAULT_TIME_ZONE,tzId);
