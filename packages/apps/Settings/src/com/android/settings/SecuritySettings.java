...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private static final String KEY_SHOW_PASSWORD_DIRECTLY = "show_password_directly";//HQ_liukai3 20150824 modify for HQ01322719

    private static final String KEY_SMART_LOCK = "Smart Lock";

    //add by HQ_caoxuhao at 20150831 HQ01349265 begin
//    private static final String KEY_SCREEN_PINNING = "screen_pinning_settings";
    //add by HQ_caoxuhao at 20150831 HQ01349265 end
    ...
    private SwitchPreference mShowPasswordDirectly;////HQ_liukai3 20150824 modify for HQ01322719
    ...
    private ContentObserver mAirplaneModeObserver = new ContentObserver(new Handler()) {
            ...
            public void onChange(boolean selfChange) {
                ...
                int value = Settings.System.getInt(
                        getActivity().getContentResolver(), AIRPLANE_MODE_ON, 0);
                updateSimCardPinPreference(value);
            }

    };

    private void updateSimCardPinPreference(int airplaneModeValue){
            if(root != null){
		Preference mPreference = root.findPreference(KEY_SIM_LOCK);
		if(mPreference != null){
			boolean isAirplaneMode = (airplaneModeValue == 1)?true:false;
			boolean enableSimLock = false;  
		  	if(isSimReady() && !isAirplaneMode){
				enableSimLock = true;
			}
			mPreference.setEnabled(enableSimLock);
		}
            }
    }
...
//        }
	...
	//add by HQ_caoxuhao at 20150928 HQ01406575 begin
	//show Sim card unable Default 
  	//add by HQ_caoxuhao at 20160429 HQ01887089 begin 

    	int AirplaneMode = Settings.System.getInt(getActivity().getContentResolver(),  
                          Settings.System.AIRPLANE_MODE_ON, 0) ;  
    	boolean isAirplaneMode = (AirplaneMode == 1)?true:false;
	boolean enableSimLock = false;  
  	if(isSimReady()){
		if(isAirplaneMode){
			enableSimLock = false;
	...
	root.findPreference(KEY_SIM_LOCK).setEnabled(enableSimLock);

	//add by HQ_caoxuhao at 20160429 HQ01887089 end
	//add by HQ_caoxuhao at 20150928 HQ01406575 end
...
//        }
        ...
        //HQ_liukai3 20150824 modify for HQ01322719 start
        mShowPasswordDirectly = (SwitchPreference) findPreference(KEY_SHOW_PASSWORD_DIRECTLY);
        if (mShowPasswordDirectly != null) {
            mShowPasswordDirectly.setOnPreferenceChangeListener(this);
            mShowPasswordDirectly.setChecked(isShowPasswordDirectlyAllowed());
        }
        //HQ_liukai3 20150824 modify for HQ01322719 end
        ...
        //add xuqian4 HQ01225573 delete App Permission and DataProtection in setting--Safety start
//      mPermCtrlExt.addPermSwitchPrf(deviceAdminCategory);
//      mPermCtrlExt.enablerResume();
//      mDataProectExt.addDataPrf(deviceAdminCategory);
        //add xuqian4 HQ01225573 delete App Permission and DataProtection in setting--Safety end
...
//        mPplExt.enablerResume();
	...
	//add by HQ_caoxuhao at 20151003 HQ01424084 begin
...
//        String summary = UtilsExt.getVolumeString(R.string.credentials_install_summary, description, getActivity());
	...
	String title = getActivity().getResources().getString(R.string.credentials_install_default);
	String summary = getActivity().getResources().getString(R.string.credentials_install_summary_default);
	//add by HQ_caoxuhao at 20151003 HQ01424084 end
    ...
    private boolean isDropdownNotificationBarAllowed() {
        int speed = Settings.System.getInt(getContentResolver(),
                SettingsEx.System.ENABLE_EXPAND_ON_HUAWEI_UNLOCK, 0);
        if (speed == 1) {
            return true;
        } else {
            return false;
    ...
    //HQ_liukai3 20150824 modify for HQ01322719 start
    private boolean isShowPasswordDirectlyAllowed() {
        int speed = Settings.System.getInt(getContentResolver(),SettingsEx.System.SHOW_HWLOCK_FIRST, 0);
        if (speed == 0) {
            return true;
        } else {
            return false;
    ...
    private void warnAppInstallation() {
        // TODO: DialogFragment?
        String cancelInstall = getActivity().getResources().getString(android.R.string.no);
        if(getResources().getConfiguration().locale.getCountry().equals("RU")){
            cancelInstall = getActivity().getResources().getString(R.string.cancel_install);
        }
        mWarnInstallApps = new AlertDialog.Builder(getActivity()).setTitle(
                getResources().getString(R.string.error_title))
                .setIcon(com.android.internal.R.drawable.ic_dialog_alert)
                .setMessage(getResources().getString(R.string.install_all_warning))
                .setPositiveButton(getResources().getString(R.string.allow_install), this)
                .setNegativeButton(cancelInstall, this)
                .show();
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (dialog == mWarnInstallApps) {
            ...
            //add by HQ_machao1 at 20150724 HQ01259541 begin
            if (turnOn) {
                getActivity().setResult(2);
            }
            //add by HQ_machao1 at 20150724 HQ01259541 end
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        //HQ_jiazaizheng 20150813 modify for HQ01322784 start
            ...
            Settings.System.putInt(getContentResolver(),
                    SettingsEx.System.ENABLE_EXPAND_ON_HUAWEI_UNLOCK, (boolean)value ? 1 : 0);
        }//HQ_jiazaizheng 20150813 modify for HQ01322784 end
        //HQ_liukai3 20150824 modify for HQ01322719 start
        else if (KEY_SHOW_PASSWORD_DIRECTLY.equals(key)) {
            mShowPasswordDirectly.setChecked((boolean)value);
            Settings.System.putInt(getContentResolver(),SettingsEx.System.SHOW_HWLOCK_FIRST, (boolean)value ? 0 : 1);
        }
        //HQ_liukai3 20150824 modify for HQ01322719 end
