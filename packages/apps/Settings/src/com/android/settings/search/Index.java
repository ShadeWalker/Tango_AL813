...
import android.telephony.TelephonyManager;//modified by maolikui at 2015-11-24
public class Index {

    private static final String LOG_TAG = "Index.java";
    ...
    public Cursor search(String query) {
        ...
        //modified by maolikui at 2015-11-24 start
        if(mContext != null){
        TelephonyManager tm = (TelephonyManager)mContext.getSystemService(Context.TELEPHONY_SERVICE);
        int SIMCount = tm.getSimCount();
        if(SIMCount == 1){
	   database.delete("prefs_index","icon like?",new String[]{"2130837692"});
           String str = mContext.getString(R.string.sim_master_slot_select_text);
           database.delete("prefs_index","data_title=?",new String[]{str});
        }
        }
        //modified by maolikui at 2015-11-24 end
    ...
    public void update() {
        ...
        Log.d(LOG_TAG, "in update() size: " + size);
    ...
    private boolean addIndexablesFromRemoteProvider(String packageName, String authority) {
        try {
            Log.d(LOG_TAG, "in addIndexablesFromRemoteProvider packageName: " + packageName + " authority: " + authority);
    ...
    private void addNonIndexablesKeysFromRemoteProvider(String packageName,
                                                        String authority) {
        Log.d(LOG_TAG, "in addNonIndexablesKeysFromRemoteProvider packageName: " + packageName + " authority: " + authority);
    ...
    public void addIndexableData(SearchIndexableData data) {
        Log.d(LOG_TAG, "in addIndexableData data: " + data);
    ...
    public void updateFromClassNameResource(String className, boolean rebuild,
        ...
        Log.d(LOG_TAG, "in updateFromClassNameResource className: " + className + " rebuild: " + rebuild + " includeInSearchResults: " + includeInSearchResults);
        if (className == null) {
            throw new IllegalArgumentException("class name cannot be null!");
        }
        final SearchIndexableResource res = SearchIndexableResources.getResourceByName(className);
        Log.d(LOG_TAG, "in updateFromClassNameResource res: " + res);
        if (res == null ) {
    ...
    private void updateInternal() {
        synchronized (mDataToProcess) {
            ...
            Log.d(LOG_TAG, "in updateInternal copy: " + copy);
            task.execute(copy);
    ...
    private void indexOneSearchIndexableData(SQLiteDatabase database, String localeStr,
        ...
        if (data instanceof SearchIndexableResource) {
            Log.i(LOG_TAG, "in indexOneSearchIndexableData data is SearchIndexableResource");
            indexOneResource(database, localeStr, (SearchIndexableResource) data, nonIndexableKeys);
        } else if (data instanceof SearchIndexableRaw) {
            Log.i(LOG_TAG, "in indexOneSearchIndexableData data is SearchIndexableRaw");
    ...
    private void indexOneResource(SQLiteDatabase database, String localeStr,
        ...
        if (sir.xmlResId > SearchIndexableResources.NO_DATA_RES_ID) {
            Log.d(LOG_TAG, "in indexOneResource xmlResId > NO_DATA_RES_ID");
            ...
            if (resNonIndxableKeys != null && resNonIndxableKeys.size() > 0) {
                Log.d(LOG_TAG, "in indexOneResource nonIndexableKeys.size: " + nonIndexableKeys.size());
            ...
            if (provider != null) {
                Log.d(LOG_TAG, "in indexOneResource provider!= null");
                ...
                Log.d(LOG_TAG, "in indexOneResource providerNonIndexableKeys.size: " + providerNonIndexableKeys.size());
    ...
    private void indexFromResource(Context context, SQLiteDatabase database, String localeStr,
        ...
        Log.d(LOG_TAG, "in indexFromResource intentAction: " + intentAction + " intentTargetPackage: " + intentTargetPackage 
            + " fragmentName: " + fragmentName + " intentTargetClass: " + intentTargetClass);
        ...
        try {
            ...
            throw new RuntimeException("Index.java Error parsing PreferenceScreen", e);
        } catch (IOException e) {
            throw new RuntimeException("Index.java Error parsing PreferenceScreen", e);
        } finally {
    ...
    private void indexFromProvider(Context context, SQLiteDatabase database, String localeStr,
        ...
        Log.d(LOG_TAG, "in indexFromProvider className: " + className + " provider: " + provider);
        if (provider == null) {
        ...
        if (rawList != null) {
            ...
            Log.d(LOG_TAG, "in indexFromProvider rawSize: " + rawSize);
    ...
    private void updateOneRow(SQLiteDatabase database, String locale,
            ...
            String intentAction, String intentTargetPackage, String intentTargetClass,
            boolean enabled, String key, int userId) {
        Log.d(LOG_TAG, "in updateOneRow updatedTitle: " + updatedTitle + " className: " + className);
    ...
    private class UpdateIndexTask extends AsyncTask<UpdateData, Integer, Void> {
        ...
        private boolean processDataToUpdate(SQLiteDatabase database, String localeStr,
            ...
            Log.i(LOG_TAG, "in processDataToUpdate count: " + count);
            for (int n = 0; n < count; n++) {
