...
public class AppViewHolder {
	...
	public ImageView arrow;//added by chenwenshuai for SDcar app
    ...
    static public AppViewHolder createOrRecycle(LayoutInflater inflater, View convertView) {
        if (convertView == null) {
			...
			holder.arrow = (ImageView) convertView.findViewById(R.id.arrow);//added by chenwenshuai for SDcar app
