...
public final class SmsDefaultDialog extends AlertActivity implements
    ...
    private boolean buildDialog(String packageName) {
		...
		/*HQ_zhangjing 2015-09-25 modified for CQ  HQ01342317 bagin*/
		String mmsLableTxt = "";
		if( mNewSmsApplicationData.mPackageName.equals("com.android.contacts")){
			mmsLableTxt = getString( R.string.default_sms );
		}else{
			mmsLableTxt = mNewSmsApplicationData.mApplicationName;
		}
        ...
        if (oldSmsApplicationData != null) {
            p.mMessage = getString(R.string.sms_change_default_dialog_text,
                    mmsLableTxt,///HQ_zhangjing 2015-09-25 modified for CQ  HQ01342317 
