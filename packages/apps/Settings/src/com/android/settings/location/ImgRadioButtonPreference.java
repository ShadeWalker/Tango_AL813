 ...
 */
public class ImgRadioButtonPreference extends CheckBoxPreference {
    public interface OnClickListener {
        public abstract void onImgRadioButtonClicked(ImgRadioButtonPreference imgRadioButtonPreference);
    }

    private OnClickListener mListener = null;

    public ImgRadioButtonPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setWidgetLayoutResource(R.layout.preference_widget_radiobutton);
    }

    public ImgRadioButtonPreference(Context context, AttributeSet attrs) {
        this(context, attrs, com.android.internal.R.attr.checkBoxPreferenceStyle);
    }

    public ImgRadioButtonPreference(Context context) {
        this(context, null);
    }
    ...
    public void onClick() {
        if (mListener != null) {
            mListener.onImgRadioButtonClicked(this);
        }
    }
