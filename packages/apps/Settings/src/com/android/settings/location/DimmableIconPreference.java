...
public class DimmableIconPreference extends Preference {
	...
	/*HQ_liugang add for HQ01427443*/
	@Override
	protected View onCreateView(ViewGroup parent) {
		ViewGroup view = (ViewGroup)super.onCreateView(parent);
		ImageView appView = (ImageView)view.findViewById(android.R.id.icon);
		appView.setLayoutParams(new LinearLayout.LayoutParams(85, 85));
		return view;
	}
	/*HQ_liugang add end*/
