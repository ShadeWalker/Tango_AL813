...
public class LocationSettings extends LocationSettingsBase
    ...
    //HQ_jiazaizheng 20150827 modify for HQ01347887 start
    //private SwitchBar mSwitchBar;
    //private Switch mSwitch;
    private SwitchPreference mGpsEnableSwitch;
    //private boolean mValidListener = false;
    //HQ_jiazaizheng 20150827 modify for HQ01347887 end
    ...
    public void onDestroyView() {
        super.onDestroyView();
        //mSwitchBar.hide();//HQ_jiazaizheng 20150827 modify for HQ01347887
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (mGpsEnableSwitch == preference) {
            if ((boolean)newValue) {
    ...
    private void addPreferencesSorted(List<Preference> prefs, PreferenceGroup container) {
        ...
        for (Preference entry : prefs) {
            entry.setWidgetLayoutResource(R.layout.arrow_img_layout);
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        //HQ_jiazaizheng 20150827 modify for HQ01347887 start
        mGpsEnableSwitch = (SwitchPreference) findPreference("gps_enable");
        mGpsEnableSwitch.setOnPreferenceChangeListener(this);
        //HQ_jiazaizheng 20150827 modify for HQ01347887 start
    ...
    public void onModeChanged(int mode, boolean restricted) {
        ...
        mGpsEnableSwitch.setEnabled(!restricted);//HQ_jiazaizheng 20150827 modify for HQ01347887
        ...
        if (enabled != mGpsEnableSwitch.isChecked()) {
            mGpsEnableSwitch.setChecked(enabled);
        }
        //HQ_jiazaizheng 20150827 modify for HQ01347887 end
