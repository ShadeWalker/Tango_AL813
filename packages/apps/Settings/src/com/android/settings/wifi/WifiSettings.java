...
//add by wanghui for al813 HQ01398542 HQ01398515
...
public class WifiSettings extends RestrictedSettingsFragment
    ...
    private static final int MENU_ID_P2P  = Menu.FIRST + 10;
    ...
    void addOptionsMenuItems(Menu menu) {
       ...
       /*HQ_sunli 2015-8-7 HQ01310120 begin*/
        menu.add(Menu.NONE, MENU_ID_SCAN, 0, R.string.wifi_menu_scan)
                .setIcon(R.drawable.ic_wifi_scan)
                .setEnabled(wifiIsEnabled)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);

	menu.add(Menu.NONE, MENU_ID_P2P, 0, R.string.wifi_menu_p2p)
                .setIcon(R.drawable.ic_wifi_direct)
	//delete by wanghui for al812
                .setEnabled(wifiIsEnabled)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
      /*HQ_sunli 2015-8-7 HQ01310120 end*/
       ...
       /*HQ_sunli 2015-8-7 HQ01310120 delete begin*/
        /*menu.add(Menu.NONE, MENU_ID_SCAN, 0, R.string.menu_stats_refresh)
               .setEnabled(wifiIsEnabled)
               .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);*/
       /*HQ_sunli 2015-8-7 HQ01310120 delete end*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case MENU_ID_P2P:
            /*HQ_sunli 20150807 HQ01310120 modify begin*/
            ...
            /*HQ_sunli 20150807 HQ01310120 modify end*/
                return true;
            ...
            case MENU_ID_WPS_PIN:
                ...
                return true;
            case MENU_ID_SCAN:
             /*HQ_sunli 20150807 HQ01310120 add begin*/
	      Toast.makeText(getActivity(), R.string.wifi_setup_status_scanning,
            		     Toast.LENGTH_SHORT).show(); 
             /*HQ_sunli 20150807 HQ01310120 add end*/
        ...
        if (info instanceof AdapterContextMenuInfo) {
            ...
            if (preference instanceof AccessPoint) {
                ...
                if (ActivityManager.getCurrentUser() == UserHandle.USER_OWNER &&
                    ...
                    /*HQ_chenwenshuai add for eap-sim 20151207,HQ01508640,b*/
                    Log.d(TAG, "ylf[onCreateContextMenu]_mSelectedAccessPoint.ssid="+mSelectedAccessPoint.ssid);
                    if(SystemProperties.get("ro.hq.southeast.wifi.eapsim").equals("1")){
                        if(mSelectedAccessPoint.ssid.equals(VIVO_AUTO_SSID) || mSelectedAccessPoint.ssid.equals(MOVISTAR_AUTO_SSID)){
                            if(mSelectedAccessPoint.security != 5){
                    ...
                    //menu.add(Menu.NONE, MENU_ID_FORGET, 0, R.string.wifi_menu_forget);
                    /*HQ_chenwenshuai add for eap-sim 20151207,HQ01508640,e*/
                }
                ...
                if (mSelectedAccessPoint.networkId != INVALID_NETWORK_ID) {
                    /*HQ_yulifeng add for eap-sim 20151016,HQ01308716,b*/
                    Log.d(TAG, "ylf[onCreateContextMenu]_mSelectedAccessPoint.ssid="+mSelectedAccessPoint.ssid);
                    if(SystemProperties.get("ro.hq.southeast.wifi.eapsim").equals("1")){
                        if(mSelectedAccessPoint.ssid.equals(WIFI_AUTO_SSID) || mSelectedAccessPoint.ssid.equals(VIVO_AUTO_SSID)
							|| mSelectedAccessPoint.ssid.equals(MOVISTAR_AUTO_SSID)){
                            if(mSelectedAccessPoint.security != 5){
                    ...
                    /*HQ_yulifeng add for eap-sim 20151016,HQ01308716,e*/
                    try {
        ...
        switch (wifiState) {
            case WifiManager.WIFI_STATE_ENABLED:
                ...
                for (AccessPoint accessPoint : accessPoints) {
                    Log.d("ylf", "accessPoints.ssid = "  + accessPoint.ssid);
                    Log.d("ylf", "accessPoint.getLevel() = "  + accessPoint.getLevel());
    ...
    private boolean isPresetSsid(String ssid,int security) {
        Log.d(TAG, "isPresetSsid is coming");
        ...
        if(("52501".equals(pMccMnc)||"52501".equals(pMccMnc2)||"52502".equals(pMccMnc)||"52502".equals(pMccMnc2))
            && WIFI_AUTO_SSID.equals(ssid)&& SECURITY_EAP == security) {
            Log.d("ylf", "isPresetSsid = true,CMCC coming,ssid = "+ssid);
            return true;
        }
        if(("46692".equals(pMccMnc)||"46692".equals(pMccMnc2)) && CHT_AUTO_SSID.equals(ssid)&& SECURITY_EAP == security) {
            Log.d("ylf", "isPresetSsid = true,CHT Wi-Fi Auto coming,ssid = "+ssid);
            return true;
        }
        if(("46601".equals(pMccMnc)||"46601".equals(pMccMnc2)) && FET_AUTO_SSID.equals(ssid)&& SECURITY_EAP == security) {
            Log.d("ylf", "isPresetSsid = true,FET Wi-Fi Auto coming,ssid = "+ssid);
            return true;
        }
        return false;
    }
    ...
    private static List<AccessPoint> constructAccessPoints(Context context,
        ...
        if (configs != null) {
            ...
            for (WifiConfiguration config : configs) {
                ...
                Log.d("ylf","[constructAccessPoints]config.SSID"+config.SSID);
                Log.d("ylf","[constructAccessPoints]config.imsi"+config.imsi);
