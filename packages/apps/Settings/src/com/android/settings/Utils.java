...
public final class Utils {
    ...
    public static String getBatteryStatus(Resources res, Intent batteryChangedIntent) {
        ...
        if (status == BatteryManager.BATTERY_STATUS_CHARGING) {
            ...
            if(FeatureOption.MTK_DUAL_INPUT_CHARGER_SUPPORT == true &&
                (plugType == (BatteryManager.BATTERY_PLUGGED_AC | BatteryManager.BATTERY_PLUGGED_USB))){
                resId = R.string.battery_info_status_charging_ac;
            }
    ...
    public static void startWithFragmentAsUser(Context context, String fragmentName, Bundle args,
        ...
        //intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);//HQ_jiangchao modified for HQ01352504 at 20150923 
