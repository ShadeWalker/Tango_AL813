...
public class ZonePicker extends ListFragment {
    ...
    static class ZoneGetter {
            ...
            try {
                ...
                while (xrp.getEventType() != XmlResourceParser.END_TAG) {
                    ...
                    if (xrp.getName().equals(XMLTAG_TIMEZONE)) {
						...
						if(olsonId != null && displayName != null) {
        ...
        private void addTimeZone(String olsonId, String displayName) {
            if (olsonId.equals("Asia/Jerusalem") && SystemProperties.get("ro.hq.remove.jerusalem.timezone").equals("1")) {//HQ_hushunli 2015-09-10 add for HQ01406282
                return;
            }
            ...
            map.put(KEY_GMT, mBidiFormatter.unicodeWrap(DateTimeSettings.getTimeZoneText(tz, false)));
            map.put(KEY_OFFSET, tz.getOffset(mNow.getTime()));
            Log.d(TAG, olsonId + "    " + mBidiFormatter.unicodeWrap(DateTimeSettings.getTimeZoneText(tz, false)) + "    " + mBidiFormatter.unicodeWrap(displayName));
            mZones.add(map);
        }
    }
