...
public class TrustAgentSettings extends SettingsPreferenceFragment implements
    ...
    private void updateAgents() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            /*modifed by libeibei for HQ02066648 to close SmartLock and disable switch,begin*/
            //preference.setChecked(mActiveAgents.contains(agent.component));
            preference.setChecked(false);
            preference.setEnabled(false);
            /*modifed by libeibei for HQ02066648 to close SmartLock and disable switch,end*/
            category.addPreference(agent.preference);
        }
        

        //add by HQ_caoxuhao at 20150914 HQ01382835 begin
        //add for default information
        if (count == None) {
        	Preference preference = new Preference(context);
        	preference.setPersistent(false);
        	preference.setTitle(R.string.trust_agents_default_title);
        	preference.setEnabled(false);
        	category.addPreference(preference);
		}
        //add by HQ_caoxuhao at 20150914 HQ01382835 end
    }
