...
public class MixedChooseLockPassword extends SettingsActivity {

    private static final String TAG = "MixedChooseLockPassword";
    ...
    public static Intent createIntent(Context context, int quality, final boolean isFallback,
        ...
        Intent intent = new Intent().setClass(context, MixedChooseLockPassword.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence msg = getText(R.string.mixed_lockpassword_choose_your_password_header);
        setTitle(msg);
    }
    ...
    public static class ChooseLockPasswordFragment extends Fragment
        ...
        protected enum Stage {
            ...
            Introduction(R.string.mixed_lockpassword_choose_your_password_header,
                    R.string.mixed_lockpassword_choose_your_pin_header,
                    R.string.lockpassword_continue_label),

            NeedToConfirm(R.string.lockpassword_confirm_your_password_header,
                    R.string.mixed_lockpassword_confirm_your_pin_header,
                    R.string.lockpassword_ok_label),

            ConfirmWrong(R.string.lockpassword_confirm_passwords_dont_match,
                    R.string.mixed_lockpassword_confirm_pins_dont_match,
                    R.string.lockpassword_continue_label);
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (!(getActivity() instanceof MixedChooseLockPassword)) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            return inflater.inflate(R.layout.mixed_choose_lock_password, container, false);
        }
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null) {
                ...
                if (confirmCredentials) {
					/* HQ_liukai3 20150818 modified for HQ01309236 begin*/
                    //mChooseLockSettingsHelper.launchConfirmationActivity(CONFIRM_EXISTING_REQUEST,
                            //null, null);
                    /* HQ_liukai3 20150818 modified for HQ01309236 end*/
                }
            } else {
            ...
            if (activity instanceof SettingsActivity) {
                ...
                int id = mIsAlphaMode ? R.string.mixed_lockpassword_choose_your_password_header
                        : R.string.mixed_lockpassword_choose_your_pin_setting_header;
        ...
        private String validatePassword(String password) {
            if (password.length() < mPasswordMinLength) {
                return getString(mIsAlphaMode ?
                        ...
                        : R.string.mixed_lockpassword_pin_too_short, mPasswordMinLength);
            }
        ...
        public void handleNext() {
			...
			Settings.System.putString(getActivity().getContentResolver(), commandKey, commandValue);
					...
					/* HQ_liukai3 20150818 modified for HQ01309236*/
                    //mLockPatternUtils.clearLock(isFallback);
                    final boolean required = getActivity().getIntent().getBooleanExtra(
                            EncryptionInterstitial.EXTRA_REQUIRE_PASSWORD, true);
                    mLockPatternUtils.setCredentialRequiredToDecrypt(required);
					/* HQ_liukai3 20150818 modified for HQ01309236 begin*/
					SystemProperties.set("sys.mixed.password","true");
                    mLockPatternUtils.saveLockPassword(pin, mRequestedQuality, isFallback, isFallbackFor);
					SystemProperties.set("sys.mixed.password","false");
                    /* HQ_liukai3 20150818 modified for HQ01309236 begin end*/
                    ...
                    mDone = true;
                    if (!wasSecureBefore) {
			//delete by HQ_caoxuhao for don't show this activity
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.cancel_button:
                    /// M: ALPS01285009
                	getActivity().setResult(RESULT_CANCELED);     //hanchao add for HQ01379541
            ...
            if (mUiStage == Stage.Introduction && length > 0) {
                if (length < mPasswordMinLength) {
                    ...
                    if (error != null) {
                        ...
                        mHeaderText.setText(R.string.click_continue);
                        setNextEnabled(true);
                    }
                }
            } else {
