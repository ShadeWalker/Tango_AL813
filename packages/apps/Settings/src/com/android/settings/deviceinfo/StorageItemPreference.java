...
public class StorageItemPreference extends Preference {
    ...
    private static ShapeDrawable createRectShape(int width, int height, int color) {
		//add by HQ_zhouguo at 20150914 start
		float[] outterR = new float[] { 12, 12, 12, 12, 12, 12, 12, 12 };
        ShapeDrawable shape = new ShapeDrawable(new RoundRectShape(outterR,null,null));  
		//add by HQ_zhouguo at 20150914 end
