 ...
 */
public class SettingsHuaweiLicenseActivity extends Activity {
    ...
    private class LicenseFileLoader implements Runnable {
        ...
        private static final String INNER_TAG = "SettingsHuaweiLicenseActivity.LicenseFileLoader";
        ...
        public void run() {
            ...
            try {
                ...
                int numRead;
                inputReader = new InputStreamReader(getResources().openRawResource(R.raw.huawei_copyright));
    ...
    public SettingsHuaweiLicenseActivity() {
        super();
        mHandler = null;
        mWebView = null;
        mSpinnerDlg = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence title = getText(R.string.settings_huawei_license_activity_title);
        CharSequence msg = getText(R.string.settings_huawei_license_activity_loading);
    ...
    private void showErrorAndFinish() {
        mSpinnerDlg.dismiss();
        mSpinnerDlg = null;
        Toast.makeText(this, R.string.settings_huawei_license_activity_unavailable, Toast.LENGTH_LONG)
                .show();
        finish();
    }
}
