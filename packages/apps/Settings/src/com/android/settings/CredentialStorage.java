...
public final class CredentialStorage extends Activity {
    ...
    private class ConfigureKeyGuardDialog implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
        private boolean mConfigureConfirmed= false;

        private ConfigureKeyGuardDialog() {
            ///M:
            if (sConfigureKeyGuardDialog == null) {
                LayoutInflater inflater = LayoutInflater.from(CredentialStorage.this);
                RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.vpn_a_dialog, null);

                final AlertDialog dialog = new AlertDialog.Builder(CredentialStorage.this).create();
                dialog.show();
                dialog.setOnDismissListener(this);
                ...
                Button btnCancel = (Button) layout.findViewById(R.id.dialog_settings);
                btnCancel.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        sConfigureKeyGuardDialog = null;
                        mConfigureConfirmed = true;
