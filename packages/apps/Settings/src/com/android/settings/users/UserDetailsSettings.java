...
public class UserDetailsSettings extends SettingsPreferenceFragment
    ...
    /// M: Add to block user quickly click deleting user icon to avoid JE. For deleting user isn't synchrous
    /// with UI, when user quickly click the delete icon while user removed broadcast received, the
    ...
    public void onCreate(Bundle icicle) {
        ...
        context.registerReceiverAsUser(mUserChangeReceiver, UserHandle.ALL, filter, null,null);        
    }
    ...
    private void showDeleteUserDialog() {
        if (mDeletingUserDialog == null) {
            ...
            mDeletingUserDialog.setMessage(getResources().getString(R.string.data_enabler_waiting_message));
