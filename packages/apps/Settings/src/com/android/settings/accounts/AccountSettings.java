...
public class AccountSettings extends SettingsPreferenceFragment
    ...
    private Preference newAddAccountPreference(Context context) {
        ...
        preference.setIcon(R.drawable.ic_menu_new);
    ...
    private void updateAccountTypes(ProfileData profileData) {
        ...
        Settings.System.putString(getActivity().getContentResolver(),Settings.System.HW_LOGIN,"false");/*HQ_jiangchao modify for Huawei account login at 20151012*/
        if (profileData.userInfo.isEnabled()) {
            ...
            //HQ_wuhuihui_20150806 modified to remove sync account start
            for (int i = 0; i < count; i++) {    
            //	if(!getString(R.string.huawei_id).equals(preferences.get(i).toString())){  //HQ_jiangchao modify for HQ01391112 at 20150917
            	   ...
            	   if("华为帐号".equals(preferences.get(i).toString())){
            	      Settings.System.putString(getActivity().getContentResolver(),Settings.System.HW_LOGIN,"true");
            	    }/*HQ_jiangchao modify end*/
            }
            //HQ_wuhuihui_20150806 modified to remove sync account end
    ...
    private class AccountPreference extends Preference implements OnPreferenceClickListener {
        ...
        public AccountPreference(Context context, CharSequence title, String titleResPackageName,
            ...
            Drawable mdrawable = zoomDrawable(icon, 150, 150);        //hanchao add HQ01377298 2015.9.21
            
            setTitle(title);
            setIcon(mdrawable);                                        //hanchao add HQ01377298 2015.9.21
    ...
    //hanchao add for HQ01377298 2015.9.21 begin
    ...
    //hanchao add for HQ01377298 2015.9.21 end
}
