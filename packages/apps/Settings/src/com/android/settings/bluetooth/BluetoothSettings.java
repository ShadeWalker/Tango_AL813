...
public final class BluetoothSettings extends DeviceListPreferenceFragment implements Indexable {
    ...
    private static final int MENU_ID_VISIBILITY_TIMEOUT = Menu.FIRST + 3;
    ...
    public static boolean isOpenBTNow = false;

    // accessed from inner class (not private to avoid thunks)
    SwitchPreference mMyDevicePreference;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        private void updateDeviceName(Context context) {
		 ...
		 mMyDevicePreference.setTitle(mLocalAdapter.getName());/*add by lihaizhou for HQ01496086 at 20151109 */
		/*delete by lihaizhou for HQ01496086 by begin at 20151109 by begin
               mMyDevicePreference.setSummary(context.getResources().getString(
                            R.string.bluetooth_is_visible_message, mLocalAdapter.getName()));
		delete by lihaizhou for HQ01496086 by begin at 20151109 by end*/
            }
        }
    };
    ...
    private void updateContent(int bluetoothState) {
        ...
        switch (bluetoothState) {
            case BluetoothAdapter.STATE_ON:
                ...
                if (mMyDevicePreference == null) {
                	mMyDevicePreference = new SwitchPreference(getActivity());
                }
                mMyDevicePreference.setTitle(mLocalAdapter.getName());/*add by lihaizhou for HQ01496086 at 20151109 */
		/*delete by lihaizhou for HQ01496086 by begin at 20151109 by begin
		...
		delete by lihaizhou for HQ01496086 by begin at 20151109 by end*/
                ...
                if (!isRestrictedAndNotProviderProtected()) {
                	Log.d(TAG, "resume BluetoothDiscoverableEnabler");
                	if (mDiscoverableEnabler == null) {
                		mDiscoverableEnabler = new BluetoothDiscoverableEnabler(mLocalAdapter, mMyDevicePreference);
                		mDiscoverableEnabler.resume(getActivity());
                	}
		    ...
		    /*delete by lihaizhou for HQ01499356 at 20151111 
