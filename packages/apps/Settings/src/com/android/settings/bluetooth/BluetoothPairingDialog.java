...
public final class BluetoothPairingDialog extends AlertActivity implements
    ...
    private View createPinEntryView() {
        ...
        //add by HQ_wuruijun start
        messageViewCaption.setTextColor(Color.BLACK);
        messageViewContent.setTextColor(Color.BLACK);
        messageView2.setTextColor(Color.BLACK);
        mPairingView.setTextColor(Color.BLACK);
        //add by HQ_wuruijun end
    ...
    private View createView() {
		...
		//add by HQ_zhouguo at 20150814 start
		messageViewCaption.setTextColor(Color.BLACK);
		messageViewContent.setTextColor(Color.BLACK);
		pairingViewCaption.setTextColor(Color.BLACK);
		pairingViewContent.setTextColor(Color.BLACK);
		messagePairing.setTextColor(Color.BLACK);
		//add by HQ_zhouguo at 20150814 end
