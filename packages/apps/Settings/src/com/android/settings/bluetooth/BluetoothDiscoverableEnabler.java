 ...
 */
final class BluetoothDiscoverableEnabler implements
    ...
    public void resume(Context context) {
        ...
        mDiscoveryPreference.setOnPreferenceChangeListener(this);
    ...
    /*public boolean onPreferenceClick(Preference preference) {
        ...
        mDiscoveryPreference.setChecked(mDiscoverable);
        Log.d(TAG, "mDiscoverable = " + mDiscoverable);
        return true;
    }*/
	...
	public boolean onPreferenceChange(Preference preference, Object newValue) {
		...
		mDiscoverable = (boolean) newValue;
		setEnabled(mDiscoverable);
		mDiscoveryPreference.setChecked(mDiscoverable);
		return false;
	}
    ...
    private void updateTimerDisplay(int timeout) {
        mDiscoveryPreference.setTitle(mLocalAdapter.getName()); //add by lihaizhou for HQ01358948  
    ...
    private void updateCountdownSummary() {
        ...
        if (BluetoothSettings.isOpenBTNow) {
        	BluetoothSettings.isOpenBTNow = false;
        	int timeout = getDiscoverableTimeout();
        	long endTimestamp = currentTimestamp + timeout * 1000L;
        	LocalBluetoothPreferences.persistDiscoverableEndTimestamp(mContext, endTimestamp);
        }
