    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(BluetoothDevice.ACTION_PAIRING_REQUEST)) {
            ...
            if (powerManager.isScreenOn() &&
                ...
                /*add by wanghui for al813 HQ01442607 20151027 begin*/
                PowerManager.WakeLock mWakelock = powerManager.newWakeLock(PowerManager.ACQUIRE_CAUSES_WAKEUP | PowerManager.SCREEN_DIM_WAKE_LOCK, "bright"); 
                mWakelock.acquire();  
                /*add by wanghui for al813 HQ01442607 20151027 end*/
                ...
                //add by wanghui for al813 HQ01442607 20151027 
                mWakelock.release();
