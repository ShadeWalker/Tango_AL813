...
public class SettingsAppWidgetProvider extends AppWidgetProvider {
    ...
    private static final float HALF_BRIGHTNESS_THRESHOLD = 0.15f;//fengyaling 20150814 add for default brightbess
    ...
    private static final class LocationStateTracker extends StateTracker {
        ...
        public int getButtonImageId(boolean on) {
        //add xuqian4 RTX：xuqian3 HQ01355643  start
//            if (on) {
...
//            return R.drawable.ic_appwidget_settings_location_off_holo;
//        }
        //add xuqian4 RTX：xuqian3 HQ01355643  end
        @Override
        public int getActualState(Context context) {
            ...
            new AsyncTask<Void, Void, Boolean>() {
                ...
                protected Boolean doInBackground(Void... args) {
                    ...
                    if (!um.hasUserRestriction(UserManager.DISALLOW_SHARE_LOCATION)) {
						...
						/*HQ_liugang add for HQ01327591*/
						if(!desiredState){
                       //add xuqian4 RTX：xuqian3 HQ01355643
//							mode = Settings.Secure.LOCATION_MODE_OFF;
						}
						/*HQ_liugang add end*/
                        Settings.Secure.putInt(resolver, Settings.Secure.LOCATION_MODE, mode);
                        //add xuqian4 RTX：xuqian3 HQ01355643  start
                        return (mode != Settings.Secure.LOCATION_MODE_OFF)&&(mode != Settings.Secure.LOCATION_MODE_BATTERY_SAVING);
                    }
                        //add xuqian4 RTX：xuqian3 HQ01355643  end
