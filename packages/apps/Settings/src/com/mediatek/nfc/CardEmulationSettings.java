...
public class CardEmulationSettings extends SettingsPreferenceFragment implements 
    ...
    public void onStart() {
        ...
        Xlog.d(TAG, "onCreate, mSwitchBar addOnSwitchChangeListener ");
        // On/off switch 
    ...
    public void onSwitchChanged(Switch switchView, boolean desiredState) {
        Xlog.d(TAG, "onCheckedChanged, desiredState " + desiredState + " mUpdateStatusOnly " + mUpdateStatusOnly);
        ...
        if(!desiredState) {
            ...
            Xlog.d(TAG, "onCheckedChanged, set  Settings.Global.NFC_MULTISE_ACTIVE  EMULATION_OFF" + EMULATION_OFF);
        } else {            
    ...
    private void updatePreferences() {
        ...
        Xlog.d(TAG, "updatePreferences(),EMULATION_OFF " + EMULATION_OFF + ", active mode: " + activeMode + ", previous mode is " + previousMode);
