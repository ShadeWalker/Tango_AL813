...
import android.preference.Preference.OnPreferenceChangeListener;//chenwenshuai modified for HQ01399462
...
public class SoundEnhancement extends SettingsPreferenceFragment implements Indexable,
		OnPreferenceChangeListener {//chenwenshuai modified for HQ01399462
    ...
    public void onCreate(Bundle icicle) {
		...
		mMusicPlusPrf.setOnPreferenceChangeListener(this);//chenwenshuai modified for HQ01399462
        mBesLoudnessPref = (SwitchPreference) findPreference(KEY_BESLOUDNESS);
		mBesLoudnessPref.setOnPreferenceChangeListener(this);//chenwenshuai modified for HQ01399462
        mBesSurroundPref = (Preference) findPreference(KEY_BESSURROUND);
        mLosslessBTPref = (SwitchPreference) findPreference(KEY_LOSSLESSBT);
		mLosslessBTPref.setOnPreferenceChangeListener(this);//chenwenshuai modified for HQ01399462
	...
	/* HQ_ChenWenshuai 2015-10-27 modified for HQ01399462 begin */
	@Override
	...
	/*HQ_ChenWenshuai 2015-10-27 modified end */
