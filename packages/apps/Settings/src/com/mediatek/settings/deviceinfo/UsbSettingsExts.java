...
/* HQ_ChenWenshuai 2015-07-24 modified for HQ01241322*/
...
public class UsbSettingsExts {
    ...
    public PreferenceScreen addUsbSettingsItem(UsbSettings usbSettings) {
        ...
        if (umsExist) {
			...
			/* HQ_ChenWenshuai 2015-07-24 modified for HQ01241322 begin */
			...
			/*HQ_ChenWenshuai 2015-07-24 modified end */
        }
	...
	/* HQ_ChenWenshuai 2015-07-24 modified for HQ01241322 begin */
	public boolean isStorageMounted(Context context) {
	StorageManager mStorageManager = null;
	mStorageManager = (StorageManager) context.getSystemService(Context.STORAGE_SERVICE);
        //String storageState = mStorageManager.getVolumeState(StorageManagerEx.getExternalStoragePath());
        String storageState = mStorageManager.getVolumeState("/storage/sdcard1"); 
	    Log.d(TAG, "isStorageMounted= "+storageState);
        if ((null == storageState) || storageState.equals(android.os.Environment.MEDIA_MOUNTED)
