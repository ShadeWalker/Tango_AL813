...
import android.os.SystemProperties;//chenwenshuai
...
public class MemoryExts {
    ...
    private void initDefaultWriteDisk() {
        ...
        UserManager.get(mActivity);
        UserManager userManager =  UserManager.get(mActivity);
        ...
        for (StorageVolume volume : availableVolumes) {
            ...
            String desc = volume.getDescription(mActivity);
            //case language is english
            if ("Phone storage".equals(desc)) {
    ...
    private OnPreferenceChangeListener defaultWriteDiskListener = new OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(final Preference preference, Object newValue) {
            if (preference != null && preference instanceof RadioButtonPreference) {
                ...
                int msgID = preference.getKey().equals("/storage/sdcard1") ?
                        R.string.dlg_internal_in_use_message_emotion : R.string.dlg_external_in_use_message_emotion;
                int themeID = preference.getContext().getResources().getIdentifier("androidhwext:style/Theme.Emui.Dialog.Alert", null, null);
                Dialog dialog = new AlertDialog.Builder(preference.getContext(), themeID).setTitle(R.string.dlg_sd_attention_title)
                        .setMessage(msgID)
                        ...
                        .setPositiveButton(R.string.dlg_ok, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(final DialogInterface arg0, final int arg1) {
                                ...
                                if (preference.getKey().equals("/storage/sdcard1")){
                                ...
                                preference.getContext().sendBroadcast(intentReboot);
                            }
