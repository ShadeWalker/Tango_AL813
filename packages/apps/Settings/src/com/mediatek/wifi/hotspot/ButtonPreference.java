...
public class ButtonPreference extends Preference implements
    ...
    public void setMacAddress(String macAddress) {
		/*modify by wanghui for al812 HQ01482891 because chengwei begin*/
        mMacAddress = macAddress;//.toUpperCase();//HQ01218165,chengwei,20150716,modify the mac address format to huawei style
        setTitle("MAC: "+mMacAddress.toUpperCase());
		/*modify by wanghui for al812 HQ01482891 because chengwei end*/
    }
