...
import android.view.Gravity; //HQ_zhangpeng5 2015-11-25 modified for modified for Arabic layout HQ00055994
import java.util.Locale; //HQ_zhangpeng5 2015-11-25 modified for modified for Arabic layout HQ00055994
...
public class BandwidthUsage extends Fragment {
    ...
    private BandwidthChartListener mChartListener = new BandwidthChartListener() {
        ...
        public void requestLimitEdit() {
            ...
            LimitEditorFragment.show(BandwidthUsage.this, mChart.getLimitBytes());
        }
    };
    ...
    /* HQ_zhangpeng5 2015-11-25 modified for modified for Arabic layout HQ00055994 begin */
    private void setPreferenceTitle(View parent, int resId, String data,Boolean bool) {
        if(bool){
            String text = getActivity().getString(resId, data);
            final TextView title = (TextView) parent.findViewById(android.R.id.title);
            ...
            setPreferenceTitle(parent,resId,data);
    }
    /* HQ_zhangpeng5 2015-11-25 modified for modified for Arabic layout HQ00055994 end */
    ...
    private void refreshTimeAndData() {
        ...
        //if time is set automatically or manually to a passed time, set both DB time and variant 0
        if(usedTime < 0) {
            Settings.System.putLong(getActivity().getContentResolver(),Settings.System.WIFI_HOTSPOT_START_TIME,
        ...
        //    setPreferenceTitle(mTotalDataView, R.string.wifi_ap_total_data, " " + String.valueOf(totalData) + unit,true);
        //else
    ...
    public static class LimitEditorFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            final View view = dialogInflater.inflate(R.layout.band_width_usage_editor, null, false);
