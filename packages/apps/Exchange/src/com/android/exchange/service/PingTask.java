...
public class PingTask extends AsyncTask<Void, Void, Void> {
    ...
    public PingTask(final Context context, final Account account,
        ...
        /// M: Set pingSyncSynchronizer to EasPing for wake lock
        mOperation = new EasPing(context, account, amAccount, pingSyncSynchronizer);
        mPingSyncSynchronizer = pingSyncSynchronizer;
    }

    /** Start the ping loop. */
    public void start() {
        /// M: acquire wake lock for ping of current account
        mPingSyncSynchronizer.acquireWakeLock(mOperation.getAccountId());
    ...
    protected Void doInBackground(Void... params) {
        ...
        mPingSyncSynchronizer.pingEnd(mOperation.getAccountId(), mOperation.getAccount(),
    ...
    protected void onCancelled (Void result) {
        ...
        /// M: Add result of ping for further handling, and use Account instead
        mPingSyncSynchronizer.pingEnd(mOperation.getAccountId(), mOperation.getAccount(),
                EasOperation.RESULT_ABORT);
    }
}
