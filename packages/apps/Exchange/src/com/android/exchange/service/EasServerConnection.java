...
public class EasServerConnection {
    ...
    /**
     * M: Get HostAuth to make it to be checked
     * @return Whether {@link #mHostAuth} was last initialized with a non-null value. Generally
     * speaking that it is no reason to set to null at construction time.
     */
