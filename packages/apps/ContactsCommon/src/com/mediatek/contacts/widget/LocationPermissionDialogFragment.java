...
public class LocationPermissionDialogFragment extends DialogFragment {
    ...
    private static final String KEY_NEW_INSTANCE = "newInstance";
    ...
    public static LocationPermissionDialogFragment getInstance(FragmentManager manager) {
        ...
        if (instance == null) {
            ...
            if (instance.mNewInstance) {
                instance.dismiss();
                instance = new LocationPermissionDialogFragment();
                Log.i(TAG, "recreate new instance " + instance + " in " + manager);
            }
        }   
        return instance;
    }
    ...
    public void onResume() {
        super.onResume();
        if (mShowCount == null && !mNewInstance) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mNewInstance = savedInstanceState.getBoolean(KEY_NEW_INSTANCE);
            Log.d(TAG, "onCreate " + mNewInstance);
        }
    }
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        savedInstanceState.putBoolean(KEY_NEW_INSTANCE, true);
    }
