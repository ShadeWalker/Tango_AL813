...
public abstract class ContactEntryListFragment<T extends ContactEntryListAdapter>
    ...
    private void configureVerticalScrollbar() {
        ...
        if (mListView != null) {
            ...
            mListView.setFastScrollAlwaysVisible(false);//取消总是显示垂直滑快   Tanghuaizhe  hasScrollbar
    ...
    /** 
     * M: For CT New Feature. By default we show SDN Number in screen.
     */
