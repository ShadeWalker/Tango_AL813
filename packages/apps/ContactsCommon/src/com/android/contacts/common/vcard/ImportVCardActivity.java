...
public class ImportVCardActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        /* HQ_tanyali 2015-8-7 modified for al812 share contact with WLAN direct */      
        if (intent != null && "android.intent.action.VIEW_WLAN_VCARD".equals(intent.getAction())) {
            Log.i("LOG_TAG", "intent.getAction() =" + intent.getAction());   
            String strUri = intent.getStringExtra("WiFiDirectImportContentUri");
            Log.i("LOG_TAG", "strUri =" + strUri);
        ...
        /* HQ_tanyali 2015-8-7 modified end */     
    }
    ...
    protected Dialog onCreateDialog(int resId, Bundle bundle) {
        switch (resId) {
            ...
            case R.id.dialog_vcard_not_found: {
                ...
                /* HQ01670707: 2016-1-26 modify by Shanlan begin */
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(this, themeID)
                        ...
                        .setOnCancelListener(mCancelListener)
                        .setPositiveButton(android.R.string.ok, mCancelListener);
                /* HQ01670707: 2016-1-26 modify by Shanlan end */
                /** @} */
                return builder.create();
            }
    ...
    private void doScanExternalStorageAndImportVCard() {
        ...
        final File file = VcardUtils.getDirectory(path, Environment.getExternalStorageDirectory().toString());
