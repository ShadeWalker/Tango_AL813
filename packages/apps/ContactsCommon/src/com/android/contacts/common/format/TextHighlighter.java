...
//add by liruihong for highlight color refer to HQ01456735
import android.graphics.Typeface;
...
public class TextHighlighter {
	...
	//modify  by liruihong for hightlight color refer to HQ01456735
	if(mTextStyle != Typeface.COLOR){
        	return new StyleSpan(mTextStyle);
	}else{
       	return new ForegroundColorSpan(0xFF30c2c8);
	}
    }
