...
class AccountTypeManagerImpl extends AccountTypeManager
    ...
    public AccountTypeManagerImpl(Context context) {
        ...
        AccountTypeManagerEx.registerReceiverOnSimStateAndInfoChanged(mContext, mBroadcastReceiver);
    ...
    protected void loadAccountsInBackground() {
        ...
        LogUtils.d(TAG, "loadAccountsInBackground()+");
        ...
        //add by zhaizhanfeng for HQ01506309 at 151117 start
        ...
        //add by zhaizhanfeng for HQ01506309 at 151117 end
        ...
        for (SyncAdapterType sync : syncs) {
            ...
            LogUtils.d(TAG, "the AuthenticatorDescription [] auths = " + auths);
            ...
            LogUtils.d("AccountTypeManager", "the   type is " + type + " the auth is = " + auth);
