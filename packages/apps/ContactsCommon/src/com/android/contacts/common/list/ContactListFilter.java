...
public final class ContactListFilter implements Comparable<ContactListFilter>, Parcelable {
    ...
    private static final String KEY_NUMBER_ONLY = "filter.numberOnly";
    ...
    public static boolean getNumberOnlyFromPreferences(SharedPreferences prefs) {
        return prefs.getBoolean(KEY_NUMBER_ONLY, false);
    }

    public static void storeNumberOnlyToPreferences(SharedPreferences prefs, Boolean numberOnly) {
        prefs.edit()
            .putBoolean(KEY_NUMBER_ONLY, numberOnly)
            .apply();
    }
