...
/*HQ_zhangjing 2015-08-13 modified for the actionBar background begin*/
import android.app.WallpaperManager;
import android.graphics.Rect;
import android.graphics.drawable.BitmapDrawable;
import android.util.Log;
/*HQ_zhangjing 2015-08-13 modified for the actionBar background end*/
...
public class ViewPagerTabStrip extends LinearLayout {
	...
	// /added by guofeiyao
	public BitmapDrawable getSpecialDrawable() {
	    return mDrawable;
	}
	// /end
...
//        setBackgroundDrawable(getResources().getDrawable(R.drawable.tabcolor));
...
//                    selectedRight, height, mSelectedUnderlinePaint);
            canvas.drawCircle((selectedRight-selectedLeft)/2+selectedLeft, height-13, 6, mSelectedUnderlinePaint);
        }
    }
	...
	private  void setDrawableBackground( ){
		Log.d("zhangjing","zhangjing :setDrawableBackground from wallpaper");
		
		if( mWallpaperManager == null ){
			Log.d("zhangjing","mWallpaperManager = null,need to get WallpaperManager service ");
			mWallpaperManager = (WallpaperManager)getContext().getSystemService(Context.WALLPAPER_SERVICE);
		}

		if (mDrawable == null) {
			Rect rect = new Rect(0,0,50,50);
			mDrawable = new BitmapDrawable(mWallpaperManager.getBlurBitmap(rect));
			Log.d("zhangjing","create a drawable form wallpaper");
		}
	}
	/*HQ_zhangjing 2015-08-13 modified for the actionBar background end*/
}