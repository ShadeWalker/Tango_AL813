        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
    ...
    private static List<String> mFamily = new ArrayList<String>();
    private static List<String> mColleague = new ArrayList<String>();
    private static List<String> mFriend = new ArrayList<String>();
    private static List<String> mSchoolmate = new ArrayList<String>();
    ...
    public static class CustomFilterConfigurationLoader extends AsyncTaskLoader<AccountSet> {
        ...
        public AccountSet loadInBackground() {
            ...
            for (AccountWithDataSet account : accountTypes.getAccounts(false)) {
                ...
                final Cursor cursor = resolver.query(groupsUri.build(), null, CLAUSE_GROUP_VISIBLE, null, null);
                if (cursor == null) {
                    continue;
                }
    ...
    protected static class DisplayAdapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
            ...
            if (child != null) {
                ...
                CharSequence groupTitle = child.getTitle(mContext);
                //modify by wangmingyue for Contcts ui begin
                if (mFamily.contains(groupTitle.toString())) {
                	groupTitle= mContext.getResources().getString(R.string.family_group);
        		} else if (mColleague.contains(groupTitle.toString())) {
        			groupTitle= mContext.getResources().getString(R.string.colleague_group);
        		} else if (mFriend.contains(groupTitle.toString())) {
        			groupTitle= mContext.getResources().getString(R.string.friend_group);
        		} else if (mSchoolmate.contains(groupTitle.toString())) {
        			groupTitle= mContext.getResources().getString(R.string.schoolmate_group);
        		} 
               //modify by wangmingyue for Contcts ui end
