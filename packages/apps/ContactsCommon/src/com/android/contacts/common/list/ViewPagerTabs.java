...
public class ViewPagerTabs extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
	...
	// /added by guofeiyao 
	public ViewPagerTabStrip getStrip(){
	    return mTabStrip;
	}
	// /end
    ...
    public ViewPagerTabs(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTextAllCaps = false;//modify by wangmingyue for ui translations
    ...
    private void addTab(CharSequence tabTitle, final int position) {
		...
		/*HQ_zhangjing 2015-08-13 modified for the actionBar background*/
    ...
    public void onPageSelected(int position) {
		...
		//HQ_zhangjing 2015-10-23 modified for CQ HQ01419307
        mTabStrip.onPageScrolled(position, 0, 0);
    }
