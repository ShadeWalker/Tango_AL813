...
import android.util.Log;//modify by zhaizhanfeng for HQ01856116 at 160413
import com.android.dialer.util.DialerUtils;//modify by zhaizhanfeng for HQ01856116 at 160413
import com.android.contacts.activities.DialerPlugIn;//modify by zhaizhanfeng for HQ01856116 at 160413
/**
 * Controls the movement and appearance of the FAB (Floating Action Button).
 */
public class FloatingActionButtonControllerEM {
    public static final int ALIGN_MIDDLE = 0;
    public static final int ALIGN_QUARTER_END = 1;
    public static final int ALIGN_END = 2;

	//added by guofeiyao begin
	public static final int ALIGN_HIDE = 3;
	//end
    ...
    public boolean isR2L = DialerUtils.isRtl();//modify by zhaizhanfeng for HQ01856116 at 160413
    public FloatingActionButtonControllerEM(Activity activity, View container, View button) {
...
//modified by guofeiyao begin
		mFloatingActionButtonContainer.setTranslationX(
                (int) (positionOffset * getTranslationXForAlignment(ALIGN_HIDE)));
//end
        //modify by zhaizhanfeng for HQ01856116 at 160413 start
		int mCurrentTabPosition = DialerPlugIn.getPosition();
		Log.d("zhaizhanfeng","onPageScrolled.mCurrentTabPosition" + mCurrentTabPosition);
		if(isR2L&&mCurrentTabPosition==2){
			mFloatingActionButtonContainer.setTranslationX(1);
		}
        //modify by zhaizhanfeng for HQ01856116 at 160413 end
