...
public class ImportProcessor extends ProcessorBase implements VCardEntryHandler {
    ...
    public void run() {
        ...
        try {
            ...
            if (isCancelled() && mListener != null) {
                LogUtils.d(LOG_TAG, "ImportProcessor, run() onImportCanceled jobId is:" + mJobId);
    ...
    private void runInternal() {
        ...
        /// M:[COMMD_FOR_OP09]@{
        final VCardEntryConstructor constructor = ExtensionManager.getInstance().getImportExportExtension()
    ...
    public synchronized boolean cancel(boolean mayInterruptIfRunning) {
        ...
        if (DEBUG) {
            Log.d(LOG_TAG, "ImportProcessor send notification mIsRunning:" + mIsRunning);
        }
        /** @} */
        synchronized (this) {
