...
public abstract class ContactEntryListAdapter extends IndexerListAdapter {
    ...
    public void changeDirectories(Cursor cursor) {
        if (cursor.getCount() == 0) {
            ...
            Log.d(TAG, "Directory search loader returned an empty cursor, which implies we have " +
...
//        }
    ...
    public DefaultImageRequest getDefaultImageRequestFromCursor(Cursor cursor,
        ...
        return ContactsCommonListUtils.getDefaultImageRequest(cursor,displayName,lookupKey,mCircularPhotos);
        /// @}
    }

    /** M: ct new feature don't show 18900189000 number when multiple delete. @{ */
