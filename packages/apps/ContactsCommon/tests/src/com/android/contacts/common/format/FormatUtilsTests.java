...
public class FormatUtilsTests extends AndroidTestCase {
    ...
    public void testIndexOfWordPrefix_NotMatchingPrefix() {
        ...
        /**
         * M: For Chinese match
         * when the Local is Chinese, the unmatched word would not be skipped
         * @{
         */
    ...
    public void testIndexOfWordPrefix_LowerCase() {
        ...
        /**
         * M: For match modification
         * MTK has modified the match rule, that the prefix no need to be in Upper case
         * Original Code:
