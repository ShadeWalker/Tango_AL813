...
public class LiveWallpaperPreview extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		if(extras != null)//HQ_liugang add for HQ01365141 20150903
        	mWallpaperIntent = (Intent) extras.get(EXTRA_LIVE_WALLPAPER_INTENT);
		
        if (mWallpaperIntent == null || extras == null) { //HQ_liugang add for HQ01432286 20151008
		...
		if(extras != null)//HQ_liugang add for HQ01432286 20151008
