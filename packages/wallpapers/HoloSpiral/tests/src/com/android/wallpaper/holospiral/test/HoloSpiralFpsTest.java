...
public class HoloSpiralFpsTest extends ActivityInstrumentationTestCase2<PreviewStubActivity> {
    ...
    @MediumTest
    public void testHoloSpiralWallpaperFps() {
