...
public class FallStubTest extends ActivityInstrumentationTestCase2<PreviewStubActivity> {
    ...
    /**
     * Live wallpaper should be launched and binded to PreivewStubActivity.
     */
    @MediumTest
