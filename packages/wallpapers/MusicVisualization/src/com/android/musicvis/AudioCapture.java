...
public class AudioCapture {
    ...
    public void start() {
        if (mVisualizer != null) {
            try {
                if (!mVisualizer.getEnabled()) {
                    Log.d("AudioCapture", "Enable Visualizer..");
    ...
    public void stop() {
        if (mVisualizer != null) {
            try {
                if (mVisualizer.getEnabled()) {
                    Log.d("AudioCapture", "Disable Visualizer..");
                    mVisualizer.setEnabled(false);
                }
            } catch (IllegalStateException e) {
    ...
    public void release() {
        if (mVisualizer != null) {
            Log.d("AudioCapture", "Release Visualizer..");
            mVisualizer.release();
            mVisualizer = null;
        }
    }
    ...
    private boolean captureData() {
        ...
        try {
            ...
            if (status != Visualizer.SUCCESS) {
                ...
                Log.d("AudioCapture", "captureData() status : " + status);
