...
public class MusicVisualizationFpsTest extends ActivityInstrumentationTestCase2<PreviewStubActivity> {
    ...
    public MusicVisualizationFpsTest() {
    ...
    @MediumTest
    public void testMusicVisualizationWallpaperFps() {
