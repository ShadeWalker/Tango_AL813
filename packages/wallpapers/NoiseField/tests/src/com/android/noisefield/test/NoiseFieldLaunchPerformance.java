...
public class NoiseFieldLaunchPerformance extends LaunchPerformanceBase {

    private static final String TAG = "NoiseFieldStubTest";
    private static final String TARGET_PACKAGE = "com.android.noisefield";
    private static final String TARGET_PREVIEW_CLASS = "com.android.noisefield.PreviewStubActivity";
