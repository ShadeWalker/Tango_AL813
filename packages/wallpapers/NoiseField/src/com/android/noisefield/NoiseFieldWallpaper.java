...
public class NoiseFieldWallpaper extends WallpaperService {
    ...
    private class RenderScriptEngine extends Engine {
        ...
        public void onSurfaceChanged(SurfaceHolder surfaceHolder,
            ...
            // /M: At the moment of configuration change, maybe the window size is 0x0, then no need to start wallpaper @{
            if (width == 0 || height == 0) {
                Log.e("NoiseField", "onSurfaceChanged size : " + width + " , " + height);
                return;
            }
            // @}
            if (mRenderScript != null) {
