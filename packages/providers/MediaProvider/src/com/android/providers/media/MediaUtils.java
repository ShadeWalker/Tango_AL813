...
public final class MediaUtils {
    ...
    public static final boolean LOG_INSERT = SystemProperties.getBoolean("debug.log_insert", true);
    public static final boolean LOG_UPDATE = SystemProperties.getBoolean("debug.log_update", true);
    public static final boolean LOG_DELETE = SystemProperties.getBoolean("debug.log_delete", true);
