...
public class Constants {
     ...
     */
    public static final boolean MTK_DRM_ENABLED = OmaDrmClient.isOmaDrmEnabled();
...
//      "com.android.providers.downloads.ui.OMADLOpenDownloadReceiver";
    ...
    /// Many ON @{
    public static final boolean MANY_ON_ENABLED =
            SystemProperties.get("ro.mtk_hetcomm_support").equals("1");

    public static final int MAX_BLOCK = 10;

    public static final int DEFAULT_BLOCKS = 10;

    public static final long RANGE_THRESHOLD_VALUE = 5 * 1024 * 1024;

    public static final int MAX_DB_UPDATE_TIMER = 3 * 1000; // 3 seconds

    public static final int RANGE_BUFFER_SIZE = 128 * 1024;

    public static final int RANGE_MAX_BUFFER_SIZE = 2 * 1024 * 1024;

    public static final int RANGE_MAX_WRITE_TIMES = 160;

    public static final int MAX_DOWNLOAD_CONNECTION = 5;

    /**
     * sub downloads column.
     */
    public static class SubDownloads {
        public static final String SUB_DOWNLOADS_DB_TABLE = "sub_downloads";
        public static final String COLUMN_DOWNLOAD_ID = "download_id";
        public static final String COLUMN_SUB_BLOCK_ID = "block_id";
        ...
        public static final String COLUMN_CURRENT_WRITE_BYTES = "current_write_bytes";
        public static final String COLUMN_STATUS = "status";
        public static final String URI_SEGMENT = "sudDownloads";
    }

    public static final String DOWNLOADS_COLUMN_AVG_BLOCK_LENGTH = "avg_block_length";
    /// @}
}
