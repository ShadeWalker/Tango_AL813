...
public class CallLogProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        ...
        /// M: @{
        mCallLogProviderEx = new CallLogProviderEx(context);
        /// @}
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case CONFERENCE_CALLS_ID: {
                mCallLogProviderEx.queryCallLog(uri, projection, selection, selectionArgs, sortOrder, match, qb, selectionBuilder, null);
                break;
            }
            case CALLS_JION_DATA_VIEW_ID: {
                long parseCallId = parseCallIdFromUri(uri);
                mCallLogProviderEx.queryCallLog(uri, projection, selection, selectionArgs, sortOrder, match, qb, selectionBuilder, parseCallId);
                break;
            }
            case SEARCH_SUGGESTIONS:
            case SEARCH_SHORTCUT: {
                return mCallLogProviderEx.queryGlobalSearch(uri, projection, selection, selectionArgs, sortOrder, match);
            }
            /// @}
            default:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (matchedUriId) {
            ...
            case CONFERENCE_CALLS_ID:
                selectionBuilder.addClause(getEqualityClause(ConferenceCalls._ID, parseCallIdFromUri(uri)));
                int count = db.update(Tables.CONFERENCE_CALLS, values, selectionBuilder.build(), selectionArgs);
                return count;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        case CALLS:
            /**
             * M: Original Android code:
            return getDatabaseModifier(db).delete(Tables.CALLS,selectionBuilder.build(), selectionArgs);
             *
             * @{
             */
