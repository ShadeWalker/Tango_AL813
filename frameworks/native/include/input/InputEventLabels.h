...
static const InputEventLabel KEYCODES[] = {
    ...
    DEFINE_KEYCODE(S_CHANGED),
    DEFINE_KEYCODE(SC_CHANGED),
    DEFINE_KEYCODE(SBA_CHANGED),
    DEFINE_KEYCODE(SV_CHANGED),
    DEFINE_KEYCODE(SM_CHANGED),
    DEFINE_KEYCODE(SO_CHANGED),
    DEFINE_KEYCODE(SW_CHANGED),
    DEFINE_KEYCODE(SS_CHANGED),
    DEFINE_KEYCODE(SZ_CHANGED),
    DEFINE_KEYCODE(SAA_CHANGED),
    DEFINE_KEYCODE(SBB_CHANGED),
    DEFINE_KEYCODE(SAB_CHANGED),
    DEFINE_KEYCODE(SCC_CHANGED),
    DEFINE_KEYCODE(SIM_CHANGED),
    DEFINE_KEYCODE(FPC),//keycode for fingerprint by liuchaochao
