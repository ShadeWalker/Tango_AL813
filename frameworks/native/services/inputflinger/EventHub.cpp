...
status_t EventHub::openDeviceLocked(const char *devicePath) {
	...
	//HQ_zhangteng added for Smart Earphone Control at 2015-09-11 begin
	/*< DTS2014091300536 tiandazhang/00107790 20140913 begin */
      String8 str(identifier.name);
       str.toLower();
       // TODO: Do not use hardcode "jack"
       //Notes:Use Earphone hardcode to match
       if (str.find("accdet") != -1) {
           char prop[PROPERTY_VALUE_MAX] = {0};
           property_get("ro.config.hwinternet_audio", prop, "0");
           if (atoi(prop)) {
            // Please keep the value of JACK_DEVICE_ID the same
            // as the value in PhoneWindowManager.
           const int JACK_DEVICE_ID = 0x1000000;
           deviceId = JACK_DEVICE_ID | deviceId;
           ALOGD("Jack device %x", deviceId);
		}
 	 }
    /*< DTS2014091300536 tiandazhang/00107790 20140913 begin */
   //HQ_zhangteng added for Smart Earphone Control at 2015-09-11 end
