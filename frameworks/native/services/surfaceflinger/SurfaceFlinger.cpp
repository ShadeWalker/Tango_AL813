...
#endif
#endif
/*< DTS2014111108096 huangbangbang/00191767 20141111 begin */
#include <SurfaceFlingerEx.h>
/* DTS2014111108096 huangbangbang/00191767 20141111 end >*/
        ...
        bool yswap, bool useIdentityTransform, Transform::orientation_flags rotation)
{
    ...
    /*<DTS2014101007273 tiandazhang/00107790 20141107 begin */
    //rebase for keyguard DTS2013081202956, impl in HwSurfaceFlinger
    if(maxLayerZ == -1000){//Flag to capture screen under keyguard view
        ALOGE("captureScreenImplLocked comes, captureScreenForKeyguard...");
        const LayerVector& layers= mCurrentState.layersSortedByZ;
        /*< DTS2014111108096 huangbangbang/00191767 20141111 begin */
        SurfaceFlingerEx::captureScreenForKeyguard(layers, filtering, hw);
        /* DTS2014111108096 huangbangbang/00191767 20141111 end >*/
    } else {
    const LayerVector& layers( mDrawingState.layersSortedByZ );
    const size_t count = layers.size();
    ...
    /* DTS2014101007273 tiandazhang/00107790 20141107 end > */
