                ...
                cameraId, cameraFacing, clientPid, clientUid, servicePid)
{
	...
	mSoundState = -1;//add by wangjing3 for HQ01218038 2015-07-06
...
status_t CameraClient::setParameters(const String8& params) {
	...
	//add by wangjing3 for HQ01218038 begin 2015-07-06
	mSoundState = p.getInt("camera_sound_state");
	if(0 == mSoundState){
		mPlayShutterSound = false;
	}else if(1 == mSoundState){
		mPlayShutterSound = true;
	}
	//add by wangjing3 for HQ01218038 end 2015-07-06
//Add by mtk start  
//if( strcmp(String8(mClientPackageName).string(), "com.huawei.camera") != 0 && strcmp(String8(mClientPackageName).string(), "com.android.cts.hardware") !=0 ) //com.tencent.mm
if( strcmp(String8(mClientPackageName).string(), "com.tencent.mobileqq") == 0 || strcmp(String8(mClientPackageName).string(), "com.tencent.mm") ==0 ) 
{//LOG1("sssssssv");
p.set (CameraParameters::KEY_METERING_AREAS,"(0,0,0,0,0)");
}
//Add by mtk end
