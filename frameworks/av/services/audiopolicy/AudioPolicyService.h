...
//MTK_AUDIO_ADD>    
   ...
   //MTK
   virtual status_t getCustomAudioVolume(AUDIO_CUSTOM_VOLUME_STRUCT* pCustomVol);
...
//<MTK_AUDIO_ADD
                    status_t    getCustomAudioVolumeCommand(AUDIO_CUSTOM_VOLUME_STRUCT* pCustomVol);
