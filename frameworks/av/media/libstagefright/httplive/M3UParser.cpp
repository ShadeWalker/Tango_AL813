...
bool M3UParser::getTypeURI(size_t index, const char *key, AString *uri) const {
    if (!mIsVariantPlaylist) {
        *uri = mBaseURI;
        ...
        return !strcmp("audio", key) || !strcmp("video", key);   //fix for ALPS01873531
        //return !strcmp("audio", key) || !strcmp("video", key) || !strcmp("subtitles", key);
#else
...
#ifdef MTK_AOSP_ENHANCEMENT
#ifdef MTK_SUBTITLE_SUPPORT
        return !strcmp("audio", key) || !strcmp("video", key);      //fix for ALPS01873619
        //return !strcmp("audio", key) || !strcmp("video", key) || !strcmp("subtitles", key);
#else
        // Assume media without any more specific attribute contains
        // audio and video, but no subtitles.
