...
#ifdef MTK_AOSP_ENHANCEMENT
    static const int64_t kMaxBufferedDurationUs;
    static const int64_t kThresholdBufferedDurationUs;
#endif
...
private:
    void selectSeqNumber(const int32_t firstSeqNumberInPlaylist,const int32_t lastSeqNumberInPlaylist);
    bool checkIfHaveMetaPicture();
#endif
