...
status_t TableOfContentThread::getFramePos(int64_t targetTimeUs, int64_t *pActualTimeUs, off_t *pActualPos, bool bMandatory)
{
        ...
        while (start <= end)
        {
            ...
            else
            {
                ...
                *pActualPos     = m_Toc.TocPos[mid];
                ...
                TOC_PRINT_DBG("seek::curpos=%d,nowTs=%lld,paktPos=%d", *pActualPos, *pActualTimeUs, mSeekPaktPos);
                return OK;
            }
    ...
    TOC_PRINT_DBG("+seek::curpos=%d,nowTs=%lld,paktPos=%d,entry =%d", curpos, nowTs, curPaktPos, entry);
    ...
    *pActualPos     = curpos;
    ...
    TOC_PRINT_DBG("-seek::curpos=%d,nowTs=%lld,paktPos=%d", curpos, nowTs, mSeekPaktPos);
    return OK;
}
