...
private:
	...
	bool checkHandlePartialFrame( sp<ABuffer> &srcBuffer, sp<ABuffer> &codecBuffer,bool isCsd,bool isEos,
								uint32_t *flags,MediaBuffer * mBuffer);
    bool mSupportsPartialFrames;
    void handleError(int32_t err, bool isACodecErr = true);    // for ACodec error notify
#endif
