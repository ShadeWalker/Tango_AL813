...
//add by HQ_zhouguo at 20150903 start
static const char* keySetFmRadioWiredheadset = "SetFmRadioWiredheadset"; //modify FmRadio for wiredheadset 
static String8 keyFmRadioWiredheadset = String8(keySetFmRadioWiredheadset); //modify FmRadio for wiredheadset
//add by HQ_zhouguo at 20150903 end
#endif
...
status_t AudioSystem::setParameters(audio_io_handle_t ioHandle, const String8& keyValuePairs) {
	...
	//start modify FmRadio for wiredheadset 
	else if (param.getInt(keyFmRadioWiredheadset, value) == NO_ERROR){ 
		const sp<IAudioPolicyService>& aps = AudioSystem::get_audio_policy_service(); 
		if(aps != 0) 
		{ 
			ALOGD("ddd setParameters(): keyFmRadioWiredheadset=%d", value); 
			aps->SetPolicyManagerParameters (POLICY_SET_FM_RADIO_WIREDHEADSET,value,0,0); 
		} 
	}//end modify FmRadio for wiredheadset 
