...
public class SubscriptionController extends ISub.Stub {
    ...
    public boolean setPlmnSpn(int slotId, boolean showPlmn, String plmn, boolean showSpn,
	    ...
	    //modify by zhoouguanghui
/*	    if(plmn != null){
		logd("MingYue plmn = " + plmn);
		showSpn = false;
	    }*/
            ...
            if (showPlmn) {
                carrierText = plmn;
                //HQ_wuruijun add for HQ01463468 start
                if (SystemProperties.get("ro.hq.spec.spn.show").equals("1")) {
                    TelephonyManager tm = (TelephonyManager) mContext.getSystemService(Context.TELEPHONY_SERVICE);
                    String operatorNumeric = tm.getSimOperator();
                    if (operatorNumeric.equals("65507")) {
                        carrierText = "Cell C";
                    }
                }
                //HQ_wuruijun add end
                if (showSpn) {
                    ...
                    carrierText = new StringBuilder().append(carrierText).append("|")
                            .append(spn).toString();
                }
            } else if (showSpn) {
                carrierText = spn;
    ...
    public int setDisplayNumber(String number, int subId, boolean writeToSim) {
	    //add by wanghui for anquanhongxian
        ...
        ContentValues value = new ContentValues(1);
        value.put(SubscriptionManager.NUMBER, number);
		//add by wanghui for an quan hongxian 
