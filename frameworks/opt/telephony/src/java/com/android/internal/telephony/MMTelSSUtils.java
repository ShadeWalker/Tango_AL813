...
public class MMTelSSUtils {
    ...
    public static String getXcapRootUri(int phoneId) {
        ...
        if (isOp01IccCard(phoneId)) {
            ...
            simSrv.setOperator(simSrv.OPERATOR_OP03);
        } else if (isOp05IccCard(phoneId)) {
            simSrv.setOperator(simSrv.OPERATOR_OP05);
    ...
    public static boolean isGsmUtSupport(int phoneId) {
        ...
        if (SystemProperties.get("ro.mtk_ims_support").equals("1") &&
            ...
            if ((isOp01IccCard(phoneId)
                || isOp03IccCard(phoneId)
                || isOp05IccCard(phoneId)
                || isOp15IccCard(phoneId))
                && isUsimCard(phoneId)) {
                return true;
            }
        }
     ...
     */
    public static boolean isEnableXcapHttpResponse409(int phoneId) {
        if (isOp05IccCard(phoneId)) {
