...
import android.provider.ChildMode;//add by lihaizhou for forbid Sending MSG Whild ChildMode is on 
...
public abstract class SMSDispatcher extends Handler {
    ...
    private static class SettingsObserver extends ContentObserver {
     ...
     //add by lihaizhou for ProhibitCall in ChildMode by begin at 2015-08-21
  ...
  //add by lihaizhou for ProhibitSendMsg in ChildMode by end at 2015-08-21  
        ...
        if (mContext.checkCallingOrSelfPermission(SEND_RESPOND_VIA_MESSAGE_PERMISSION)
            ...
            if (rule == PREMIUM_RULE_USE_SIM || rule == PREMIUM_RULE_USE_BOTH) {
                ...
                if (simCountryIso == null || simCountryIso.length() != 2) {
                    ...
                    // MTK-START
                    simCountryIso = mTelephonyManager.getNetworkCountryIsoForSubscription(getSubId());
                    // MTK-END
                }
            ...
            if (rule == PREMIUM_RULE_USE_NETWORK || rule == PREMIUM_RULE_USE_BOTH) {
                // MTK-START
                String networkCountryIso = mTelephonyManager.getNetworkCountryIsoForSubscription(getSubId());
                // MTK-END
