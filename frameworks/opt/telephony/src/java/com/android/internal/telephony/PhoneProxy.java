...
public class PhoneProxy extends Handler implements Phone {
    ...
    public PhoneProxy(PhoneBase phone) {
        ...
        if (0 == HwSystemManager.mPermissionEnabled) {
            mPhoneSubInfoProxy = new PhoneSubInfoProxy(phone.getPhoneSubInfo());
                ...
                mPhoneSubInfoProxy = HwTelephonyFactory.getHwSubInfoProxy(
                    phone.getContext(), phone.getPhoneSubInfo());
        }
        /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
    ...
    public void setDataEnabled(boolean enable) {
        /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
        //[HSM]
        /*HQ_xionghaifeng 20150811 remove for data select adapt systemUI*/
		//if (!HwSystemManager.allowOp(getContext(), HwSystemManager.PERMISSION_MOBILEDATE, mActivePhone.getDataEnabled())) 
		//{
		//	return;
		//}
		/* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
