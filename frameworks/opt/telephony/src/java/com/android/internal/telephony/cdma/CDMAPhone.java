...
public class CDMAPhone extends PhoneBase {
    ...
    public String getVoiceMailNumber() {
        ...
        Rlog.d(LOG_TAG, "[CDMAPhone] getVoiceMailNumber, from SP " + number);
        ...
        Rlog.d(LOG_TAG, "[CDMAPhone] getVoiceMailNumber, final " + number);
        return number;
    }
    ...
    public void handleMessage(Message msg) {
        ...
        switch(msg.what) {
            ...
            case EVENT_GET_DEVICE_IDENTITY_DONE:{
				...
				SystemProperties.set("cdma.meid", mMeid);
