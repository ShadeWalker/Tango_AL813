...
public class GsmConnection extends Connection {
    ...
    static final int PAUSE_DELAY_FIRST_MILLIS_LONG = 1000;
    /// @}
    ...
    int disconnectCauseFromCode(int causeCode) {
        ...
        switch (causeCode) {
			...
			// / Modified by guofeiyao 2015/12/12
			// For 813 Telcel clear code
            case CallFailCause.CALL_REJECTED: //21
    ...
    public String toString() {
        ...
        str.append("*  -> id: " + (mIndex + 1))
                .append(", num: " + (Build.TYPE.equals("eng") ? getAddress() : ""))/* HQ_guomiao 2015-10-27 modified for HQ01444267 */
