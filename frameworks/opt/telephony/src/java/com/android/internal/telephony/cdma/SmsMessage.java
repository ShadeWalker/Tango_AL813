...
public class SmsMessage extends SmsMessageBase {
    ...
    */
    ...
    protected void parseSms() {
		...
		//modified by maolikui at 2015-09-29 start 
                if (destinationAddress .ton == CdmaSmsAddress.TON_INTERNATIONAL_OR_IP) { 
                      if (destinationAddress .address.charAt(0) != '+') { 
                            destinationAddress .address = "+" + destinationAddress .address; 
                        } 
                } 
                Rlog.v(LOG_TAG, "mtk add SMS originating address: " + destinationAddress.address); 
                //modified by maolikui at 2015-09-29 end
        }
