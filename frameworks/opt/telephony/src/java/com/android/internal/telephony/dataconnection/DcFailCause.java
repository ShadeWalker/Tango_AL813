...
public enum DcFailCause {
    ...
    BCM_VIOLATION(0x30),
    LAST_PDN_DISC_NOT_ALLOWED (0x31),
    ONLY_IPV4_ALLOWED(0x32),                /* no retry */
    ONLY_IPV6_ALLOWED(0x33),                /* no retry */
    ONLY_SINGLE_BEARER_ALLOWED(0x34),
    INFORMATION_NOT_RECEIVED (0x35),
    PDN_CONNECTION_NOT_EXIST(0x36),
    MULTIPLE_PDN_APN_NOT_ALLOWED(0x037),           /*no retry*/
    ...
    DUE_TO_REACH_RETRY_COUNTER(0x0E0F);             /*no retry*/
