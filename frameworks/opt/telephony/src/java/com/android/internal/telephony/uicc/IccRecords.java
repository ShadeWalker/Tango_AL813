...
public abstract class IccRecords extends Handler implements IccConstants {
    ...
    public String toString() {
        return "mDestroyed=" + mDestroyed
                ...
                + (Build.TYPE.equals("eng") ? " mImsi=" + mImsi : " mImsi= null")/* HQ_guomiao 2015-10-10 modified for HQ01419154,HQ01419645*/
    ...
    public String getServiceProviderName() {
        ...
        //add by yanqing for HQ01363571 start
        //make sure that when insert CMCC card, phone show operator name: 
        //in engilsh: China Mobile
        //in symple and troditional chinese: zhong guo yi dong
        String newSpn = null;
        if(mSpn!= null && mSpn.equals("CMCC"))
        {
            newSpn = Resources.getSystem().getText(com.hq.resource.internal.R.string.hq_cmcc_display_name).toString();
            log("getServiceProviderName: mSpn=" + mSpn + " change to newSpn=" + newSpn);  
            if(newSpn != null)
            {
                return newSpn;
            }          
        }
        //add by yanqing for HQ01363571 end
