 ...
 * communicates with the actual implementation of the video call provider in the Gsm service; it is
 * in essence, a wrapper around the Gsm's video call provider implementation.
 *
 * This class maintains a binder by which the GsmVideoCallProvider's implementation can communicate
...
public class GsmVideoCallProviderWrapper extends Connection.VideoProvider {
    ...
    /**
     * IGsmVideoCallCallback stub implementation.
     */
    ...
    /**
     * Instantiates an instance of the GsmVideoCallProvider, taking in the binder for Gsm's video
     * call provider implementation.
     *
     * @param VideoProvider
     */
    public GsmVideoCallProviderWrapper(IGsmVideoCallProvider VideoProvider)
            throws RemoteException {
        Log.d(TAG, "New GsmVideoCallProviderWrapper");
        mVideoCallProvider = VideoProvider;
        mVideoCallProvider.asBinder().linkToDeath(mDeathRecipient, 0);

        mBinder = new GsmVideoCallCallback();
    ...
    public void onSetVTConnected() {
        try {
            mVideoCallProvider.setVTConnected();
        } catch (RemoteException e) {
        }
    }
    ...
    public void onOnDisconnected() {
        try {
            mVideoCallProvider.onDisconnected();
        } catch (RemoteException e) {
        }
    }
    ...
    public void onSetDisplay(Surface local, Surface peer) {
        try {
            mVideoCallProvider.setDisplay(local, peer);
        } catch (RemoteException e) {
        }
    }
    ...
    public void onSwitchDisplaySurface() {
        try {
            mVideoCallProvider.switchDisplaySurface();
        } catch (RemoteException e) {
        }
    }
    ...
    public void onSetLocalView(int videoType, String path) {
        try {
            mVideoCallProvider.setLocalView(videoType, path);
        } catch (RemoteException e) {
        }
    }
    ...
    public void onSetPeerView(int bEnableReplacePeerVideo, String sReplacePeerVideoPicturePath) {
        try {
            mVideoCallProvider.setPeerView(bEnableReplacePeerVideo, sReplacePeerVideoPicturePath);
        } catch (RemoteException e) {
        }
    }
    ...
    public void onSwitchCamera() {
        try {
            mVideoCallProvider.switchCamera();
        } catch (RemoteException e) {
        }
    }
    ...
    public void onSetVTVisible(boolean isVisible) {
        try {
            mVideoCallProvider.setVTVisible(isVisible);
        } catch (RemoteException e) {
        }
    }
    ...
    public void onOnUserInput(String input) {
        try {
            mVideoCallProvider.onUserInput(input);
        } catch (RemoteException e) {
        }
    }
    /// @}
