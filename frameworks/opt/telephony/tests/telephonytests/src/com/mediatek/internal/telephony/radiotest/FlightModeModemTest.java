...
public class FlightModeModemTest extends RadioTest {
    ...
    protected void setUp() throws Exception {
        ...
        SystemProperties.set("radio.test.poweroffmd", "1");
    }
    
    @SmallTest
    public void testFlightModeSwitch() {
        log("TEST FLIGHT MODE MODEM: flight mode on");
        ...
        log("TEST FLIGHT MODE MODEM: flight mode off");
