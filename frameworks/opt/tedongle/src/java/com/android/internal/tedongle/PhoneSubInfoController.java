...
import com.android.internal.tedongle.PhoneSubInfoProxy;

public class PhoneSubInfoController extends IPhoneSubInfo.Stub {
    private static final String TAG = "3GD-PhoneSubInfoController";
    private Phone[] mPhone;

    public PhoneSubInfoController(Phone[] phone) {
        mPhone = phone;
        if (ServiceManager.getService("iphonesubinfotedongle") == null) {
            ServiceManager.addService("iphonesubinfotedongle", this);
        }
    }
