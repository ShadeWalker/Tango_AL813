...
public class TelephonyIntents {
    ...
    public static final String ACTION_DATA_CONNECTION_CONNECTED_TO_PROVISIONING_APN
            = "tedongle.intent.action.DATA_CONNECTION_CONNECTED_TO_PROVISIONING_APN";
     ...
     * permission.</p>
     */
    public static final String ACTION_CARRIER_SETUP = "tedongle.intent.action.ACTION_CARRIER_SETUP";
     ...
     */
    public static final String SECRET_CODE_ACTION = "tedongle.provider.Telephony.SECRET_CODE";
    ...
    public static final String ACTION_SIMINFO_CONTENT_CHANGE
            = "tedongle.intent.action.ACTION_SIMINFO_CONTENT_CHANGE";
    ...
    public static final String ACTION_SUBINFO_CONTENT_CHANGE
            = "tedongle.intent.action.ACTION_SUBINFO_CONTENT_CHANGE";
    ...
    public static final String ACTION_SIMINFO_UPDATED
            = "tedongle.intent.action.ACTION_SIMINFO_UPDATED";
    ...
    public static final String ACTION_SUBINFO_RECORD_UPDATED
            = "tedongle.intent.action.ACTION_SUBINFO_RECORD_UPDATED";
    ...
    public static final String ACTION_DEFAULT_SUBSCRIPTION_CHANGED
            = "tedongle.intent.action.ACTION_DEFAULT_SUBSCRIPTION_CHANGED";
    ...
    public static final String ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGED
            = "tedongle.intent.action.ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGED";
    ...
    public static final String ACTION_DEFAULT_VOICE_SUBSCRIPTION_CHANGED
            = "tedongle.intent.action.ACTION_DEFAULT_VOICE_SUBSCRIPTION_CHANGED";
    ...
    public static final String ACTION_DEFAULT_SMS_SUBSCRIPTION_CHANGED
            = "tedongle.intent.action.ACTION_DEFAULT_SMS_SUBSCRIPTION_CHANGED";
}
