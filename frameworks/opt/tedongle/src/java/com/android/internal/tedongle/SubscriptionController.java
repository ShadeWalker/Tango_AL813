...
import com.android.internal.tedongle.ISub;
...
public class SubscriptionController extends ISub.Stub {
    static final String LOG_TAG = "3GD-SUB";
    ...
    private SubscriptionController(Context c) {
        ...
        if(ServiceManager.getService("isubtedongle") == null) {
                ServiceManager.addService("isubtedongle", this);
        }
