...
interface IMms {
     ...
     *  sending the message. See {@link android.tedongle.MessagingConfigurationManager} for the
     ...
     * @param configOverrides the carrier-specific messaging configuration values to override for
     *  downloading the message. See {@link android.tedongle.MessagingConfigurationManager} for the
     *  value names and types.
