...
public class DctController extends Handler {
    private static final String LOG_TAG = "3GD-DctController";
    ...
    private TedonglePhoneNotifier.IDataStateChangedCallback mDataStateChangedCallback =
            new TedonglePhoneNotifier.IDataStateChangedCallback() {
    ...
    public TedonglePhoneNotifier.IDataStateChangedCallback getDataStateChangedCallback() {
