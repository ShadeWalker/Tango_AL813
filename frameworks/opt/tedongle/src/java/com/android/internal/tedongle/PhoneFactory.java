...
import static com.android.internal.tedongle.TelephonyProperties.PROPERTY_DEFAULT_SUBSCRIPTION;
...
import com.android.internal.tedongle.imsphone.ImsPhoneFactory;
...
public class PhoneFactory {
    static final String LOG_TAG = "3GD-PhoneFactory";
    ...
    public static void makeDefaultPhone(Context context) {
        synchronized (sLockProxyPhones) {
            if (!sMadeDefaults) {
                ...
                sPhoneNotifier = new TedonglePhoneNotifier(sContext);
                ...
                ///M modify by mtk94127,for 3Gdongle
                int numPhones = 1;
