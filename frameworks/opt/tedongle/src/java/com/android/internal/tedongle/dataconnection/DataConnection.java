...
public final class DataConnection extends StateMachine {
    ...
    private DataConnection(PhoneBase phone, String name, int id,
        ...
        mNetworkInfo = new NetworkInfo(ConnectivityManager.TYPE_TEDONGLE,
                networkType, "tedongle", TelephonyManager.getNetworkTypeName(networkType));
    ...
    private NetworkCapabilities makeNetworkCapabilities() {
        ...
        result.addTransportType(NetworkCapabilities.TRANSPORT_TEDONGLE);
    ...
    private class DcActiveState extends State {
        @Override public void enter() {
            ...
            mNetworkAgent = new DcNetworkAgent(getHandler().getLooper(), mPhone.getContext(),
                    "tedongleDcNetworkAgent", mNetworkInfo, makeNetworkCapabilities(), mLinkProperties,
                    55);
        }
