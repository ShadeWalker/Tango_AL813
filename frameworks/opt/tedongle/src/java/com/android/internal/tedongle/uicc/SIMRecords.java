...
public class SIMRecords extends IccRecords {
    protected static final String LOG_TAG = "3GD-SIMRecords";
    ...
    private static final int EVENT_RADIO_STATE_CHANGED = 200;
    ...
    protected void resetRecords() {
        ...
        log("SIMRecords: onRadioOffOrNotAvailable set PROPERTY_ICC_OPERATOR_NUMERIC to operator=null");
        ...
        try { switch (msg.what) {
            ...
            case EVENT_GET_GID1_DONE:
             ...
             case EVENT_RADIO_STATE_CHANGED:
                 ...
                 log("Reciver EVENT_RADIO_STATE_CHANGED");
