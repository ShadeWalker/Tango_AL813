...
import com.android.internal.tedongle.uicc.IccCardProxy;
...
public class PhoneProxy extends Handler implements Phone {
    ...
    private static final String LOG_TAG = "3GD-PhoneProxy";
    ...
    ///M:add by mtk94127, for 3Gdongle @{
    public void registerForRadioStateChanged(Handler h, int what, Object obj) {
        
        mCommandsInterface.registerForRadioStateChanged(h, what, obj);
    }

    public void unregisterForRadioStateChanged(Handler h) {
        
        mCommandsInterface.unregisterForRadioStateChanged(h);
    }
    ///M:@}
