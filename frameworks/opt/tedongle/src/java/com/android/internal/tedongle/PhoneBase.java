...
import android.tedongle.CellIdentityCdma;
import android.tedongle.CellInfo;
import android.tedongle.CellInfoCdma;
...
import com.android.internal.tedongle.dataconnection.DcTrackerBase;
import com.android.internal.tedongle.imsphone.ImsPhone;
import com.android.internal.tedongle.test.SimulatedRadioControl;
import com.android.internal.tedongle.uicc.IccCardApplicationStatus.AppType;
import com.android.internal.tedongle.uicc.IccFileHandler;
 ...
 * A base implementation for the com.android.internal.tedongle.Phone interface.
 *
...
public abstract class PhoneBase extends Handler implements Phone {
    private static final String LOG_TAG = "3GD-PhoneBase";
     ...
     *
     * @return com.android.internal.tedongle.{mName}.action_detached
     *          {mName} is GSM, CDMA ...
     */
    ...
    private void checkCorrectThread(Handler h) {
        if (h.getLooper() != mLooper) {
            throw new RuntimeException(
                    "com.android.internal.tedongle.Phone must be used from within one thread");
        }
    }
