...
public class SipPhone extends SipPhoneBase {
    private static final String LOG_TAG = "3GD-SipPhone";
    ...
    private class SipCall extends SipCallBase {
        private static final String SC_TAG = "3GD-SipCall";
    ...
    private class SipConnection extends SipConnectionBase {
        private static final String SCN_TAG = "3GD-SipConnection";
    ...
    private abstract class SipAudioCallAdapter extends SipAudioCall.Listener {
        private static final String SACA_TAG = "3GD-SipAudioCallAdapter";
