...
package com.android.internal.tedongle.dataconnection;
...
public final class DcTracker extends DcTrackerBase {
    protected final String LOG_TAG = "3GD-DCT";
    ...
    public DcTracker(PhoneBase p) {
        ...
        mNetworkFilter.addTransportType(NetworkCapabilities.TRANSPORT_TEDONGLE);
        ...
        */
        ...
        mNetworkFactory = new TelephonyNetworkFactory(this.getLooper(), p.getContext(),
                "TedongleNetworkFactory", mNetworkFilter);
        mNetworkFactory.setScoreFilter(55);
        mNetworkFactoryMessenger = new Messenger(mNetworkFactory);
        cm.registerNetworkFactory(mNetworkFactoryMessenger, "Tedongle");
    ...
    private ApnContext apnContextForNetworkRequest(NetworkRequest nr) {
        ...
        if (nc.getTransportTypes().length > 0 &&
                nc.hasTransport(NetworkCapabilities.TRANSPORT_TEDONGLE) == false) {
            return null;
        }
        ...
        if (nc.hasCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET)) {
            ...
            type = ConnectivityManager.TYPE_TEDONGLE;
        }
    ...
    protected void supplyMessenger() {
       ...
       if (!isActiveDataSubscription()) {
        ...
        ConnectivityManager cm = (ConnectivityManager)mPhone.getContext().getSystemService(
                Context.CONNECTIVITY_SERVICE);
        cm.supplyMessenger(ConnectivityManager.TYPE_TEDONGLE, new Messenger(this));
   ...
   private boolean imsiMatches(String imsiDB, String imsiSIM) {
    ...
    protected void onUpdateIcc() {
        ...
        }else if((mPhone instanceof CDMAPhone) || (mPhone instanceof CDMALTEPhone)) {
    ...
    public void update() {
        ...
        if (isActiveDataSubscription()) {
            ...
            mUserDataEnabled = true;/*Settings.Global.getInt(mPhone.getContext().getContentResolver(),
