...
import com.android.internal.tedongle.cdma.CdmaSMSDispatcher;
import com.android.internal.tedongle.gsm.GsmSMSDispatcher;
import com.android.internal.tedongle.gsm.GsmInboundSmsHandler;
import com.android.internal.tedongle.cdma.CdmaInboundSmsHandler;
...
public final class ImsSMSDispatcher extends SMSDispatcher {
    ...
    protected void injectSmsPdu(byte[] pdu, String format, PendingIntent receivedIntent) {
        ...
        try {
            ...
            android.tedongle.SmsMessage msg =
                    android.tedongle.SmsMessage.createFromPdu(pdu, format);

            // Only class 1 SMS are allowed to be injected.
            if (msg.getMessageClass() != android.tedongle.SmsMessage.MessageClass.CLASS_1) {
    ...
    public void sendRetrySms(SmsTracker tracker) {
        ...
        if (map.containsKey("text")) {
            ...
            if (isCdmaFormat(newFormat)) {
                ...
                pdu = com.android.internal.tedongle.cdma.SmsMessage.getSubmitPdu(
                        scAddr, destAddr, text, (tracker.mDeliveryIntent != null), null);
            } else {
                Rlog.d(TAG, "old format (cdma) ==> new format (gsm)");
                pdu = com.android.internal.tedongle.gsm.SmsMessage.getSubmitPdu(
                        scAddr, destAddr, text, (tracker.mDeliveryIntent != null), null);
            }
