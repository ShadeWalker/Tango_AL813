...
import static com.android.internal.tedongle.RILConstants.*;
import static android.tedongle.TelephonyManager.NETWORK_TYPE_UNKNOWN;
import static android.tedongle.TelephonyManager.NETWORK_TYPE_EDGE;
import static android.tedongle.TelephonyManager.NETWORK_TYPE_GPRS;
import static android.tedongle.TelephonyManager.NETWORK_TYPE_UMTS;
import static android.tedongle.TelephonyManager.NETWORK_TYPE_HSDPA;
import static android.tedongle.TelephonyManager.NETWORK_TYPE_HSUPA;
import static android.tedongle.TelephonyManager.NETWORK_TYPE_HSPA;
...
import android.tedongle.NeighboringCellInfo;
...
import com.android.internal.tedongle.gsm.SmsBroadcastConfigInfo;
import com.android.internal.tedongle.gsm.SuppServiceNotification;
import com.android.internal.tedongle.uicc.IccCardApplicationStatus;
import com.android.internal.tedongle.uicc.IccCardStatus;
import com.android.internal.tedongle.uicc.IccIoResult;
import com.android.internal.tedongle.uicc.IccRefreshResponse;
import com.android.internal.tedongle.uicc.IccUtils;
import com.android.internal.tedongle.cdma.CdmaCallWaitingNotification;
import com.android.internal.tedongle.cdma.CdmaInformationRecords;
import com.android.internal.tedongle.cdma.CdmaSmsBroadcastConfigInfo;
import com.android.internal.tedongle.dataconnection.DcFailCause;
import com.android.internal.tedongle.dataconnection.DataCallResponse;
import com.android.internal.tedongle.dataconnection.DataProfile;
import com.android.internal.tedongle.TelephonyDevController;
import com.android.internal.tedongle.HardwareConfig;
 ...
 */
class RILRequest {
    static final String LOG_TAG = "3GD-RilRequest";
...
public final class RIL extends BaseCommands implements CommandsInterface {
    static final String RILJ_LOG_TAG = "3GD-RILJ";
    ...
    static final String[] SOCKET_NAME_RIL = {"rild-dongle", "rild2", "rild3"};
    ...
    public RIL(Context context, int preferredNetworkType,
       ...
       /* if (cm.isNetworkSupported(ConnectivityManager.TYPE_TEDONGLE) == false) {
...
*/
    ...
    /* (non-Javadoc)
     * @see com.android.internal.tedongle.BaseCommands#testingEmergencyCall()
     */
    @Override
