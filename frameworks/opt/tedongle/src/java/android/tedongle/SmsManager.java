...
import com.android.internal.tedongle.IMms;
import com.android.internal.tedongle.uicc.IccConstants;
...
public final class SmsManager {
     ...
     * @see android.tedongle.TelephonyManager.hasCarrierPrivileges
     *
    ...
    public void injectSmsPdu(byte[] pdu, String format, PendingIntent receivedIntent) {
        ...
        try {
            ISms iccISms = ISms.Stub.asInterface(ServiceManager.getService("ismstedongle"));
            if (iccISms != null) {
    ...
    */
    ...
    private static ISms getISmsService() {
        return ISms.Stub.asInterface(ServiceManager.getService("ismstedongle"));
    }
    ...
    String getImsSmsFormat() {
        String format = com.android.internal.tedongle.SmsConstants.FORMAT_UNKNOWN;
        try {
            ISms iccISms = getISmsService();
            if (iccISms != null) {
    ...
    public static long getDefaultSmsSubId() {
        ISms iccISms = null;
        try {
            iccISms = ISms.Stub.asInterface(ServiceManager.getService("ismstedongle"));
    ...
    public void sendMultimediaMessage(Context context, Uri contentUri, String locationUrl,
        ...
        try {
            final IMms iMms = IMms.Stub.asInterface(ServiceManager.getService("immstedongle"));
            if (iMms == null) {
                return;
            }
    ...
    public static final String EXTRA_MMS_DATA = "android.tedongle.extra.MMS_DATA";
    ...
    public void updateMmsSendStatus(Context context, int messageRef, byte[] pdu, int status,
            Uri contentUri) {
        try {
            IMms iMms = IMms.Stub.asInterface(ServiceManager.getService("immstedongle"));
            if (iMms == null) {
                return;
            }
