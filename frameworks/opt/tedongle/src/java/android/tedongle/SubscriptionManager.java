...
public class SubscriptionManager implements BaseColumns {
    ...
    /** @hide */
    public static final Uri CONTENT_URI = Uri.parse("content://com.mediatek.dongle/siminfo");
    ...
    public static SubInfoRecord getSubInfoForSubscriber(long subId) {
        ...
        try {
            ISub iSub = ISub.Stub.asInterface(ServiceManager.getService("isubtedongle"));
            if (iSub != null) {
