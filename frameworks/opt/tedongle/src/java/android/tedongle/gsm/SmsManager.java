 ...
 * @deprecated Replaced by android.tedongle.SmsManager that supports both GSM and CDMA.
 */
@Deprecated public final class SmsManager {
    private static SmsManager sInstance;
    private android.tedongle.SmsManager mSmsMgrProxy;

    /** Get the default instance of the SmsManager
     *
     * @return the default instance of the SmsManager
     * @deprecated Use android.tedongle.SmsManager.
     */
    @Deprecated
    ...
    @Deprecated
    private SmsManager() {
        mSmsMgrProxy = android.tedongle.SmsManager.getDefault();
    }
     ...
     */
    @Deprecated
    public final ArrayList<android.tedongle.SmsMessage> getAllMessagesFromSim() {
        return android.tedongle.SmsManager.getAllMessagesFromIcc();
    }
