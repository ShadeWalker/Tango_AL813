...
LOCAL_SRC_FILES := \
    ...
    src/java/android/tedongle/ims/internal/IImsConfig.aidl \
    src/java/android/tedongle/ims/internal/IImsCallSessionListener.aidl \
    src/java/android/tedongle/ims/internal/IImsEcbmListener.aidl \
    src/java/android/tedongle/ims/internal/IImsUtListener.aidl \
    src/java/android/tedongle/ims/internal/IImsVideoCallCallback.aidl \
    src/java/android/tedongle/ims/internal/IImsService.aidl \
	src/java/android/tedongle/ims/internal/IImsRegistrationListener.aidl \
	src/java/android/tedongle/ims/internal/IImsUt.aidl \
	src/java/android/tedongle/ims/internal/IImsCallSession.aidl \
	src/java/android/tedongle/ims/internal/IImsStreamMediaSession.aidl \
	src/java/android/tedongle/ims/internal/IImsEcbm.aidl \
	src/java/android/tedongle/ims/internal/IImsVideoCallProvider.aidl \
	src/java/android/tedongle/ims/ImsConfigListener.aidl \
...
LOCAL_SRC_FILES += $(call all-java-files-under, src/java) \
                   ...
                   $(call all-java-files-under, ../net/ims/src/java) \
