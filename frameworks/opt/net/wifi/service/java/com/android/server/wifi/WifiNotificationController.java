...
//        if (!mNotificationEnabled) return;
    ...
    private void setNotificationVisible(boolean visible, int numNetworks, boolean force,
		...
		Bitmap mBitmap = BitmapFactory.decodeResource(mContext.getResources(), com.hq.resource.internal.R.drawable.stat_notify_wifi_in_range_large);
		if(mBitmap != null){
                   mNotification.largeIcon = mBitmap;
                }
		//add by HQ_caoxuhao at 20160519 HQ01927909 end
            ...
            ///M:@{add by wanghui for al812 not need notification sound
            ...
            SXlog.d(TAG, "cancel notification");
    ...
    private boolean isDataAvailable() {
        try {
            ...
            if (phone == null || !phone.isRadioOn() || tm == null) {
                return false;
            }
