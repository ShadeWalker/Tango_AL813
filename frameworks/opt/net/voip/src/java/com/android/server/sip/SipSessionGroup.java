...
class SipSessionGroup implements SipListener {
    ...
    synchronized void reset() throws SipException {
        ...
        String local = null;
        try {
            ///M: Fix ANR issue due to DNS lookup time. Use public IP address to avoid DNS query.
            for (InetAddress remote : InetAddress.getAllByName("8.8.8.8")) {
        ...
        ///M: Configure DNS querty with timeout.
