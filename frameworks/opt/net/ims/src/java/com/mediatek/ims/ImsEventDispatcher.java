...
import com.mediatek.ims.internal.SimDispatcher;
...
public class ImsEventDispatcher extends Handler {
    ...
    /* Event Dispatcher */
    private SimDispatcher mSimDispatcher;
    ...
    private void createDispatcher() {
        ...
        mSimDispatcher = new SimDispatcher(mContext, mSocket);
        mVaEventDispatcher.add(mSimDispatcher);
    ...
    void dispatchCallback(VaEvent event) {
        ...
        switch (event.getRequestID()) {
            case MSG_ID_REQUEST_DO_AKA_AUTHENTICATION:
            case MSG_ID_REQUEST_READ_USIM_FILE:
            case MSG_ID_REQUEST_READ_ISIM_FILE:
            case MSG_ID_REQUEST_QUERY_SIM_STATUS:
                mSimDispatcher.vaEventCallback(event);
                break;
            case MSG_ID_IMSA_IMCB_XUI_IND:
            ...
            case MSG_ID_REQUEST_DEDICATE_BEARER_ACTIVATATION:
            case MSG_ID_REQUEST_BEARER_DEACTIVATION:
            case MSG_ID_REQUEST_BEARER_MODIFICATION:
            case MSG_ID_REQUEST_PCSCF_DISCOVERY:
            case MSG_ID_REQUEST_BEARER_ACTIVATION:
            ...
            case MSG_ID_REQUEST_TIMER_CANCEL:
                ...
                break;
            case MSG_ID_NOTIFY_IMS_SERVICE_UP:
                ImsAdapter.getInstance().ImsServiceUp();
                break;
        }
    }
}
