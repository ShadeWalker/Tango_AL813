...
public:
    ...
    // fix google ID
    status_t addAndroid(const SourcePos& pos,
                       const String16& package,
                       const String16& type,
                       const String16& name,
                       const uint32_t ident);
    ...
    class Android {
    public:
        Android() : sourcePos(), ident(0) { }
        Android(const SourcePos& pos,
               const String16& _comment,
               uint32_t _ident)
            : sourcePos(pos),
            comment(_comment), ident(_ident) { }
        Android(const Android& o) : sourcePos(o.sourcePos),
            comment(o.comment), ident(o.ident) { }
        ~Android() { }

        Android& operator=(const Android& o) {
            sourcePos = o.sourcePos;
            comment = o.comment;
            ident = o.ident;
            return *this;
    ...
    private:
        ...
        /* < DTS2014102105499 yinwenshuai/00211458 20141105 begin */
        // fix google ID
        DefaultKeyedVector<String16, Android> mAndroid;
        /* DTS2014102105499 yinwenshuai/00211458 20141105 end > */
