    ...
    final class SensorEventListenerImpl implements SensorEventListener {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            synchronized (mLock) {
                ...
                if (!skipSample) {
                    ...
                    if (magnitude < NEAR_ZERO_MAGNITUDE) {
                        ...
                        if (mOverhead) {
                            ...
                            //wangmeihua modify for HQ01176453 start
                            int nearestRotation = -1;
                             switch (mCurrentRotation)
                {
                 // if it is port,then we rotate it for 60 degree
                 case 0: 
                 case 2:
                 {
                 ...
                 // if it is land,then we rotate it for 45 degree
                 case 1: 
                 case 3:
                 {
             ...
             //wangmeihua modify for HQ01176453 end
                            ...
                            //HQ_liugang delete it for eservice FAQ03882 
