...
/*<DTS2014102003380 by shenjinhua 20141110 begin */
import android.view.AbsLayoutParams;
/* DTS2014102003380 by shenjinhua 20141110 end> */
...
import com.android.internal.policy.impl.HwPolicyFactory;//gepengfei add
import android.app.KeyguardManager;
import android.os.SystemProperties;
/**
 ...
 */
/*< DTS2014102003633  taolan/00264981 20141106 begin*/
public class PhoneWindowManager extends AbsPhoneWindowManager implements WindowManagerPolicy {
/* DTS2014102003633 taolan/00264981 20141106 end> */
    ...
    //wuhuihui add for key lock gesture enable start
    public static final String ACTION_GESTURE_ENABLE = "android.intent.action.GESTURE_ENABLE";
    ...
    /*< DTS2014120603171 zhudengkui / 00180854 20141208 begin */
    WindowState mKeyguard = null;
    /* DTS2014120603171 zhudengkui / 00180854 20141208 end>*/
	...
	/*< DTS2014110604349 zhaifeng/00107904 20141106 begin */
	public boolean mLastFocusNeedsMenu = false;
	/* DTS2014110604349 zhaifeng/00107904 20141106 end >*/
	//end
	...
	//add by wangjing3 for *** begin  2015-07-28
    ...
    private  final int  REPAI_CAPTURE_KEY_VALUME_TIME = 400;
	
	//add by wangjing3 for *** end    2015-07-28
    ...
    private static final int MSG_POWER_LONG_PRESS = 14;
     /*< DTS2014102003633  taolan/00264981 20141106 begin*/
    private static boolean mUsingHwNavibar = SystemProperties.getBoolean("ro.config.hw_navigationbar",  true);
    /*< DTS2014102003633  taolan/00264981 20141106 end*/
    ...
    void showGlobalActionsInternal() {
        ...
        /* < DTS2014112700432 xuxuefei/00258670 20141127 begin */
        // showHwGlobalActionsFragment();
        /* <DTS2015032805876 liutie/00176215 20150401 begin */
        if (HwPolicyFactory.ifUseHwGlobalActions()){
            HwPolicyFactory.showHwGlobalActionsFragment(mContext, mWindowManagerFuncs,
                    mPowerManager, keyguardIsShowingTq(), isKeyguardSecure(),isDeviceProvisioned());
            return;
        }
        /* DTS2015032805876 liutie/00176215 20150401 end > */
        /* DTS2014112700432 xuxuefei/00258670 20141127 end > */
    ...
    public void init(Context context, IWindowManager windowManager,
		...
		//wuhuihui add for key gesture enable start
        Log.v(TAG, "register gesture receiver");
        IntentFilter gestureEnableFilter= new IntentFilter();
        gestureEnableFilter.addAction(ACTION_GESTURE_ENABLE);
        context.registerReceiver(mgestureEnableReceiver, gestureEnableFilter);
        //wuhuihui add for key gesture enable end
        ...
        mSystemGestures = new SystemGesturesPointerEventListener(context,
                new SystemGesturesPointerEventListener.Callbacks() {
                    ...
                    public void onSwipeFromTop() {
                        /*< DTS2014102003589 zhaifeng/00107904 20141105 begin */
                        // 0 means startup guide mode
                        if (Settings.Secure.getInt(mContext.getContentResolver(), Settings.Global.DEVICE_PROVISIONED, 1) == 0) {
                            return;
                        }
                        /* DTS2014102003589 zhaifeng/00107904 20141105 end>*/
					
                        if (isGestureIsolated())
                            return;
                        if ((mStatusBar != null)&&(1 != getFactoryKitMode())) {
    ...
    public boolean checkShowToOwnerOnly(WindowManager.LayoutParams attrs) {
        ...
        switch (attrs.type) {
            ...
            /* < DTS2014112802441 shenjinhua/00171968 20141204 begin */
            case TYPE_KEYGUARD:
            /* DTS2014112802441 shenjinhua/00171968 20141204 end > */
    ...
    public void adjustWindowParamsLw(WindowManager.LayoutParams attrs) {
        ...
        /* < DTS2014112802441 shenjinhua/00171968 20141204 begin */
        if ((attrs.type != TYPE_STATUS_BAR) && (attrs.type != TYPE_KEYGUARD)){
        /* DTS2014112802441 shenjinhua/00171968 20141204 end > */
    ...
    /* < DTS2014121202430 fengwei/00209624 20141212 begin */
        if (attrs.type == TYPE_KEYGUARD) {
            return ((attrs.flags & FLAG_SHOW_WALLPAPER) != 0);
        } else {
        ...
        /// M: [ALPS01939364][ALPS01948669] Fix app window is hidden even when Keyguard is occluded
				...
				(isKeyguardHostWindow(attrs) &&  (mKeyguardDelegate != null && mKeyguardDelegate.isShowing())) ||
                (attrs.type == TYPE_KEYGUARD_SCRIM);
        }
    /* DTS2014121202430 fengwei/00209624 20141212 end > */
    }
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
		...
		/*<DTS2014102003380 by shenjinhua 20141110 begin */
		// home key passing to user
		if (SystemProperties.get("ro.config.keypasstouser", "0").equals("true") 
			&& (keyCode == KeyEvent.KEYCODE_HOME) && (win != null) 
			&& (win.getAttrs().hwFlags & AbsLayoutParams.FLAG_KEYEVENT_PASS_TO_USER_HOME) == AbsLayoutParams.FLAG_KEYEVENT_PASS_TO_USER_HOME) {			 
			if (DEBUG) Log.i(TAG, "HOME received and passsing to user.");
			return 0;
		}
		/* DTS2014102003380 by shenjinhua 20141110 end> */
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
        	/*[FACTORY_TEST_BY_APK] modify start*/	
			//if (getTopActivityPackageName().equals("com.huaqin.factory")) {
        	/// M: [ALPS00054781]Dispatch the home key to the application @{
        	if(win != null && win.getAttrs() != null&& (win.getOwningPackage().equals("com.android.factory")||win.getOwningPackage().equals("com.android.factory_mmi2"))){
...
// zhouyoukun fix Start support: get the application currently in the front
    ...
    void launchHomeFromHotKey() {
		...
		// Start specific code
        // Check if the specific app is in the front. If so, do nothing, so the appstays
       if(SystemProperties.get("ro.hq.claro_start","0").equals("1")){
	      // Log.i("zhouyoukuns",SystemProperties.get("ro.hq.claro_start","0")+"start");
          String lockApp = "com.celltick.lockscreen.LockerActivity";
          String topApp = getTopApp();
         //Log.i("zhouyoukuns",topApp+"topapp");
         if ( topApp.startsWith(lockApp)) {
	       // Log.i("zhouyoukuns","return");
          return;
         }
      }
// zhouyoukun fix end of Start specific code
    ...
    public void beginLayoutLw(boolean isDefaultDisplay, int displayWidth, int displayHeight,
        ...
        if (isDefaultDisplay) {
            ...
            /*< DTS2014112802304 zhudengkui / 00180854 20141209 begin */
            //recovery kk
            //boolean isKeyguardShowing = isStatusBarKeyguard() && !mHideLockScreen;
            //if (!isKeyguardShowing) {
                navTranslucent &= areTranslucentBarsAllowed();
            //}
            /* DTS2014112802304 zhudengkui / 00180854 20141209 end>*/
 ...
 /*< DTS2014102003633  taolan/00264981 20141106 begin*/
            if (navVisible && mUsingHwNavibar) {
                boolean needHideNaviBar = computeNaviBarFlag();//getNaviBarFlag();
                navVisible = navVisible && (!needHideNaviBar);
            }
            /* DTS2014102003633 taolan/00264981 20141106 end> */
 ...
 /*< DTS2014102003633  taolan/00264981 20141106 begin*/
    protected boolean getNaviBarFlag() {
        WindowManager.LayoutParams focusAttrs = mFocusedWindow != null ? mFocusedWindow.getAttrs() : null;
        //fix navbar show decision issue caused by wrong focused win
        int type = (focusAttrs != null) ? focusAttrs.type : 0;
        boolean keyguardOn = (type == WindowManager.LayoutParams.TYPE_KEYGUARD);
        boolean dreamOn = (focusAttrs != null && focusAttrs.type == WindowManager.LayoutParams.TYPE_DREAM);
        /* < DTS2014120800432 xuxuefei/00258670 20141127 begin */
        boolean isNeedHideNaviBarWin = ((focusAttrs != null) ? ((focusAttrs.privateFlags & WindowManager.LayoutParams.PRIVATE_FLAG_HIDE_NAVI_BAR) != 0) : false);
        /* DTS2014120800432 xuxuefei/00258670 20141127 end > */
        if(mStatusBar == mFocusedWindow) {
            ...
            return true;
        /* < DTS2014120800432 xuxuefei/00258670 20141127 begin */
        } else if (isNeedHideNaviBarWin) {
            return true;
        /* DTS2014120800432 xuxuefei/00258670 20141127 end > */
        } else {
            return isNavibarHide;
        }
    }
    /*< DTS2014102003633  taolan/00264981 20141106 end*/
    ...
    public void layoutWindowLw(WindowState win, WindowState attached) {
        ...
        dcf.setEmpty();
        /*< DTS2014102003633  taolan/00264981 20141106 begin*/
        boolean isNeedHideNaviBarWin = (mUsingHwNavibar) && ((attrs.privateFlags & WindowManager.LayoutParams.PRIVATE_FLAG_HIDE_NAVI_BAR) != 0);
        /* DTS2014102003633 taolan/00264981 20141106 end> */
        ...
        if (!isDefaultDisplay) {
            ...
            //HQ01268645 modify by HQ_jiangchao  start
           ...
           // cf.bottom = vf.bottom = mStableBottom;
            ...
            cf.bottom = vf.bottom = pf.bottom = df.bottom = of.bottom = mRestrictedOverscanScreenTop + mRestrictedOverscanScreenHeight; 
          //HQ01268645 modify by HQ_jiangchao  end
            ...
            if (isAppWindow && !inheritTranslucentDecor && !topAtRest) {
                ...
                if ((fl & WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION) == 0
                        && (sysUiFl & View.SYSTEM_UI_FLAG_HIDE_NAVIGATION) == 0 && !isNeedHideNaviBarWin
                        && (fl & WindowManager.LayoutParams.
                                FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS) == 0) {
            ...
            if ((fl & (FLAG_LAYOUT_IN_SCREEN | FLAG_LAYOUT_INSET_DECOR))
                ...
                if (attached != null) {
                    ...
                    /* < DTS2014112802441 shenjinhua/00171968 20141204 begin */
                            ...
                            && (attrs.type == TYPE_TOP_MOST || attrs.type == WindowManager.LayoutParams.TYPE_KEYGUARD || (
                                attrs.type >= WindowManager.LayoutParams.FIRST_APPLICATION_WINDOW
                            && attrs.type <= WindowManager.LayoutParams.LAST_SUB_WINDOW)) || isNeedHideNaviBarWin) {
                    /* DTS2014112802441 shenjinhua/00171968 20141204 end > */
                    /* DTS2014102003633 taolan/00264981 20141106 end> */
                ...
                /*< DTS2014102003633  taolan/00264981 20141106 begin*/
                        ...
                        && (attrs.type == TYPE_STATUS_BAR
                            ...
                            || (attrs.type >= WindowManager.LayoutParams.FIRST_APPLICATION_WINDOW
                            && attrs.type <= WindowManager.LayoutParams.LAST_SUB_WINDOW))
                        || (mUsingHwNavibar && (attrs.type == TYPE_WALLPAPER)) || isNeedHideNaviBarWin) {
                /* DTS2014102003633 taolan/00264981 20141106 end> */
                    // Asking for layout as if the nav bar is hidden, lets the
        ...
        /*< DTS2014102003633  taolan/00264981 20141106 begin*/
        if (isNeedHideNaviBarWin && attrs.type == TYPE_KEYGUARD) {
            cf.top = vf.top = 0;
            cf.bottom = vf.bottom = pf.bottom;
        }
        //fix navigationbar flash issue between activitys which hide navigationbar use hw method
        if (mUsingHwNavibar && (isNeedHideNaviBarWin || isNavibarHide)) {
            dcf.bottom = cf.bottom = vf.bottom = pf.bottom;
        }
        /* DTS2014102003633 taolan/00264981 20141106 end> */
    ...
    public void applyPostLayoutPolicyLw(WindowState win, WindowManager.LayoutParams attrs,
        ...
        if ((attrs.type == TYPE_STATUS_BAR && (attrs.privateFlags & PRIVATE_FLAG_KEYGUARD) != 0)
                || (attrs.type == TYPE_KEYGUARD && (attrs.privateFlags & PRIVATE_FLAG_KEYGUARD) != 0)) {
        ...
        if (mTopFullscreenOpaqueWindowState == null &&
            ...
            if (appWindow && attached == null) {
                /*<DTS2014121702829 shenjinhua/00171968 20141229 begin */
                if (showWhenLocked) {
                ...
                if(!showWhenLocked && !dismissKeyguard) {
                    /*<DTS2014120603171 zhudengkui / 00180854 20141208 begin */
                    /*<DTS2015032301185 hanmincheng/00178881 20150331 begin */
                    mAppsToBeHidden.add(appToken);
                    /* DTS2015032301185 hanmincheng/00178881 20150331 end>*/
                    /* DTS2014120603171 zhudengkui / 00180854 20141208 end>*/
                }
                /* DTS2014121702829 shenjinhua/00171968 20141229 end>*/
    ...
    public int finishPostLayoutPolicyLw() {
        if (mWinShowWhenLocked != null &&
            ...
            mWinShowWhenLocked.getAttrs().flags |= FLAG_SHOW_WALLPAPER;
                  //  add by zhouyoukun for HQ01435349 begin
            if(mTopFullscreenOpaqueWindowState != null)
            	 //  add by zhouyoukun for HQ01435349 end	
        ...
        /*<DTS2014120603171 zhudengkui / 00180854 20141208 begin */
        //recovery to KK
        if (mKeyguardDelegate != null && mKeyguard != null) {
    ...
    public boolean allowAppAnimationsLw() {
        ...
        if (mKeyguard != null && mKeyguard.isVisibleLw() && !mKeyguard.isAnimatingLw() || mShowingDream) {
        /* DTS2014120603171 zhudengkui / 00180854 20141208 end>*/
    ...
    public int interceptKeyBeforeQueueing(KeyEvent event, int policyFlags) {
		Log.d(TAG, "--- interceptKeyBeforeQueueing() KeyCode = "+event.getKeyCode()+" policyFlags = "+policyFlags+" ---");
        if (!mSystemBooted) {
        ...
        /*[FACTORY_TEST_BY_APK] modify start*/
	 Log.w(TAG, "getFactoryKitMode()="+getFactoryKitMode());
		 Log.w(TAG, "sys.factorytest.unit.key="+Settings.System.getInt(mContext.getContentResolver(),"sys.factorytest.unit.key",0));
		  Log.w(TAG, "sys.factorytest.power_status="+Settings.System.getInt(mContext.getContentResolver(),"sys.factorytest.power_status",0));
    	if(KeyEvent.KEYCODE_POWER == event.getKeyCode() && (getFactoryKitMode() == 1  || 1 == Settings.System.getInt(mContext.getContentResolver(),"sys.factorytest.unit.key",0))&&  
						(1 == Settings.System.getInt(mContext.getContentResolver(),"sys.factorytest.power_status",0)))/*HQ_liugang modify for HQ00669413 20140625*/
    	{
            Log.w(TAG, "wangwenjin power");
    		return ACTION_PASS_TO_USER;
    	}

	Log.d(TAG,"meiyingtest-------");
	  if(KeyEvent.KEYCODE_SC_CHANGED == event.getKeyCode()) {
                  if((getFactoryKitMode() == 1) || (1 == Settings.System.getInt(mContext.getContentResolver(),"sys.factorytest.unit.key",0) )) {
		  Log.d(TAG,"sendbroadcast");
	         SystemProperties.set("sys.meiying_test", "1");
			 mPowerManager.wakeUp(SystemClock.uptimeMillis());
    			return ACTION_PASS_TO_USER; 
                  	}
	  	}	
        Log.w(TAG, "wangwenjin power 234523 = "+Settings.System.getInt(mContext.getContentResolver(),"sys.factorytest.status",0));
        /*[FACTORY_TEST_BY_APK] modify end*/
        ...
        final boolean down = event.getAction() == KeyEvent.ACTION_DOWN;
        //HQ_zhangteng added for HQ01464211 at 2015-10-27 begin
		...
		//add by majian for keylock gestures	 
	if(keyCode == KeyEvent.KEYCODE_SC_CHANGED)
	{
	    if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_C , 1) == 1)
	    {
			Log.d(TAG,"Test if keyguardservice is true:" + isKeyguardSecure());
			Intent gestureIntent = new Intent("com.android.action.gesture");
			mContext.sendBroadcast(gestureIntent);

	    }
            return 0;
	}else if(keyCode == KeyEvent.KEYCODE_SM_CHANGED)
	{	
		if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_M , 1) == 1)
		{			
			Log.d(TAG,"Test if keyguardservice is true:" + isKeyguardSecure());
			Intent gestureIntent = new Intent("com.android.action.gesture");
			mContext.sendBroadcast(gestureIntent);
		...
		return 0;
	}else if(keyCode == KeyEvent.KEYCODE_S_CHANGED)
	{
       if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_E , 1) == 1)
       {
  			Log.d(TAG,"Test if keyguardservice is true:" + isKeyguardSecure());
			Intent gestureIntent = new Intent("com.android.action.gesture");
			mContext.sendBroadcast(gestureIntent);
	...
	else if(keyCode == KeyEvent.KEYCODE_SW_CHANGED)
	{
       if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_W , 1) == 1)
       {		
            Log.d(TAG,"Test if keyguardservice is true:" + isKeyguardSecure());
			Intent gestureIntent = new Intent("com.android.action.gesture");
			mContext.sendBroadcast(gestureIntent);      
    ...
    if (keyCode == KeyEvent.KEYCODE_FPC) {
        Log.i(TAG, "KEYCODE_FPC has receive%%%%%%%%%%%%%");   
        Log.d(TAG, "weijie " + getCurRunningActivityPackageName());
        if("com.android.deskclock".equals(getCurRunningActivityPackageName())){
            if(isFingerprintOffAlarmclockAllowed()){
                Log.i(TAG, "off alarm!!!!!");
        ...
        else if("com.huawei.camera".equals(getCurRunningActivityPackageName())){
            if(isFingerprintTakePictureAllowed()){
        ...
        else if("com.android.contacts".equals(getCurRunningActivityPackageName())){    
            if(isFingerprintRecieveCallAllowed()){
                Log.i(TAG, "answer calls!!!!!"); 
                Intent intent = new Intent("com.android.server.input.receivephonecall");
                mContext.sendBroadcast(intent);
            }
        }
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_MUTE: {
                if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN) {
                    //HQ_zhangteng modified for HQ01464211 at 2015-10-27 begin
                    if (up) {
                        //add by zhouyoukun for *** end
                        AudioManager audioManager = (AudioManager) mContext.getSystemService(Context.AUDIO_SERVICE);
                        
                        if(!audioManager.isMusicActive()){
                           //add by wangjing3 for *** begin 2015-07-28
                            Log.i(TAG,"wangjing3 add for camera test  2");
                            if((event.getEventTime() - lastTime) < REPAI_CAPTURE_KEY_VALUME_TIME ) {
                               isDouble  = true ;       
                               count++;
                            } else {
                               isDouble = false ;
                            ...
                            if(count < 3) {                                
                                String power_mode = SystemProperties.get("sys.super_power_save","false");  //获得属性值,超级省电模式不启动快拍
                                if(power_mode.equals("false")){
                                    Intent intent=new Intent();
                                    intent.setAction("com.huawei.RapidCapture");
                                    intent.setPackage("com.huawei.camera");
                                    intent.putExtra("command",isDouble ? "start" :"wakeup");
                                    intent.putExtra("type", "volumekey");
                                    mContext.startService(intent);
                                }
                            }
                            lastTime = event.getEventTime();
                    
                            //add by zhouyoukun for HQ01337844 begin
                            //enableKeyguard(false);
                            //add by zhouyoukun for HQ01337844 end
                            //add by wangjing3 for *** end   2015-07-28
                    ...
                    //HQ_zhangteng modified for HQ01464211 at 2015-10-27 end
    ...
    private boolean isFingerprintRecieveCallAllowed(){
        ContentResolver resolver = mContext.getContentResolver();
        try{
            Log.d(TAG, "Settings.System.FINGERPRINT_PHONE_SWITCH = " +Settings.System.getInt(resolver,
                                      Settings.System.FINGERPRINT_PHONE_SWITCH));
    ...
    private boolean isFingerprintTakePictureAllowed(){
        ContentResolver resolver = mContext.getContentResolver();
        try{
            Log.d(TAG, "Settings.System.FINGERPRINT_CAMERA_SWITCH = " +Settings.System.getInt(resolver,
                                      Settings.System.FINGERPRINT_CAMERA_SWITCH));
            return Settings.System.getInt(resolver,
    ...
    private boolean isFingerprintOffAlarmclockAllowed(){
        ContentResolver resolver = mContext.getContentResolver();
        try{
            Log.d(TAG, "Settings.System.FINGERPRINT_ALARMCLOCK_SWITCH = " +Settings.System.getInt(resolver,
                                      Settings.System.FINGERPRINT_ALARMCLOCK_SWITCH));
            return Settings.System.getInt(resolver,
    ...
    private void sendKeyEvent(int keycode) {
        ...
        for (int i=0; i<actions.length; i++) {
            ...
            ev = new KeyEvent(curTime, curTime,
            actions[i], keycode,
            0, 0,
            6, 0,
            0 | KeyEvent.FLAG_FROM_SYSTEM,
    ...
    BroadcastReceiver mPoweroffAlarmReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            Log.v(TAG, "mIpoEventReceiver -- onReceive -- entry");
            String action = intent.getAction();
            SystemProperties.set("persist.sys.powerup_reason ", "C");//gepengfei added for power off alarm
            mIsAlarmBoot = false;
   ...
   ///@}
    ...
    BroadcastReceiver mStatusBarEventReceiver = new BroadcastReceiver() {
      ...
      //wuhuihui add for gesture key enable start	  
      BroadcastReceiver mgestureEnableReceiver = new BroadcastReceiver() {
          public void onReceive(Context context, Intent intent) {
              String action = intent.getAction();
              ...
              Log.v(TAG, "write gesture_enable procName:" + procName);
              Log.v(TAG, "write gesture_enable:" + flag);
              if(action.equals(ACTION_GESTURE_ENABLE)) {
                  writeGestureEnable(procName,flag);
              }
              Log.v(TAG, "receive action:" + action);
          }
      };
      //wuhuihui add for gesture key enable end
    ...
    private void requestTransientBars(WindowState swipeTarget) {
        synchronized (mWindowManagerFuncs.getWindowManagerLock()) {
            ...
            if (!isDeviceProvisionedInSettingsDb()) {//HQ_hudianteng 2016-04-14 add for HQ01854887
                return;
            }
    ...
    public void goingToSleep(int why) {
       ...
       //add by wangjing3 for HQ01354211 begin 2015-09-29
		/* < DTS2013120900911 shenjinhua/00171968 20131216 begin */
        /* < DTS2014040305824 shenjinhua/00171968 20140408 begin */
        if (mKeyguardDelegate != null
            && needTurnOff(why) && needTurnOffWithDismissFlag()) {
            if(DEBUG) Log.d(TAG, "call onScreenTurnedOff(why)");
            mKeyguardDelegate.onScreenTurnedOff(why);
        }
        /* DTS2014040305824 shenjinhua/00171968 20140408 end > */
        /* DTS2013120900911 shenjinhua/00171968 20131216 end > */ 
		//add by wangjing3 for HQ01354211 end 2015-09-29
    }
	...
	/*<DTS2014110801467 taolan/264981 20141108 begin */
    protected boolean keyguardIsShowingTq() {
        return isKeyguardShowingAndNotOccluded();
    }
    /*DTS2014110801467 taolan/264981 20141108 end > */
    ...
    //add by majian	
    private void writeGestureEnable(String FileName,String flag) 
    {
        File file = new File(FileName);
        FileOutputStream out = null;
        try {
            Log.d(TAG, "is exise : " + file.exists()+", flag: "+flag);
...
//add end
    ...
    public void systemBooted() {
        ...
        synchronized (mLock) {
            mSystemBooted = true;
			//add by majian
			if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_SWITCH , 1) == 1)
			{
				writeGestureEnable("/proc/gesture_enable","1");				
			}
			if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_C, 1) == 1)
			{
				writeGestureEnable("/proc/gesture_enablec","1");		
			}
			if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_E, 1) == 1)
			{
				writeGestureEnable("/proc/gesture_enablee","1");		
			}
			if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_W, 1) == 1)
			{
				writeGestureEnable("/proc/gesture_enablew","1");		
			}
			if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_M, 1) == 1)
			{
				writeGestureEnable("/proc/gesture_enablem","1");		
			}
			if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.KEYLOCK_GESTURES_DOUBLECLICK, 1) == 1)
			{
				writeGestureEnable("/proc/gesture_enablecc","1");		
			}
			//add end
        }
        wakingUp();
    ...
    private boolean isDeviceProvisionedInSettingsDb() {//HQ_hudianteng 2016-04-14 add for HQ01854887
        return Settings.Global.getInt(mContext.getContentResolver(),
    ...
    private int updateSystemUiVisibilityLw() {
        ...
        //HQ_hudianteng 2016-04-14 add for HQ01854887 begin
        boolean ret = win.toString().contains(".LanguageSelectActivity") || win.toString().contains(".WifiSetupActivity")
                || win.toString().contains(".StartUpGuideLoginActivity") || win.toString().contains(".ServiceSwitchActivity")
                || win.toString().contains(".LockScreenActivity");
        if (!isDeviceProvisionedInSettingsDb() && ret) {
            tmpVisibility=0;
            tmpVisibility=View.SYSTEM_UI_FLAG_LAYOUT_STABLE
                   | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION
                   | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                   | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION
                   | View.SYSTEM_UI_FLAG_FULLSCREEN
        ...
        //add log
        Log.d(TAG,"tdp ,updateSystemUiVisibilityLw tmpVisibility="+Integer.toHexString(tmpVisibility));
        //HQ_hudianteng 2016-04-14 add for HQ01854887 end
        ...
        /* HQ_xuqian4 20151112 modified for HQ01498193 begin */
        if (diff != 0) {
            Slog.d(TAG, "update systemui visibility:[" + Integer.toHexString(visibility)
              + "], mLastSystemUiFlags:[" + Integer.toHexString(mLastSystemUiFlags)
              + "], win:[" + win + "]");
          }
        /* HQ_xuqian4 20151112 modified end */
	...
	String getTopActivityPackageName() {
		...
		if (runningTaskInfos != null) {
			topActivityPackageName = (runningTaskInfos.get(0).topActivity)
					.getPackageName().toString();
			Log.e(TAG, "getTopActivityPackageName = " + topActivityPackageName);
    ...
    private int getFactoryKitMode()
    {
   	...
   	/*[FACTORY_TEST_BY_APK] modify end*/
    /*< DTS2014102003235  taolan/00264981 20141105 begin*/
    protected void cancelPendingPowerKeyActionForDistouch() {
        cancelPendingPowerKeyAction();
    }
    /* DTS2014102003235 taolan/00264981 20141105 end> */
