...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    public final void openPanel(int featureId, KeyEvent event) {
        /*< DTS2014082601417 tianjing/00102012 20140919 begin*/
        if (featureId == FEATURE_OPTIONS_PANEL && mDecorContentParent != null &&
                mDecorContentParent.canShowOverflowMenu() &&
                CheckPermanentMenuKey()) {
        /*< DTS2014082601417 tianjing/00102012 20140919 end>*/
    ...
    private final class DecorView extends FrameLayout implements RootViewSurfaceTaker {
        ...
        private boolean mIgnoreHwStyle;
            ...
            if (heightMode == AT_MOST) {
                ...
                if (tvh != null && tvh.type != TypedValue.TYPE_NULL) {
                    ...
                    if (h > 0) {
                        ...
                        heightMeasureSpec = getHeightMeasureSpec(h, heightSize, heightMeasureSpec);
        ...
        public ActionMode startActionMode(ActionMode.Callback callback) {
			...
			/* < DTS2015042301272 zhangxinming/00181848 20150429 begin */
			boolean ignoreHwStyle = ignoreHwActionModeStyle(callback);
			boolean isEmui = isEmuiStyle();
			if (isEmui && ignoreHwStyle) {
				 ((ActionModeCallbackWrapper)wrappedCallback).setIgnoreHwActionModeStyle();
				 mIgnoreHwStyle = true;
			}
			/*   DTS2015042301272 zhangxinming/00181848 20150429 end > */
            ...
            if (mode != null) {
                ...
                if (mActionModeView == null) {
                    if (isFloating()) {
						...
						/* < DTS2015042301272 zhangxinming/00181848 20150429 begin */
						if (mActionModeView != null && isEmui && ignoreHwStyle) {
							mActionModeView.setIgnoreHwActionModeStyle();
							mIgnoreHwStyle = true;
						}
						/*   DTS2015042301272 zhangxinming/00181848 20150429 end > */
                        }
		...
		protected void onConfigurationChanged(Configuration newConfig) {
			...
			if (mActionMode != null && mIgnoreHwStyle) {
        ...
        private class ActionModeCallbackWrapper implements ActionMode.Callback {
			...
			/* < DTS2015042301272 zhangxinming/00181848 20150429 begin */
			private boolean mIgnoreHwActionModeStyle;
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        if (mIsStartingWindow) {
            ...
            if (mIsFloating) {
                ...
                /* < DTS2014111801378 zhangxinming/00181848 20141118 begin */ 
                layoutResource = getEmuiActionBarLayout(layoutResource);
                /*   DTS2014111801378 zhangxinming/00181848 20141118 end > */
            } else {
    ...
    protected int getEmuiActionBarLayout(int layoutResource) {
        //Hook, override at HwPhoneWindow
	...
	protected boolean ignoreHwActionModeStyle(ActionMode.Callback callback) {
		try {
			Class cls = callback.getClass();
			java.lang.reflect.Field field = cls.getDeclaredField("mIgnoreHwStyle");
			field.setAccessible(true);
			Object obj = field.get(callback);
			return obj != null && obj.equals(Boolean.valueOf("true"));
		} catch (Exception ex) {
			//eat
		}
		return false;
