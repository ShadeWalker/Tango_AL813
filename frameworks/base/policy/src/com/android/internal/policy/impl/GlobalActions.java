...
/*< DTS2014092907175 xufusheng/00297139 20141010 begin*/
//rebase for DTS2013120204950, deleted
import com.android.internal.policy.impl.HwPolicyFactory;
/* DTS2014092907175 xufusheng/00297139 20141010 end>*/
...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private GlobalActionsDialog createDialog() {
        ...
        for (int i = 0; i < defaultActions.length; i++) {
            ...
            /*< DTS2014092907175 xufusheng/00297139 20141010 begin*/
                ...
                //rebase for DTS2013120204950
                HwPolicyFactory.addRebootMenu(mItems);
            /* DTS2014092907175 xufusheng/00297139 20141010 end>*/
    ...
    private final class PowerAction extends SinglePressAction implements LongPressAction {
        ...
        public void onPress() {
            ...
            /*<DTS2014120400391 liutie/00176215 20141209 begin */
    ...
    private Action getBugReportAction() {
        /*<DTS2013081607240 lifei/00129990 20130821 begin */
        //return new SinglePressAction(com.android.internal.R.drawable.ic_lock_bugreport,
               // R.string.bugreport_title) {
	int drawableID = mContext.getResources().getIdentifier("androidhwext:drawable/stat_sys_adb_emui", null, null);
        return new SinglePressAction(drawableID,
               R.string.bugreport_title) {
        /*DTS2013081607240 lifei/00129990 20130821 end>*/
            public void onPress() {
    ...
    private void prepareDialog() {
        refreshSilentMode();
        /* < DTS2014021903729 zhangqian/00186201 20140227 begin */
        boolean airplaneModeOn = Settings.System.getInt(
                mContext.getContentResolver(),
                Settings.System.AIRPLANE_MODE_ON,
                0) == 1;
        mAirplaneState = airplaneModeOn ? ToggleAction.State.On : ToggleAction.State.Off;
        /* DTS2014021903729 zhangqian/00186201 20140227 end > */
        ...
        if (mShowSilentToggle) {
            ...
            /* < DTS2013012908690 lidong/00209185 20130301 begin */
            mContext.registerReceiver(mRingerModeReceiver = new BroadcastReceiver() {
                @Override
            ...
            /* DTS2013012908690 lidong/00209185 20130301 end > */
