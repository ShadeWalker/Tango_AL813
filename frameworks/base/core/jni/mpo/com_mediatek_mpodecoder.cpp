...
static const char *classPathName = "com/mediatek/mpodecoder/MpoDecoder";
...
static jobject mpodecoder_frameBitmap(JNIEnv* env, jobject mpodecoder,
    ...
    SkBitmap *createdBitmap = md->getImageBitmap(env, frameIndex, options,&javaAllocator);
    if (createdBitmap != NULL)
        return GraphicsJNI::createBitmap(env, createdBitmap,javaAllocator.getStorageObj(),false, NULL, NULL,-1);
    else 
        return NULL;
}
...
static JNINativeMethod methods[] = {
    { "decodeByteArray", "([BII)Lcom/mediatek/mpodecoder/MpoDecoder;",
                             (void*)mpodecoder_decodeByteArray },
    { "decodeFile", "(Ljava/lang/String;)Lcom/mediatek/mpodecoder/MpoDecoder;",
                             (void*)mpodecoder_decodeFile },
    { "getWidth",        "()I", (void*)mpodecoder_width  },
    { "getHeight",       "()I", (void*)mpodecoder_height  },
    { "getFrameCount",   "()I", (void*)mpodecoder_frameCount  },
    { "getMpoType",   "()I", (void*)mpodecoder_getMtkMpoType  },
    { "getMpoSubType",   "()I", (void*)mpodecoder_suggestMtkMpoType  },
    { "getFrameBitmap", 
