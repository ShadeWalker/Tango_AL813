...
LOCAL_C_INCLUDES += \
	...
	libcore/include \
        $(MTK_ROOT)/frameworks-ext/native/include \
        $(MTK_ROOT)/external/sqlite/custom \
        $(MTK_ROOT)/frameworks-ext/av/include \
...
ifeq ($(TARGET_ARCH), $(filter $(TARGET_ARCH), arm arm64))
  ifeq ($(TARGET_BUILD_VARIANT), eng)
    LOCAL_CFLAGS += -DMTK_DUMP_HPROF_WHEN_OOME
  endif
endif
