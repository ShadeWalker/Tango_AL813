...
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    Settings.System.putInt(context.getContentResolver(),"sys.factorytest.power_status",0);
                    Settings.System.putInt(context.getContentResolver(),"sys.factorytest.receiver",0);
                } catch (Exception e) {
                    Slog.e(TAG, "Can't set the propety:sys.factorytest.power_status", e);
                }
                try {
    ...
    private void logBootEvents(Context ctx) throws IOException {
        ...
        //huangyisong_add for auto recovery start,20130902
        Intent factorySetService = new Intent("com.huaqin.action.factoryset");
        ctx.sendBroadcast(factorySetService);
        //add end
