...
public class LockPatternView extends View {
	...
	//add by HQ_caoxuhao at 20151001 HQ01419581 begin
	//set the mRegularColor(Default) in grey
	//set the mSuccessColor in blue
	//mRegularColor = Color.parseColor("#808080");//grey
	mRegularColor = Color.parseColor("#20C5E1");//blue
	mSuccessColor = Color.parseColor("#20C5E1");//blue
	
        int pathColor = a.getColor(R.styleable.LockPatternView_pathColor, mRegularColor);

	pathColor = Color.parseColor("#20C5E1");
        mPathPaint.setColor(pathColor);

	//Log.i(TAG,"mRegularColor = " + mRegularColor);
	//Log.i(TAG,"mErrorColor = " + mErrorColor);
	//Log.i(TAG,"mSuccessColor = " + mSuccessColor);
	//Log.i(TAG,"pathColor = " + pathColor);
	//add by HQ_caoxuhao at 20151001 HQ01419581 end
	...
	//add by HQ_caoxuhao at 20151001 HQ01419581 begin
	//we should show successColor when user begin to touch the circle
	if (!partOfPattern || mInStealthMode) {
            // unselected circle
	    //Log.i(TAG,"getCurrentColor partOfPattern = " + partOfPattern);
	    //Log.i(TAG,"getCurrentColor mInStealthMode = " + mInStealthMode);
	    //Log.i(TAG,"getCurrentColor mPatternInProgress = " + mPatternInProgress);
	    //Log.i(TAG,"getCurrentColor unselected circle mRegularColor");
            return mRegularColor;
        } else if (mPatternDisplayMode == DisplayMode.Wrong) {
            // the pattern is wrong
	    //Log.i(TAG,"getCurrentColor the pattern is wrong mErrorColor");
            return mErrorColor;
        }else if(mPatternDisplayMode == DisplayMode.Correct ||
                mPatternDisplayMode == DisplayMode.Animate  || mPatternInProgress){
	    //Log.i(TAG,"getCurrentColor Animate mSuccessColor");
