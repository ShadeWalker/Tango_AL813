...
public class ScrollingTabContainerView extends HorizontalScrollView
    ...
    /*   DTS2014111801378 zhangxinming/00181848 20141118 end > */
        ...
        protected void insertOrAppendView(View view, boolean insertPreferentially) {
            if (null != mTab.getTag() && "show-icon-right".equals(mTab.getTag().toString())) {
                addView(view, insertPreferentially ? 0 : -1);
            } else {
                addView(view, insertPreferentially ? -1 : 0);
            }
        }
        /*   DTS2014111801378 zhangxinming/00181848 20141118 end > */
    }
