...
public class ActionBarView extends AbsActionBarView implements DecorToolbar {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if(mLastConfiguration.diff(newConfig) == 0) return;
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        ...
        if (mActionMenuPresenter == null) {
            /* < DTS2014112006793 zhangxinming/00181848 20141120 begin */
            mActionMenuPresenter = initActionMenuPresenter(mContext);
            /*   DTS2014112006793 zhangxinming/00181848 20141120 end > */
    ...
    protected LinearLayout initTitleLayout() {
        ...
        return (LinearLayout) inflater.inflate(R.layout.action_bar_title_item,
                        this, false);
    }
