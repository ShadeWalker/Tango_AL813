...
public class ExternalMediaFormatActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    public void onClick(DialogInterface dialog, int which) {
        ...
        if (which == POSITIVE_BUTTON) {
			...
			/* HQ_ChenWenshuai 2015-09-18 modified for HQ01340512 begin */
			StorageVolume storageVolume = (StorageVolume)getIntent().getParcelableExtra("storage_volume");
			Log.d(TAG, "get format storageVolume: " + storageVolume);
			...
			/*HQ_ChenWenshuai 2015-09-18 modified end */
