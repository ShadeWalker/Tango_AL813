...
public class WindowDecorActionBar extends ActionBar implements
    ...
    /* < DTS2014122908329 yinwenshuai/00211458 20150122 begin */
    protected void animateToMode(boolean toActionMode) {
    /* DTS2014122908329 yinwenshuai/00211458 20150122 end > */
        if (toActionMode) {
            showForActionMode();
        } else {
            hideForActionMode();
    ...
    protected void initContainerView(View decor) {
        View view = decor.findViewById(com.android.internal.R.id.action_bar_container);
        if (view instanceof ActionBarContainer) {
            mContainerView = (ActionBarContainer)view;
        }
    }

    protected void initContextView(View decor) {
        View view = decor.findViewById(com.android.internal.R.id.action_context_bar);
        if (view instanceof ActionBarContextView) {
            mContextView = (ActionBarContextView)view;
        }
    }

    protected ScrollingTabContainerView initScrollingTabContainerView() {
        return new ScrollingTabContainerView(mContext);
    }
