...
public class Switch extends CompoundButton {
    ...
    private void stopDrag(MotionEvent ev) {
        ...
        if (newState != oldState) {
            ...
            setChecked(oldState); //yuankangbo add for HQ01368150
        }
    ...
    public void draw(Canvas c) {
        ...
        if (mThumbDrawable != null) {
			...
			/*HQ_liugang add for HQ01575860*/
			final int thumbLeft;
			final int thumbRight;
			//Log.i("switch", "LayoutDirection " + getLayoutDirection());
			if(isRtlLocale() && getLayoutDirection() == 0){
	            thumbLeft = mSwitchRight - mThumbWidth - thumbInitialLeft;		
	            thumbRight = mSwitchRight - thumbInitialLeft;
			} else {
