...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        /* < DTS2014111205796 guyue/00295151 20141112 begin */
        inflateSearchView(context, attrs, a);
        /* DTS2014111205796 guyue/00295151 20141112 end > */
        ...
        /*<DTS2015033102840  guyue/295151 20150403 begin*/
        setIconsAndBackgrounds(a);
        /*DTS2015033102840  guyue/295151 20150403 end >*/
    ...
    /*<DTS2014112706754 guyue/295151 20141129 begin*/
    /*DTS2014112706754 guyue/295151 20141129 end >*/
...
/// M:  mSearchSrcTextView.setOnEditorActionListener(mOnEditorActionListener);
    ...
    public void setQuery(CharSequence query, boolean submit) {
        ...
        /* < DTS2014111205796 guyue/00295151 20141112 begin */
        if ((!isEmuiStyle() || !isInActionMode()) && submit && !TextUtils.isEmpty(query)) {
            onSubmitQuery();
        }
        /* DTS2014111205796 guyue/00295151 20141112 end > */
    }
    ...
    private void updateCloseButton() {
        ...
        if(isEmuiStyle()) {
            updateVoiceButton(!showClose);// && !hasText
        }
        /* DTS2014111205796 guyue/00295151 20141112 end >*/
    ...
    private void updateVoiceButton(boolean empty) {
        ...
        if (mVoiceButtonEnabled && !isIconified() && empty) {
            visibility = VISIBLE;
            if (!isEmuiStyle()) mGoButton.setVisibility(GONE);
        }
        /* DTS2014111205796 guyue/00295151 20141112 end >*/
    ...
    private void adjustDropDownSizeAndPosition() {
        if (mDropDownAnchor.getWidth() > 1) {
            ...
            /*< DTS2014111205796 guyue/00295151 20141112 begin*/
            final boolean isLayoutRtl = isRtlLocale();
            /* DTS2014111205796 guyue/00295151 20141112 end>*/
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        public boolean enoughToFilter() {
            /*< DTS2014111205796 guyue/00295151 20141112 begin */
            if (mSearchView.isInActionMode() && mSearchView.isSubmitButtonEnabled()) {
                return false;
            }
            /* DTS2014111205796 guyue/00295151 20141112 end >*/
    ...
    /*<DTS2014120501090 guyue/295151 20141211 begin*/
    protected ImageView getGoButton() {
        return mGoButton;
    }
    /*DTS2014120501090 guyue/295151 20141211 end >*/
