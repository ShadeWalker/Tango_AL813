...
/*DTS2014101007196 guyue/00295151 20141106 end>*/
    ...
    /// M: cosider sycn height to layout top of view
    private View fillSyncSpecific(int position, int top, int syncHeight) {
        boolean tempIsSelected = position == mSelectedPosition;
        View temp = makeAndAddView(position, top, true, mListPadding.left, tempIsSelected);

        int currtHeight = temp.getMeasuredHeight();
        if (syncHeight > 0 && currtHeight != syncHeight) {
            float ratio = (float)(top) / syncHeight;
            int targetHeight = (int) (ratio * currtHeight);
            temp.offsetTopAndBottom(targetHeight - top);
        }
    ...
    protected void layoutChildren() {
        ...
        try {
            ...
            case LAYOUT_SET_SELECTION:
                ...
                break;
            case LAYOUT_SYNC:
                sel = fillSyncSpecific(mSyncPosition, mSpecificTop, mSpecificHeight);
                break;
            case LAYOUT_FORCE_BOTTOM:
    ...
    private void scrollListItemsBy(int amount) {
        ...
        if (amount < 0) {
            ...
            while ( (null != first) && (first.getBottom() < listTop) ) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if ((headerDividers || !isHeader) && (footerDividers || !isFooter)) {
                        ...
                        if (drawDividers && (bottom < listBottom)
                            ...
                            if (checkIsEnabled(adapter, itemIndex) && (headerDividers || !isHeader
                                    && (nextIndex >= headerCount)) && (isLastItem
                                    //|| adapter.isEnabled(nextIndex) && (footerDividers || !isFooter
                                      || checkIsEnabled(adapter, nextIndex) && (footerDividers || !isFooter
                    ...
                    if ((headerDividers || !isHeader) && (footerDividers || !isFooter)) {
                        ...
                        if (drawDividers && (top > effectivePaddingTop)) {
                            ...
                            if (checkIsEnabled(adapter, itemIndex) && (headerDividers || !isHeader
                                    ...
                                    checkIsEnabled(adapter, previousIndex) && (footerDividers || !isFooter
