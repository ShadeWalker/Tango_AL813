...
public class NumberPicker extends LinearLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            // draw text on middle position with white color, otherwises with black color
    ...
    private void initializeSelectorWheel() {
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        mSelectorElementHeight = initializeSelectorElementHeight(mTextSize, mSelectorTextGapHeight);
        /*< DTS2014101007196 guyue/00295151 20141106 end*/
    ...
    protected void setSelectorColor(int i, int currentOffset, int initOffset,
            int index, int height, Paint paint) {
        // hook
    }
