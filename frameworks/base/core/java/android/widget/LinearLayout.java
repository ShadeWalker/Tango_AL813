...
public class LinearLayout extends ViewGroup {
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        /*< DTS2013121107644 tianjing/00102012 20131203 begin*/
        // boolean isLayoutRtl;
        // if (mHwActionBarViewUsed) {
        //     isLayoutRtl = isRtlLocale();
        // } else {
            ...
            if (child != null && child.getVisibility() != GONE) {
                if (hasDividerBeforeChildAt(i)) {
                    ...
                    if (isLayoutRtl) {
                        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                        /*< DTS2013121107644 tianjing/00102012 20131203 begin*/
                        /* 0 is for the first item, it need add divider at item right side with its width, others no need. */
                        if (0 == i) {
                            position = child.getRight() + lp.rightMargin - mDividerWidth;
                        } else {
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (useLargestChild &&
            ...
            for (int i = 0; i < count; ++i) {
                ...
                /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                /*< DTS2013121107644 tianjing/00102012 20131203 begin*/
                if (mHwActionBarTabLayoutUsed && hasDividerBeforeChildAt(i)) {
                    mTotalLength += mDividerWidth;
                }
                /* DTS2013121107644 tianjing/00102012 20131203 end>*/
                /*< DTS2014101007196 guyue/00295151 20141106 end*/
