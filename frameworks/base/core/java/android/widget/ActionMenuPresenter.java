...
public class ActionMenuPresenter extends BaseMenuPresenter
    ...
    public void initForMenu(Context context, MenuBuilder menu) {
        ...
        if (mReserveOverflow) {
            if (mOverflowButton == null) {
                /* < DTS2014101007196 guyue/00295151 20141106 begin */
                mOverflowButton = HwWidgetFactory.getHwOverflowMenuButton(mSystemContext, this);
                if(null == mOverflowButton) mOverflowButton = new OverflowMenuButton(mSystemContext);
                /* DTS2014101007196 guyue/00295151 20141106 end > */
    ...
    public void bindItemView(MenuItemImpl item, MenuView.ItemView itemView) {
		...
		if (mIgnoreHwActionModeStyle) {
			item.setIgnoreHwActionModeStyle();
		}
    ...
    public void onRestoreInstanceState(Parcelable state) {
        /*HQ_xupeixin 2015-10-14 modified about resolve class cast exception begin*/
        ...
        /*HQ_xupeixin 2015-10-14 modified end*/
    }
