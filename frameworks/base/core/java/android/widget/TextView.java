...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
    private HwTextView mHwTextView = null;
    /*< DTS2014101007196 guyue/00295151 20141106 end*/
    ...
    private int mTextViewDerection = Layout.DIR_LEFT_TO_RIGHT; //HQ_yulifeng add HQ01401362, 201501126
    ...
    /// M: Post this runnable in onRestoreInstanceState() if the TextView has been set an error.
    ///    With this variable, we can cancel the post event anytime if necessary.
    private Runnable mSetErrorRunnable;
    ...
    public TextView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        mHwTextView = HwWidgetFactory.getHwTextView(context, this, attrs);
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        mText = "";
        ...
        /*HQ_xupeixin at 2015-09-30 modified about resolve the typeface settings crash begin*/
        try {
            File file = new File("/data/skin/fonts/DroidSansChinese.ttf");
            if (file.exists()) {
                Typeface typeface = Typeface.createFromFile(file);
                if (typeface == null) {
                    Log.d(LOG_TAG, "DroidSansChinese.ttf is not fond");
                    setTypefaceFromAttrs(fontFamily, typefaceIndex, styleIndex);
                } else {
            ...
            Log.d(LOG_TAG, "RuntimeException");
            setTypefaceFromAttrs(fontFamily, typefaceIndex, styleIndex);
        }
        /*HQ_xupeixin at 2015-09-30 modified end*/
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        if (mHwTextView != null) {
            mHwTextView.initTextViewAddtionalStyle(context,  attrs, this, mEditor);
        }
        /*< DTS2014101007196 guyue/00295151 20141106 end*/
    }
    ...
    private void setTypefaceFromAttrs(String familyName, int typefaceIndex, int styleIndex) {
        Typeface tf = null;
        if (familyName != null) {
            /* < DTS2014102204524 xuxuefei/00258670 20141015 begin */
            /*< DTS2014071603257 zhaifeng/00107904 20140716 begin */
            if (HwThemeManager.shouldUseAdditionalChnFont(familyName)) {
                tf = Typeface.CHNFZSLIM;
            } else {
                if (!HwThemeManager.isTargetFamily(familyName)) {
                    tf = Typeface.create(familyName, styleIndex);
                }
            }
            /* DTS2014071603257 zhaifeng/00107904 20140716 end >*/
            /* DTS2014102204524 xuxuefei/00258670 20141015 end > */
            if (tf != null) {
                setTypeface(tf);
                return;
            }
    ...
    public void setTextAppearance(Context context, int resid) {
        ...
        //jiangchao add for HQ01308424 start
        try {
            Typeface typeface = Typeface.createFromFile("data/skin/fonts/DroidSansChinese.ttf");
                         if (typeface == null) {
               Log.d(LOG_TAG, "DroidSansChinese.ttf is not fond");
                           setTypefaceFromAttrs(familyName, typefaceIndex, styleIndex);
                      } else {
             ...
             Log.d(LOG_TAG, "RuntimeException");
                ...
                //jiangchao add for HQ01308424 end
         //setTypefaceFromAttrs(fontFamily, typefaceIndex, styleIndex);
            //jiangchao add for HQ01308424 end
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (ss.error != null) {
            ...
            /// M: Keep the runnable as a variable, then we can cancel it if necessary
            mSetErrorRunnable = new Runnable() {
                public void run() {
                    setError(error);
                    mSetErrorRunnable = null;
                }
            };
            post(mSetErrorRunnable);
        }
    }
    ...
    public final void setText(CharSequence text) {
        /*< DTS2014112002878 tantailong/00296178 20150115 begin*/
        String  curr_lang = Locale.getDefault().getLanguage();
        String  curr_country = Locale.getDefault().getCountry();
        if(curr_lang.contains("en")&&curr_country.contains("US")){
            CharSequence cts_text = "\u1019\u102f\u102d";
            if(cts_text.equals(text))
               text = "\u1013\u102d\u102f";
        }
        /* DTS2014112002878 tantailong/00296178 20150115 end>*/
    ...
    public void setError(CharSequence error) {
        /// M: If an old set error posted event is found, cancel it.
        if (mSetErrorRunnable != null) {
            removeCallbacks(mSetErrorRunnable);
        }
        ...
        if (error == null) {
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            /*< DTS2014050806536 taolan/00264981 20140524 begin */
            if (mHwTextView != null) {
                mHwTextView.setError(this, getContext(), error);
            } else {
            ...
            /* DTS2014050806536 taolan/00264981 20140524 end>*/
            /*< DTS2014101007196 guyue/00295151 20141106 end*/
        }
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final int top = mTop;
        /*HQ_yulifeng add HQ01401362, 201501126,start*/
        //final boolean isLayoutRtl = isLayoutRtl();
        final boolean isLayoutRtl = (mTextViewDerection == Layout.DIR_LEFT_TO_RIGHT)?false:true;
        final int offset = getHorizontalOffsetForDrawables();
        //final int leftOffset = isLayoutRtl ? 0 : offset;
        //final int rightOffset = isLayoutRtl ? offset : 0 ;
        final int leftOffset = isRtlLocale() ? 0 : offset;
        final int rightOffset = isRtlLocale() ? offset : 0 ;
        /*HQ_yulifeng add HQ01401362, 201501126,end*/
        ...
        */
        ...
        final int layoutDirection = (mTextViewDerection == Layout.DIR_LEFT_TO_RIGHT)?LAYOUT_DIRECTION_LTR:LAYOUT_DIRECTION_RTL;
        /*HQ_yulifeng add HQ01401362, 201501126,end*/
        ...
        if (mMarquee != null && mMarquee.shouldDrawGhost()) {
            ...
            /*HQ_yulifeng add HQ01401362, 201501126*/
            //canvas.translate(layout.getParagraphDirection(0) * dx, 0.0f);
            canvas.translate(isLayoutRtl ? -dx : +dx, 0.0f);
            layout.draw(canvas, highlight, mHighlightPaint, cursorOffsetVertical);
        }
    ...
    public boolean onKeyPreIme(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            boolean isInSelectionMode = mEditor != null && mEditor.isInSelectionActionMode();
    ...
    private int doKeyDown(int keyCode, KeyEvent event, KeyEvent otherEvent) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_BACK:
                /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                if (mEditor != null && mEditor.isInSelectionActionMode()) {
                /*< DTS2014101007196 guyue/00295151 20141106 end*/
                    stopSelectionActionMode();
                    return -1;
                }
    ...
    public void setExtractedText(ExtractedText text) {
        ...
        if (text.text != null) {
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            /* < DTS2014042104022 zhangxinming/00181848 20140421 begin */
            ignoreTextChange();
            /*   DTS2014042104022 zhangxinming/00181848 20140421 end > */
            /*< DTS2014101007196 guyue/00295151 20141106 end*/
            if (content == null) {
            ...
            case TEXT_ALIGNMENT_GRAVITY:
                switch (mGravity & Gravity.RELATIVE_HORIZONTAL_GRAVITY_MASK) {
                    case Gravity.START:
                        ...
                        alignment = isRtlLocale()? Layout.Alignment.ALIGN_RIGHT : Layout.Alignment.ALIGN_NORMAL;
                        break;
                    case Gravity.END:
                        //alignment = Layout.Alignment.ALIGN_OPPOSITE;
                        alignment = isRtlLocale()? Layout.Alignment.ALIGN_LEFT : Layout.Alignment.ALIGN_OPPOSITE;
						/*HQ_yulifeng add HQ01401362, 201501126,end*/
                        break;
                    case Gravity.LEFT:
    ...
    */
    ...
    private boolean bringTextIntoView() {
        ...
        int dir = mTextViewDerection = layout.getParagraphDirection(line);
    ...
    TextDirectionHeuristic getTextDirectionHeuristic() {
        if (hasPasswordTransformationMethod()) {
            ...
            /*< DTS2014122003015 wuchengyu-WX238930 20141224 begin*/
		if (isRtlLocale()) {
		return TextDirectionHeuristics.FIRSTSTRONG_LTR;
		}
	    /* DTS2014122003015 wuchengyu-WX238930 20141224 end>*/
        ...
        switch (getTextDirection()) {
            default:
            case TEXT_DIRECTION_FIRST_STRONG://HQ_sunli 20151126 HQ01528794
                return (defaultIsRtl ? TextDirectionHeuristics.ANYRTL_LTR :
    ...
    private void createEditorIfNeeded() {
        if (mEditor == null) {
            if (mHwTextView != null) {
                mEditor = mHwTextView.getEditor(this);
            } else {
    ...
    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
    /*< DTS2013121107644 tianjing/00102012 20131203 begin*/
    /* < DTS2014032707325 zhangxinming/00181848 20140327 begin */
    public void reLayoutAfterMeasure() {
    /*   DTS2014032707325 zhangxinming/00181848 20140327 end > */
        if (mHwTextView != null) {
            mHwTextView.reLayoutAfterMeasure(this, mLayout);
        }
    }
    ...
    */
    ...
    protected void ignoreTextChange() {
        if (null != mEditor) {
            mEditor.ignoreTextChange();
        }
    }
    /*   DTS2014042104022 zhangxinming/00181848 20140421 end > */
    /* DTS2013121107644 tianjing/00102012 20131203 end>*/
    /* < DTS2014061008065 liuyang/00281952 20140611 begin */
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mTrySelectAllAndShowEditor && !mSelectAllAndShowEditorDone) {
            selectAllAndShowEditor();
            mSelectAllAndShowEditorDone = true;
        }
    }

    public void trySelectAllAndShowEditor() {
        mTrySelectAllAndShowEditor = true;
    }

    protected void selectAllAndShowEditor() {
        if (mEditor != null) {
            mEditor.selectAllAndShowEditor();
        }
    }
    ...
    /* DTS2014061008065 liuyang/00281952 20140611 end >*/
    /* < DTS2014082002187 zhangxinming/00181848 20140903 begin */
    public void setEditorHideFlag(int flag) {
        if (null != mEditor) {
            mEditor.setEditorHideFlag(flag);
        }
    }
    /*   DTS2014082002187 zhangxinming/00181848 20140903 end > */
    public Layout getHintLayoutOuter() {
        return getHintLayout();
    }

    public void setRawTextSizeOuter(float size) {
        setRawTextSize(size);
    }

    public void nullLayoutsOuter() {
        nullLayouts();
    }

    public int viewportToContentHorizontalOffsetOuter() {
        return viewportToContentHorizontalOffset();
    }

    public int viewportToContentVerticalOffsetOuter() {
        return viewportToContentVerticalOffset();
    }

    public void createEditorIfNeededOuter() {
        createEditorIfNeeded();
    }
    ...
    public void setTextSelectHandleRes(int leftRes, int midRes, int rightRes) {
        mTextSelectHandleLeftRes = leftRes;
        mTextSelectHandleRes = midRes;
        mTextSelectHandleRightRes = rightRes;
    }
    /*< DTS2014101007196 guyue/00295151 20141106 end*/
