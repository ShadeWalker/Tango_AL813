...
public class RelativeLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isLayoutRtl() && myWidth == -1) {
            if (sDebugLayout) {
                Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Pass.1 (RtL), this=" + this);
            }
            myWidth = DEFAULT_WIDTH;
            if (sDebugLayout) {
                Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] - Pass.1, this=" + this
        ...
        if (sDebugLayout) {
            Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Pass.2 (Horizontal measure), this=" + this);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                if (sDebugLayout) {
                    Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Child in Pass2: " + i
                ...
                if (sDebugRule) {
                    Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Child_horizontal: i = " + i + ", "
        ...
        if (sDebugLayout) {
            Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] - Pass.2, this=" + this);
        ...
        if (sDebugLayout) {
           Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Pass.3 (Vertical measure), this=" + this);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                if (sDebugLayout) {
                    Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Child in Pass3: " + i
                            + ", child=" + child + ", this=" + this);
                }
                LayoutParams params = (LayoutParams) child.getLayoutParams();

                if (sDebugRule) {
                    Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Child_vertical: i = " + i + ", "
                            + "params(L,R,T,B) = " + params.mLeft + "," + params.mRight + ","
                            + params.mTop + "," + params.mBottom + ", "
                            + "params(width,height) = " + params.width + " , " + params.height
                            + ", " + "child = " + child + ", this = " + this);
        ...
        if (sDebugLayout) {
            Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] - Pass.3, this=" + this + ", "
        ...
        if (mHasBaselineAlignedChild) {
            if (sDebugLayout) {
                Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Pass.4 (HasBaselineAlignedChild), this="
                        + this);
            }
            for (int i = 0; i < count; i++) {
            ...
            if (sDebugLayout) {
                Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] - Pass.4, this= " + this + ", "
        ...
        if (isWrapContentWidth) {
            if (sDebugLayout) {
               Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Pass.5 (WrapContentWidth), this=" + this);
            }
            ...
            if (sDebugLayout) {
                Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] - Pass.5, this=" + this + ", width=" + width
                        + ", height=" + height);
        ...
        if (isWrapContentHeight) {
            if (sDebugLayout) {
                Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] + Pass.6 (WrapContentHeight), this="
                        + this);
            }
            ...
            if (sDebugLayout) {
                Xlog.d(DEBUG_LOG_TAG, "[RelativeLayout] - Pass.6, this=" + this
