...
import libcore.icu.LocaleData;//HQ_hushunli 2016-03-16 add for HQ01809152
...
public class DatePicker extends FrameLayout {
    ...
    private static class DatePickerSpinnerDelegate extends AbstractDatePickerDelegate {
        ...
        DatePickerSpinnerDelegate(DatePicker delegator, Context context, AttributeSet attrs,
            ...
            OnValueChangeListener onChangeListener = new OnValueChangeListener() {
                ...
                if (!mDelegator.hwValueChange(picker, oldVal, newVal)) {
        ...
        protected void setCurrentLocale(Locale locale) {
            ...
            /* HQ_hushunli 2016-03-16 add for HQ01809152 begin */
            //mShortMonths = new DateFormatSymbols().getShortMonths();
            LocaleData localeData = LocaleData.get(locale);
            mShortMonths = localeData.shortStandAloneMonthNames;
            /* HQ_hushunli 2016-03-16 add for HQ01809152 end*/
    ...
    protected LinearLayout getSpinners() {
      if(mDelegate instanceof DatePickerSpinnerDelegate)
         return ((DatePickerSpinnerDelegate)mDelegate).mSpinners;
      return null;
    }

    protected NumberPicker getDaySpinner() {
      if(mDelegate instanceof DatePickerSpinnerDelegate)
         return ((DatePickerSpinnerDelegate)mDelegate).mDaySpinner;
      return null;
    }

    protected NumberPicker getMonthSpinner() {
      if(mDelegate instanceof DatePickerSpinnerDelegate)
         return ((DatePickerSpinnerDelegate)mDelegate).mMonthSpinner;
      return null;
    }

    protected NumberPicker getYearSpinner() {
      if(mDelegate instanceof DatePickerSpinnerDelegate)
         return ((DatePickerSpinnerDelegate)mDelegate).mYearSpinner;
      return null;
    }

    protected Calendar getTempDate() {
      if(mDelegate instanceof DatePickerSpinnerDelegate)
         return ((DatePickerSpinnerDelegate)mDelegate).mTempDate;
      return null;
    }
    /* DTS2014111204149 liuyang/00281952 20141112 end > */
}
