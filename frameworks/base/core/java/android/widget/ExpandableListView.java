...
public class ExpandableListView extends ListView {
    ...
    private void resolveChildIndicator() {
         /* <DTS2014022204796 yangbo 00108674 20140303 begin*/
        final boolean isLayoutRtl = isRtlLocale();
        /* DTS2014022204796 yangbo 00108674 20140303 end>*/
        if (isLayoutRtl) {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        /* DTS2014022204796 yangbo 00108674 20140303 end>*/
            ...
            if (pos.position.type != lastItemType) {
                ...
                /* <DTS2014121400079 chenjintao/00204658 20141222 begin*/
                if (isLayoutRtl && mIndicatorStart != 0 && mGroupIndicator != null) {
                    indicatorRect.left = mIndicatorStart;
                    indicatorRect.right = mIndicatorStart + mGroupIndicator.getIntrinsicWidth();
                }
                /* DTS2014121400079 chenjintao/00204658 20141222 end>*/
                /* <DTS2014101007196 guyue/00295151 20141106 begin*/
                if (isLayoutRtl ^ isEmuiStyle()) {  // EMUI and not arabic || not EMUI and arabic
                /* DTS2014101007196 guyue/00295151 20141106 end>*/
    ...
    /* <DTS2014101007196 guyue/00295151 20141106 begin*/
    private boolean isEmuiStyle() {
        android.util.TypedValue tv = new android.util.TypedValue();
        getContext().getTheme().resolveAttribute(com.android.internal.R.attr.themeOfEmui, tv, true);
        return tv.type == 1;
    }
    /* DTS2014101007196 guyue/00295151 20141106 end>*/
}
