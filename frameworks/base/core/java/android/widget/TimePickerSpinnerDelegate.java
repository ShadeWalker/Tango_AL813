...
class TimePickerSpinnerDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    public TimePickerSpinnerDelegate(TimePicker delegator, Context context, AttributeSet attrs,
        ...
        mMinuteSpinner.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
            public void onValueChange(NumberPicker spinner, int oldVal, int newVal) {
              /* < DTS2015033102909 guyue/00295151 20150408 begin */
                if (!mDelegator.hwValueChange()) {
                updateInputState();
                ...
                /* DTS2015033102909 guyue/00295151 20150408 > */
            }
        });
        ...
        if (isAmPmAtStart()) {
            ...
            /* < DTS2015033102909 guyue/00295151 20150408 begin */
            mDelegator.updateAmPmStart(amPmParent);
            /* DTS2015033102909 guyue/00295151 20150408 end > */
    ...
    private boolean isAmPmAtStart() {
        final String bestDateTimePattern = DateFormat.getBestDateTimePattern(mCurrentLocale,
                "hm" /* skeleton */);
        /* < DTS2015033102909 guyue/00295151 20150408 begin */
        // and arabic and hebrew script locales.
        final Locale defaultLocale = Locale.getDefault();
        return bestDateTimePattern.startsWith("a")
                ||(android.text.TextUtils.getLayoutDirectionFromLocale(defaultLocale)==View.LAYOUT_DIRECTION_RTL);
        /* DTS2015033102909 guyue/00295151 20150408 end > */
    }
    ...
    public static String[] getAmPmStrings(Context context) {
        ...
        /* HQ_zhangpeng5 2015-11-09 modified for Malay's UI change HQ01457489 begin */
        String locale = Locale.getDefault().getLanguage();
        if(locale.equals("ms")){
            result[1] = d.amPm[1];
        }else if(locale.equals("bg") || locale.equals("my") || locale.equals("el") || locale.equals("nb") || locale.equals("ro") || locale.equals("si") || locale.equals("fa") || locale.equals("lt") || locale.equals("iw")) {   //HQ_zhangpeng5 2015-11-09 modified for modified for bulgarian's UI change HQ01430241
            result[0] = d.amPm[0];
            result[1] = d.amPm[1];
        }
        /* HQ_zhangpeng5 2015-11-09 modified for Malay's UI change HQ01457489 end */
        return result;
    }
