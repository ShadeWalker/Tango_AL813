...
public class AppSecurityPermissions {
    ...
    public static class PermissionItemView extends LinearLayout implements View.OnClickListener {
        ...
        public void setPermission(MyPermissionGroupInfo grp, MyPermissionInfo perm,
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            permGrpIcon = (ImageView) PermissionInformation.getPermissionImageView(mContext, this);
            permNameView = (TextView) PermissionInformation.getPermissionTextView(mContext, this);
            //PackageManager pm = getContext().getPackageManager();
            Drawable icon = null;
            if (first) {
                icon = mContext.getResources().getDrawable(R.drawable.ic_text_dot);
                /* DTS2014101007196 guyue/00295151 20141106 end>*/
            }
        ...
        public void onClick(View v) {
            if (mGroup != null && mPerm != null) {
                ...
                /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                PermissionInformation.setPositiveButton(getContext(), builder, mDialog);
                /* DTS2014101007196 guyue/00295151 20141106 end>*/
    ...
    private static PermissionItemView getPermissionItemView(Context context, LayoutInflater inflater,
            ...
            PermissionItemView permView = (PermissionItemView)inflater.inflate(
                ...
                null);
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            permView = PermissionInformation.getHwPermItemView(context, (perm.flags & PermissionInfo.FLAG_COSTS_MONEY) != 0, inflater);
            /* DTS2014101007196 guyue/00295151 20141106 end>*/
    ...
    private static View getPermissionItemViewOld(Context context, LayoutInflater inflater,
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        permView = PermissionInformation.getPermissionItemViewOld(context, inflater);
        /* DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        permGrpView = PermissionInformation.getPermissionItemViewOldPermGrpView(context, permView);
        permDescView = PermissionInformation.getPermissionItemViewOldPermDescView(context, permView);
        imgView = PermissionInformation.getPermissionItemViewOldImgView(context, permView);
        /* DTS2014101007196 guyue/00295151 20141106 end>*/
