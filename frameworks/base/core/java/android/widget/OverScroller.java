...
/* < DTS2014060903218 yinwenshuai/00211458 20140609 begin */
import android.hwcontrol.HwWidgetFactory;
import android.widget.IHwSplineOverScroller;
/* DTS2014060903218 yinwenshuai/00211458 20140609 end > */
...
public class OverScroller {
    ...
    public IHwSplineOverScroller getIHwSplineOverScroller() {
        return mScrollerY.mIHwSplineOverScrollerInner;
    }
    ...
    /* DTS2014101007196 guyue/00295151 20141106 end > */
        ...
        // Whether the scroller is fling indeed
        /*<DTS2014112601808 huangwen 00181596 20141126 begin */
        ...
        SplineOverScroller(Context context) {
            ...
            mPhysicalCoeff = SensorManager.GRAVITY_EARTH // g (m/s^2)
             ...
             /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            /* <DTS2014052605401 wangshuoxing 00185953 20140610 begin */
            /* < DTS2014060903218 yinwenshuai/00211458 20140609 begin */
            mIHwSplineOverScrollerInner = HwWidgetFactory.getHwSplineOverScroller(this, context);
            /* DTS2014060903218 yinwenshuai/00211458 20140609 end > */
            /* DTS2014052605401 wangshuoxing 00185953 20140610 end> */
            /*< DTS2014101007196 guyue/00295151 20141106 end*/
        }
        ...
        void finish() {
            ...
            if (mFlinging) {
                mFlinging = false;
                LogPower.push(LogPower.FLING_FINISH);
            }
            /* DTS2014112601808 huangwen 00181596 20141126 end>*/
        ...
        private void startSpringback(int start, int end, int velocity) {
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            /* <DTS2014052605401 wangshuoxing 00185953 20140610 begin */
            mDuration = mIHwSplineOverScrollerInner.getCubicDuration(mDuration);
            /* DTS2014052605401 wangshuoxing 00185953 20140610 end> */
             /*< DTS2014101007196 guyue/00295151 20141106 end*/
        }
        ...
        void fling(int start, int velocity, int min, int max, int over) {
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            /* < DTS2014060903218 yinwenshuai/00211458 20140609 begin */
            mIHwSplineOverScrollerInner.resetLastDistanceValue(0, 0);
            /* DTS2014060903218 yinwenshuai/00211458 20140609 end > */
            /*< DTS2014101007196 guyue/00295151 20141106 end*/
            ...
            if (velocity != 0) {
                ...
                /*<DTS2014112601808 huangwen 00181596 20141126 begin */
                mFlinging = true;
                LogPower.push(LogPower.FLING_START, Integer.toString(mDuration), Double.toString(totalDistance));
                /* DTS2014112601808 huangwen 00181596 20141126 end>*/
            }
        ...
        private void onEdgeReached() {
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            /* <DTS2014052605401 wangshuoxing 00185953 20140610 begin */
            mVelocity = mIHwSplineOverScrollerInner.adjustBallisticVelocity(mVelocity, mDeceleration, mOver);
            /* DTS2014052605401 wangshuoxing 00185953 20140610 end> */
            /*< DTS2014101007196 guyue/00295151 20141106 end*/
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            /* <DTS2014052605401 wangshuoxing 00185953 20140610 begin */
            mDuration = mIHwSplineOverScrollerInner.getBallisticDuration(mDuration);
            /* DTS2014052605401 wangshuoxing 00185953 20140610 end> */
            /*< DTS2014101007196 guyue/00295151 20141106 end*/
        }
        ...
        boolean update() {
            ...
            switch (mState) {
                case SPLINE: {
                    ...
                    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                    /* < DTS2014060903218 yinwenshuai/00211458 20140609 begin */
                    distance = mIHwSplineOverScrollerInner.adjustDistance(distance);
                    /* DTS2014060903218 yinwenshuai/00211458 20140609 end > */
                    /*< DTS2014101007196 guyue/00295151 20141106 end*/
                    break;
                }
                ...
                case BALLISTIC: {
                    ...
                    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                    /* <DTS2014052605401 wangshuoxing 00185953 20140610 begin */
                    distance = mIHwSplineOverScrollerInner.getBallisticDistance(distance, mStart, mFinal, mDuration, currentTime);
                    /* DTS2014052605401 wangshuoxing 00185953 20140610 end> */
                    /*< DTS2014101007196 guyue/00295151 20141106 end*/
                    break;
                }
                ...
                case CUBIC: {
                    ...
                    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                    /* <DTS2014052605401 wangshuoxing 00185953 20140610 begin */
                    distance = mIHwSplineOverScrollerInner.getCubicDistance(distance, mStart, mFinal, mDuration, currentTime);
                    /* DTS2014052605401 wangshuoxing 00185953 20140610 end> */
                    /*< DTS2014101007196 guyue/00295151 20141106 end*/
                    break;
                }
