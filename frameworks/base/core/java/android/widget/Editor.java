...
public class Editor {
    ...
    /* < DTS2014092808206 zhangxinming/00181848 20141205 begin */
    protected boolean isOffsetVisible(int offset) {
    /*   DTS2014092808206 zhangxinming/00181848 20141205 end > */
    ...
    public boolean performLongClick(boolean handled) {
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        if (!handled && isInSelectionActionMode()) {
        /*DTS2014101007196 guyue/00295151 20141106 end>*/
    ...
    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
    protected void sendOnTextChanged(int start, int after) {
    /* DTS2014101007196 guyue/00295151 20141106 end>*/
	...
	Log.v(TextView.LOG_TAG, "startSelectionActionMode()");
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        /* < DTS2014092808206 zhangxinming/00181848 20141205 begin */
        if (isInSelectionActionMode() && isSelectedAll()) {
        /*   DTS2014092808206 zhangxinming/00181848 20141205 end > */
        /*DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        setSelectionActionMode(willExtract);
        final boolean selectionStarted = isInSelectionActionMode() || willExtract;
        /* DTS2014101007196 guyue/00295151 20141106 end>*/
    ...
    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
    protected void onTouchUpEvent(MotionEvent event) {
    /*DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        if (!selectAllGotFocus && text.length() > 0) {
            ...
            if (!extractedTextModeWillBeStarted()) {
                if (isCursorInsideEasyCorrectionSpan()) {
                    ...
                    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                    showInsertionController(offset);
                    /* DTS2014101007196 guyue/00295151 20141106 end>*/
                }
            }
        }
    ...
    private class PositionListener implements ViewTreeObserver.OnPreDrawListener {
        ...
        public boolean onPreDraw() {
            updatePosition();
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            //Force the scroll to changed,then refresh some position.
            //in case of the TextView has included in ScrollView(e.g. NotePad)
            //the onScrollChanged has dealed in ScrollView but not delivered to TextView
    ...
    private abstract class PinnedPopupWindow implements TextViewPositionListener {
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        protected void updatePosition(int parentPositionX, int parentPositionY) {
        /* DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        protected void computeLocalPositionOuter() {
            computeLocalPosition();
        }
        /* DTS2014101007196 guyue/00295151 20141106 end>*/
    }
    ...
    /* DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        protected int clipVertically(int positionY) {
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        final int satusBarHeight =
                mTextView.getResources().getDimensionPixelSize(com.android.internal.R.dimen.status_bar_height);
            if (positionY - satusBarHeight< 0) {
        /* DTS2014101007196 guyue/00295151 20141106 end>*/
                final int offset = getTextOffset();
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        protected TextView getPasteTextView() {
            return mPasteTextView;
        }

        protected void setPasteTextView(TextView tv) {
            mPasteTextView = tv;
        }

        protected TextView getReplaceTextView() {
            return mReplaceTextView;
        }

        protected void setReplaceTextView(TextView tv) {
            mReplaceTextView = tv;
        }
    ...
    /* DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        protected final PopupWindow mContainer; // too many if private
        // Position with respect to the parent TextView
        protected int mPositionX, mPositionY; // too many if private
        protected boolean mIsDragging;
        // Offset from touch position to mPosition
        protected float mTouchToWindowOffsetX, mTouchToWindowOffsetY;
        ...
        protected int mLastParentX, mLastParentY;
        ...
        void showActionPopupWindow(int delay) {
            if (mActionPopupWindow == null) {
                /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                mActionPopupWindow = createActionPopupWindow();
                /* DTS2014101007196 guyue/00295151 20141106 end>*/
            }
        ...
        protected void positionAtCursorOffset(int offset, boolean parentScrolled) {
            ...
            if (offsetChanged || parentScrolled) {
                ...
                /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                mPositionY = getPositionYByLine(layout, line);
                /* DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        protected void onDraw(Canvas c) {
            ...
            /* < DTS2014112508674 zhangxinming/00181848 20141201 begin */
            mDrawable.setBounds(left, 0, left + drawWidth, getDesignHandleHeight());
            /*   DTS2014112508674 zhangxinming/00181848 20141201 end > */
            mDrawable.draw(c);
        }
        ...
        public boolean onTouchEvent(MotionEvent ev) {
            switch (ev.getActionMasked()) {
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    /* < DTS2014120202763 zhangxinming/00181848 20141208 begin */
                    final float newPosY = rawY - mTouchToWindowOffsetY + mTouchOffsetY + getMovePositionY();
                    /*   DTS2014120202763 zhangxinming/00181848 20141208 end > */
        ...
        protected int getPositionYByLine(Layout layout, int line) {
        ...
        protected float getIdealVerticalOffset() {
            return mIdealVerticalOffset;
        }
        protected void addPositionToTouchUpFilterOuter(int offset) {
            addPositionToTouchUpFilter(offset);
        }
        protected void showActionPopupWindowOuter(int delay) {
            showActionPopupWindow(delay);
        }
        protected void onHandleMovedOuter() {
            onHandleMoved();
        }
        /* < DTS2014112508674 zhangxinming/00181848 20141201 begin */
        protected int getDesignHandleHeight() {
    ...
    public class InsertionHandleView extends HandleView {
        ...
        public void show() {
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            if (mAddtionConfig.mUseCustomStyle || durationSinceCutOrCopy < RECENT_CUT_COPY_DURATION) {
            /* DTS2014101007196 guyue/00295151 20141106 end>*/
    ...
    /* DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        private InsertionHandleView getHandle() {
            ...
            if (mHandle == null) {
                /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                mHandle = mTextView.getEditor().getInsertionHandleView(mSelectHandleCenter);
                /* DTS2014101007196 guyue/00295151 20141106 end>*/
            }
            return mHandle;
        }
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        public InsertionHandleView getHandleOuter() {
            return getHandle();
        }
    }
    ...
    /* DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        private void initHandles() {
            ...
            if (mStartHandle == null) {
                /*< DTS2014101007196 guyue/00295151 20141106 begin*/
                mStartHandle =  mTextView.getEditor().getSelectionStartHandleView(mSelectHandleLeft, mSelectHandleRight);
            }
            if (mEndHandle == null) {
                mEndHandle =  mTextView.getEditor().getSelectionEndHandleView(mSelectHandleRight, mSelectHandleLeft);
                /* DTS2014101007196 guyue/00295151 20141106 end>*/
            }
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        public SelectionStartHandleView getStartHandle() {
            return mStartHandle;
        }

        public SelectionEndHandleView getEndHandle() {
            return mEndHandle;
        }
        /*   DTS2014032707325 zhangxinming/00181848 20140327 end > */

        /* < DTS2014102202787 yinwenshuai/00211458 20141030 begin */
        public void setMinTouchOffset(int minTouchOffset) {
            mMinTouchOffset = minTouchOffset;
        }

        public void setMaxTouchOffset(int maxTouchOffset) {
            mMaxTouchOffset = maxTouchOffset;
        }
        /* DTS2014101007196 guyue/00295151 20141106 end>*/
    }
    ...
    /* <DTS2014101007196 guyue/00295151 20141106 begin*/
    protected InsertionPointCursorController getInsertionControllerDirectly() {
        return mInsertionPointCursorController;
    }

    protected SelectionModifierCursorController getSelectionControllerDirectly() {
        return mSelectionModifierCursorController;
    }

    protected SelectionModifierCursorController getSelectionControllerOuter() {
        return getSelectionController();
    }

    protected ActionMode getSelectionActionMode() {
        return mSelectionActionMode;
    }

    protected Rect getTempRect() {
        return mTempRect;
    }

    protected void setTempRect(Rect rect) {
        mTempRect = rect;
    }

    protected void prepareCursorControllersOuter() {
        prepareCursorControllers();
    }

    protected void hideControllersOuter() {
        hideControllers();
    }

    protected boolean canSelectTextOuter() {
        return canSelectText();
    }

    protected boolean selectCurrentWordOuter() {
        return selectCurrentWord();
    }

    protected long getCharRangeOuter(int offset) {
        return getCharRange(offset);
    }

    protected boolean isPositionVisibleOuter(int positionX, int positionY) {
        return isPositionVisible(positionX, positionY);
    }

    public long getLastTouchOffsetsOuter() {
        return getLastTouchOffsets();
    }

    protected void ensureEndedBatchEditOuter() {
        ensureEndedBatchEdit();
    }

    protected float getPrimaryHorizontalOuter(Layout layout, Layout hintLayout, int offset,
            boolean clamped) {
        return getPrimaryHorizontal(layout, hintLayout, offset, clamped);
    }

    protected boolean startSelectionActionModeOuter() {
        return startSelectionActionMode();
    }

    protected boolean isCursorInsideSuggestionSpanOuter() {
        return isCursorInsideSuggestionSpan();
    }

    protected boolean hasSelectionControllerOuter() {
        return hasSelectionController();
    }

    protected void setSelectionActionMode(boolean willExtract) {
        if (!willExtract) {
    ...
    protected boolean canSelectAll() {
        if (mTextView != null) {
            return mTextView.canSelectAll();
        } else {
            return false;
        }
    }

    public void setAddtionalConfig(EditTextAddtionConfig config) {
        mAddtionConfig = config;
    }
    /* < DTS2014112508674 zhangxinming/00181848 20141201 begin */
    protected boolean isInSelectionActionMode() {
    /*   DTS2014112508674 zhangxinming/00181848 20141201 end > */
         return (mSelectionActionMode != null);
    }
    protected ActionPopupWindow createActionPopupWindow() {
        return new ActionPopupWindow();
    }
    public static class EditTextAddtionConfig {
        public boolean mUseCustomStyle = false;
        public int mMinTextSizeInPopup;
        public int mMaxViewWidthInPopup;
        public int mMinViewWidthInPopup;
        public int mMaxWindowWidthInPopup;
        public int mCustomPopupPadding;
        public int mTextDividerRes;
        public int mTextBackgroundRes;
        public int mTextBackgroundLeftRes;
        public int mTextBackgroundRightRes;
        public int mTextBackgroundMediumRes;
        public int mTextBackgroundSingleRes;
    }

    /* < DTS2014092808206 zhangxinming/00181848 20141205 begin */
    //delete mIsSelectedAll
    /*   DTS2014092808206 zhangxinming/00181848 20141205 end > */
    public EditTextAddtionConfig mAddtionConfig = new EditTextAddtionConfig();
    //moved to HwEditor.java
    ...
    public InsertionHandleView getInsertionHandleView(Drawable selectHandleCenter) {
        return new InsertionHandleView(selectHandleCenter);
    }
    public SelectionStartHandleView getSelectionStartHandleView(Drawable selectHandleLeft, Drawable selectHandleRight) {
        return new SelectionStartHandleView(selectHandleLeft, selectHandleRight);
    }
    public SelectionEndHandleView getSelectionEndHandleView(Drawable selectHandleRight, Drawable selectHandleLeft) {
        return new SelectionEndHandleView(selectHandleRight, selectHandleLeft);
    }
    protected void showInsertionController(int offset) {
        //hook, override at HwEditor
        showInsertionController();
    }

    protected void showInsertionController() {
        if (getInsertionController() != null) {
            getInsertionController().show();
        }
    }

    protected void ignoreTextChange() {
        //hook, override at HwEditor
    }
    protected boolean mExitFromExtractEditText = false;
    protected void hideErrorIfNeed() {
        if (mError != null) {
            hideError();
        }
    }
    ...
    protected boolean isInBatchEditMode() {
        return mTextView != null && mTextView.isInBatchEditMode();
    }
    public void setEditorHideFlag(int flag) {
        //hook
    }
    /* DTS2014101007196 guyue/00295151 20141106 end>*/
}
