...
public class ActionMenuView extends LinearLayout implements MenuBuilder.ItemInvoker, MenuView {
    ...
    protected void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
    /* DTS2014101007196 guyue/00295151 20141106 end > */
        ...
        final int childCount = getChildCount();
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        // Pre-reserve a cell for Option Menu to avoid of
        // last ActionMenuItemView being overlapped with it.
        for (int i = 0; i < childCount; i++) {
     ...
     */
     /* < DTS2014101007196 guyue/00295151 20141106 begin */
    protected static int measureChildForCells(View child, int cellSize, int cellsRemaining,
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (p.isOverflowButton) {
                ...
                hasOverflow = true;
                /* < DTS2014101007196 guyue/00295151 20141106 begin */
                elimOverflowWidth = overflowWidth; 
                /* DTS2014101007196 guyue/00295151 20141106 end > */
            } else {
        ...
        if (isLayoutRtl) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                int t = midVertical - height / 2;
                /* < DTS2014101007196 guyue/00295151 20141106 begin */
                /*contrapose two view and one is overflow*/
                if (2 == childCount && hasOverflow && lp.expandable){
                    v.layout(startLeft, t, right - elimOverflowWidth, t + height); 
                    elimOverflowWidth = 0;
                } else {
    ...
    protected int getGeneratedItemPadding() {
        return mGeneratedItemPadding;
    }
/*
    protected void setMeasuredExtraWidth(int setmMeasuredExtraWidth) {
        mMeasuredExtraWidth = setmMeasuredExtraWidth;
    }

    protected int getMaxItemHeight() {
        return mMaxItemHeight;
    }

    protected void setMaxItemHeightDirect(int setmMaxItemHeight) {
        mMaxItemHeight = setmMaxItemHeight;
    }
*/
    /*< DTS2014101007196 guyue/00295151 20141106 end*/
}
