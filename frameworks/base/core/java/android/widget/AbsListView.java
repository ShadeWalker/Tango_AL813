...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher,
    ...
    private void setFastScrollerEnabledUiThread(boolean enabled) {
        if (mFastScroll != null) {
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            mFastScroll = (FastScroller)HwWidgetFactory.getHwFastScroller(this, mFastScrollStyle, mContext);
            /* DTS2014101007196 guyue/00295151 20141106 end >*/
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (mPendingSync != null) {
			...
			ss.viewHeight = mPendingSync.viewHeight;
        ...
        if (selectedId >= 0) {
			...
			ss.viewHeight = mSelectorRect.height();
            ...
            if (haveChildren && mFirstPosition > 0) {
                ...
                View v = getChildAt(0);
                ss.viewTop = v.getTop();
				ss.viewHeight = v.getMeasuredHeight();
    ...
    void resetList() {
        ...
        if (sDbgSelector) {
            Xlog.d(TAG, "mSelectorRect.setEmpty in resetList this=" + this,
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (sDbgLayout) {
            Xlog.d(TAG, "++onLayout mDataChanged=" + mDataChanged
    ...
    View obtainView(int position, boolean[] isScrap) {
        ...
        if (transientView != null) {
            ...
            if (params.viewType == mAdapter.getItemViewType(position)) {
                ...
                if (nowTime - logTime > DBG_TIMEOUT_VALUE) {
                    Xlog.d(TAG, "[ANR Warning] getView time too long, adapter = " + mAdapter
                            + ", position = " + position + ", updatedView = " + updatedView
                            + ", time = " + (nowTime - logTime));
                }

                if (sDbgLayout) {
                    Xlog.d(TAG, "obtainView1: position = " + position
        ...
        if (sDbgLayout) {
            Xlog.d(TAG, "obtainView2: position = " + position + ",scrapView = " + scrapView
    ...
    void updateSelectorState() {
        if (mSelector != null) {
            if (sDbgSelector) {
               Xlog.d(TAG, "updateSelectorState shouldShowSelector=" + shouldShowSelector()
    ...
    private class PerformClick extends WindowRunnnable implements Runnable {
        ...
        public void run() {
            ...
            Xlog.d(TAG, "PerformClick error mDataChanged = " + mDataChanged
                    + ", isAttachedToWindow = " + isAttachedToWindow() + ", adapter = " + adapter
                    + ", mItemCount = " + mItemCount + ", motionPosition = " + motionPosition
    ...
    private void scrollIfNeeded(int x, int y, MotionEvent vtev) {
        ...
        if (mTouchMode == TOUCH_MODE_SCROLL) {
            ...
            if (y != mLastY) {
                ...
                if (sDbgMotion) {
                    Xlog.d(TAG, "Touch scroll: incrementalDeltaY = " + incrementalDeltaY
            ...
            if (y != mLastY) {
                ...
                if (incrementalDeltaY != 0) {
                    if (sDbgMotion) {
                        Xlog.d(TAG, "Coming back to 'real' list scrolling: incrementalDeltaY = "
        ...
        case TOUCH_MODE_DONE_WAITING:
            ...
            if (child != null) {
                ...
                if (inList && !child.hasFocusable()) {
                     ...
                     */
                    Xlog.d(TAG, "Touch up out of list: mTouchMode = " + mTouchMode
                            + ", pressed = " + isPressed());
                    if (mTouchMode != TOUCH_MODE_DOWN) {
                        setPressed(false);
                        if (child != null) {
            ...
            if (childCount > 0) {
                ...
                if (mFirstPosition == 0 && firstChildTop >= contentTop &&
                    ...
                    final int initialVelocity = (int)
                        ...
                        Xlog.d(TAG, "Fling from scroll with initialVelocity = " + initialVelocity
    ...
    public boolean onInterceptHoverEvent(MotionEvent event) {
        if (sDbgMotion) {
            Xlog.d(TAG, "onInterceptHoverEvent: mFastScroll = "
                    + mFastScroll + ", this = " + this);
        }
        if (mFastScroll != null && mFastScroll.onInterceptHoverEvent(event)) {
            if (sDbgMotion) {
                Xlog.d(TAG, "FastScroller interceptHoverEvent: action = " + event.getAction()
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (sDbgMotion) {
            Xlog.d(TAG, "onInterceptTouchEvent: actionMasked = " + actionMasked
        ...
        if (mFastScroll != null && mFastScroll.onInterceptTouchEvent(ev)) {
            if (sDbgMotion) {
                Xlog.d(TAG, "FastScroller interceptTouchEvent: actionMasked = " + actionMasked
                        + ", x = " + ev.getX() + ", y = " + ev.getY()
                        + ", mTouchMode = " + mTouchMode + ", mFastScroll = " + mFastScroll
                        + ",this = " + this);
            }
    ...
    void reportScrollStateChange(int newState) {
        Xlog.d(TAG, "reportScrollStateChange: newState = " + newState
    ...
    /* DTS2014101007196 guyue/00295151 20141106 end>*/
        ...
        private final Runnable mCheckFlywheel = new Runnable() {
            ...
            public void run() {
                ...
                if (vt == null || activeId == INVALID_POINTER) {
                    Xlog.d(TAG, "Direct return : vt = " + vt + ",activeId = " + activeId
                            + ",mScrollY = " + mScrollY);
                    return;
                }
        ...
        void start(int initialVelocity) {
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            setStableItemHeight(mScroller, mFlingRunnable);
            /* DTS2014101007196 guyue/00295151 20141106 end >*/
        ...
        void edgeReached(int delta) {
            ...
            if(!hasSpringAnimatorMask()){
                ...
                mScroller.notifyVerticalEdgeReached(mScrollY, 0, (int)(0.25f*getHeight()));
            }
            /* DTS2014101007196 guyue/00295151 20141106 end>*/
            final int overscrollMode = getOverScrollMode();
            if (overscrollMode == OVER_SCROLL_ALWAYS ||
            ...
            case TOUCH_MODE_OVERFLING: {
                ...
                if (scroller.computeScrollOffset()) {
                    ...
                    if (overScrollBy(0, deltaY, 0, scrollY, 0, 0,
                        ...
                        if (sDbgMotion) {
                            Xlog.d(TAG, "FlingRunnable overScrollBy return false: mScrollY = "
    ...
    public void smoothScrollToPositionFromTop(int position, int offset, int duration) {
        if (sDbgMotion) {
            Xlog.d(TAG, "smoothScrollToPositionFromTop: position = " + position
    ...
    void smoothScrollBy(int distance, int duration, boolean linear) {
        ...
        if (distance == 0 || mItemCount == 0 || childCount == 0 ||
            ...
            Xlog.d(TAG, "smoothScrollBy: mScrollY = " + mScrollY + ",distance = " + distance
    ...
    boolean trackMotionScroll(int deltaY, int incrementalDeltaY) {
        ...
        if (!inTouchMode && mSelectedPosition != INVALID_POSITION) {
            ...
            mSelectorRect.setEmpty();
            if (sDbgSelector) {
                Xlog.d(TAG, "mSelectorRect.setEmpty in trackMotionScroll this = " + this,
    ...
    boolean resurrectSelection() {
        ...
        if (toPosition >= firstPosition && toPosition < firstPosition + childCount) {
			...
			selectedHeight = selected.getMeasuredHeight();
            ...
            if (toPosition < firstPosition) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (i == 0) {
                        ...
                        selectedTop = top;
						selectedHeight = v.getMeasuredHeight();
		...
		mSpecificHeight = selectedHeight;
        ...
        void addScrapView(View scrap, int position) {
            ...
            if (scrapHasTransientState) {
                ...
                if (scrapsCount > 0 && scrapsCount % DBG_OOM_VALUE == 0) {
                    Xlog.d(TAG, "[OOM warning] total = " + scrapsCount + ", scrap = " + scrap
                            + ", position = " + position
    ...
    boolean setDataChanged(boolean changed) {
        if (sDbgDataChange) {
            Xlog.d(TAG, "setDataChanged oldDataChanged=" + mDataChanged
    ...
    boolean setListLayoutMode(int mode) {
        if (sDbgLayout) {
            Xlog.d(TAG, "setListLayoutMode oldLayoutMode=" + mLayoutMode
                      + ", mLayoutMode=" + mode
                      + ", mSpecificTop=" + mSpecificTop
                      + ", mSyncPosition=" + mSyncPosition
                      + ", mSyncRowId=" + mSyncRowId
    ...
    boolean setSyncPosition(int pos) {
        if (sDbgLayout) {
            Xlog.d(TAG, "setSyncPosition oldSyncPosition=" + mSyncPosition
                      + ", mSyncPosition=" + pos
                      + ", mSpecificTop=" + mSpecificTop
                      + ", mSyncRowId=" + mSyncRowId
                      + ", mSyncHeight=" + mSyncHeight
    ...
    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
    protected void setEdgeGlowTopBottom(EdgeEffect edgeGlowTop,
            EdgeEffect edgeGlowBottom) {
        mEdgeGlowTop = edgeGlowTop;
        mEdgeGlowBottom = edgeGlowBottom;
    }
    ...
    protected void setScrollerInner(FastScroller scroller) {
        mFastScroll = scroller;
    }

    public void setTag(final Object tag) {
        super.setTag(tag);
        if (null != tag && "disable-multi-select-move".equals(tag.toString())) {
    ...
    protected void setStableItemHeight(OverScroller scroller, AbsListView.FlingRunnable fr) {
        // hook
    }

    /**
     * whether list view has multi select feature.
     *
     * @return true, has the feature, false, otherwise.
     */
    ...
    /**
     * whether list view has spring effect feature.
     *
     * @return true, has the feature, false, otherwise.
     */
    ...
    /**
     * whether list view has high speed stable feature.
     *
     * @return true, has the feature, false, otherwise.
     */
