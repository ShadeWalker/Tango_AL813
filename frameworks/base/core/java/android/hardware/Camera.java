...
public class Camera {
	...
	//add by wangjing3 for HQ01258144 2015-08-07 begin
	private String currentAppPackageName = null;
	//add by wangjing3 for HQ01258144 2015-08-07 end
    ...
    private int cameraInitVersion(int cameraId, int halVersion) {
		...
		currentAppPackageName = packageName; //add wangjing3 for HQ01258144 2015-08-07
		//Log.i(TAG,"wangjing3 package is "+packageName);
        /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
        //[HSM]
        boolean blocked = !HwSystemManager.allowOp(HwSystemManager.PERMISSION_CAMERA);
        return native_setup(new WeakReference<Camera>(this), cameraId, halVersion, packageName, blocked);
        /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
    }
    ...
    /* <DTS2013120203764 huangbangbang/00191767 20131202 begin */
    //[HSM]
    private native final int native_setup(Object camera_this, int cameraId, int halVersion,
                                           String packageName, boolean isBlock);
    /* DTS2013120203764 huangbangbang/00191767 20131202 end> */
    ...
    public final void setPreviewDisplay(SurfaceHolder holder) throws IOException {
        /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
        //[HSM]
        boolean allow = HwSystemManager.allowOp(HwSystemManager.PERMISSION_CAMERA);
        if (allow && holder != null) {
        /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
  ...
  /**
   ...
   /**
    ...
    public void setParameters(Parameters params) {
		...
		//add by wangjing3 for HQ01258144 2015-08-07 begin
		if("com.huawei.camera".equals(currentAppPackageName)){
			params.set(Parameters.KEY_IS_HW_CAMERA,"true");
		}
		//add by wangjing3 for HQ01258144 2015-08-07 end
    ...
    public Parameters getParameters() {
      ...
      //add by zhouyoukun for HQ01386927  begin 2015-09-17
        String s="";//modify by HQ_Pangxuhui for HQ01447820 20151016
        try{
         s = native_getParameters();
        }catch(Exception e){
             s="";//modify by HQ_Pangxuhui for HQ01447820 20151016
        	 Log.i(TAG, "Camera framework getParameters =" + e);
        }
        //add by zhouyoukun for HQ01386927  end 2015-09-17
        p.unflatten(s);
        //!++
    ...
    private static final String KEY_MUTE_RECORDING_SOUND = "rec-mute-ogg";
        ...
        //add by wangmingyue for ISO
        public static final String KEY_ISO_VALUES = "iso-mode-values";
		//add by longteng for FOCUS
		public static final String HW_MANUAL_FOCUS_SUPPORTED_KEY = "hw-manual-focus-supported";
		//for mirror
 		public static final String HW_CAMERA_MIRROR_SUPPROTED_KEY = "hw-capture-mirror-supproted";
		public static final String HW_CAMERA_MIRROR_KEY = "hw-capture-mirror-mode";
		//for focus value
		public static final String MIN_MANUAL_FOCUS_VALUE = "hw-vcm-start-value";
		public static final String MAX_MANUAL_FOCUS_VALUE = "hw-vcm-end-value";
		//for focus swither
		public static final String MANUAL_FOCUS_STATE = "hw-manual-focus-mode";
		public static final String CURRENT_FOCUS_VALUE = "hw-manual-focus-step-value";
    /**
     * @hide
    */
        ...
        */
		...
		//add by wangjing3 for HQ01258144  begin 2015-08-07
		public static final String KEY_HW_STOP_BURST_SUPPORTED = "hw-k3-burst-supported";
		public static final String KEY_HW_BURST_INTERVAL = "burst-delay-ms";
		public static final String KEY_BURST_NUMBER = "burst-capture";
		public static final String KEY_HW_BURST_SUPPORT_COUNT = "hw-burst-support-count";
		public static final String KEY_SCALADO_STOP_BURST = "scalado-burst-stop-command";
		public static final String KEY_HW_STOP_BURST = "hw-burst-stop-command";
		public static final String KEY_IS_HW_CAMERA = "is_hw_camera";
		
		//add by wangjing3 for HQ01258144 2015-08-07 end
		//add by wangjing3 for HQ01257237 begin
		public static final String HW_SMILE_FACE_SHOTMODE_SUPPORTED_KEY = "hw-smile-face-shotmode-supported";	
		public static final String HW_SMILE_DETECTION_KEY = "hw-smile-detection";
		//add by wangjing3 for HQ01257237 end
	...
	private final Object mMapLock = new Object();//add by zhouguo at 20151129 for HQ01471372
	    ...
	    synchronized(mMapLock){//add by zhouguo at 20151129 for HQ01471372
            	mMap.putAll(other.mMap);
	    }//add by zhouguo at 20151129 for HQ01471372
        }
