...
public final class PreferenceScreen extends PreferenceGroup implements AdapterView.OnItemClickListener,
    ...
    /*< DTS2014101007196 guyue/00295151 20141106 begin*/
    private boolean mIsHwActionBar = false;
    /*DTS2014101007196 guyue/00295151 20141106 end >*/
    /**
    ...
    private void showDialog(Bundle state) {
        ...
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        Dialog dialog = mDialog = mIsHwActionBar ? new HwDialog(context,context.getThemeResId())
                  : new Dialog(context, context.getThemeResId());
        /* DTS2014101007196 guyue/00295151 20141106 end >*/
    ...
    private void initHwTheme(Context context, AttributeSet attrs){
        //read the hw theme attr
        TypedArray a = context.obtainStyledAttributes(
                    attrs, com.android.internal.R.styleable.HwActionBar,
                    com.android.internal.R.attr.actionBarOfHw, 0);
        final int N = a.getIndexCount();
        for (int i = 0; i < N; ++i) {
            int attr = a.getIndex(i);
            switch (attr) {
            case com.android.internal.R.styleable.HwActionBar_isHwActionBar:
                mIsHwActionBar = a.getBoolean(attr, false);
                break;
            }
        }
        a.recycle();
