    ...
    protected View getDefaultView() {
        ...
        try {
            if (mInfo != null) {
                ...
                /* < DTS2014042600654 taolan/00264981 20140426 begin */
                /**
                 * Because the context in WidgetFactoryHuaWei's onCreateView method is restricted in popedom,
                 * so we should pass an unrestricted context object to WidgetFactoryHuaWei by constuctor method
                 */
                int flags = mRemoteContext.getApplicationInfo() == null
                        ? 0
                        : mRemoteContext.getApplicationInfo().flags;
                if ((flags & ApplicationInfo.FLAG_SYSTEM) != 0) {
                    inflater.setFactory(HwFrameworkFactory.getHwWidgetManager().createWidgetFactoryHuaWei(mContext, mInfo.provider.getPackageName()));
                }
