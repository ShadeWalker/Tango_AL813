...
public class Linkify {
    ...
    public static final int CUST_MMS_NUMBER = 0x10;
    ...
    public static final int ALL_MMS = WEB_URLS | EMAIL_ADDRESSES | PHONE_NUMBERS | MAP_ADDRESSES | CUST_MMS_NUMBER;
    ...
    //modified for cts android.text.util.cts.LinkifyTest-- testAddLinks7 failed by taojin 20151029
    /*private static SpannableString filterSpannable = new SpannableString(
            "123456789 not a phone number"
            + " " + "tel:(0812)1234560 (0812)1234561"
            + " " + "tel:(812)1234562 (812)123.4563 " + " tel:(800)5551210 (800) 555-1211 555-1212"
            + " " + "tel:+4408121234564 +44-0812-123-4565" + " tel:+18005551213 +1-800-555-1214");
    */
    ...
    public static final boolean addLinks(Spannable text, int mask) {
        ...
        if ((mask & PHONE_NUMBERS) != 0) {
        	Log.d("Linkify", "addLinks(), mms lp"+ mask);
        	if(SystemProperties.get("ro.hq.mms.number.link").equals("1") && mask == ALL_MMS){ 
        		 Log.d("Linkify", "addLinks(), mms lp");
        		 /*gatherLinks(links, text, Patterns.PHONE_HUGO,
                         new String[] { "tel:" },
                         null, null);*/
        		 
        		 gatherLinks(links, text, Patterns.PHONE_HUGO, new String[] { "tel:" }, sPhoneNumberMatchFilter, sPhoneNumberTransformFilter);
        	}else{
