...
public class Dialog implements DialogInterface, Window.Callback,
    ...
    Dialog(Context context, int theme, boolean createContextThemeWrapper) {
		...
		/*< DTS2014101007196 guyue/00295151 20141106 begin*/
        mHwDialogStub = HwWidgetFactory.getHwDialogStub(context, mWindow, this, null);
        /* DTS2014101007196 guyue/00295151 20141106 end >*/
    ...
    public void show() {
        ...
        if (mActionBar == null && mWindow.hasFeature(Window.FEATURE_ACTION_BAR)) {
            ...
            mActionBar = HwWidgetFactory.getHuaweiActionBarImpl(this);
        ...
        if ((l.softInputMode
            ...
            /*< DTS2014101007196 guyue/00295151 20141106 begin*/
            // when we exec mWindowManager.addView(mDecor, l), we will add token (represent this window) to l(LayoutParams),
            // I think we should make sure that this modify(add token) will be raletive with mWindow's LayoutParams
            // but if we new a LayoutParams : nl, nl is point to a new momery area,if we exec l = nl,
            // l will not point to mWindow's LayoutParams, so when we add token to l, it is not add to mWindow's LayoutParams
        ...
        /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
        //[HSM]
        l.privateFlags |= HwSystemManager.PRIVATE_FLAG_COMMON_SHOW_DIALOG;
        /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
        try {
    ...
    public void onAttachedToWindow() {
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        if(hasAnimatorMask()){
            mHwDialogStub.showDialogFactory();
        }
        /*DTS2014101007196 guyue/00295151 20141106 end >*/
    }
    ...
    public void onDetachedFromWindow() {
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        if(hasAnimatorMask()){
            mHwDialogStub.dismissDialogFactory();
        }
        /*DTS2014101007196 guyue/00295151 20141106 end >*/
    }
    ...
    private boolean hasAnimatorMask() {
        return (null != mHwDialogStub &&
                ((mHwDialogStub.getMask() & HwDialogStub.DIALOG_STUB_MASK_ANIMATOR) != 0));
    }
    private boolean hasDismissMask() {
        return (null != mHwDialogStub &&
                ((mHwDialogStub.getMask() & HwDialogStub.DIALOG_STUB_MASK_DISMISS) != 0));
    }
    private boolean hasButtons() {
        return (hasDismissMask() && mHwDialogStub.hasButtons());
    }
    /*DTS2014101007196 guyue/00295151 20141106 end >*/
}
