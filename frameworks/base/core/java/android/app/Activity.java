...
/* DTS2014042818262 xiongshiyi/00165767 20140424 end>*/
...
public class Activity extends ContextThemeWrapper
    ...
    public void onWindowAttributesChanged(WindowManager.LayoutParams params) {
        ...
        if ((params.flags & WindowManager.LayoutParams.FLAG_FULLSCREEN) != 0){
            if (!mIsFullFlag && mResumed) {
                LogPower.push(LogPower.FULL_SCREEN, getPackageName());
                mIsFullFlag = true;
            }
        } else {
            if (mIsFullFlag) {
                LogPower.push(LogPower.FULL_SCREEN_END, getPackageName());
                mIsFullFlag = false;
            }
        }
        /* DTS2014112601808 huangwen 00181596 20141126 end>*/
    ...
    public boolean moveTaskToBack(boolean nonRoot) {
        /// M: ALPS02078629 reset stick when moveTaskToBack. @{
        if (MultiWindowProxy.isFeatureSupport()) {
            MultiWindowProxy mMultiWindowProxy = MultiWindowProxy.getInstance();  
            if (mMultiWindowProxy != null){
                mMultiWindowProxy.stickWindow(mToken, false);
            }
        }
        /// @}
        try {
