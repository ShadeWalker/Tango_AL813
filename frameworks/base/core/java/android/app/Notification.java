...
public class Notification implements Parcelable
{
    ...
    public void setLatestEventInfo(Context context,
        ...
        /*< DTS2015010506788 zhudengkui / 00180854 20140105 begin */
        builder.setDeleteIntent(this.deleteIntent);
        /* DTS2015010506788 zhudengkui / 00180854 20140105 end>*/
        /*< DTS2014101007196 guyue/00295151 20141106 begin*/
        if (this.largeIcon != null){
            builder.setLargeIcon(this.largeIcon);
        }
        /*< DTS2014101007196 guyue/00295151 20141106 d*/
	...
	//caoxuhao
	private RemoteViews tmpContentView = null;
	    ...
	    if(tmpContentView != contentView){
		    ...
		    contentView.setViewVisibility(R.id.profile_badge_line3, View.VISIBLE);
		    tmpContentView = contentView;
                }
                return true;
            }
            return false;
        ...
        private RemoteViews applyStandardTemplate(int resId, boolean hasProgress) {
            ...
            if (mLargeIcon != null) {
                ...
                /*< DTS2014121102122 tianjing/102012 20141212 begin */
                //processLargeLegacyIcon(mLargeIcon, contentView);
                /* DTS2014121102122 tianjing/102012 20141212 end > */
            ...
            /*< DTS2014121200074 tianjing/102012 20141222 begin */
            //contentView.setViewPadding(R.id.line1, 0, calculateTopPadding(mContext,
               ...
               //     0, 0);
            /* DTS2014121200074 tianjing/102012 20141222 end> */
        ...
        private RemoteViews makeContentView() {
            if (mContentView != null) {
                return mContentView;
            /*< DTS2014112706701 tianjing/102012 20141202 begin */
            } else if (mProgressMax == 0) {
                return applyStandardTemplate(R.layout.notification_template_base_no_progressbar, false);
            /* DTS2014112706701 tianjing/102012 20141202 end > */
            } else {
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            button.setViewPadding(R.id.action0, 0, 0, 0, 0);
