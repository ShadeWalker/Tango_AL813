...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    */
    ...
    void handleFocusGainInternal(@FocusRealDirection int direction, Rect previouslyFocusedRect) {
        ...
        if (DBG_FOCUS) {
            Xlog.d(VIEW_LOG_TAG, "handleFocusGainInternal: this = " + this + ", callstack = " ,
    ...
    /* <DTS2013030403065 yangbo 00108674 20130307 begin  */
    /* < DTS2014010603281 yangbo 00108674 20140103 begin */
    public boolean isRtlLocale() {
        String currentLang = java.util.Locale.getDefault().getLanguage();
        return (currentLang.contains("ar")||currentLang.contains("fa")||currentLang.contains("iw")||isLayoutRtl());
    }
    /* DTS2014010603281 yangbo 00108674 20140103 end > */
    /* DTS2013030403065 yangbo 00108674 20130307 end > */
    ...
    */
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            ...
            Xlog.i(VIEW_LOG_TAG, "Key up dispatch to " + this + ", event = " + event);
        }
        ...
        if (li != null && li.mOnKeyListener != null && (mViewFlags & ENABLED_MASK) == ENABLED
            ...
            if (DBG_KEY) {
                Xlog.d(VIEW_LOG_TAG, "handle Key event by listerner, listener = " + li
   ...
   /**
    ...
    public boolean post(Runnable action) {
        ...
        if (DBG_MOTION) {
            Xlog.w(VIEW_LOG_TAG, "(View)post runnable but AttachInfo = null, this = " + this);
        }
    ...
    protected void onAttachedToWindow() {
        if ((mPrivateFlags & PFLAG_REQUEST_TRANSPARENT_REGIONS) != 0) {
            //modify by wangmingyue for HQ01386812 begin
            try {
                mParent.requestTransparentRegion(this);
            } catch (NullPointerException e) {
                Log.e(VIEW_LOG_TAG, "null object reference", e);
            }
           //modify by wangmingyue for HQ01386812 end
        }
    ...
    private void updateDisplayListIfDirty() {
        ...
        if ((mPrivateFlags & PFLAG_DRAWING_CACHE_VALID) == 0
            ...
            if (renderNode.isValid()
                ...
                if (DBG_DRAW) {
                    Xlog.d(VIEW_LOG_TAG, "getDisplayList : do not dirty itself only dispatch"
            ...
            try {
                ...
                if (layer != null && layer.isValid()) {
                    ...
                    if ((mPrivateFlags & PFLAG_SKIP_DRAW) == PFLAG_SKIP_DRAW) {
                        if (DBG_DRAW) {
                            Xlog.d(VIEW_LOG_TAG, "getDisplayList : calling dispatchDraw,this = "
                                    + this);
                        }
                        dispatchDraw(canvas);
    ...
    private void buildDrawingCacheImpl(boolean autoScale) {
        ...
        if ((mPrivateFlags & PFLAG_SKIP_DRAW) == PFLAG_SKIP_DRAW) {
            mPrivateFlags &= ~PFLAG_DIRTY_MASK;
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "view buildDrawingCache : calling dispatchDraw,this = "
                        + this);
            }
            dispatchDraw(canvas);
            if (mOverlay != null && !mOverlay.isEmpty()) {
    ...
    Bitmap createSnapshot(Bitmap.Config quality, int backgroundColor, boolean skipChildren) {
        ...
        Bitmap bitmap;
        /* HQ_xuqian4 2015-9-23 HQ01394968 modified for APR createSnapshot start*/
        if(mResources!=null){
           bitmap = Bitmap.createBitmap(mResources.getDisplayMetrics(),width > 0 ? width : 1, height > 0 ? height : 1, quality);
        }else{
           bitmap = Bitmap.createBitmap(width > 0 ? width : 1, height > 0 ? height : 1, quality);
        }
        /* HQ_xuqian4 2015-9-23 HQ01394968 modified for APR createSnapshot end*/
        if (bitmap == null) {
            ...
            if (!layerRendered) {
                if (!hasDisplayList) {
                    ...
                    if ((mPrivateFlags & PFLAG_SKIP_DRAW) == PFLAG_SKIP_DRAW) {
                        mPrivateFlags &= ~PFLAG_DIRTY_MASK;
                        if (DBG_DRAW) {
                            Xlog.d(VIEW_LOG_TAG, "view draw1 : calling dispatchDraw,this = "
                                    + this);
                        }
                        dispatchDraw(canvas);
                    } else {
    ...
    public void draw(Canvas canvas) {
        ...
        if (!verticalEdges && !horizontalEdges) {
            ...
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "view draw2 : calling onDraw ,dirtyOpaque= " + dirtyOpaque
                        + " ,this = " + this);
            }
            ...
            if (!dirtyOpaque) {
                ...
                if (nowTime - logTime > DBG_TIMEOUT_VALUE) {
                    Xlog.d(VIEW_LOG_TAG, "[ANR Warning]onDraw time too long, this =" + this
        ...
        // Step 3, draw the content
        if (DBG_DRAW) {
            Xlog.d(VIEW_LOG_TAG, "view draw3 : calling onDraw, dirtyOpaque = " + dirtyOpaque
                    + " ,this = " + this);
        }
        /// M: Monitor onDraw time if longer than 3s print log.
        if (!dirtyOpaque) {
    ...
    public void requestLayout() {
        ...
        if (DBG_LAYOUT) {
            Xlog.d(VIEW_LOG_TAG, "view request layout, this =" + this);
        }
    ...
    public final void measure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DBG_LAYOUT || DBG_MEASURE_LAYOUT) {
            Xlog.d(VIEW_LOG_TAG, "view measure start, this = " + this + ", widthMeasureSpec = "
        ...
        if (forceLayout || !matchingSize &&
            ...
            if (cacheIndex < 0 || sIgnoreMeasureCache) {
                ...
                if (DBG_LAYOUT || DBG_MEASURE_LAYOUT) {
                    Xlog.d(VIEW_LOG_TAG, "view measure end, this = " + this + ", mMeasuredWidth = "
                ...
                mPrivateFlags3 |= PFLAG3_MEASURE_NEEDED_BEFORE_LAYOUT;
                if (DBG_LAYOUT || DBG_MEASURE_LAYOUT) {
                    Xlog.d(VIEW_LOG_TAG, "view measure end 2 (use measure chache), this = " + this
                            + ", mMeasuredWidth = " + mMeasuredWidth + ", mMeasuredHeight = "
            ...
            if (DBG_LAYOUT || DBG_MEASURE_LAYOUT) {
                Xlog.d(VIEW_LOG_TAG, "view measure end 3 (use prevuious measurement), this = "
        ...
        if (hasRtlSupport()) {
            ...
            switch(textDirection) {
                case TEXT_DIRECTION_INHERIT:
                    ...
                    try {
                    	///HQ_xionghaifeng 20151029 add for HQ01476076 reboot start @{
                    	if (mParent != null)
                		{
