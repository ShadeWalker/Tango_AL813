...
/// @}
/*<DTS2014060902905 shenjinhua/00171968 20140609 begin */
//rebase for DTS2013031101504
import android.common.HwFrameworkFactory;
/* DTS2014060902905 shenjinhua/00171968 20140609 end > */
...
public class AnimationUtils {
    ...
    private static Interpolator createInterpolatorFromXml(Resources res, Theme theme, XmlPullParser parser)
        ...
        while (((type = parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            /* < DTS2014122904428 zhangxinming/00181848 20150106 begin */
            //delete DTS2014112801506 change and mContext
            } else if (name.equals("cubicBezierInterpolator") || name.equals("cubicBezierReverseInterpolator")) {
                /* < DTS2014111309478 zhangxinming/00181848 20141113 begin */
                /*<DTS2014060902905 shenjinhua/00171968 20140609 begin */
                //rebase for DTS2013031101504, impl in AnimUtil
                interpolator = (BaseInterpolator)HwFrameworkFactory.createHwInterpolator(name, res, theme, attrs);
            } else {
                throw new RuntimeException("Unknown interpolator name: " + parser.getName());
            }
                /*   DTS2014111309478 zhangxinming/00181848 20141113 end > */
        }
               /* DTS2014060902905 shenjinhua/00171968 20140609 end > */
        /*   DTS2014122904428 zhangxinming/00181848 20150106 end > */
        return interpolator;
    }
}
