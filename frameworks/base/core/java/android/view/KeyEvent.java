...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    */
	...
	/*< DTS2014110604349 zhaifeng/00107904 20141106 begin */
	/* Key code constant: touch plus key up left*/
	public static final int KEYCODE_TOUCH_PLUS_1 = 303;
	/* Key code constant: touch plus key up right*/
	public static final int KEYCODE_TOUCH_PLUS_2 = 304;
	/* Key code constant: touch plus key down left*/
	public static final int KEYCODE_TOUCH_PLUS_3 = 305;
	/* Key code constant: touch plus key down middle*/
	public static final int KEYCODE_TOUCH_PLUS_4 = 306;
	/* Key code constant: touch plus key down right*/
	public static final int KEYCODE_TOUCH_PLUS_5 = 307;
	private static final int LAST_KEYCODE = KEYCODE_TOUCH_PLUS_5;
	/* DTS2014110604349 zhaifeng/00107904 20141106 end >*/
	//end
	
	//add keycode for fingerprint by liuchaochao begin
	/** M:fingerprints keycode
     * @hide
     */
	public static final int KEYCODE_FPC = 282;
	//add keycode for fingerprint by liuchaochao end

	 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_S_CHANGED        = 268;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SC_CHANGED        = 269;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SBA_CHANGED        = 270;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SV_CHANGED        = 271;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SM_CHANGED        = 272;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SO_CHANGED        = 273;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SW_CHANGED        = 274;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SS_CHANGED        = 275;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SZ_CHANGED        = 276;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SAA_CHANGED        = 277;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SBB_CHANGED        = 278;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SAB_CHANGED        = 279;//niyangadd130
		 /** M:handgesture function
     * @hide
     */
	public static final int KEYCODE_SCC_CHANGED        = 280;//niyangadd130
	   /** M:[SmartBook] Key code constant: gallery key.
     * Starts the system gallery activity.
     * @hide
     */
	public static final int KEYCODE_SIM_CHANGED        = 281;//niyangadd128
    ...
    public static final boolean isSystemKey(int keyCode) {
        switch (keyCode) {
			...
			case KeyEvent.KEYCODE_S_CHANGED:
			case KeyEvent.KEYCODE_SC_CHANGED:	
			case KeyEvent.KEYCODE_SBA_CHANGED:
			case KeyEvent.KEYCODE_SV_CHANGED:
		    case KeyEvent.KEYCODE_SM_CHANGED:
			case KeyEvent.KEYCODE_SO_CHANGED:	
			case KeyEvent.KEYCODE_SW_CHANGED:
			case KeyEvent.KEYCODE_SS_CHANGED:
		    case KeyEvent.KEYCODE_SZ_CHANGED:
			case KeyEvent.KEYCODE_SAA_CHANGED:	
			case KeyEvent.KEYCODE_SBB_CHANGED:
			case KeyEvent.KEYCODE_SAB_CHANGED:
			case KeyEvent.KEYCODE_SCC_CHANGED:	
		    case KeyEvent.KEYCODE_SIM_CHANGED:
		    case KeyEvent.KEYCODE_FPC://add keycode for fingerprint by liuchaochao
                return true;
        }
    ...
    public final int getKeyCode() {
		/*< DTS2014110604349 zhaifeng/00107904 20141106 begin */
		mOrigKeyCode = mKeyCode;
		if (SystemProperties.getBoolean("ro.config.hw_touchplus_enabled", false)) {
			 switch (mKeyCode) {
				 case KeyEvent.KEYCODE_TOUCH_PLUS_3:
					 mKeyCode = KeyEvent.KEYCODE_BACK;
					 break;
				 case KeyEvent.KEYCODE_TOUCH_PLUS_4:
					 mKeyCode = KeyEvent.KEYCODE_HOME;
					 break;
				 case KeyEvent.KEYCODE_TOUCH_PLUS_5:
					 mKeyCode = KeyEvent.KEYCODE_MENU;
					 break;
				  default:
					 break;
			 }
