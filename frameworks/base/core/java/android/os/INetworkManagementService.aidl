...
interface INetworkManagementService
{
     ...
     * @hide
     */
    void setHetCommInterface(String iface1, String iface2, double ratio1, double ratio2);
     ...
     * @hide
     */
    void removeHetCommInterface();

    /**
     * M: HetComm Feature
     * @hide
     */
    void setHetCommRatio(double ratio1 ,double ratio2);
