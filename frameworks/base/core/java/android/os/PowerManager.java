...
/*<DTS2014112601808 huangwen 00181596 20141126 begin*/
    public void setLcdRatio(int ratio,boolean autoAdjust){
       try {
          mService.setLcdRatio(ratio,autoAdjust);
...
/* DTS2014112601808 huangwen 00181596 20141126 end>*/
   ...
   /**
    ...
    public void setInCallDTMFFlag(boolean isincall, boolean isDTMF) {
        try {
			Log.d("guo", "manager setInCallDTMFFlag");
            mService.setInCallDTMFFlag(isincall, isDTMF);
        } catch (RemoteException e) {
            Log.d("guo", "manager setInCallDTMFFlag, exception");
            return;
        }
    }
