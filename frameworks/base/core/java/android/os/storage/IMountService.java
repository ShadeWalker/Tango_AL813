...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        private static class Proxy implements IMountService {
	      ...
	      public void startUpdateApp() throws RemoteException {
		    Parcel _data = Parcel.obtain();
		    Parcel _reply = Parcel.obtain();
		    try {
			Log.d( "IMountservice", "startUpdateApp RemoteException" );
		        _data.writeInterfaceToken(DESCRIPTOR);
		        mRemote.transact(Stub.TRANSACTION_startUpdateAPP, _data, _reply, 0);
		        _reply.readException();
		    } finally {
		        _reply.recycle();
		        _data.recycle();
		  ...
		  public void endUpdateApp() throws RemoteException {
			    Parcel _data = Parcel.obtain();
			    Parcel _reply = Parcel.obtain();
			    try {
				Log.d( "IMountservice", "endUpdateApp RemoteException" );
			        _data.writeInterfaceToken(DESCRIPTOR);
			        mRemote.transact(Stub.TRANSACTION_endUpdateAPP, _data, _reply, 0);
			        _reply.readException();
			    } finally {
			        _reply.recycle();
			        _data.recycle();
	      ...
	      public void endUnloadApp() throws RemoteException {
			    Parcel _data = Parcel.obtain();
			    Parcel _reply = Parcel.obtain();
			    try {
				Log.d( "IMountService", "endUpdateApp RemoteException" );
			        _data.writeInterfaceToken(DESCRIPTOR);
			        mRemote.transact(Stub.TRANSACTION_endUnloadApp, _data, _reply, 0);
			        _reply.readException();
			    } finally {
			        _reply.recycle();
			        _data.recycle();
		  ...
		  /* add end*/
		  //chenwenshuai
		public void addMoveAppRef() throws RemoteException {
			Parcel _data = Parcel.obtain();
		    Parcel _reply = Parcel.obtain();
			try {
				_data.writeInterfaceToken(DESCRIPTOR);
		        mRemote.transact(Stub.TRANSACTION_addMoveAppRef, _data, _reply, 0);
		        _reply.readException();
			} finally {
				_reply.recycle();
		        _data.recycle();
		...
		public void deleteMoveAppRef() throws RemoteException {
			Parcel _data = Parcel.obtain();
		    Parcel _reply = Parcel.obtain();
			try {
				_data.writeInterfaceToken(DESCRIPTOR);
		        mRemote.transact(Stub.TRANSACTION_deleteMoveAppRef, _data, _reply, 0);
		        _reply.readException();
			} finally {
				_reply.recycle();
		        _data.recycle();
		...
		public int getMoveAppRef() throws RemoteException {
			Parcel _data = Parcel.obtain();
		    Parcel _reply = Parcel.obtain();
			int _result;
			try {
				_data.writeInterfaceToken(DESCRIPTOR);
		        mRemote.transact(Stub.TRANSACTION_getMoveAppRef, _data, _reply, 0);
		        _reply.readException();
				_result = _reply.readInt();
			} finally {
				_reply.recycle();
		...
		//chenwenshuai
		static final int TRANSACTION_startUpdateAPP = IBinder.FIRST_CALL_TRANSACTION + 47;
		static final int TRANSACTION_endUpdateAPP  =  IBinder.FIRST_CALL_TRANSACTION + 48;
		static final int TRANSACTION_endUnloadApp  =  IBinder.FIRST_CALL_TRANSACTION + 49;
		//chenwenshuai
		static final int TRANSACTION_addMoveAppRef = IBinder.FIRST_CALL_TRANSACTION + 50;
		static final int TRANSACTION_deleteMoveAppRef = IBinder.FIRST_CALL_TRANSACTION + 51;
		static final int TRANSACTION_getMoveAppRef = IBinder.FIRST_CALL_TRANSACTION + 52;
        /// @}
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply,
            ...
            switch (code) {
				...
				/*chenwenshuai add for prompt begin*/
				case TRANSACTION_startUpdateAPP: {
				   data.enforceInterface(DESCRIPTOR);
							startUpdateApp();
							reply.writeNoException();
							return true;
				}
				case TRANSACTION_endUpdateAPP: {
				   data.enforceInterface(DESCRIPTOR);
							endUpdateApp();
							reply.writeNoException();
							return true;
				}
			    case TRANSACTION_endUnloadApp: {
			          data.enforceInterface(DESCRIPTOR);
							endUnloadApp();
							reply.writeNoException();
						        return true;
				...
				//chenwenshuai
				case TRANSACTION_addMoveAppRef:{
					data.enforceInterface(DESCRIPTOR);
					addMoveAppRef();
					reply.writeNoException();
					return true;
				}
				case TRANSACTION_deleteMoveAppRef:{
					data.enforceInterface(DESCRIPTOR);
					deleteMoveAppRef();
					reply.writeNoException();
					return true;
				}
				case TRANSACTION_getMoveAppRef:{
					data.enforceInterface(DESCRIPTOR);
					int moveRef = getMoveAppRef();
					reply.writeNoException();
					reply.writeInt(moveRef);
					return true;
				}
				//chenwenshuai add end
