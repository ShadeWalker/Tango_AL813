...
/* < DTS2014111100582 zhouyuxiang/00208241 20141111 begin */
import android.provider.SettingsEx;
/* DTS2014111100582 zhouyuxiang/00208241 20141111 end > */
...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        //add by HQ_caoxuhao at 20150827 HQ01322819 begin
		 /**
         * light screen when notification arrival
         * @hide
         */
        public static final String NOTIFICATION_LIGHT_SCREEN = "notification_light_screen";
        //add by HQ_caoxuhao at 20150827 HQ01322819 end
        ...
        //add by xiajunjun for hiding week
        /**
         * M: Is hiding week?
         * false = no
         * true = yes
         * @hide
         */
        public static final String HW_NOT_DISPALY_WEEK = "hw_not_dispaly_week";

        //add by xiajunjun for start day of week which claro_mccmnc
        /**
         * start day of week which claro_mccmnc
         */
        public static final String HW_START_WHICH_CLARO = "hw_start_day_of_week";

	     //add by HQ_zhouguo at 20150720 start
	     /**
         * Control led light mode.
         */
        public static final String LED_LIGHT_MODE = "led_light_mode";

       /**
        * Whether mobile data always connect.
        * @hide
        */
       public static final String MOBILE_DATA_ALWAYS_ON = "power_saving_on";
         ...
         * @hide
         */
        public static final String LED_LIGHT_ADJ = "led_light_adj";

        /**
         * LED_LIGHT_MODE value for manual mode.
         */
        public static final int LED_LIGHT_MODE_MANUAL = 0;

        /**
         * LED_LIGHT_MODE value for automatic mode.
         */
        public static final int LED_LIGHT_MODE_AUTOMATIC = 1;
		//add by HQ_zhouguo at 20150720 end

        /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
        /* < DTS2014112804554 zhuxuefu 00290029 20141208 begin */
        public static final String RINGTONE2 = "ringtone2";
        /* DTS2014112804554 zhuxuefu 00290029 20141208 end > */
        ...
        public static final String RINGTONE = "ringtone";
         /** {@hide} */ 
        public static final String BROWSER_PACKAGES = "browser_packages";//add by lihaizhou for Childmode
        

		public static final String RINGTONE_SIM2 = "ringtone_sim2";//add by wuhuihui for multisim ringtone

        public static final String ISSHOW_NETWORKTYPE = "isShowNetworkType";
		...
		public static final Uri DEFAULT_RINGTONE_SIM2_URI = getUriFor(RINGTONE_SIM2);//add by wuhuihui for multisim ringtone
		...
		public static final String CALENDAR_PATH = "calendar_path";
        ...
        //public static final String VIBRATE_WHEN_RINGING_SIM2 = "vibrate_when_ringing2";
        
        public static final String VIBIRATE_WHEN_SILENT = "vibirate_when_silent";
	...
	public static final String SMART_EARPHONE_CONTROL="smart_earphone_control";//added by zhangteng for Smart Earphone Control

	public static final String HW_CUST_DISPLAY_SEARCH_ENGINE="hw_cust_display_search_engine";//added by zhangteng for HQ01544181 at 2015-12-07
        ...
        public static final String[] SETTINGS_TO_BACKUP = {
            ...
            DATE_FORMAT,
            /* < DTS2014111100582 zhouyuxiang/00208241 20141111 begin */
            SettingsEx.System.FIRST_DAY_OF_WEEK,
            SettingsEx.System.WEEKEND,
            /* DTS2014111100582 zhouyuxiang/00208241 20141111 end > */
        ...
        /**
          * @deprecated Use {@link android.provider.Settings.Global#DATA_ROAMING default} instead
          * HQ_yulifeng for roaming default HQ01308722,20151028
          */
        @Deprecated
        public static final String FIRST_INTERNATIONAL_ROAMING_SIM1 = "first_international_roaming_sim1";
        public static final String FIRST_INTERNATIONAL_ROAMING_SIM2 = "first_international_roaming_sim2";
        public static final String FIRST_INTERNATIONAL_ROAM_STATE_SIM1 = "first_international_roam_state_sim1";
        public static final String FIRST_INTERNATIONAL_ROAM_STATE_SIM2 = "first_international_roam_state_sim2";
       ...
       /**
		...
		/*HQ_zhangjing 2015-11-24 modified for cell broadcaat for southeast */
        /**
         * Multi SIM mode setting.
         * @hide
         * @internal
         */
        public static final String CBC_CHANGE_TIME = "cellbroadcast_change_time_setting";
        ...
        public static final String POWER_OFF_ALARM_PACKAGE_NAME = "power_off_alarm_package_name";
          ...
          /*** Enable flip phone feature when incomming call ? true = yes false = no
         * wangmeihua add
         * @hide
         */
        public static final String FLIP_PHONE_SWITCH = "flip_phone_switch";
        
        /**
         * Incoming call and flip phone ? 0=mute 1=reject
         * wangmeihua add 
         * @hide
         */
        public static final String FLIP_PHONE_VALUE = "flip_phone_value";
       ...
       /**
         ...
         */
		 ...
		 /**
          * M: add for email's signature 813
          *
          * @hide 
          */
         public static String EMAIL_SIGNATURE_WITH_PRODUCTNAME = "email_signature_with_productname";
		 //add by gaoyuhao for bookmark_homepage
		 /**
          * M: add for bookmark_homepage 813
          *
          * @hide 
          */
         public static String CUSTOM_BOOKMARK_HOMEPAGE = "custom_bookmark_homepage";
         //add by wangmingyue for bookmark_homepage
		 /**
          * M: add for bookmark_homepage 813
          *
          * @hide 
          */
         public static String CHANGE_BOOKMARK_BY_MCC = "change_bookmark_by_mcc";
          //add by zhangpeng5
          /**
          * M: add for AT&T calendar
          *
          * @hide
          */
          ...
          //add by gaoyuhao
          /**
          * M: add for clock hide jerusalem 813
          *
          * @hide
          */
          public static String IS_HIDE_JERUSALEM = "is_hide_jerusalem";
          //add by gaoyuhao
          /**
          * M: add for toast of weatherclock 813 HQ01311900
          *
          * @hide
          */
         public static String IS_SHOW_GPS_ERROR_TOAST = "is_show_gps_error_toast";

		 //add by gaoyuhao
          /**
          * M: add for calander vibrate add by gaoyuhao  813 HQ01487644
          *
          * @hide
          */
         public static String VIBRATE_ON_CALENDAR = "vibrate_on_calendar";
		//add by gaoyuhao
          /**
          * M: add for claroEmail HQ01453223
          *
          * @hide
          */
        public static String USE_EXTRA_EMAILLIST = "use_extra_emaillist";
		public static String EXCHANGE_POSITION_CUSTOM = "exchange_position_custom";
		public static String DOMAIN_FOR_30MIN_CHECK = "domain_for_30min_check";
		public static String HW_EMAIL_HIT_DOMAIN = "hw_email_hit_domain";

      /*HQ_yulifeng for systemui  HQ01453039,20151105*/
         public static String NO_SHOW_NETWORKTYPE_DATA_DISABLE  = "isShowNetworkType";
         /*HQ_yulifeng for systemui  HQ01453039,20151105*/
         public static String SHOW_4G_ICON_CLARO  = "hw_show_4g";
         public static String SHOW_LTE_ICON_CLARO  = "hw_show_lte";
         /**
         ...
         //add by wuhuihui
         /**
          * M: keylog gestures enable
          * * @hide
          */
         public static final String KEYLOCK_GESTURES_SWITCH = "keylock_gestures_switch";
         /**
          * M: keylog gestures c
          * * @hide
          */
         public static final String KEYLOCK_GESTURES_C = "keylock_gestures_c";
         /**
          * M: keylog gestures e
          * * @hide
          */
         public static final String KEYLOCK_GESTURES_E = "keylock_gestures_e";
         /**
          * M: keylog gestures w
          * * @hide
          */
         public static final String KEYLOCK_GESTURES_W = "keylock_gestures_w";
         /**
          * M: keylog gestures m
          * * @hide
          */
         public static final String KEYLOCK_GESTURES_M = "keylock_gestures_m";
         /**
          * M: keylog gestures doubleclick
          * * @hide
          */
         public static final String KEYLOCK_GESTURES_DOUBLECLICK = "keylock_gestures_doubleclick";

		 /**
          * M: keylog gestures doubleclick
          * * @hide
          */
	     public static final String KEYLOCK_GESTURES_C_PKG = "keylock_gestures_c_pkg";

		 /**
          * M: keylog gestures doubleclick
          * * @hide
          */
		 public static final String KEYLOCK_GESTURES_E_PKG = "keylock_gestures_e_pkg";

		 /**
          * M: keylog gestures doubleclick
          * * @hide
          */
		 public static final String KEYLOCK_GESTURES_W_PKG = "keylock_gestures_w_pkg";
		 
		 /**
          * M: keylog gestures doubleclick
          * * @hide
          */
		 public static final String KEYLOCK_GESTURES_M_PKG = "keylock_gestures_m_pkg";
          
         //add end
         //add by jiangchao
         /**
          * M: Account Login for HW
          * * @hide
          */
        public static final String HW_LOGIN = "false";
        //add

        //add by jiangchao
        /**
         * M: DoubleClock auto time zone
         * * @hide
         */
        ...
        //add end
         //add by xuweijie
         /**
          * M: fingerprint phone enable
          * * @hide
          */
         public static final String FINGERPRINT_PHONE_SWITCH = "fingerprint_phone_switch";
         /**
          * M: fingerprint camera enable
          * * @hide
          */
         public static final String FINGERPRINT_CAMERA_SWITCH = "fingerprint_camera_switch";
	/**
          * M: fingerprint alarmclock enable
          * * @hide
          */
         public static final String FINGERPRINT_ALARMCLOCK_SWITCH = "fingerprint_alarmclock_switch";
         /**
         /**
          * M: fingerprint keyguard enable
          * * @hide
          */
         public static final String FINGERPRINT_KEYGUARD_SWITCH = "fingerprint_keyguard_switch";
         /**
          * M: fingerprint security enable
          * * @hide
          */
         public static final String FINGERPRINT_SECURITY_SWITCH = "fingerprint_security_switch";
         /**
          * M: fingerprint applock enable
          * * @hide
          */
         public static final String FINGERPRINT_APPLOCK_SWITCH = "fingerprint_applock_switch";
        //add end

         /** MTK ADD END. @} */
		
		/*HQ_liugang add for set default theme 20150821*/
         public static final String HW_DEFAULT_THEME = "hw_def_theme";
        /*add end*/	

		//HQ_liukai3 20150901 modify for HQ01336075 start
	     public static final String DOUBLE_CLOCK_SWITCH = "dual_clocks";
         public static final String DOUBLE_CLOCK_CITY_LIST_SWITCH = "dual_clocks_city_list";
	     public static final String DOUBLE_CLOCK_DEFAULT_TIME_ZONE = "keyguard_default_time_zone";
	    //HQ_liukai3 20150901 modify for HQ01336075 end
	  /** HQ_yanzewen ADD END. @} */
	     public static final String TOUCH_DISABLE_MODE = "touch_disable_mode";
        /** HQ_yanzewen ADD END. @} */
	     /**
          * M: add data cost tip dialog switch for HQ01454910 by hushunli
          * * @hide
          */
         public static final String DATA_COST_TIP_SWITCH = "data_cost_tip_switch";
    }
    ...
    public static final class Global extends NameValueTable {
        ...
        //fengyaling 20150814 add for default brightbess start
          public static final String CONVERT_BRIGHTNESS_FACTOR = "convert_brightnesss_factor";
       ...
       public static final String DATA_ROAMING_STATE = "data_roaming_state";
