...
/*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
    ...
    public CharSequence getText(int id) throws NotFoundException {
        ...
        if (res != null) {
			if("sr".equals(Locale.getDefault().getLanguage())){
                               res = HQTextUtils.serbianSyrillic2Latin(res);//add by gaoyuhao for HQ01337790
                       }
            return res;
        }
    ...
    public CharSequence getQuantityText(int id, int quantity) throws NotFoundException {
        ...
        if (res != null) {
			 if("sr".equals(Locale.getDefault().getLanguage())){
                               res = HQTextUtils.serbianSyrillic2Latin(res);//add by gaoyuhao
                       }
            return res;
        }
    ...
    public String getString(int id) throws NotFoundException {
		...
		if (res != null) {
//			Log.i("tang", "the res is " + res.toString());
			if (res.toString().equals("simple default")) {
				Locale locale = getConfiguration().locale;// 获得local对象
...
*/				if (country.equals("US") && language.equals("fil")) {
        ...
        if (res != null) {
			if("sr".equals(Locale.getDefault().getLanguage())){
                               for(int i = 0;i<res.length;i++){
                                       res[i] = HQTextUtils.serbianSyrillic2Latin(res[i]);//add by gaoyuhao
                               }
                       }
            return res;
        }
    ...
    public final class Theme {
        ...
        public void applyStyle(int resId, boolean force) {
            /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
            //DTS2013121107644
            int realTheme = HwWidgetFactory.getHuaweiRealTheme(resId);
            AssetManager.applyThemeStyle(mTheme, realTheme, force);
            /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
            mThemeResId = resId;
    ...
    /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
    protected Drawable loadDrawable(TypedValue value, int id, Theme theme) throws NotFoundException {
    /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
        if (TRACE_FOR_PRELOAD) {
        ...
        /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
        dr = handleAddIconBackground(id, dr);
        /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
    ...
    /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
    protected ColorStateList loadColorStateList(TypedValue value, int id)
            throws NotFoundException {
    /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
        if (TRACE_FOR_PRELOAD) {
            // Log only framework resources
