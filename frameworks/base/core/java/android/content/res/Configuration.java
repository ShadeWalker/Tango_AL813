...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
    public IHwConfiguration extraConfig = HwThemeManager.initHwConfiguration();
    /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
    ...
    public String toString() {
        ...
        /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
        sb.append(extraConfig.toString());
        /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
        if (seq != 0) {
            sb.append(" s.");
            sb.append(seq);
    ...
    public int updateFrom(Configuration delta) {
        ...
        /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
        changed |= extraConfig.updateFrom(delta.extraConfig);
        /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
        if (delta.seq != 0) {
            seq = delta.seq;
        }
    ...
    public int diff(Configuration delta) {
        ...
        /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
        changed |= extraConfig.diff(delta.extraConfig);
        /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
        if (delta.locale != null
                && (locale == null || !locale.equals(delta.locale))) {
            changed |= ActivityInfo.CONFIG_LOCALE;
    ...
    public static boolean needNewResources(int configChanges, int interestingChanges) {
        ...
        return ((configChanges & (interestingChanges|ActivityInfo.CONFIG_FONT_SCALE)) != 0
                      || (configChanges & ActivityInfoEx.CONFIG_HWTHEME) != 0);
        /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
    }
    ...
    public int compareTo(Configuration that) {
        ...
        /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
        if (n != 0) return n;
        n = extraConfig.compareTo(that.extraConfig);
        /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
        return n;
    }
