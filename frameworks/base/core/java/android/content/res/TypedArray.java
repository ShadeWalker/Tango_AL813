...
import android.text.HQTextUtils;//add by gaoyuhao for HQ01337790

import java.util.Locale;//add by gaoyuhao for HQ01337790
    ...
    public CharSequence getText(int index) {
        ...
        if (type == TypedValue.TYPE_NULL) {
            ...
            //return loadStringValueAt(index);
			 CharSequence text = loadStringValueAt(index);
               if("sr".equals(Locale.getDefault().getLanguage())){
                               text = HQTextUtils.serbianSyrillic2Latin(text);//add by gaoyuhao
                       }
                       return text;
        }
        ...
        if (getValueAt(index, v)) {
            ...
            //return v.coerceToString();
			 CharSequence text = v.coerceToString();
               if("sr".equals(Locale.getDefault().getLanguage())){
                               text = HQTextUtils.serbianSyrillic2Latin(text);//add by gaoyuhao
                       }
                       return text;
    ...
    public String getString(int index) {
        ...
        if (type == TypedValue.TYPE_NULL) {
            ...
            //return loadStringValueAt(index).toString();
			 String text = loadStringValueAt(index).toString();
//			 Log.i("tang", "the text is "+text);
			 if(text.equals("bag default")){
				 Locale locale = getResources().getConfiguration().locale;// 获得local对象
					String country = locale.getCountry(); // 可以通过local获得相关的属性 如国家
					String language = locale.getLanguage();
/*					Log.i("tang", "the country is " + country);
					Log.i("tang", "the language is " + language);
*/					if (country.equals("US") && language.equals("fil")) {
						return "bag tl";
					} else if (country.equals("PH") && language.equals("fil")) {
						return "bag tl PH";
					} else if (country.equals("PH") && language.equals("tgl")) {
						return "bag tgl PH";

					} else if (language.equals("tgl")) {
						return "bag tgl";
					}
			}
        ...
        if (getValueAt(index, v)) {
			...
			CharSequence cs = v.coerceToString();
                       if("sr".equals(Locale.getDefault().getLanguage())){
                               cs = HQTextUtils.serbianSyrillic2Latin(cs);//add by gaoyuhao
                       }
        ...
        if (type == TypedValue.TYPE_STRING) {
            ...
            if (cookie < 0) {
               // return mXml.getPooledString(
				...
				String text=mXml.getPooledString(data[index+AssetManager.STYLE_DATA]).toString();
                               if("sr".equals(Locale.getDefault().getLanguage())){
                                       text = HQTextUtils.serbianSyrillic2Latin(text);//add by gaoyuhao
                               }
                               return text;
    ...
    public int getColor(int index, int defValue) {
        ...
        /* < DTS2014071600122 zhangxinming/00181848 20140724 begin */
        if (index >= length()) {
            Log.w(Resources.TAG, "TypedArray.getColor() index=" + index +
                    " out of bounds[" + length() + "] and return defValue=" + defValue);
            return defValue;
        }
        /*   DTS2014071600122 zhangxinming/00181848 20140724 end > */
        index *= AssetManager.STYLE_NUM_ENTRIES;
        final int[] data = mData;
        final int type = data[index+AssetManager.STYLE_TYPE];
        if (type == TypedValue.TYPE_NULL) {
            ...
            && type <= TypedValue.TYPE_LAST_INT) {
            /* < DTS2014102001272 zhangxinming/00181848 20140926 begin */
            return HwThemeManager.getThemeColor(data, index, mValue, mResources, getValueAt(index, mValue));
            /*   DTS2014102001272 zhangxinming/00181848 20140926 end > */
        } else if (type == TypedValue.TYPE_STRING) {
    ...
    public int getInteger(int index, int defValue) {
        ...
        /* < DTS2014071600122 zhangxinming/00181848 20140724 begin */
        if (index >= length()) {
            Log.w(Resources.TAG, "TypedArray.getInteger() index=" + index +
                    " out of bounds[" + length() + "] and return defValue=" + defValue);
            return defValue;
        }
        /*   DTS2014071600122 zhangxinming/00181848 20140724 end > */
    ...
    public int getDimensionPixelSize(int index, int defValue) {
        ...
        /* < DTS2014071600122 zhangxinming/00181848 20140724 begin */
        if (index >= length()) {
            Log.w(Resources.TAG, "TypedArray.getDimensionPixelSize() index=" + index +
                   " out of bounds[" + length() + "] and return defValue=" + defValue);
            return defValue;
        }
        /*   DTS2014071600122 zhangxinming/00181848 20140724 end > */
    ...
    public float getFraction(int index, int base, int pbase, float defValue) {
        ...
        /* < DTS2014071600122 zhangxinming/00181848 20140724 begin */
        if (index >= length()) {
            Log.w(Resources.TAG, "TypedArray.getFraction() index=" + index +
                    " out of bounds[" + length() + "] and return defValue=" + defValue);
            return defValue;
        }
        /*   DTS2014071600122 zhangxinming/00181848 20140724 end > */
