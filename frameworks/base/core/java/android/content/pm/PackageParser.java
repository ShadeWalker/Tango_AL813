...
/*< DTS2014101007196 guyue/00295151 20141114 begin*/
import android.hwcontrol.HwWidgetFactory;
/* DTS2014101007196 guyue/00295151 20141114 end>*/
/**
...
public class PackageParser {
    ...
    */
    ...
    /* HQ_tanyali 2015-10-10 modified for al812 insatlled apk can move to sd */
    ...
    /* HQ_tanyali 2015-10-10 modified end */
    ...
    private static Pair<String, String> parsePackageSplitNames(XmlPullParser parser,
        ...
        if (!"android".equals(packageName) && !"androidhwext".equals(packageName)) {
    ...
    private Package parseBaseApk(Resources res, XmlResourceParser parser, int flags,
        ...
        if (str != null && str.length() > 0) {
            ...
            /* < DTS2014102105499 yinwenshuai 00211458 20141107 begin */
            if (nameError != null && !"android".equals(pkgName) && !"androidhwext".equals(pkgName)) {
            /* DTS2014102105499 yinwenshuai 00211458 20141107 end > */
