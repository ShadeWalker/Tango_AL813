...
public class Patterns {
	...
	/**
	   * @hide
	   */
	public static final String GOOD_IRI_CHAR_MTK =
		"a-zA-Z0-9\\-\\_\\~";
	 
	private static final String GOOD_GTLD_CHAR_MTK =
		"a-zA-Z\\_\\~";
	 
	private static final String GOOD_PATH_CHAR_MTK =
		GOOD_IRI_CHAR_MTK + "\\;\\/\\?\\:\\@\\&\\=\\#\\~" + "\\-\\.\\+\\!\\*\\'\\(\\)\\_"; 
     ...
     */
		private static final String IRI =
			"[" + GOOD_IRI_CHAR_MTK + "]([" + GOOD_IRI_CHAR_MTK + "\\-]{0,61}[" + GOOD_IRI_CHAR_MTK + "]){0,1}"; 

    private static final String GOOD_GTLD_CHAR =
        "a-zA-Z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF";
	private static final String GTLD = "[" + GOOD_GTLD_CHAR_MTK + "]{2,63}"; 
     ...
     */
		public static final Pattern WEB_URL =
			Pattern.compile( "((?:(HTTP|http|https|Http|Https|rtsp|Rtsp):\\/\\/(?:(?:[a-zA-Z0-9\\$\\-\\_\\.\\+\\!\\*\\'\\(\\)"
			+ "\\,\\;\\?\\&\\=]|(?:\\%[a-fA-F0-9]{2})){1,64}(?:\\:(?:[a-zA-Z0-9\\$\\-\\_"
			+ "\\.\\+\\!\\*\\'\\(\\)\\,\\;\\?\\&\\=]|(?:\\%[a-fA-F0-9]{2})){1,25})?\\@)?)?"
			+ "(?:" + DOMAIN_NAME + ")"
			+ "(?:\\:\\d{1,5})?)" // plus option port number
			+ "(\\/(?:(?:[" + GOOD_IRI_CHAR + "\\;\\/\\?\\:\\@\\&\\=\\#\\~" // plus option query params
			+ "\\-\\.\\+\\!\\*\\'\\(\\)\\,\\_])|(?:\\%[a-fA-F0-9]{2}))*(?:[" + GOOD_PATH_CHAR_MTK + "]{1}))?"
			+ "(?:\\b|$|(?=[^a-zA-Z0-9\\-\\_\\~]+))"); // and finally, a word boundary or end of
    ...
    public static final Pattern PHONE_HUGO
    = Pattern.compile(                      // sdd = space, dot, or dash
            "(\\+[0-9]*[\\ ]*[0-9]*)|([0-9]*)"); // <digit><digit|sdd>+<digit>    modify by zhouguo for HQ01685543 at 20160121
