...
/* < DTS2016032208339 n00188159 20150122 delete for make use of google.android.webview begin*/
//delete
/*   DTS2016032208339 n00188159 20150122 delete for make use of google.android.webview end> */
...
public final class WebViewFactory {
    ...
    static WebViewFactoryProvider getProvider() {
        synchronized (sProviderLock) {
			...
			/*add by zhaizhanfeng for huawei privacy and copyright at 150928 start
            final int uid = android.os.Process.myUid();
            if (uid == android.os.Process.ROOT_UID || uid == android.os.Process.SYSTEM_UID) {
                throw new UnsupportedOperationException(
                        "For security reasons, WebView is not allowed in privileged processes");
            }
			add by zhaizhanfeng for huawei privacy and copyright at 150928 end */
