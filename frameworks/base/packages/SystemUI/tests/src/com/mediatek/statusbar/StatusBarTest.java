...
//    private List<SimInfoManager.SimInfoRecord> sSimInfos;
    ...
    public void testDataForDataSIMChanged() {
        ...
        /*
        if (SIMHelper.isMtkGeminiSupport()) {
 ...
 */
    ...
    private void checkMobileIconResource() {
        /// TODO: Should fix timing issue for incorrect state.
...
/*
    private boolean isAllRadioOff() {
        boolean isAllRadioOff = isAirplaneModeOn()
...
*/
    ...
    /*
        TextView carrierLabel = (SIMHelper.isMtkGeminiSupport())
