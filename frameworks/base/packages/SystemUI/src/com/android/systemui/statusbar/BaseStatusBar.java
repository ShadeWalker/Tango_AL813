...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    /// M: add for multi window 
    KeyguardSecurityModel mSecurityModel;
    ...
    public boolean isDeviceProvisioned() {
        /// M: Patch back CR ALPS02097912 for ALPS02150294,
        //  there maybe a timing issue that our mDeviceProvisioned is not the latest value,
        //  and this value is should not be false for most normal case, so when mDeviceProvisioned
...
//                + mFloatPanelView);
    ...
    /*new AsyncTask<Void, Void, Void>() {
                ...
                public Void doInBackground(Void... v) {
                    try {
                        Log.d(TAG, "getMountService");
                        final IMountService service = getMountService();
                        Log.d(TAG, "getPasswordType");
