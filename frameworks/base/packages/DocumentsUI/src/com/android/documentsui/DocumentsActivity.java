...
public class DocumentsActivity extends Activity {
    ...
    public void onCreate(Bundle icicle) {
		...
		// setActionBar(mToolbar);//HQ_zhangteng delete for HQ01284480 at 2015-07-26
    ...
    private class RestoreStackTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (/*mExternal && */ mState.action == ACTION_GET_CONTENT) {//modify by wangmingyue for HQ01381756
                showDrawer = true;
            }
    ...
    public void updateActionBar() {
        ...
        if (mSearchExpanded) {
            ...
            getActionBar().setDisplayShowTitleEnabled(false);//add by wangmingyue for HQ01438422
            ...
            if (mState.stack.size() <= 1) {
                ...
                mToolbarStack.setVisibility(View.GONE);
                mToolbarStack.setAdapter(null);
                getActionBar().setDisplayShowTitleEnabled(true);//add by wangmingyue for HQ01438422
				   getActionBar().setTitle(root.title);//HQ_zhangteng add for HQ01284480 at 2015-07-26
            } else {
                mToolbar.setTitle(null);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        mSearchView.getSearchSrcTextView().setTextColor(Color.WHITE);//add by wangmingyue for HQ01438422
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        //HQ_pangxuhui modify for bug:HQ01359622 20150912
