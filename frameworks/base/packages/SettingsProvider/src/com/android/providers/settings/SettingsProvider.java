...
public class SettingsProvider extends ContentProvider {
    ...
    private static final boolean LOCAL_LOGV = Build.TYPE.equals("eng");/* HQ_guomiao 2015-10-22 modified for HQ01419645 */
    ...
    private void sendNotify(Uri uri, int userHandle) {
        ...
        if (property != null) {
            ...
            for(int i=0;i<10;i++) {
                long newVersion = SystemProperties.getLong(property,0);
                if(newVersion >= version){
                    ...
                    try {
                        ...
                        Log.d(TAG,"after add interruptedException");
                    }
                }
                Log.d(TAG, "after added,property:" + property + "=" + version);
            }
        }
    ...
    public Bundle call(String method, String request, Bundle args) {
    	if( "ringtone2".equals(request) || "ringtone_2".equals(request)){
    		request = "ringtone_sim2";
    	}
        ...
        synchronized (cache) {
            ...
            if (value != null) {
                if (value != TOO_LARGE_TO_CACHE_MARKER) {
                    /* HQ_guomiao 2015-10-09 modified for HQ01433574 begin */
                    /*Log.d(TAG, "lookupValue table " + table + " cache contains Key "
                            + key + " , value = " + value);*/
                    /* HQ_guomiao 2015-10-09 modified for HQ01433574 end */
                    return value;
                }
