...
public class DefaultContainerService extends IntentService {
    ...
    private IMediaContainerService.Stub mBinder = new IMediaContainerService.Stub() {
        ...
        public String copyPackageToContainer(String packagePath, String containerId, String key,
			...
			Slog.d(TAG, "copyPackageToContainer:containerId:" + containerId +", isExternal:" + isExternal); //added for debug.chenwenshuai
            if (isExternal) {
                // Make sure the sdcard is mounted.
                String status = Environment.getExternalStorageStateEx();//changed for install app sdcard.chenwenshuai
	       Slog.d(TAG, "copyPackageToContainer:status:" + status );
            ...
            try {
				...
				Slog.d(TAG, "copyPackageToContainer:status: ");
        ...
        public PackageInfoLite getMinimalPackageInfo(String packagePath, int flags,
			...
			Slog.d(TAG,"getMinimalPackageInfo ret ="+ret.recommendedInstallLocation);//add Log for chenwenshuai
            return ret;
        }
