...
//HQ_zhangjing 2015-10-20 modified for al812 UI  
...
public class SubscriptionInfo implements Parcelable {
    ...
    public CharSequence getCarrierName() {
       /**add by liruihong for HQ01413006 begin*/
	...
	//Phone mPhone = PhoneFactory.getPhone(phoneId);
	 Context mContext =  SubscriptionManager.mContextEx;
	 ActivityManager amgr = null;
	 if(mContext != null){
		amgr=(ActivityManager)mContext.getSystemService(Context.ACTIVITY_SERVICE);
	 }
        String classname = null;

        if (amgr!=null && amgr.getRunningTasks(1) != null && amgr.getRunningTasks(1).get(0) != null) {
            classname = amgr.getRunningTasks(1).get(0).topActivity.getClassName();
        }

        if (classname != null && classname.equals("com.huawei.netassistant.ui.NetAssistantMainActivity")) {
             return this.mDisplayName;
        }
	/**add by liruihong for HQ01413006 end*/
    ...
    /*HQ_zhangjing 2015-10-20 modified for al812 ui begin*/
	/*
		...
		*/
        ...
        Bitmap iconbit;
        if( mSimSlotIndex == 0 ){
			iconbit = BitmapFactory.decodeResource(context.getResources(),com.hq.resource.internal.R.drawable.icon_card_sim1) ;  
        }else{
			iconbit = BitmapFactory.decodeResource(context.getResources(),com.hq.resource.internal.R.drawable.icon_card_sim2) ;  
        }
		return iconbit;
	/*HQ_zhangjing 2015-10-20 modified for al812 ui end*/	
    }
