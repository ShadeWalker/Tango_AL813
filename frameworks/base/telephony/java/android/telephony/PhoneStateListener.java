            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case LISTEN_SIGNAL_STRENGTHS:
                        /*HQ_guomiao add for HQ01455070 begin*/
                        if (SystemProperties.get("ro.hq.signal.while.calling").equals("1")) {
                            TelephonyManager tm = TelephonyManager.getDefault();
                            if(tm.getCallState() == TelephonyManager.CALL_STATE_OFFHOOK) {
                                int dbm = ((SignalStrength)msg.obj).getGsmSignalStrengthDbm();
                                Rlog.d(LOG_TAG, "dbm=" + dbm);
                                if (dbm < -105)
                                    return;
                            }
                        }
                        /*HQ_guomiao add for HQ01455070 end*/
