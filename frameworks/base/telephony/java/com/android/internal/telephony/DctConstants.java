...
public class DctConstants {
    ...
    public static final int EVENT_CHECK_FDN_LIST = MTK_BASE + 8;
    //VoLTE
    ...
    public static final int EVENT_POST_CREATE_PHONE = MTK_BASE + 27;
    // M: [LTE][Low Power][UL traffic shaping] Start
    public static final int EVENT_DEFAULT_APN_REFERENCE_COUNT_CHANGED = MTK_BASE + 28;
    public static final int EVENT_LTE_ACCESS_STRATUM_STATE = MTK_BASE + 29;
