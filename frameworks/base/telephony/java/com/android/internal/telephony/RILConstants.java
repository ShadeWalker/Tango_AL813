...
*/
    ...
    int RIL_REQUEST_DEACTIVATE_LINK_DOWN_PDN = (RIL_REQUEST_VENDOR_BASE + 126);
    ///@}
    /// M: IMS feature. @{
    int RIL_REQUEST_HOLD_CALL = (RIL_REQUEST_VENDOR_BASE + 127);
    /// @}


    /// M: [C2K][SVLTE] Set the STK UTK mode. @{
    int RIL_REQUEST_SET_STK_UTK_MODE = (RIL_REQUEST_VENDOR_BASE + 128);
    /// M: [C2K][SVLTE] Set the STK UTK mode. @}

    int RIL_REQUEST_SWITCH_ANTENNA = (RIL_REQUEST_VENDOR_BASE + 129);
    int RIL_REQUEST_SWITCH_CARD_TYPE = (RIL_REQUEST_VENDOR_BASE + 130);
    
    int RIL_REQUEST_ENABLE_MD3_SLEEP = (RIL_REQUEST_VENDOR_BASE + 131);

    // M: [LTE][Low Power][UL traffic shaping] Start
    int RIL_REQUEST_SET_LTE_ACCESS_STRATUM_REPORT = (RIL_REQUEST_VENDOR_BASE + 132);
    int RIL_REQUEST_SET_LTE_UPLINK_DATA_TRANSFER = (RIL_REQUEST_VENDOR_BASE + 133);
    ...
    /// M: For 3G VT only @{
    int RIL_UNSOL_VT_STATUS_INFO = (RIL_UNSOL_VENDOR_BASE + 68);
    int RIL_UNSOL_VT_RING_INFO = (RIL_UNSOL_VENDOR_BASE + 69);
    /// @}

    //External SIM [Start]
    int RIL_UNSOL_VSIM_OPERATION_INDICATION = (RIL_UNSOL_VENDOR_BASE + 70);
    //External SIM [End]

    int RIL_UNSOL_TRAY_PLUG_IN = (RIL_UNSOL_VENDOR_BASE + 71);

    // M: [LTE][Low Power][UL traffic shaping] Start
    int RIL_UNSOL_LTE_ACCESS_STRATUM_STATE_CHANGE = (RIL_UNSOL_VENDOR_BASE + 72);
    // M: [LTE][Low Power][UL traffic shaping] End
