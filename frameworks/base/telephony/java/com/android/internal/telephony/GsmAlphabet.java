...
import android.util.Log;//add by lipeng
//add by lipeng
import com.android.internal.telephony.SevenConfigOverride;
import com.android.internal.telephony.SevenConfigOverride.MmsSevenConfigBean;
...
public class GsmAlphabet {
    ...
    private final static String mccmncNoSimInserted = "999999";//add by lipeng
    ...
    public static byte[] stringToGsm7BitPackedWithHeader(String data, byte[] header,
        ...
        byte[] ret = stringToGsm7BitPacked(data, headerSeptets, true, languageTable,
                languageShiftTable);
        //add by lipeng for 7bit in al813
        if(SystemProperties.get("ro.hq.mms.ap.sevenbit").equals("1")) {
        ret = stringToGsm7BitPacked(data, headerSeptets, false, languageTable,
                languageShiftTable);
        }//end by lipeng
        // Paste in the header
    ...
    public static byte[] stringToGsm7BitPacked(String data, int languageTable,
            ...
            throws EncodeException {
        //add by lipeng for 7bit al813 in 20150818
        if(SystemProperties.get("ro.hq.mms.ap.sevenbit").equals("1")) {         
         return stringToGsm7BitPacked(data, 0, false, languageTable, languageShiftTable);
        }//end by lipeng
    ...
    public static String getSimMccMnc(int slotId) {
		...
		Log.d("lipeng","frameworkmmsSlot = " + slotId);
    ...
    static {
     ...
     //add by lipeng for 7-bit tools xml
         if(SystemProperties.get("ro.hq.mms.ap.sevenbit").equals("1")) {
                 Resources r = Resources.getSystem();
                 //String[] array_before;
                 //int[] array_int;
				 ...
				 /*HQ_zhangjing 2015-11-11 modified for CQ HQ01453218 begin*/
				 //final int[] specialForPeru = {'\u03c0','\u00b6','\u00a9','\u00ae','\u2122','\u2022','\u221a','\u00f7','\u00d7','\u00a2','\u00b0','\u00b7','\u005c'};
				 final int[] specialForPeru = {0x3c0,0xb6,0xa9,0xae,0x2122,0x221a,0xf7,0xd7,0xa2,0xb0,0xb7,0x5c};
				 /*HQ_zhangjing 2015-11-11 modified for CQ HQ01453218 begin*/
                 SevenConfigOverride mSevenConfigOverride = SevenConfigOverride.getInstance();
                 
				 int slotId=PhoneNumberUtils.getSlotId();
				 Log.d("lipeng","activieSlot_framework = " + slotId);
                 String mccmnc = getSimMccMnc(slotId);/*slotId*/
                 //String config = mSevenConfigOverride.getSevenBitWithSim(mccmnc);

                 String config = "";
                 if(mSevenConfigOverride.containsMccmncForSevenBit(mccmnc)){
                     MmsSevenConfigBean bean = mSevenConfigOverride.getSevenBitWithSim(mccmnc);
                     config = bean.sevenBitConfig;
                 }
                 if(config==null ||"".equals(config)){
                         config = "-1";
                 }
                 Log.d("7bit","config :"+config);
                 /*HQ_zhaizhanfeng 2015-12-16 modified for ICE 7bit begin*/
                 if(SystemProperties.get("ro.hq.mms.ice.sevenbit").equals("1")){
                 final String[] array_before_ice ={"À","Á","Â","Ã","È","Ê","Ë","Ð","Ì","Í","Î","Ï","Ò","Ó","Ô","Õ","Ù","Ú","Û","Ü","Ý","Þ","á","â","ã","ç","ê","ë","ð","í","î","ï","ó","ô","õ","ú","û","ü","ý","þ","ÿ"};
                 final int[] array_int_ice ={0x41,0x41,0x41,0x41,0x45,0x45,0x45,0x44,0x49,0x49,0x49,0x49,0x4f,0x4f,0x4f,0x4f,0x55,0x55,0x55,0x55,0x59,0x59,0x61,0x61,0x61,0x63,0x65,0x65,0x65,0x69,0x69,0x69,0x6f,0x6f,0x6f,0x75,0x75,0x75,0x79,0x79,0x79};
                 if(!mccmnc.equals("999999") && array_int_ice!=null && array_int_ice.length>0 &&(array_int_ice.length==array_before_ice.length)){
                         for(int i =0;i< array_int_ice.length;i++){
                                 int beforeCode = array_before_ice[i].charAt(0);                                 
                                 defaultCharToGsm.put(beforeCode, array_int_ice[i]);
                         }
                     }
                 }
                 /*HQ_zhaizhanfeng 2015-12-16 modified for ICE 7bit end*/
                 /*HQ_lipeng 2015-11-11 modified for Telcel 7bit begin*/
                 if(SystemProperties.get("ro.hq.mms.telcel.sevenbit").equals("1")){
                 final String[] array_before_telcel ={"À","Á","Â","Ã","È","Ê","Ë","Ð","Ì","Í","Î","Ï","Ò","Ó","Ô","Õ","Ù","Ú","Û","Ý","Þ","á","â","ã","ç","ê","ë","ð","í","î","ï","ó","ô","õ","ú","û","ý","þ","ÿ"};
                 final int[] array_int_telcel ={0x41,0x41,0x41,0x41,0x45,0x45,0x45,0x44,0x49,0x49,0x49,0x49,0x4f,0x4f,0x4f,0x4f,0x55,0x55,0x55,0x59,0x59,0x61,0x61,0x61,0x63,0x65,0x65,0x65,0x69,0x69,0x69,0x6f,0x6f,0x6f,0x75,0x75,0x79,0x79,0x79};
                 if(!mccmnc.equals("999999") && array_int_telcel!=null && array_int_telcel.length>0 &&(array_int_telcel.length==array_before_telcel.length)){
                         for(int i =0;i< array_int_telcel.length;i++){
                                 int beforeCode = array_before_telcel[i].charAt(0);                                 
                                 defaultCharToGsm.put(beforeCode, array_int_telcel[i]);
                         }
                     }
                 }
                 /*HQ_lipeng 2015-11-11 modified for Telcel 7bit end*/
                 /*HQ_lipeng 2015-11-11 modified for tigo 7bit begin*/
                 if(SystemProperties.get("ro.hq.mms.tigo.sevenbit").equals("1")){
                 final String[] array_before_tigo ={"À","Á","Â","Ã","È","Ê","Ë","Ì","Í","Î","Ï","Ð","Ò","Ó","Ô","Õ","Ù","Ú","Û","Ý","Þ","á","â","ã","ç","ê","ë","í","í","î","ï","ð","ó","ô","õ","ú","û","ý","þ","ÿ"};
                 final int[] array_int_tigo ={0x41,0x41,0x41,0x41,0x45,0x45,0x45,0x49,0x49,0x49,0x49,0x44,0x4f,0x4f,0x4f,0x4f,0x55,0x55,0x55,0x59,0x59,0x61,0x61,0x61,0x63,0x65,0x65,0x69,0x69,0x69,0x69,0x65,0x6f,0x6f,0x6f,0x75,0x75,0x79,0x79,0x79};
                 if(!mccmnc.equals("999999") && array_int_tigo!=null && array_int_tigo.length>0 &&(array_int_tigo.length==array_before_tigo.length)){
                         for(int i =0;i< array_int_tigo.length;i++){
                                 int beforeCode = array_before_tigo[i].charAt(0);                                 
                                 defaultCharToGsm.put(beforeCode, array_int_tigo[i]);
                         }
                     }
                 }
                 /*HQ_lipeng 2015-11-11 modified for tigo 7bit end*/
                 /*HQ_lipeng 2015-11-11 modified for Movistar 7bit begin*/
                 if(SystemProperties.get("ro.hq.mms.movistar.sevenbit").equals("1")){
                 final String[] array_before_movistar ={"¨","ę","ē","Ę","Ē","ř","Ř","ť","Ť","ů","ū","á","å","æ","à","ä","â","ã","Á","ó","œ","ǿ","õ","ô","ò","¹","²","³","Ă","Ĕ","đ","Ĳ","Ů","Ū","ī","Ī","İ","ō","Ō","ą","ā","Ą","Å","Æ","À","Ä","Â","Ã","è","Ґ","Œ","Ǿ","Õ","Ô","Ö","Ò","ª","΄","ö","Ũ","Ĺ","Ľ","Ā","ś","ş","Ś","Ş","ď","Ď","ğ","Ğ","ł","Ł","ê","ë","ė","È","Ê","ú","ù","û","Ú","š","ë","Ð","Ž","Ũ","Ý","ý","ŕ","Š","ź","ż","Ź","Ż","ć","č","Ć","Č","ń","ň","Ň","Ë","Ė","í","î","į","Ù","Û","Ó","ž","Ґ","­","«","“","þ","ö","ÿ","ǎ","ţ","ĳ","Ń","–","—","˝","‚","†","√","•","÷","¢","º","ì","ï","Í","Î","Į","Ì","Ï","¯","”","≥","ç","ě","ǔ","Ţ","Ŕ","¶","×","„","⅓","⅔","♠","′","→","≤","⁴","⅝","©","…","¼","¾","½","♪","″","∞","›","⅞","ⁿ","®","°","⅛","⅜","₱","♥","←","≠","`","∅","‘","™","±","‡","·","★","♦","↑","≈","¦","’","»","`","‰","¬","ð","♣","π","↓","‹","‛","℉","¿"};
                 final int[] array_int_movistar ={};
                 if(array_int_movistar!=null && array_int_movistar.length>0 &&(array_int_movistar.length==array_before_movistar.length)){
                         for(int i =0;i< array_int_movistar.length;i++){
                                 int beforeCode = array_before_movistar[i].charAt(0);                                 
                                 defaultCharToGsm.put(beforeCode, array_int_movistar[i]);
                         }
                     }
                 }
                 /*HQ_lipeng 2015-11-11 modified for Movistar 7bit end*/
                 /*HQ_lipeng 2015-11-11 modified for latin 7bit begin*/
                 if(SystemProperties.get("ro.hq.mms.latin.sevenbit").equals("1")&& (!mccmnc.startsWith("734"))){
                 final String[] array_before_latin ={"À","Á","Â","Ã","È","Ê","Ë","Ð","Ì","Í","Î","Ï","Ò","Ó","Ô","Õ","Ù","Ú","Û","Ý","Þ","á","â","ã","ê","ë","ð","í","î","ï","ó","ô","õ","ú","û","ý","þ","ÿ","ç"};
                 final int[] array_int_latin ={0x41,0x41,0x41,0x41,0x45,0x45,0x45,0x44,0x49,0x49,0x49,0x49,0x4f,0x4f,0x4f,0x4f,0x55,0x55,0x55,0x59,0x59,0x61,0x61,0x61,0x65,0x65,0x65,0x69,0x69,0x69,0x6f,0x6f,0x6f,0x75,0x75,0x79,0x79,0x79,0x63};
                 if(!mccmnc.equals("999999") && array_int_latin!=null && array_int_latin.length>0 &&(array_int_latin.length==array_before_latin.length)){
                         for(int i =0;i< array_int_latin.length;i++){
                                 int beforeCode = array_before_latin[i].charAt(0);                                 
                                 defaultCharToGsm.put(beforeCode, array_int_latin[i]);
                         }
                    }
                 }
                 /*HQ_lipeng 2015-11-11 modified for latin 7bit end*/
                 /*HQ_lipeng 2015-11-11 modified for Venezuela 7bit begin*/
                 if(SystemProperties.get("ro.hq.mms.latin.sevenbit").equals("1") && mccmnc.startsWith("734")){
                 final String[] array_before_Venezuela ={"₱","★","♣","♠","♪","♥","♦","π","′","″","←","↑","↓","→","∞","≠","≈","‹","≤","›","≥","Á","Ã","Ă","Ĕ","Ó","Ô","Ö","ó","ô","ö","Ũ","Ý","ý","ÿ","ǎ","ç","ě","ǔ","đ","Ĳ","ĳ","Ĺ","Ľ","Ŕ","ŕ","Š","Ţ","ţ","Ž","ž","Ґ","¶","©","®","™","•","√","÷","×","¢","`","°","…","„","±","‰","º","¨","ę","ē","Ę","Ē","ř","Ř","ť","Ť","ů","ū","Ů","Ū","ī","Ī","İ","ō","Ō","ą","ā","Ą","Ā","ś","ş","Ś","Ş","ď","Ď","ğ","Ğ","ł","Ł","ź","ż","Ź","Ż","ć","č","Ć","Č","ń","ň","Ň","Ń","⅓","⅛","⅔","⅜","–","—","˝","‚","†","‡","¹","²","³","ª","þ","š","ð","Ð","·","«","»","“","”","¦","½","¼","¾","¬","á","å","æ","à","ä","â","ã","Å","Æ","À","Ä","Â","è","ê","ë","ė","È","Ê","Ë","Ė","í","î","į","ì","ï","Í","Î","Į","Ì","Ï","œ","ǿ","õ","ò","Œ","Ǿ","Õ","Ò","ú","ù","û","Ù","Û","Ú","¯","­","∏","℉","΄"};
                 final int[] array_int_Venezuela ={};
                 if(!mccmnc.equals("999999") && array_int_Venezuela!=null && array_int_Venezuela.length>0 &&(array_int_Venezuela.length==array_before_Venezuela.length)){
                         for(int i =0;i< array_int_Venezuela.length;i++){
                                 int beforeCode = array_before_Venezuela[i].charAt(0);                                 
                                 defaultCharToGsm.put(beforeCode, array_int_Venezuela[i]);
                         }
                     }
                 }
                 /*HQ_lipeng 2015-11-11 modified for Venezuela 7bit end*/

                 /*HQ_lipeng 2015-11-11 modified for claro 7bit begin*/
                 if(SystemProperties.get("ro.hq.mms.claro.sevenbit").equals("1")&& (!mccmnc.startsWith("71610"))){
                 final String[] array_before_claro ={"Á","Ú","Í","Ó","á","ú","í","ó"};
                 final int[] array_int_claro ={0x41,0x55,0x49,0x4f,0x61,0x75,0x69,0x6f};
                 if(!mccmnc.equals("999999") && array_int_claro!=null && array_int_claro.length>0 &&(array_int_claro.length==array_before_claro.length)){
                         for(int i =0;i< array_int_claro.length;i++){
                                 int beforeCode = array_before_claro[i].charAt(0);                                 
                                 defaultCharToGsm.put(beforeCode, array_int_claro[i]);
                         }
                    }
                 }
                 /*HQ_lipeng 2015-11-11 modified for claro 7bit end*/  
                 /*HQ_lipeng 2015-11-11 modified for peru of claro 7bit begin*/
                 if(SystemProperties.get("ro.hq.mms.claro.sevenbit").equals("1") && mccmnc.startsWith("71610")){
                 final String[] array_before_peru ={"À","Á","Â","Ã","È","Ê","Ë","Ì","Í","Î","Ï","Ò","Ó","Ô","Õ","Ù","Ú","Û","á","â","ã","ê","ë","í","î","ï","ó","ô","õ","ú","û","ç","π","¶","©","®","™","√","÷","×","¢","°","•","Ė","Ę","Ē","Ū","Ü","Ī","Į","º","Ō","Œ","Ø","Ö","Å","Ą","Æ","Ā","ª","Ä","Č","Ç","Ć","Ñ","Ń","ė","ę","ē","è","ū","ù","ü","ī","į","ì","ï","º","ō","œ","ø","ö","ó","å","ą","æ","ā","ª","à","ä","ä","ã","č","ç","ć","ñ","ń","`","♪","√","÷","×","§","¢","←","↑","↓","→","∞","≠","≈","℅","≤","«","≥","»","…","¹","½","⅓","¼","⅛","²","⅔","⅜","³","¾","⁴","⅝","⅞","ⁿ","∅","₱","‰","±","★","†","‡","„","“","”","«","»","‚","‘","’","‹","›","…","—","¢","_","–","·","_"};
                 final int[] array_int_peru ={};
                 if(!mccmnc.equals("999999") && array_int_peru!=null && array_int_peru.length>0 &&(array_int_peru.length==array_before_peru.length)){
                         for(int i =0;i< array_int_peru.length;i++){
                                 int beforeCode = array_before_peru[i].charAt(0);                                 
                                 defaultCharToGsm.put(beforeCode, array_int_peru[i]);
                         }
                     }
                 }
                 /*HQ_lipeng 2015-11-11 modified for peru of claro 7bit end*/

 
         }//end by lipeng for 7-bit tools xml
