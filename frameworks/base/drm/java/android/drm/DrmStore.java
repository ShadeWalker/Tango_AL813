...
public class DrmStore {
	...
	/// M: Add for huawei, use to show renew and expire dialog when do check right status
        /**
         * @hide
         */
        //public static final int DRM_ACTION_SHOW_DIALOG = 0x100; // for huawei
	  public static final int DRM_ACTION_SHOW_DIALOG = 0x101;//modified by lihaizhou for show huawei own dialog instead of MTK dialog
	...
	/// M: Add for huawei, MTK define status, if need more protection, huawei can check this {@
        /**
         * M: MTK will check secure timer whether valid, only valid device could open drm file.
         * @hide
     ...
     */
    public DrmStore() {}
    /// M: Add for huawei, MTK define metadata key and drm method.
    /// huawei define DrmType, need convert from mtk drm method to huawei drm type {@
    /**
     * MTK defines the key of DCF file metadata.
     * @hide
     */
    public static class MetadataKey {
        public static final String META_KEY_IS_DRM = "isdrm";
    ...
    /**
     * MTK defines method type of OMA DRM v1.0
     * @hide
     */
    ...
    /**
     * MTK defines object mimetype of OMA DRM v1.0
     * @hide
     */
    public static class DrmObjectMimeType {
        ...
        public static final String MIME_CTA5_MESSAGE = "application/vnd.mtk.cta5.message";
    }

    /**
     * Huawei define drm type of OMA DRM v1.0(same as drm method)
     * @hide
     */
    public static class DrmType {
        public static final int UNKOWN = 0x04;
	public static final int FORWARD_LOCK = 0x05;
	public static final int COMBINED_DELIVERY = 0x06;
	public static final int SEPARATE_DELIVERY = 0x07;
	public static final int SEPARATE_DELIVERY_FL = 0x08;
    }
    /// @}
}
