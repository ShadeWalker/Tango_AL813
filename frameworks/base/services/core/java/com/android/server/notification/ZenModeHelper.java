...
/* <DTS2015030701092 xiongshiyi/x00165767 20150307 begin */
import android.hsm.HwSystemManager;
/* DTS2015030701092 xiongshiyi/x00165767 20150307 end> */
/**
...
public class ZenModeHelper implements AudioManagerInternal.RingerModeDelegate {
    ...
    private boolean shouldInterceptAudience(NotificationRecord record) {
        /* <DTS2015030701092 xiongshiyi/x00165767 20150307 begin */
    	/* <DTS2015042405887 xiongshiyi/x00165767 20150421 begin */
        //[HSM]
        if (HwSystemManager.shouldInterceptAudience(
            ValidateNotificationPeople.getExtraPeople(record.getNotification().extras),
            record.sbn.getPackageName())) {
            return true;
        }
        /* DTS2015042405887 xiongshiyi/x00165767 20150421 end> */
        /* DTS2015030701092 xiongshiyi/x00165767 20150307 end> */
    ...
    */
    ...
    private void applyRestrictions(boolean mute, int usage) {
        /* DTS2014121200445 tiandazhang/00107790 20141218 begin */
        final String[] alarmExceptionPackages = {"com.android.deskclock"};
		
        final String[] exceptionPackages = null; // none (for now)
        mAppOps.setRestriction(AppOpsManager.OP_VIBRATE, usage,
                mute ? AppOpsManager.MODE_IGNORED : AppOpsManager.MODE_ALLOWED,
                alarmExceptionPackages);
    ...
    private void applyZenToRingerMode() {
        ...
        switch (mZenMode) {
            case Global.ZEN_MODE_NO_INTERRUPTIONS:
            	//hanchao change for HQ01428341 begin
                /*if (ringerModeInternal != AudioManager.RINGER_MODE_SILENT) {
                    mPreviousRingerMode = ringerModeInternal;
                    newRingerModeInternal = AudioManager.RINGER_MODE_SILENT;
                }*/
            	//hanchao change for HQ01428341 end
                break;
            case Global.ZEN_MODE_IMPORTANT_INTERRUPTIONS:
                if (ringerModeInternal != AudioManager.RINGER_MODE_SILENT) {
                    mPreviousRingerMode = ringerModeInternal;
            ...
            case Global.ZEN_MODE_OFF:
                if (ringerModeInternal == AudioManager.RINGER_MODE_SILENT) {
                    ...
                    /*newRingerModeInternal = mPreviousRingerMode != -1 ? mPreviousRingerMode
                            : AudioManager.RINGER_MODE_SILENT;     //hanchao change HQ01397213  2015.9.29
                    mPreviousRingerMode = -1;*/
                	//hanchao change for HQ01428341 end
                }
                break;
        }
        //mod by HQ_machao1 at 20150727 HQ01254531 begin
        //hanchao change for HQ01428341 begin
        /*if (newRingerModeInternal != -1) {
            mAudioManager.setRingerModeInternal(newRingerModeInternal, TAG);
        }*/
        //mod by HQ_machao1 at 20150727 HQ01254531 end
        //hanchao change for HQ01428341 end
    }
