...
/*< DTS2014102003603 zhaifeng/00107904 20141106 begin */
import com.android.server.HwServiceFactory;
/* DTS2014102003603 zhaifeng/00107904 20141106 end >*/
 ...
 **/
/*<DTS2015010602760 huangbangbang/00191767 & gaowei/00231769 20150107 begin */
public class WindowStateAnimator {
/* DTS2015010602760 huangbangbang/00191767 & gaowei/00231769 20150107 end>*/
    ...
    /*<DTS2014082501967 zhudengkui / 00180854 20140831 begin */
    boolean mWallpaperOffSetPending;
    float mSurfaceXPending = 0;
    float mSurfaceYPending = 0;
    /* DTS2014082501967 zhudengkui / 00180854 20140831 end>*/
    ...
    boolean stepAnimationLocked(long currentTime) {
        ...
        mKeyguardGoingAwayAnimation = false;
        /*<DTS2014082501967 zhudengkui / 00180854 20140831 begin */
        if (mWallpaperOffSetPending && mSurfaceControl != null ) {
            mWallpaperOffSetPending = false;
            setWallpaperOffsetPending(mSurfaceXPending, mSurfaceYPending);
            mSurfaceXPending = 0;
            mSurfaceYPending = 0;
        }
        /* DTS2014082501967 zhudengkui / 00180854 20140831 end>*/
    ...
    static class SurfaceTrace extends SurfaceControl {
        ...
        public SurfaceTrace(SurfaceSession s,
            ...
            if (logSurfaceTrace) Slog.v(SURFACE_TAG, "create: " + this + ". Called by "
                    + Debug.getCallers(3));
        ...
        if (mIsWallpaper && !mWin.mWallpaperVisible) {
            ...
            if (mSurfaceControl != null) {
                try {
                    ...
                    /*< DTS2014102003603 zhaifeng/00107904 20141106 begin */
                    /*<DTS2015010602760 huangbangbang/00191767 & gaowei/00231769 20150107 begin */
                    mAnimLayer = adjustAnimLayerIfCoverclosed(mWin.mAttrs.type, mAnimLayer);
                    /* DTS2015010602760 huangbangbang/00191767 & gaowei/00231769 20150107 end>*/
                    /* DTS2014102003603 zhaifeng/00107904 20141106 end >*/
                    mSurfaceControl.setLayer(mAnimLayer);
    ...
    void setTransparentRegionHintLocked(final Region region) {
        ...
        if (WindowManagerService.SHOW_LIGHT_TRANSACTIONS) Slog.i(TAG, ">>> OPEN TRANSACTION setTransparentRegion");
        SurfaceControl.openTransaction();
        try {
            if (WindowManagerService.SHOW_TRANSACTIONS) WindowManagerService.logSurface(mWin,
...
//            mSurfaceY = top;
            ...
            if (mAnimating) {
                ...
                /*<DTS2014082501967 zhudengkui / 00180854 20140831 begin */
                Slog.w(TAG, "setWallpaperOffset  mAnimating is true");
                mWallpaperOffSetPending = true;
                mSurfaceXPending = mSurfaceX;
                mSurfaceYPending = mSurfaceY;
                /* DTS2014082501967 zhudengkui / 00180854 20140831 end>*/
                return;
            }
            /// M: ALPS00434925. When animating, it should not update the top
            ...
            mSurfaceY = top;
            /// @}
            if (WindowManagerService.SHOW_LIGHT_TRANSACTIONS) Slog.i(TAG, ">>> OPEN TRANSACTION setWallpaperOffset");
            SurfaceControl.openTransaction();
            try {
                if (WindowManagerService.SHOW_TRANSACTIONS) WindowManagerService.logSurface(mWin,
                        "POS " + left + ", " + top, null);
                ...
                if (MultiWindowProxy.isFeatureSupport()) {
                    TaskStack tmpStack = getStack();
                    if (tmpStack != null)
                        tmpStack.onWinPositionChanged(this, mWin.mFrame.left + left, mWin.mFrame.top + top);
                }
                /// @}
    ...
    /*<DTS2014082501967 zhudengkui / 00180854 20140831 begin */
    private void setWallpaperOffsetPending(float left, float top) {
        Slog.w(TAG, "setWallpaperOffsetPending >>> OPEN TRANSACTION setWallpaperOffset  left =" + left + " top = " +top);
        SurfaceControl.openTransaction();
        try {
            if (WindowManagerService.SHOW_TRANSACTIONS) WindowManagerService.logSurface(mWin,
                    "POS " + left + ", " + top, null);
