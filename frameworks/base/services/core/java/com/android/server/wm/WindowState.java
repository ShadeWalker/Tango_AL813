...
/* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
    ...
    WindowState(WindowManagerService service, Session s, IWindow c, WindowToken token,
        ...
        if(iwsa != null) {
            mWinAnimator = iwsa.getInstance(this);
        } else {
    ...
    void reportResized() {
        try {
            ...
            /*<DTS2015011509714 zhudengkui/00180854 20150115 begin >*/
            mOverscanInsetsChanged = false;
            mContentInsetsChanged = false;
            mVisibleInsetsChanged = false;
            mStableInsetsChanged = false;
            mWinAnimator.mSurfaceResized = false;
            /* DTS2015011509714 zhudengkui/00180854 20150115 end>*/
    ...
    public void adjustFloatingRect(int xOffset, int yOffset){
        if (isFloatingWindow()) {
            ...
            /// M: [ALPS02079422] Return window offset replace stach offset
            mXOffsetOfStackbound = xOffset;
            mYOffsetOfStackbound = yOffset;
        }
    }
    /// @}
    ...
    public boolean isFullFloatWindow() {
        ...
        /// M: BMW. [ALPS02018327]. Do not update stackbackground winAnimator for starting window
    ...
    void getStackOffsets(int[] offsets) {
        /// M: [ALPS02079422] Return window offset replace stack offset for touch region
        offsets[0] = mXOffsetOfStackbound;
        offsets[1] = mYOffsetOfStackbound;
    }

    //boolean isMiniMax = false;
    
    /// M: BMW. [ALPS02079422] Window offset replace stack offset for touch region
    private int mXOffsetOfStackbound = 0, mYOffsetOfStackbound = 0; 
