...
public class PowerOffAlarmUtility {
    ...
    public void launchPowrOffAlarm(Boolean recover, Boolean shutdown) {
        ...
        mContext.sendBroadcast(new Intent(
                "android.intent.action.normal.boot"));
    }
    ...
    public static boolean isAlarmBoot() {
        ...
        String hwBootReason = SystemProperties.get("persist.sys.powerup_reason");
        Log.i(TAG, "hwBootReason ="+hwBootReason+" bootReason"+bootReason);
        boolean ret = (hwBootReason != null && hwBootReason.equals("C")) ?true:false;
        Log.i(TAG, "fengyalign add ret ="+ret);
        return ret;
    }
    // gepengfei modified for power off alarm end
