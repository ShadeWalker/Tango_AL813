...
/*<DTS2014112601808 huangwen 00181596 20141126 begin*/
    private static double mRatio = 1.0; 
...
/*<DTS2014112601808 huangwen 00181596 20141126 begin*/
        ...
        public void setLcdRatio(int ratio,boolean autoAdjust) {
            mIsAutoAdjust = autoAdjust;
            if ((ratio > 100) || (ratio < 1)) {
                mRatio = 1.0;
            } else {
                mRatio = ((double)ratio)/100.0;
            }
            setBrightness(mLcdBrightness);
        }
/*<DTS2014112601808 huangwen 00181596 20141126 end*/
...
/*<DTS2014112601808 huangwen 00181596 20141126 begin*/
            if((mId == LightsManager.LIGHT_ID_BACKLIGHT)) {
                ...
                if ( mRatio < 1.0 ) { //if ( (int)mRatio < 1 ) {
                    brightness = Utils.getRatioBright(brightness, mRatio);
                    Slog.v(TAG, "getRatioBright:" + brightness);
                }

                if (mIsAutoAdjust) {
                    brightness = Utils.getAutoAdjustBright(brightness);
                    Slog.v(TAG, "getAutoAdjustBright:" + brightness);
                }
            }
/*<DTS2014112601808 huangwen 00181596 20141126 end*/
            synchronized (this) {
