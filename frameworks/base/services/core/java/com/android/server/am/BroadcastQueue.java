...
/* DTS2014103001999 litao/185177 20141106 end> */
    static String TAG = "BroadcastQueue";
    ...
    final boolean dumpLocked(FileDescriptor fd, PrintWriter pw, String[] args,
        ...
        if (!Build.TYPE.equals("eng")) return needSep;/* HQ_guomiao 2015-10-27 modified for HQ01457385 */
    ...
    /* < DTS2014080606071 xuxuefei/00258670 20140808 begin */
    public void cleanupBroadcastLocked(ProcessRecord app) {
        //hook function;
    }
    /* DTS2014080606071 xuxuefei/00258670 20140808 end > */
}
