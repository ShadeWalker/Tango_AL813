...
/* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
    ...
    private static final boolean DBG = Build.TYPE.equals("eng"); // STOPSHIP if true/* HQ_guomiao 2015-10-29 modified for HQ01419645*/
    private static final boolean DBG_LOC = false; // STOPSHIP if true
    private static final boolean VDBG = Build.TYPE.equals("eng"); // STOPSHIP if true/* HQ_guomiao 2015-10-29 modified for HQ01419645*/
...
//        mConnectedApns = new ArrayList<String>();
    ...
    public void notifyDataConnectionForSubscriber(int subId, int state,
        ...
        synchronized (mRecords) {
            ...
            if (validatePhoneId(phoneId)) {
                ...
                //MTK START
                // VoLTE
                Integer nImsConnState = mImsDataConnState[phoneId].get(apnType);
                if (null != nImsConnState && nImsConnState.intValue() != state) {
                    mImsDataConnState[phoneId].put(apnType, state);
                    bIsIMSChanged = true;
                }
                if (DBG) {
    ...
    boolean idMatch(int rSubId, int subId) {
        ...
        if ((subId == -2)&&(rSubId == Integer.MAX_VALUE)) {
        	return true;
    	}
