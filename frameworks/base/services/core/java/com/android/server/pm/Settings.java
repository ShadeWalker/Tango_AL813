        ...
        if (p == null) {
            if (origPackage != null) {
                ...
                if ((pkgFlags&ApplicationInfo.FLAG_SYSTEM) == 0
                        || HwServiceFactory.isCustedCouldStopped(name, false, false)) {
                /* DTS2014051200015 xiongshiyi/00165767 20140512 end>*/
                    if (DEBUG_STOPPED) {
            ...
            try {
                ...
                for (final PackageSetting pkg : mPackages.values()) {
                    ...
                    if (gids != null && gids.length > 0) {
						...
						//add by mtk for Email get permission.WRITE_MEIDA_STORAGE(1023)
                        if(ai.packageName.equals("com.android.email")){
