...
/*< DTS2014052706261 taolan/00264981 20140619 begin*/
import android.graphics.Bitmap;
import android.graphics.BitmapFactory;
/* DTS2014052706261  taolan/00264981 20140619 end>*/

/**
 * This class provides a system service that manages input methods.
 */
 /*< DTS2014071202372  taolan/00264981 20140717 begin*/
public class InputMethodManagerService extends AbsInputMethodManagerService
	...
	int drawableID = mRes.getIdentifier("androidhwext:drawable/ic_notification_ime_emui", null, null);
        mImeSwitcherNotification.icon = drawableID;
        /* DTS2014101007196 guyue/00295151 20141117 end>*/
        /*< DTS2014052706261 taolan/00264981 20140619 begin*/
	int largeDrawableID = mRes.getIdentifier("androidhwext:drawable/ic_notification_ime_default_large", null, null);
        Bitmap bmp = BitmapFactory.decodeResource(mRes, largeDrawableID);
        if(bmp != null){
            mImeSwitcherNotification.largeIcon = bmp; 
        }
        /* DTS2014052706261  taolan/00264981 20140619 end>*/
    ...
    private void resetStateIfCurrentLocaleChangedLocked() {
		//add by chiguoqing for HQ01648380
...
//            mDialogBuilder = new AlertDialog.Builder(themedContext);
            ...
            ContextThemeWrapper themeContext = new ContextThemeWrapper(context, themeID);
            mDialogBuilder = new AlertDialog.Builder(themeContext, themeID)
	    ...
	    int layoutID = context.getResources().getIdentifier("androidhwext:layout/input_method_switch_dialog_title_emui", null, null);
	    ...
	    int resID = context.getResources().getIdentifier("androidhwext:id/hard_keyboard_section", null, null);
            mSwitchingDialogTitleView
                    .findViewById(resID)
                    .setVisibility(mWindowManagerService.isHardKeyboardAvailable()
                            ? View.VISIBLE : View.GONE);
	    resID = context.getResources().getIdentifier("androidhwext:id/hard_keyboard_switch", null, null);
            final Switch hardKeySwitch = (Switch)mSwitchingDialogTitleView.findViewById(
                    resID);
            ...
            /*<DTS2014101007196 guyue/00295151 20141117 begin*/
            final ImeSubtypeListAdapter adapter = new ImeSubtypeListAdapter(themeContext,
                    com.android.internal.R.layout.simple_list_item_2_single_choice, imList, checkedItem);
            /*<DTS2014101007196 guyue/00295151 20141117 end*/
            ...
            /*<DTS2014101007196 guyue/00295151 20141117 begin*/
		int stringID = context.getResources().getIdentifier("androidhwext:string/configure_input_methods_new", null, null);
                mDialogBuilder.setPositiveButton(
                        stringID, positiveListener);
            }
            /*DTS2014101007196 guyue/00295151 20141117 end >*/
    ...
    private static class ImeSubtypeListAdapter extends ArrayAdapter<ImeSubtypeListItem> {
        ...
        public ImeSubtypeListAdapter(Context context, int textViewResourceId,
            ...
            /*<DTS2014101007196 guyue/00295151 20141117 begin*/
            final TypedArray array = context.obtainStyledAttributes(null, com.android.internal.R.styleable.Theme, 0, 0);
            mTextColorPri = array.getColor(com.android.internal.R.styleable.Theme_textColorPrimary, 0);
            mTextColorSec = array.getColor(com.android.internal.R.styleable.Theme_textColorSecondary, 0);
            /*<DTS2014101007196 guyue/00295151 20141117 end*/
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            /*<DTS2014101007196 guyue/00295151 20141117 begin*/
            if (mTextColorPri != 0) {
                firstTextView.setTextColor(mTextColorPri);
            }
            if (mTextColorSec != 0) {
                secondTextView.setTextColor(mTextColorSec);
            }
            /*<DTS2014101007196 guyue/00295151 20141117 end*/
            if (TextUtils.isEmpty(subtypeName)) {
                ...
                /*< DTS2014101007196 guyue/00295151 20141117 begin */
                //revert display seq of two views
                //HQ_hushunli 2015-10-26 add for HQ01465797 begin
                if (subtypeName.toString().startsWith("Српски")) {
                    secondTextView.setText(subtypeName.toString().replace("Српски", "Srpski"));
                } else {
                    //HQ_hushunli 2015-11-16 add for HQ01496783 begin
                    int startIndex = subtypeName.toString().indexOf("(");
                    if (SystemProperties.get("ro.hq.aosp.nocountryinfo").equals("1") && startIndex != -1) {
                        secondTextView.setText(subtypeName.toString().substring(0, startIndex));
                    } else {
                        secondTextView.setText(subtypeName);
                    }
                    //HQ_hushunli 2015-11-16 add for HQ01496783 end
                }
                //HQ_hushunli 2015-10-26 add for HQ01465797 end
                firstTextView.setText(imeName);
                /* DTS2014101007196 guyue/00295151 20141117 end >*/
