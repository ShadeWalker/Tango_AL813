...
public final class BatteryStatsService extends IBatteryStats.Stub
    ...
    public void noteStartSensor(int uid, int sensor) {
        ...
        if (uid >= Process.FIRST_APPLICATION_UID) {
            LogPower.push(LogPower.ENABLE_SENSOR, Integer.toString(uid), Integer.toString(sensor));
        }
        /* DTS2014112601808 huangwen 00181596 20141126 end>*/
    }
    ...
    public void noteStopSensor(int uid, int sensor) {
        ...
        /*<DTS2014112601808 huangwen 00181596 20141126 begin */
        if (uid >= Process.FIRST_APPLICATION_UID) {
            LogPower.push(LogPower.DISABLE_SENSOR, Integer.toString(uid), Integer.toString(sensor));
        }
        /* DTS2014112601808 huangwen 00181596 20141126 end>*/
    }
    ...
    public void noteStartGps(int uid) {
        ...
        synchronized (mStats) {
            ...
            /*<DTS2014112601808 huangwen 00181596 20141126 begin */
            LogPower.push(LogPower.GPS_START, Integer.toString(uid));//qindiwen
            /* DTS2014112601808 huangwen 00181596 20141126 end>*/
        }
    }
    ...
    public void noteStopGps(int uid) {
        ...
        synchronized (mStats) {
            ...
            /*<DTS2014112601808 huangwen 00181596 20141126 begin */
            LogPower.push(LogPower.GPS_END, Integer.toString(uid));//qindiwen
            /* DTS2014112601808 huangwen 00181596 20141126 end>*/
        }
    }
