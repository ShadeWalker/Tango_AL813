...
/* DTS2014102002680 taolan/00264981 20141107 end> */
    ...
    static String TAG = ActivityManagerService.TAG;
    static String TAG_MU = ActivityManagerService.TAG_MU;
        ...
        void rescheduleDelayedStarts() {
            ...
            while (mDelayedStartList.size() > 0
                ...
                if (r.pendingStarts.size() <= 0) {
                    ...
                    /*< DTS2014050501312 qianpeng/00227536 20140505 begin */
                    continue;
                    /* DTS2014050501312 qianpeng/00227536 20140505 end >*/
                }
    ...
    int bindServiceLocked(IApplicationThread caller, IBinder token,
        ...
        try {
            ...
            /*<DTS2013080907908 lifei/00129990 20130809 begin */
            if(b.client != null){
                b.client.connections.add(c);
            }
            /*DTS2013080907908 lifei/00129990 20130809 end>*/
            /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
            //[HSM]
            mAm.smartTrimAddProcessRelation_HwSysM(b, c.binding);
    ...
    private final String bringUpServiceLocked(ServiceRecord r,
        ...
        if (mRestartingServices.remove(r)) {
            /*<DTS2015011701417 zhudengkui / 00180854 20150117 begin */
            r.resetRestartCounter();
            /* DTS2015011701417 zhudengkui / 00180854 20150117 end>*/
            clearRestartingIfNeededLocked(r);
        }
        ...
        if (!c.serviceDead) {
            ...
            if (s.app != null && s.app.thread != null && b.intent.apps.size() == 0
                ...
                try {
                    ...
                    /*<DTS2014071106373 zhudengkui / 00180854 20140723 begin */
                    if (!s.app.killedByAm) {
                        serviceProcessGoneLocked(s);
                    }
                    /* DTS2014071106373 zhudengkui / 00180854 20140723 end>*/
                }
            }
    ...
    private boolean collectForceStopServicesLocked(String name, int userId,
        ...
        for (int i=0; i<services.size(); i++) {
            ...
            if (service != null && service.packageName.equals("com.cootek.smartdialer_oem_module")) {
                Slog.i(TAG, " Please do not remove " + service);
                continue;
            }
    ...
    void serviceTimeout(ProcessRecord proc) {
        ...
        synchronized(mAm) {
            ...
            if (timeout != null && mAm.mLruProcesses.contains(proc)) {
                ...
                msg.obj = proc;
                /* < DTS2014041608602 zhangqian00186201 20140416 begin */
                if (nextTime == 0) {
                    Slog.e(TAG, "nextTime invaild, remove the message");
                    mAm.mHandler.removeMessages(ActivityManagerService.SERVICE_TIMEOUT_MSG, proc);
                } else {
                   mAm.mHandler.sendMessageAtTime(msg, proc.execServicesFg
                         ? (nextTime+SERVICE_TIMEOUT) : (nextTime + SERVICE_BACKGROUND_TIMEOUT));
                }
                /*  DTS2014041608602 zhangqian00186201 20140416  end > */
            }
        }
