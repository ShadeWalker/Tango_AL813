    ...
    public void systemRunning() {
        ...
        if (isFirstBoot) {
           ...
           if ("".equals(decryptState) || DECRYPT_STATE.equals(decryptState)) {
              ...
              today.set(0, 8, 8, 8, 0, mDefaultYear);/*HQ_jiangchao modified for the factory default time at 20151009*/ /*HQ_daiwenqiang modified for the factory default time at 20151231 HQ01612490*/
