        ...
        */
        public void notifyActivityState(String packageName, String className, IActivityStateNotifier.ActivityState actState) {
            ...
            case Destroyed:
                ...
                break;
            case Stopped:
                state = PerfService.STATE_STOPPED;
                break;
            default:
                return;
            }
            PerfService.nativePerfNotifyAppState(packageName, className, state, 0);
        }
        ...
        */
        public void notifyAppDied(int pid, HashSet<String> packageList)
        {
            ...
            while (i.hasNext()) {
                ...
                PerfService.nativePerfNotifyAppState(packageName, null, PerfService.STATE_DEAD, pid);
            }
        }
