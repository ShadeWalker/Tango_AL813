...
public class StatusBarManagerService extends IStatusBarService.Stub {
    ...
    /*	HQ_xionghaifeng 20150724 for HWSystemUI crash start
        if (mBar != null) {
            try {
                Xlog.d(TAG, "showSimIndicator , businiss is " + businessType +
                    ", indicatorID is " + indicatorID + ".");
                mBar.showSimIndicator(businessType, indicatorID);
            } catch (RemoteException ex) {
        ...
        HQ_xionghaifeng 20150724 for HWSystemUI crash end */
    }
