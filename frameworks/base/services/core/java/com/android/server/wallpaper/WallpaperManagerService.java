...
public class WallpaperManagerService extends IWallpaperManager.Stub {
        ...
        public void onEvent(int event, String path) {
            ...
            synchronized (mLock) {
                ...
                if (mWallpaperFile.equals(changedFile)) {
                    ...
                    handleWallpaperObserverEvent(mWallpaper);
                    ...
                    if (mWallpaper.wallpaperComponent == null
                        ...
                        if (written) {
                         ...
                         /*< DTS2014070104107 zhaifeng/00107904 20140701 begin */
                        bindWallpaperComponentLocked(mImageWallpaper, false,
                                false, mWallpaper, null);
                        /* DTS2014072105745 zhaifeng/00107904 20140721 end >*/
    ...
    class WallpaperData {
        ...
        /*   DTS2014110704417 liuyang/00281952 20141107 end > */
        /* < DTS2014110707891 zhangxinming/00181848 20141107 begin */
        public void setWidth(int w) {
            width = w;
        }
        /*   DTS2014110707891 zhangxinming/00181848 20141107 end > */
    }
    ...
    private void loadSettingsLocked(int userId) {
        ...
        if (wallpaper.width < baseSize) {
            /* < DTS2014110707891 zhangxinming/00181848 20141107 begin */
            if (!getHwWallpaperWidth(wallpaper, success)) {
    ...
    protected boolean getHwWallpaperWidth(WallpaperData wallpaper, boolean success) {
        // Hook, impl in HwWallpaperManagerService
        return false;
    }
    /*   DTS2014110707891 zhangxinming/00181848 20141107 end > */
    /* < DTS2014110704417 liuyang/00281952 20141107 begin */
