...
public class TelecomManager {
    ...
    /// M: For 3G VT only @{
    /**
     * Determine whether the device support ViLTE or 3G VT.
     *
     * @return {@code true} if the device is video-call-supported and {@code false} otherwise.
     * @hide
     */
    public boolean isVideoEnabled() {
        return ((SystemProperties.get("ro.mtk_vilte_support").equals("1")) ||
                (SystemProperties.get("ro.mtk_vt3g324m_support").equals("1")));
    }
    /// @}
    /// @}
}
