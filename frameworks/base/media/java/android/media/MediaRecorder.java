...
public class MediaRecorder
{
    ...
    /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
    private boolean mIsMediaRecoderRecordingPaused = false;//add by wangmingyue for HQ01258234
    ...
    public void setPreviewDisplay(Surface sv) {
        /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
        //[HSM]
        mSurface = mPerm.setPreviewDisplay(sv);
        /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
    }
    ...
    private native void native_setVideoSource(int video_source)
            throws IllegalStateException;
    ...
    /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
    //[HSM]
    public native void _setOutputFile(FileDescriptor fd, long offset, long length)
    ...
    public void prepare() throws IllegalStateException, IOException
    {
        ...
        //[HSM]
        if (mPath != null) {
            /* < DTS2014053103746 yubinke/y00159260 20140531 begin */
            mPerm.setOutputFile(this, mPath, 0, 0);
            /* DTS2014053103746 yubinke/y00159260 20140531 end > */
        } else if (mFd != null) {
            mPerm.setOutputFile(this, mFd, 0, 0);
            /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
        } else {
   ...
   //add by wangmingyue for HQ01258234 begin
  	public void pause(){
  		try{
    ...
    //add by wangmingyue for HQ01258234 end
