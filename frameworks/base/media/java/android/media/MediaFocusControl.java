...
public class MediaFocusControl implements OnFinished {
    ...
    protected int requestAudioFocus(AudioAttributes aa, int focusChangeHint, IBinder cb,
        ...
        /*<DTS2014112601808 huangwen 00181596 20141126 begin */
        if ((AudioManager.STREAM_MUSIC == AudioAttributes.toLegacyStreamType(aa))/* || (AudioManager.STREAM_FM == mainStreamType)*/) {
            LogPower.push(LogPower.AUDIO_START,callingPackageName,Integer.toString(AudioAttributes.toLegacyStreamType(aa)));
        }
        /*<DTS2014112601808 huangwen 00181596 20141126 end */
