...
public class AudioRecord
{
    ...
    /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
    //[HSM]
    private HwAudioPermWrapper mPermission = new HwAudioPermWrapper();
    /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
    ...
    public int read(byte[] audioData, int offsetInBytes, int sizeInBytes) {
        ...
        /* < DTS2014052000650 yubinke/y00159260 20140520 begin */
        //[HSM]
        int recordSize = native_read_in_byte_array(audioData, offsetInBytes, sizeInBytes);
        /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
        if (mPermission.isBlocked()) {
            return mPermission.mockRead(audioData, offsetInBytes, recordSize);
        }
        /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/

        return recordSize;
        /* DTS2014052000650 yubinke/y00159260 20140520 end > */
    }
    ...
    public int read(short[] audioData, int offsetInShorts, int sizeInShorts) {
        ...
        /* < DTS2014052000650 yubinke/y00159260 20140520 begin */
        //[HSM]
        int recordSize = native_read_in_short_array(audioData, offsetInShorts, sizeInShorts);
        /* <DTS2014042818262 xiongshiyi/00165767 20140428 begin */
        if (mPermission.isBlocked()) {
            return mPermission.mockRead(audioData, offsetInShorts, recordSize);
        }
        /* DTS2014042818262 xiongshiyi/00165767 20140428 end>*/
