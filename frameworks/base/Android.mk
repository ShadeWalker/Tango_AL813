...
# HQ:add huaqin resource path
huaqin-res-source-path := APPS/hq-res_intermediates/src
...
# DTS2014072605388 litao/185177 20140726 begin
-include $(TOP)/vendor/huawei/Emui/frameworks/hwCommInterface/base/hwCommInterface.mk
# DTS2014072605388 litao/185177 20140726 end
# EventLogTags files.
LOCAL_SRC_FILES += \
...
# DTS2014042600654 taolan/00264981 20140426 begin
LOCAL_SRC_FILES += $(call all-java-files-under,  ../../vendor/huawei/Emui/frameworks/hwCommInterface/base/core/java/android/app/)
LOCAL_SRC_FILES += $(call all-java-files-under,  ../../vendor/huawei/Emui/frameworks/hwCommInterface/base/core/java/android/view/)
LOCAL_SRC_FILES += $(call all-java-files-under,  ../../vendor/huawei/Emui/frameworks/hwCommInterface/base/core/java/android/widget/)
# DTS2014042600654 taolan/00264981 20140426 end
...
LOCAL_SRC_FILES += \
	...
	core/java/com/huawei/securitymgr/IAuthenticationClient.aidl \
	core/java/com/huawei/securitymgr/IAuthenticationClientExt.aidl \
	core/java/com/huawei/securitymgr/IAuthenticationService.aidl \
	...
	wifi/java/android/net/wifi/IWifiOffListener.aidl \
...
# wangyi add for APR
LOCAL_SRC_FILES += core/java/com/huawei/lcagent/client/ILogCollect.aidl
...
LOCAL_SRC_FILES += core/java/android/os/IMultiWinService.aidl
#MW Integration MW_callback_requirement
LOCAL_SRC_FILES += core/java/android/os/IMultiWinServiceCallBack.aidl
...
# @}
# M:add huaqin resource R.java into framework,@{
LOCAL_INTERMEDIATE_SOURCES += \
                        $(huaqin-res-source-path)/com/hq/resource/internal/R.java \
                        $(huaqin-res-source-path)/com/hq/resource/R.java
# @}
...
#LOCAL_STATIC_JAVA_LIBRARIES += TouchPalOemModule

LOCAL_DX_FLAGS := --core-library --multi-dex

LOCAL_RMTYPEDEFS := true

# DTS2014121806604 yinwenshuai/00211458 20141218 begin
LOCAL_JAR_EXCLUDE_PACKAGES := huawei/android/widget
# DTS2014121806604 yinwenshuai/00211458 20141218 end
...
# @}
# HQ:add huaqin resource dependes framework->hq_res->mediatek_res->framework_res,@{
huaqin_res_R_stamp := \
        $(call intermediates-dir-for,APPS,hq-res,,COMMON)/src/R.stamp
$(full_classes_compiled_jar): $(hq_res_R_stamp)
# @}
...
#include $(CLEAR_VARS)
#LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES :=TouchPalOemModule:core/java/com/mediatek/geocoding/TouchPalOemModule47.jar
#include $(BUILD_MULTI_PREBUILT)
