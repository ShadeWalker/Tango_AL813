...
class WebViewChromium implements WebViewProvider,
    ...
    public boolean savePage() {
        try {
            return
                (Boolean) mAwContents.getClass().getDeclaredMethod("savePage").invoke(mAwContents);
        } catch (NoSuchMethodException ex) {
            Log.e(TAG, "No such method for awcontents save page:" + ex);
            return false;
        } catch (NullPointerException ex) {
            Log.e(TAG, "Null pointer for awcontents save page:" + ex);
            return false;
        } catch (IllegalAccessException ex) {
            Log.e(TAG, "Illegal access for awcontents save page:" + ex);
            return false;
        } catch (InvocationTargetException e) {
            Log.e(TAG, "Invocation target exception for awcontents save page: " + e);
            return false;
        }
    }
    /// @}
    ...
    /* < DTS2014112906493 l00214371 20141202 ContextMenu_Select_Text begin */
    //@Override
    public void selectText() {
        mAwContents.selectText();
     }
    /*   DTS2014112906493 l00214371 20141202 ContextMenu_Select_Text end >*/
    ...
    public void setSavePageClient(SavePageClient client) {
        mContentsClientAdapter.setSavePageClient(client);
    }
    /// @}
...
//    @Override
    ...
    /* <DTS2014120808002 l00214315, add adblock feature begin */
     @Override
     public void setEnableAdblockFeature(final boolean enable) {
        if (checkNeedsPost()) {
            mRunQueue.addTask(new Runnable() {
                @Override
                public void run() {
                    setEnableAdblockFeature(enable);
                }
            });
            return;
        }
        mAwContents.setEnableAdblockFeature(enable);
     }
    /*  DTS2014120808002 l00214315, add adblock feature end > */
