...
public class ContentSettingsAdapter extends android.webkit.WebSettings {
    ...
    /* < DTS2014120403680 l00214371 Force_Zoom 20141204 begin */
    @Override
    public  void setForceUserScalable(boolean support) {
        mAwSettings.setForceUserScalable(support);
    }
    /*   DTS2014120403680 l00214371 Force_Zoom 20141204 end > */
    ...
    public void setSavePassword(boolean save) {
        ...
        try {
            Class<?> c = mAwSettings.getClass();
            Method m = c.getMethod("setSavePassword", boolean.class);
            m.invoke(mAwSettings, save);
        } catch (NoSuchMethodException e) {
            Log.e(LOGTAG, "No such method for save password: " + e);
        } catch (IllegalAccessException e) {
            Log.e(LOGTAG, "Illegal access for save password:" + e);
        } catch (InvocationTargetException e) {
            Log.e(LOGTAG, "Invocation target exception for save password: " + e);
        } catch (NullPointerException e) {
            Log.e(LOGTAG, "Null pointer for save password: " + e);
        }
    }
    ...
    public void setDoubleTapZoom(int doubleTapZoom) {
        ...
        try {
            ...
            Log.e(LOGTAG, "No such method for setDoubleTapZoom: " + e);
        } catch (IllegalAccessException e) {
            Log.e(LOGTAG, "Illegal access for setDoubleTapZoom:" + e);
        } catch (InvocationTargetException e) {
            Log.e(LOGTAG, "Invocation target exception for setDoubleTapZoom: " + e);
        } catch (NullPointerException e) {
            Log.e(LOGTAG, "Null pointer for setDoubleTapZoom: " + e);
        }
    }
