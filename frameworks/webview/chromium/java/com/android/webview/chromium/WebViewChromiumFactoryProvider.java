    ...
    public WebViewDatabase getWebViewDatabase(Context context) {
        synchronized (mLock) {
            if (mWebViewDatabase == null) {
                ...
                try {
                    Class<?> c = browserContext.getClass();
                    Method method =
                        c.getMethod("getPasswordDatabase", Context.class);
                    Object obj =
                        method.invoke(browserContext, context);
                    ...
                    Log.e(TAG, "No such method for save password: " + e);
                } catch (IllegalAccessException e) {
                    Log.e(TAG, "Illegal access for save password:" + e);
                } catch (InvocationTargetException e) {
                    Log.e(TAG, "Invocation target exception for save password: " + e);
                } catch (NullPointerException e) {
                    Log.e(TAG, "Null pointer for save password: " + e);
                }
                mWebViewDatabase = new WebViewDatabaseAdapter(
                        browserContext.getFormDatabase(),
                        browserContext.getHttpAuthDatabase(context));
